...
export default (path: string): void => {
  ...
  loadClosureCollection.Dispatch.ckeditor = loadClosureFactory(`${path}dispatch/ckeditor.js`);
  loadClosureCollection.Dispatch.emoditor = loadClosureFactory(`${path}dispatch/emoditor.js`);
  ...
  loadClosureCollection.Dispatch.Edit._emojiedit = loadClosureFactory(`${path}dispatch/edit/_emojiedit.js`);
  ...
  assignLoadClosure('ACMS.Dispatch._ckeditorPre', loadClosureCollection.Dispatch.ckeditor);
  assignLoadClosure('ACMS.Dispatch._ckeditorPost', loadClosureCollection.Dispatch.ckeditor);
  assignLoadClosure('ACMS.Dispatch.highslide', loadClosureCollection.Dispatch.highslide);
  assignLoadClosure('ACMS.Dispatch.ckeditor', loadClosureCollection.Dispatch.ckeditor);
  assignLoadClosure('ACMS.Dispatch.emoditor', loadClosureCollection.Dispatch.emoditor);
  ...
  assignLoadClosure('ACMS.Dispatch.Edit._emojiedit', loadClosureCollection.Dispatch.Edit._emojiedit);
