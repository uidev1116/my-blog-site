...
export default class MediaModal extends Component<MediaModalProp, MediaModalState> {
  ...
  render() {
    ...
    const {
      loading, open, preview, copied, previewWidth, previewHeight, pdfHasPrevPage, pdfHasNextPage
    } = this.state;
                  ...
                  <form className="acms-admin-form" ref={(form: HTMLFormElement) => { this.form = form; }}>
                    <div className="acms-admin-grid">
                      <div className="acms-admin-col-md-6">
                        ...
                        <div className="acms-admin-media-thumb-container acms-admin-margin-bottom-small acms-admin-media-thumb-container-assets">
                          <div className="acms-admin-media-thumb-wrap" style={{ width: 'auto' }}>
                            <img src={item.media_thumbnail} style={{ margin: 'auto', display: 'block', width: '70%' }} />
                          </div>
                          <div style={{ marginTop: '5px' }} className="acms-admin-media-thumb-pager">
                            {pdfHasPrevPage && <button className="acms-admin-media-thumb-pager-arrow acms-admin-media-thumb-pager-arrow-left" onClick={this.pdfPrevPage.bind(this)}><span className="acms-admin-icon-arrow-small-left"></span><span className="acms-admin-hide-visually">前ページ</span></button>}
                            {pdfHasNextPage && <button className="acms-admin-media-thumb-pager-arrow acms-admin-media-thumb-pager-arrow-right" onClick={this.pdfNextPage.bind(this)}><span className="acms-admin-icon-arrow-small-right"></span><span className="acms-admin-hide-visually">次ページ</span></button>}
                          </div>
                          <p className="acms-admin-media-thumb-ext">{item.media_title}</p>
                        </div>
                        }
                              ...
                              {item.media_type === 'file' && <tr>
                                ...
                                <td>
                                  <div className="acms-admin-form-action">
                                    <input type="text" value={item.media_path} readOnly
                                    ...
                                    >
                                      <span className="acms-admin-form-side-btn">
                                        <button type="button"
                                                className="acms-admin-btn">{ACMS.i18n("media.copy")}</button>
                                      </span>
                                    </CopyToClipboard>
                                  </div>
                                  <p style={{fontSize: '12px', marginTop: '5px'}}
                                     className="acms-admin-text-primary">{ACMS.i18n("media.intrinsic_link_attention")}</p>
                                </td>
                              </tr>}
                              <tr>
                          ...
                          <table className="acms-admin-table-admin-media-edit">
                            <tbody>
                              ...
                              <tr style={{display: (typeof ACMS !== 'undefined' && ACMS.Config && ACMS.Config.mediaShowAltAndCaptionOnModal) ? 'table-row' : 'none'}}>
                                ...
                                <td>
                                  <input type="text" value={item.media_caption} name="field_1" className="acms-admin-form-width-full" onInput={(e) => { this.onInput(e, 'media_caption'); }} />
                              ...
                              <tr style={{display: (typeof ACMS !== 'undefined' && ACMS.Config && ACMS.Config.mediaShowAltAndCaptionOnModal) ? 'table-row' : 'none'}}>
                                ...
                                <td>
                                  <input type="text" value={item.media_alt} name="field_3" className="acms-admin-form-width-full" onInput={(e) => { this.onInput(e, 'media_alt'); }} />
                              ...
                              <tr>
                                <th className="acms-admin-table-nowrap">{ACMS.i18n("media.details")}<i className="acms-admin-icon-tooltip acms-admin-margin-left-mini js-acms-tooltip-hover" data-acms-position="top" data-acms-tooltip={ACMS.i18n("media.details_settings")}></i></th>
                                <td>
