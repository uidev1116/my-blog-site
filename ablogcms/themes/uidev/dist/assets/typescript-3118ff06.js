import { H as a } from './vendor-b4af7ed9.js'
/*!-----------------------------------------------------------------------------
    ...
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let n of g(e))
        !l.call(t, n) &&
          ...
          c(t, n, {
            get: () => e[n],
            enumerable: !(i = p(e, n)) || i.enumerable,
          })
    return t
  },
  d = (t, e, o) => (s(t, e, 'default'), o && s(o, e, 'default')),
  r = {}
d(r, a)
var x = {
    wordPattern:
    ...
    onEnterRules: [
      ...
      {
        beforeText: /^(\t|(\ \ ))*\ \*\/\s*$/,
        action: { indentAction: r.languages.IndentAction.None, removeText: 1 },
      },
    ],
    autoClosingPairs: [
      { open: '{', close: '}' },
