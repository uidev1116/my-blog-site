...
var dc = (Ge, Me, Ae) =>
  Me in Ge
    ? hc(Ge, Me, { enumerable: !0, configurable: !0, writable: !0, value: Ae })
    : (Ge[Me] = Ae)
var je = (Ge, Me, Ae) => (dc(Ge, typeof Me != 'symbol' ? Me + '' : Me, Ae), Ae)
;(function () {
  'use strict'
  class Ge {
    constructor() {
...
` +
  ...
  function ci(e) {
    if (e instanceof Error) {
      ...
      return {
        ...
        message: n,
        stack: i,
        noTelemetry: Ze.isErrorNoTelemetry(e),
      }
    }
    return e
  }
  ...
  function ka(e) {
    return e instanceof Aa
      ? !0
      : e instanceof Error && e.name === rn && e.message === rn
  }
  class Aa extends Error {
    constructor() {
      super(rn), (this.name = this.message)
    }
  }
  ...
  ;(function (e) {
    ...
    e.from = a
    function* u(A) {
      for (let M = A.length - 1; M >= 0; M--) yield A[M]
    }
    e.reverse = u
    function o(A) {
    ...
    e.first = l
    function c(A, M) {
      for (const R of A) if (M(R)) return !0
      return !1
    }
    e.some = c
    function d(A, M) {
      for (const R of A) if (M(R)) return R
    }
    e.find = d
    function* m(A, M) {
      for (const R of A) M(R) && (yield R)
    }
    e.filter = m
    function* f(A, M) {
      let R = 0
      for (const D of A) yield M(D, R++)
    }
    e.map = f
    function* w(...A) {
      for (const M of A) yield* M
    }
    e.concat = w
    function g(A, M, R) {
      let D = R
      for (const b of A) D = M(D, b)
      return D
    }
    e.reduce = g
    function* S(A, M, R = A.length) {
      for (
        M < 0 && (M += A.length),
          R < 0 ? (R += A.length) : R > A.length && (R = A.length);
        M < R;
        M++
      )
        yield A[M]
    ...
    e.slice = S
    function x(A, M = Number.POSITIVE_INFINITY) {
      const R = []
      if (M === 0) return [R, A]
      const D = A[Symbol.iterator]()
      for (let b = 0; b < M; b++) {
        const p = D.next()
        if (p.done) return [R, e.empty()]
        R.push(p.value)
      }
      return [
        R,
    ...
    async function T(A) {
      const M = []
      for await (const R of A) M.push(R)
  ...
  pt.None = Object.freeze({ dispose() {} })
  let Q = class li {
    constructor(t) {
      ;(this.element = t),
        (this.next = li.Undefined),
        (this.prev = li.Undefined)
    }
  }
  ...
  class Ca {
    ...
    _insert(t, n) {
      const i = new Q(t)
      if (this._first === Q.Undefined) (this._first = i), (this._last = i)
      else if (n) {
        const s = this._last
    ...
    _remove(t) {
      if (t.prev !== Q.Undefined && t.next !== Q.Undefined) {
        ...
        t.prev === Q.Undefined && t.next === Q.Undefined
          ...
          : t.next === Q.Undefined
          ? ((this._last = this._last.prev), (this._last.next = Q.Undefined))
          : t.prev === Q.Undefined &&
            ((this._first = this._first.next), (this._first.prev = Q.Undefined))
      this._size -= 1
    }
    *[Symbol.iterator]() {
      let t = this._first
  ...
  ;(function (e) {
    e.None = () => pt.None
    function t(v, _) {
      return d(v, () => {}, 0, void 0, !0, void 0, _)
    }
    e.defer = t
    function n(v) {
      return (_, L = null, y) => {
        ...
        return (
          (N = v(
            (I) => {
              if (!C) return N ? N.dispose() : (C = !0), _.call(L, I)
            },
            null,
            y,
          )),
    ...
    e.once = n
    function i(v, _, L) {
      return l((y, C = null, N) => v((I) => y.call(C, _(I)), null, N), L)
    }
    e.map = i
    function r(v, _, L) {
      return l(
    ...
    e.forEach = r
    function s(v, _, L) {
      return l((y, C = null, N) => v((I) => _(I) && y.call(C, I), null, N), L)
    }
    e.filter = s
    function a(v) {
      return v
    ...
    function u(...v) {
      return (_, L = null, y) => {
        const C = La(...v.map((N) => N((I) => _.call(L, I))))
        return c(C, y)
      }
    }
    e.any = u
    ...
    function l(v, _) {
      ...
      const y = {
        ...
        C = new _e(y)
      return _ == null || _.add(C), C.event
    }
    function c(v, _) {
      return _ instanceof Array ? _.push(v) : _ && _.add(v), v
    }
    function d(v, _, L = 100, y = !1, C = !1, N, I) {
      let P,
        U,
        W,
        G = 0,
      ...
      const le = {
          ...
          onWillAddFirstListener() {
            P = v((oi) => {
              G++,
                ...
                typeof L == 'number'
                  ? (clearTimeout(W), (W = setTimeout($, L)))
                  : W === void 0 && ((W = 0), queueMicrotask($))
            })
          },
        ...
        ke = new _e(le)
      return I == null || I.add(ke), ke.event
    }
    e.debounce = d
    function m(v, _ = 0, L) {
      return e.debounce(
    ...
    e.latch = f
    function w(v, _, L) {
      return [e.filter(v, _, L), e.filter(v, (y) => !_(y), L)]
    }
    e.split = w
    function g(v, _ = !1, L = [], y) {
      let C = L.slice(),
        N = v((U) => {
          C ? C.push(U) : P.fire(U)
        })
      y && y.add(N)
      const I = () => {
          C == null || C.forEach((U) => P.fire(U)), (C = null)
        },
        P = new _e({
          onWillAddFirstListener() {
            N || ((N = v((U) => P.fire(U))), y && y.add(N))
          },
    ...
    class T {
      ...
      forEach(_) {
        return this.steps.push((L) => (_(L), L)), this
      }
      filter(_) {
        return this.steps.push((L) => (_(L) ? L : x)), this
      }
      reduce(_, L) {
        let y = L
        return this.steps.push((C) => ((y = _(y, C)), y)), this
      }
      latch(_ = (L, y) => L === y) {
        let L = !0,
          y
        return (
          this.steps.push((C) => {
            const N = L || !_(C, y)
            return (L = !1), (y = C), N ? C : x
          }),
          this
        )
      }
      evaluate(_) {
        for (const L of this.steps) if (((_ = L(_)), _ === x)) break
        return _
      }
    }
    function A(v, _, L = (y) => y) {
      const y = (...P) => I.fire(L(...P)),
        C = () => v.on(_, y),
        N = () => v.removeListener(_, y),
        I = new _e({ onWillAddFirstListener: C, onDidRemoveLastListener: N })
      return I.event
    }
    e.fromNodeEventEmitter = A
    function M(v, _, L = (y) => y) {
      const y = (...P) => I.fire(L(...P)),
        C = () => v.addEventListener(_, y),
        N = () => v.removeEventListener(_, y),
        I = new _e({ onWillAddFirstListener: C, onDidRemoveLastListener: N })
      return I.event
    }
    e.fromDOMEventEmitter = M
    function R(v) {
      return new Promise((_) => n(v)(_))
    }
    e.toPromise = R
    function D(v) {
      const _ = new _e()
    ...
    class p {
      constructor(_, L) {
        ...
        ;(this.emitter = new _e(y)), L && L.add(this.emitter)
      }
      beginUpdate(_) {
        this._counter++
      }
    ...
    function k(v, _) {
      return new p(v, _).emitter.event
    }
    e.fromObservable = k
    function H(v) {
      return (_, L, y) => {
        ...
        const I = {
          ...
          endUpdate() {
            C--, C === 0 && (v.reportChanges(), N && ((N = !1), _.call(L)))
          },
        ...
        v.addObserver(I), v.reportChanges()
        const P = {
          dispose() {
            v.removeObserver(I)
          },
        }
        return y instanceof Ke ? y.add(P) : Array.isArray(y) && y.push(P), P
      }
    }
  ...
  class et {
    ...
    start(t) {
      ;(this._stopWatch = new Mt()), (this.listenerCount = t)
    }
    stop() {
      if (this._stopWatch) {
  ...
  ;(et.all = new Set()), (et._idPool = 0)
  let Ra = -1
  class Ma {
    constructor(t, n, i = Math.random().toString(18).slice(2, 5)) {
  ...
  class an {
    static create() {
      var t
      const n = new Error()
      return new an((t = n.stack) !== null && t !== void 0 ? t : '')
    }
    constructor(t) {
      this.value = t
    }
...
`),
  ...
  class _e {
      ...
      ;(this._size = 0),
        ...
        (this._leakageMon =
          ...
          n.leakWarningThreshold
            ? new Ma(
                (i = t == null ? void 0 : t.onListenerError) !== null &&
                i !== void 0
                  ? i
                  : Ae,
                (s =
            ...
            : void 0),
        (this._perfMon =
          !((a = this._options) === null || a === void 0) && a._profName
        ...
        ((t = this._event) !== null && t !== void 0) ||
          (this._event = (n, i, r) => {
            ...
            if (
              ...
              console.warn(g)
              const S =
                  (s = this._leakageMon.getMostFrequentStack()) !== null &&
                  s !== void 0
                    ? s
                    : ['UNKNOWN stack', -1],
                x = new Da(
                  `${g}. HINT: Stack shows most frequent listener (${S[1]}-times)`,
                  S[0],
                )
              return (
                (
                  ((a = this._options) === null || a === void 0
                    ? void 0
                    : a.onListenerError) || Ae
                )(x),
                pt.None
              )
            }
            if (this._disposed) return pt.None
            i && (n = n.bind(i))
            const m = new on(n)
            let f
            this._leakageMon &&
              ...
              ((m.stack = an.create()),
              (f = this._leakageMon.check(m.stack, this._size + 1))),
              this._listeners
                ? this._listeners instanceof on
                  ? (((d = this._deliveryQueue) !== null && d !== void 0) ||
                      (this._deliveryQueue = new za()),
                    (this._listeners = [this._listeners, m]))
                  : this._listeners.push(m)
                : ((o =
                    (u = this._options) === null || u === void 0
                      ? void 0
                      : u.onWillAddFirstListener) === null ||
                    o === void 0 ||
                    o.call(u, this),
                  (this._listeners = m),
                  (c =
                    (l = this._options) === null || l === void 0
                      ? void 0
                      : l.onDidAddFirstListener) === null ||
                    c === void 0 ||
                    c.call(l, this)),
              this._size++
            const w = Rt(() => {
              f == null || f(), this._removeListener(m)
            })
            return r instanceof Ke ? r.add(w) : Array.isArray(r) && r.push(w), w
          }),
        this._event
      )
    }
        ...
        for (let c = 0; c < a.length; c++)
          a[c]
            ...
            : o &&
              ...
              l < this._deliveryQueue.i && this._deliveryQueue.i--)
        a.length = l
      }
    }
    _deliver(t, n) {
    ...
    fire(t) {
      ...
      if (
        ...
        (r = this._perfMon) === null || r === void 0 || r.start(this._size),
        this._listeners)
      )
        if (this._listeners instanceof on) this._deliver(this._listeners, t)
        else {
  ...
  function ln(e) {
    const t = []
    for (const n of Ua(e)) typeof e[n] == 'function' && t.push(n)
    return t
  }
  function Wa(e, t) {
    const n = (r) =>
  ...
  typeof $e.vscode < 'u' && typeof $e.vscode.process < 'u'
    ? (ae = $e.vscode.process)
    : typeof process < 'u' &&
      typeof ((un = process == null ? void 0 : process.versions) === null ||
      un === void 0
        ? void 0
        : un.node) == 'string' &&
      (ae = process)
  const qa =
    typeof ((cn = ae == null ? void 0 : ae.versions) === null || cn === void 0
      ? void 0
      : cn.electron) == 'string' &&
    (ae == null ? void 0 : ae.type) === 'renderer'
  if (typeof ae == 'object') {
    ;(hn = ae.platform === 'win32'),
      (dn = ae.platform === 'darwin'),
      (mn = ae.platform === 'linux'),
      mn && ae.env.SNAP && ae.env.SNAP_REVISION,
      ae.env.CI || ae.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
      (Nt = tt),
      (fn = tt)
    ...
    if (e)
      try {
        ...
        ;(Nt = t.locale),
          (di = t.osLocale),
          (fn = n || tt),
          (Ba = t._translationsConfigFile)
      } catch {}
  } else
    typeof navigator == 'object' && !qa
      ? ((we = navigator.userAgent),
        (hn = we.indexOf('Windows') >= 0),
        (dn = we.indexOf('Macintosh') >= 0),
        (we.indexOf('Macintosh') >= 0 ||
          we.indexOf('iPad') >= 0 ||
          we.indexOf('iPhone') >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (mn = we.indexOf('Linux') >= 0),
        (we == null ? void 0 : we.indexOf('Mobi')) >= 0,
        X({ key: 'ensureLoaderPluginIsLoaded', comment: ['{Locked}'] }, '_'),
        (Nt = tt),
        (fn = Nt),
  ...
  const gt = hn,
    Oa = dn,
    Le = we,
    Va = typeof $e.postMessage == 'function' && !$e.importScripts
  ;(() => {
    if (Va) {
      const e = []
      ...
      return (n) => {
        ...
        e.push({ id: i, callback: n }),
          $e.postMessage({ vscodeScheduleAsyncWork: i }, '*')
      }
    }
    return (e) => setTimeout(e)
  })()
  const ja = !!(Le && Le.indexOf('Chrome') >= 0)
  Le && Le.indexOf('Firefox') >= 0,
    !ja && Le && Le.indexOf('Safari') >= 0,
    Le && Le.indexOf('Edg/') >= 0,
    Le && Le.indexOf('Android') >= 0
  function Ga(e) {
    return e
  }
  class $a {
    constructor(t, n) {
      ;(this.lastCache = void 0),
        ...
        typeof t == 'function'
          ? ((this._fn = t), (this._computeKey = Ga))
  ...
  ;(nt = Xe),
    (Xe.ambiguousCharacterData = new mi(() =>
      JSON.parse(
    ...
    (Xe.cache = new $a({ getCacheKey: JSON.stringify }, (e) => {
      function t(l) {
        const c = new Map()
        for (let d = 0; d < l.length; d += 2) c.set(l[d], l[d + 1])
        return c
      }
      function n(l, c) {
        const d = new Map(l)
        for (const [m, f] of c) d.set(m, f)
        return d
      }
      function i(l, c) {
        if (!l) return c
        const d = new Map()
        for (const [m, f] of l) c.has(m) && d.set(m, f)
        return d
      }
      const r = nt.ambiguousCharacterData.value
      let s = e.filter((l) => !l.startsWith('_') && l in r)
    ...
    (Xe._locales = new mi(() =>
      Object.keys(nt.ambiguousCharacterData.value).filter(
        (e) => !e.startsWith('_'),
      ),
    ))
  class ze {
  ...
  class lo {
    ...
    sendMessage(t, n) {
      ...
      return new Promise((r, s) => {
        ;(this._pendingReplies[i] = { resolve: r, reject: s }),
          this._send(new ro(this._workerId, i, t, n))
      })
    }
    listen(t, n) {
      let i = null
      const r = new _e({
        onWillAddFirstListener: () => {
          ;(i = String(++this._lastSentReq)),
            ...
            this._send(new so(this._workerId, i, t, n))
        },
        onDidRemoveLastListener: () => {
          this._pendingEmitters.delete(i),
            this._send(new oo(this._workerId, i)),
            (i = null)
        },
      })
      return r.event
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.method, t.args).then(
        (r) => {
          this._send(new pi(this._workerId, n, r, void 0))
        },
        (r) => {
          r.detail instanceof Error && (r.detail = ci(r.detail)),
            this._send(new pi(this._workerId, n, void 0, ci(r)))
        },
      )
    }
    _handleSubscribeEventMessage(t) {
      const n = t.req,
        i = this._handler.handleEvent(
          ...
          this._send(new ao(this._workerId, n, r))
        })
  ...
  function gi(e) {
    return e[0] === 'o' && e[1] === 'n' && fi(e.charCodeAt(2))
  }
  function bi(e) {
    return /^onDynamic/.test(e) && fi(e.charCodeAt(9))
  }
  function uo(e, t, n) {
    const i = (a) =>
        function () {
  ...
  class co {
    ...
    _handleMessage(t, n) {
      if (t === io) return this.initialize(n[0], n[1], n[2], n[3])
    ...
    initialize(t, n, i, r) {
      ...
      const u = uo(
        r,
        (o, l) => this._protocol.sendMessage(o, l),
        (o, l) => this._protocol.listen(o, l),
      )
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(u)),
          Promise.resolve(ln(this._requestHandler)))
        : (n &&
          ...
          new Promise((o, l) => {
            ...
            c(
              ...
              (d) => {
                if (
                  ((this._requestHandler = d.create(u)), !this._requestHandler)
                ) {
                  l(new Error('No RequestHandler!'))
                  return
                }
                o(ln(this._requestHandler))
              },
              l,
            )
          }))
  ...
  function ho(e, t) {
    t = _i(149417, t)
    for (let n = 0, i = e.length; n < i; n++) t = _i(e.charCodeAt(n), t)
    return t
  }
  class wi {
    constructor(t) {
  ...
  function mo(e, t, n) {
    return new Ue(new wi(e), new wi(t)).ComputeDiff(n).changes
  }
  class it {
    static Assert(t, n) {
  ...
  class Ue {
    constructor(t, n, i = null) {
      ...
      const [r, s, a] = Ue._getElements(t),
        [u, o, l] = Ue._getElements(n)
    ...
    static _getElements(t) {
      ...
      if (Ue._isStringArray(n)) {
        ...
        for (let r = 0, s = n.length; r < s; r++) i[r] = ho(n[r], 0)
        return [n, i, !0]
      }
    ...
    ElementsAreStrictEqual(t, n) {
      ...
      const i = Ue._getStrictElement(this._originalSequence, t),
        r = Ue._getStrictElement(this._modifiedSequence, n)
      return i === r
    }
    ...
    _ComputeDiff(t, n, i, r, s) {
      ...
      return s && (u = this.PrettifyChanges(u)), { quitEarly: a[0], changes: u }
    }
    ComputeDiffRecursive(t, n, i, r, s) {
      ...
      const a = [0],
        u = [0],
        o = this.ComputeRecursionPoint(t, n, i, r, a, u, s),
        l = a[0],
        c = u[0]
      if (o !== null) return o
      if (!s[0]) {
        ...
        return (
          s[0]
            ? (m = [new He(l + 1, n - (l + 1) + 1, c + 1, r - (c + 1) + 1)])
            : (m = this.ComputeDiffRecursive(l + 1, n, c + 1, r, s)),
          this.ConcatenateChanges(d, m)
        )
      }
      return [new He(t, n - t + 1, i, r - i + 1)]
    }
    WALKTRACE(t, n, i, r, s, a, u, o, l, c, d, m, f, w, g, S, x, T) {
      let A = null,
        M = null,
        R = new vi(),
        D = n,
      ...
      do {
        ...
        v === D || (v < b && l[v - 1] < l[v + 1])
          ? ((d = l[v + 1]),
            (w = d - p - r),
            d < k && R.MarkNextChange(),
            (k = d),
            R.AddModifiedElement(d + 1, w),
            (p = v + 1 - t))
          : ((d = l[v - 1] + 1),
            (w = d - p - r),
            d < k && R.MarkNextChange(),
            (k = d - 1),
            R.AddOriginalElement(d, w + 1),
            (p = v - 1 - t)),
          H >= 0 &&
            ((l = this.m_forwardHistory[H]),
            (t = l[0]),
            (D = 1),
            (b = l.length - 1))
      } while (--H >= -1)
      if (((A = R.getReverseChanges()), T[0])) {
        let v = f[0] + 1,
          _ = S[0] + 1
        if (A !== null && A.length > 0) {
          const L = A[A.length - 1]
          ;(v = Math.max(v, L.getOriginalEnd())),
            (_ = Math.max(_, L.getModifiedEnd()))
        }
        M = [new He(v, m - v + 1, _, g - _ + 1)]
      } else {
        ;(R = new vi()),
          (D = a),
          (b = u),
        ...
        do {
          ...
          v === D || (v < b && c[v - 1] >= c[v + 1])
            ? ((d = c[v + 1] - 1),
              ...
              d > k && R.MarkNextChange(),
              (k = d + 1),
              R.AddOriginalElement(d + 1, w + 1),
              (p = v + 1 - s))
            : ((d = c[v - 1]),
              (w = d - p - o),
              d > k && R.MarkNextChange(),
              (k = d),
              R.AddModifiedElement(d + 1, w + 1),
              (p = v - 1 - s)),
            H >= 0 &&
    ...
    ComputeRecursionPoint(t, n, i, r, s, a, u) {
      ...
      for (let p = 1; p <= w / 2 + 1; p++) {
        let k = 0,
          H = 0
        ;(c = this.ClipDiagonalBound(T - p, p, T, g)),
          (d = this.ClipDiagonalBound(T + p, p, T, g))
        for (let _ = c; _ <= d; _ += 2) {
          _ === c || (_ < d && S[_ - 1] < S[_ + 1])
            ? (o = S[_ + 1])
            : (o = S[_ - 1] + 1),
          ...
          if (
            ((S[_] = o),
            o + l > k + H && ((k = o), (H = l)),
            !b && Math.abs(_ - A) <= p - 1 && o >= x[_])
          )
            return (
              (s[0] = o),
              (a[0] = l),
              L <= x[_] && 1447 > 0 && p <= 1447 + 1
                ? this.WALKTRACE(
                    T,
                    c,
                    d,
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(k, v)
        )
          return (
            (u[0] = !0),
            (s[0] = k),
            ...
            v > 0 && 1447 > 0 && p <= 1447 + 1
              ...
              : (t++, i++, [new He(t, n - t + 1, i, r - i + 1)])
          )
        ;(m = this.ClipDiagonalBound(A - p, p, A, g)),
          (f = this.ClipDiagonalBound(A + p, p, A, g))
        for (let _ = m; _ <= f; _ += 2) {
          _ === m || (_ < f && x[_ - 1] >= x[_ + 1])
            ? (o = x[_ + 1] - 1)
            : (o = x[_ - 1]),
            (l = o - (_ - A) - R)
          const L = o
          for (; o > t && l > i && this.ElementsAreEqual(o, l); ) o--, l--
          if (((x[_] = o), b && Math.abs(_ - T) <= p && o <= S[_]))
            return (
              (s[0] = o),
              (a[0] = l),
              L >= S[_] && 1447 > 0 && p <= 1447 + 1
                ? this.WALKTRACE(
                    T,
                    c,
                    d,
      ...
      for (let n = t.length - 1; n >= 0; n--) {
        ...
        for (let d = 1; ; d++) {
          ...
          if (
            ...
            (u && !this.ModifiedElementsAreEqual(f, f + i.modifiedLength))
          )
            break
          const g =
            (m === r && f === s ? 5 : 0) +
      ...
      if (this._hasStrings)
        for (let n = 1, i = t.length; n < i; n++) {
          const r = t[n - 1],
            ...
            m = d - c
          if (a < 5 && l < 20 && m < 20) {
            const f = this._findBetterContiguousSequence(u, l, c, m, a)
            if (f) {
              const [w, g] = f
    ...
    ConcatenateChanges(t, n) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
        ...
        return (
          rt.Copy(t, 0, r, 0, t.length - 1),
          (r[t.length - 1] = i[0]),
          rt.Copy(n, 1, r, t.length, n.length - 1),
          r
        )
      } else {
        const r = new Array(t.length + n.length)
        return (
          rt.Copy(t, 0, r, 0, t.length), rt.Copy(n, 0, r, t.length, n.length), r
        )
      }
    }
    ChangesOverlap(t, n, i) {
      if (
        ...
        return (
          ...
          t.modifiedStart + t.modifiedLength >= n.modifiedStart &&
            (u = n.modifiedStart + n.modifiedLength - t.modifiedStart),
          (i[0] = new He(r, s, a, u)),
          !0
        )
  ...
  if (typeof gn < 'u' && typeof gn.process < 'u') {
    ...
    typeof process < 'u'
      ...
      : (st = {
          get platform() {
            return gt ? 'win32' : Oa ? 'darwin' : 'linux'
          },
          get arch() {},
          get env() {
            return {}
  ...
  class yi extends Error {
    constructor(t, n, i) {
      ...
      ;(a += `. Received type ${typeof i}`),
        super(a),
        (this.code = 'ERR_INVALID_ARG_TYPE')
    }
  }
  function yo(e, t) {
    if (e === null || typeof e != 'object') throw new yi(t, 'Object', e)
  }
  function K(e, t) {
    if (typeof e != 'string') throw new yi(t, 'string', e)
  }
  const Pe = po === 'win32'
  function q(e) {
    return e === re || e === ue
        ...
        if (!(a === l - 1 || u === 1))
          if (u === 2) {
            if (
              r.length < 2 ||
              s !== 2 ||
              r.charCodeAt(r.length - 1) !== We ||
              r.charCodeAt(r.length - 2) !== We
            ) {
              if (r.length > 2) {
  ...
  const oe = {
      resolve(...e) {
        ...
        for (let r = e.length - 1; r >= -1; r--) {
          let s
          if (r >= 0) {
            if (((s = e[r]), K(s, 'path'), s.length === 0)) continue
          } else
            t.length === 0
              ? (s = Dt())
              : ((s = fo[`=${t}`] || Dt()),
          ...
          if (a === 1) q(c) && ((u = 1), (l = !0))
            ...
            if (((l = !0), q(s.charCodeAt(1)))) {
              let d = 2,
                m = d
              for (; d < a && !q(s.charCodeAt(d)); ) d++
              if (d < a && d !== m) {
                const f = s.slice(m, d)
                for (m = d; d < a && q(s.charCodeAt(d)); ) d++
                if (d < a && d !== m) {
                  for (m = d; d < a && !q(s.charCodeAt(d)); ) d++
                  ;(d === a || d !== m) &&
                    ((o = `\\\\${f}\\${s.slice(m, d)}`), (u = d))
      ...
      normalize(e) {
        ...
        if (t === 1) return bn(s) ? '\\' : e
        if (q(s))
          if (((r = !0), q(e.charCodeAt(1)))) {
            let u = 2,
              o = u
            for (; u < t && !q(e.charCodeAt(u)); ) u++
            if (u < t && u !== o) {
              const l = e.slice(o, u)
              for (o = u; u < t && q(e.charCodeAt(u)); ) u++
              if (u < t && u !== o) {
                for (o = u; u < t && !q(e.charCodeAt(u)); ) u++
                if (u === t) return `\\\\${l}\\${e.slice(o)}\\`
          ...
          Be(s) &&
            ...
            ((i = e.slice(0, 2)),
            (n = 2),
            t > 2 && q(e.charCodeAt(2)) && ((r = !0), (n = 3)))
        let a = n < t ? It(e.slice(n), !r, '\\', q) : ''
        return (
          a.length === 0 && !r && (a = '.'),
          a.length > 0 && q(e.charCodeAt(t - 1)) && (a += '\\'),
          i === void 0 ? (r ? `\\${a}` : a) : r ? `${i}\\${a}` : `${i}${a}`
        )
      },
      isAbsolute(e) {
        K(e, 'path')
        ...
        return (
          q(n) ||
          (t > 2 && Be(n) && e.charCodeAt(1) === Fe && q(e.charCodeAt(2)))
        )
      },
      join(...e) {
      ...
      relative(e, t) {
        ...
        const a = s - r
        let u = 0
        for (; u < t.length && t.charCodeAt(u) === ue; ) u++
        let o = t.length
        for (; o - 1 > u && t.charCodeAt(o - 1) === ue; ) o--
        const l = o - u,
          c = a < l ? a : l
        let d = -1,
          m = 0
        ...
        if (m !== c) {
          ...
          if (l > c) {
            if (t.charCodeAt(u + m) === ue) return i.slice(u + m + 1)
            if (m === 2) return i.slice(u + m)
          }
          a > c && (e.charCodeAt(r + m) === ue ? (d = m) : m === 2 && (d = 3)),
            d === -1 && (d = 0)
        }
        let f = ''
        for (m = r + d + 1; m <= s; ++m)
        ...
        return (
          ...
          f.length > 0
            ? `${f}${i.slice(u, o)}`
            : (i.charCodeAt(u) === ue && ++u, i.slice(u, o))
        )
      },
      toNamespacedPath(e) {
        ...
        if (t.charCodeAt(0) === ue) {
          if (t.charCodeAt(1) === ue) {
            ...
            if (n !== vo && n !== We) return `\\\\?\\UNC\\${t.slice(2)}`
          }
        } else if (
          Be(t.charCodeAt(0)) &&
          t.charCodeAt(1) === Fe &&
      ...
      parse(e) {
        ...
        if (q(r)) {
          if (((i = 1), q(e.charCodeAt(1)))) {
            let d = 2,
              m = d
            for (; d < n && !q(e.charCodeAt(d)); ) d++
            if (d < n && d !== m) {
              for (m = d; d < n && q(e.charCodeAt(d)); ) d++
              if (d < n && d !== m) {
                for (m = d; d < n && !q(e.charCodeAt(d)); ) d++
                d === n ? (i = d) : d !== m && (i = d + 1)
              }
        ...
        return (
          u !== -1 &&
            (s === -1 || c === 0 || (c === 1 && s === u - 1 && s === a + 1)
              ? (t.base = t.name = e.slice(a, u))
              : ((t.name = e.slice(a, s)),
                (t.base = e.slice(a, u)),
                (t.ext = e.slice(s, u)))),
    ...
    ce = {
      resolve(...e) {
        ...
        for (let i = e.length - 1; i >= -1 && !n; i--) {
          const r = i >= 0 ? e[i] : xo()
          K(r, 'path'),
            r.length !== 0 && ((t = `${r}/${t}`), (n = r.charCodeAt(0) === re))
        }
        return (t = It(t, !n, '/', bn)), n ? `/${t}` : t.length > 0 ? t : '.'
      },
      normalize(e) {
        if ((K(e, 'path'), e.length === 0)) return '.'
        const t = e.charCodeAt(0) === re,
          n = e.charCodeAt(e.length - 1) === re
        return (
          (e = It(e, !t, '/', bn)),
          e.length === 0
            ? t
      ...
      isAbsolute(e) {
        return K(e, 'path'), e.length > 0 && e.charCodeAt(0) === re
      },
      join(...e) {
        if (e.length === 0) return '.'
        let t
      ...
      relative(e, t) {
        if (
          (K(e, 'from'),
          K(t, 'to'),
          e === t || ((e = ce.resolve(e)), (t = ce.resolve(t)), e === t))
        )
          return ''
        const n = 1,
          i = e.length,
        ...
        if (l === u)
          if (a > u) {
            if (t.charCodeAt(s + l) === re) return t.slice(s + l + 1)
            if (l === 0) return t.slice(s + l)
          } else
            r > u && (e.charCodeAt(n + l) === re ? (o = l) : l === 0 && (o = 0))
        let c = ''
        for (l = n + o + 1; l <= i; ++l)
          (l === i || e.charCodeAt(l) === re) &&
            (c += c.length === 0 ? '..' : '/..')
  ...
  ;(ce.win32 = oe.win32 = oe),
    ...
    Pe ? oe.normalize : ce.normalize,
    Pe ? oe.resolve : ce.resolve,
    Pe ? oe.relative : ce.relative,
    Pe ? oe.dirname : ce.dirname,
    Pe ? oe.basename : ce.basename,
    Pe ? oe.extname : ce.extname,
    Pe ? oe.sep : ce.sep
  const To = /^\w[\w\d+.-]*$/,
    ko = /^\//,
    Ao = /^\/\//
  ...
  let _n = class nn {
    ...
    constructor(t, n, i, r, s, a = !1) {
      typeof t == 'object'
        ? ((this.scheme = t.scheme || J),
          (this.authority = t.authority || J),
          (this.path = t.path || J),
          (this.query = t.query || J),
          (this.fragment = t.fragment || J))
        : ((this.scheme = Lo(t, a)),
          (this.authority = n || J),
          (this.path = Co(this.scheme, i || J)),
          (this.query = r || J),
          (this.fragment = s || J),
          So(this, a))
    }
    ...
    with(t) {
      ...
      return (
        ...
        i === void 0 ? (i = this.authority) : i === null && (i = J),
        r === void 0 ? (r = this.path) : r === null && (r = J),
        s === void 0 ? (s = this.query) : s === null && (s = J),
        a === void 0 ? (a = this.fragment) : a === null && (a = J),
        n === this.scheme &&
        i === this.authority &&
        r === this.path &&
        s === this.query &&
    ...
    static file(t) {
      let n = J
      if ((gt && (t = t.replace(/\\/g, ve)), t[0] === ve && t[1] === ve)) {
        const i = t.indexOf(ve, 2)
        i === -1
          ? ((n = t.substring(2)), (t = ve))
          : ((n = t.substring(2, i)), (t = t.substring(i) || ve))
      }
      return new at('file', n, t, J, J)
    }
    static from(t, n) {
      return new at(t.scheme, t.authority, t.path, t.query, t.fragment, n)
    }
    static joinPath(t, ...n) {
      if (!t.path)
      ...
      return (
        gt && t.scheme === 'file'
          ? (i = nn.file(oe.join(wn(t, !0), ...n)).path)
          : (i = ce.join(t.path, ...n)),
        t.with({ path: i })
      )
    }
    ...
    static revive(t) {
      ...
      if (t) {
        if (t instanceof nn) return t
        {
          ...
          return (
            (r._formatted =
              (n = t.external) !== null && n !== void 0 ? n : null),
            (r._fsPath =
              t._sep === Ti && (i = t.fsPath) !== null && i !== void 0
                ? i
                : null),
            r
          )
  ...
  class at extends _n {
    ...
    toString(t = !1) {
      return t
        ? vn(this, !0)
        : (this._formatted || (this._formatted = vn(this, !1)), this._formatted)
    }
    toJSON() {
      const t = { $mid: 1 }
      return (
        this._fsPath && ((t.fsPath = this._fsPath), (t._sep = Ti)),
  ...
  function Ai(e, t, n) {
    ...
    for (let s = 0; s < e.length; s++) {
      ...
      if (
        ...
        r !== -1 && ((i += encodeURIComponent(e.substring(r, s))), (r = -1)),
  ...
  function Ro(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const i = e.charCodeAt(n)
      i === 35 || i === 63
        ? (t === void 0 && (t = e.substr(0, n)), (t += ki[i]))
        : t !== void 0 && (t += e[n])
    }
    return t !== void 0 ? t : e
  }
  ...
  function vn(e, t) {
    const n = t ? Ro : Ai
    let i = '',
      { scheme: r, authority: s, path: a, query: u, fragment: o } = e
    if (
      (r && ((i += r), (i += ':')),
      (s || r === 'file') && ((i += ve), (i += ve)),
      s)
      ...
      if (l !== -1) {
        ...
        ;(s = s.substr(l + 1)),
          ...
          l === -1
            ? (i += n(c, !1, !1))
            : ((i += n(c.substr(0, l), !1, !1)),
              (i += ':'),
              (i += n(c.substr(l + 1), !1, !0))),
          (i += '@')
      }
      ;(s = s.toLowerCase()),
        (l = s.lastIndexOf(':')),
        l === -1
          ? (i += n(s, !1, !0))
          : ((i += n(s.substr(0, l), !1, !0)), (i += s.substr(l)))
    }
    if (a) {
  ...
  const Li = /(%[0-9A-Za-z][0-9A-Za-z])+/g
  function zt(e) {
    return e.match(Li) ? e.replace(Li, (t) => Si(t)) : e
  }
  let Ce = class Ye {
      constructor(t, n) {
      ...
      with(t = this.lineNumber, n = this.column) {
        return t === this.lineNumber && n === this.column ? this : new Ye(t, n)
      }
      delta(t = 0, n = 0) {
        return this.with(this.lineNumber + t, this.column + n)
      }
      equals(t) {
        return Ye.equals(this, t)
      }
      static equals(t, n) {
        return !t && !n
          ? !0
      ...
      isBeforeOrEqual(t) {
        return Ye.isBeforeOrEqual(this, t)
      }
      ...
      clone() {
        return new Ye(this.lineNumber, this.column)
      }
      toString() {
        return '(' + this.lineNumber + ',' + this.column + ')'
      }
      static lift(t) {
        return new Ye(t.lineNumber, t.column)
      }
      static isIPosition(t) {
        return (
          t && typeof t.lineNumber == 'number' && typeof t.column == 'number'
        )
      }
      toJSON() {
    ...
    Y = class ee {
      ...
      static intersectRanges(t, n) {
        ...
        const u = n.startLineNumber,
          ...
          c = n.endColumn
        return (
          i < u ? ((i = u), (r = o)) : i === u && (r = Math.max(r, o)),
          s > l ? ((s = l), (a = c)) : s === l && (a = Math.min(a, c)),
          i > s || (i === s && r > a) ? null : new ee(i, r, s, a)
        )
      }
      equalsRange(t) {
  ...
  class Fo {
      ...
      for (const i of n)
        this._acceptDeleteRange(i.range),
          this._acceptInsertText(
            new Ce(i.range.startLineNumber, i.range.startColumn),
            i.text,
          )
    ...
    _acceptInsertText(t, n) {
      ...
      ;(i[i.length - 1] += this._lines[t.lineNumber - 1].substring(
        ...
        this._setLineText(
          t.lineNumber - 1,
          this._lines[t.lineNumber - 1].substring(0, t.column - 1) + i[0],
        )
  ...
  function Bo(e = '') {
    let t = '(-?\\d*\\.\\d\\w*)|([^'
    for (const n of Po) e.indexOf(n) >= 0 || (t += '\\' + n)
  ...
  const Ni = new Ca()
  Ni.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
  function yn(e, t, n, i, r) {
    if (((t = Mi(t)), r || (r = Et.first(Ni)), n.length > r.maxLen)) {
      let l = e - r.maxLen / 2
      return (
        l < 0 ? (l = 0) : (i += l),
        (n = n.substring(l, e + r.maxLen / 2)),
        yn(e, t, n, i, r)
      )
    }
    const s = Date.now(),
  ...
  class xn {
    constructor(t) {
      ...
      ;(this._defaultValue = n),
        (this._asciiMap = xn._createAsciiMap(n)),
        (this._map = new Map())
    }
  ...
  function Go() {
    if (bt === null) {
      bt = new xn(0)
      const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`
      for (let n = 0; n < e.length; n++) bt.set(e.charCodeAt(n), 1)
      const t = '.,;:'
      for (let n = 0; n < t.length; n++) bt.set(t.charCodeAt(n), 2)
    }
    return bt
  }
  class Wt {
    ...
    static computeLinks(t, n = jo()) {
      const i = Go(),
        r = []
      for (let s = 1, a = t.getLineCount(); s <= a; s++) {
        const u = t.getLineContent(s),
          o = u.length
        let l = 0,
          c = 0,
          d = 0,
        ...
        for (; l < o; ) {
          ...
          if (m === 13) {
            ...
            A === 1 && (r.push(Wt._createLink(i, u, s, c, l)), (x = !0))
          } else if (m === 12) {
            let A
            T === 91 ? ((w = !0), (A = 0)) : (A = i.get(T)),
              A === 1 ? (x = !0) : (m = 13)
          } else (m = n.nextState(m, T)), m === 0 && (x = !0)
          x && ((m = 1), (f = !1), (w = !1), (S = !1), (c = l + 1), (d = T)),
            l++
        }
        m === 13 && r.push(Wt._createLink(i, u, s, c, o))
      }
      return r
    }
  }
  ...
  kn.INSTANCE = new kn()
  const Di = Object.freeze(function (e, t) {
  ...
  class Pt {
    ...
    get onCancellationRequested() {
      return this._isCancelled
        ? Di
        : (this._emitter || (this._emitter = new _e()), this._emitter.event)
    }
    dispose() {
  ...
  ;(function () {
    const e = '',
      ...
      i = []
    for (const r of t) {
      const [s, a, u, o, l, c, d, m, f] = r
      if (
        (i[a] || ((i[a] = !0), (Qo[u] = a), (Yo[u.toLowerCase()] = a)), !n[o])
      ) {
        if (((n[o] = !0), !l))
          throw new Error(
            `String representation missing for key code ${o} around scan code ${u}`,
          )
        Bt.define(o, l), Sn.define(o, m || l), Ln.define(o, f || m || l)
      }
      c && (Jo[c] = o)
    }
  })()
  ...
  ;(function (e) {
    ...
    function s(u) {
      return Sn.strToKeyCode(u) || Ln.strToKeyCode(u)
    }
  ...
  class de extends Y {
    ...
    static fromRange(t, n) {
      return n === 0
        ...
        : new de(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn)
    }
    ...
    static createWithDirection(t, n, i, r, s) {
      return s === 0 ? new de(t, n, i, r) : new de(i, r, t, n)
    }
  }
  ...
  ;(function (e) {
    const t = new Map()
    t.set(0, F.symbolMethod),
      t.set(1, F.symbolFunction),
      t.set(2, F.symbolConstructor),
      t.set(3, F.symbolField),
      t.set(4, F.symbolVariable),
      t.set(5, F.symbolClass),
      t.set(6, F.symbolStruct),
      t.set(7, F.symbolInterface),
      t.set(8, F.symbolModule),
      t.set(9, F.symbolProperty),
      t.set(10, F.symbolEvent),
      t.set(11, F.symbolOperator),
      t.set(12, F.symbolUnit),
      t.set(13, F.symbolValue),
      t.set(15, F.symbolEnum),
      t.set(14, F.symbolConstant),
      t.set(15, F.symbolEnum),
      t.set(16, F.symbolEnumMember),
      t.set(17, F.symbolKeyword),
      t.set(27, F.symbolSnippet),
      t.set(18, F.symbolText),
      t.set(19, F.symbolColor),
      t.set(20, F.symbolFile),
      t.set(21, F.symbolReference),
      t.set(22, F.symbolCustomColor),
      t.set(23, F.symbolFolder),
      t.set(24, F.symbolTypeParameter),
      t.set(25, F.account),
      t.set(26, F.issues)
    function n(s) {
      let a = t.get(s)
      return (
        a ||
          (console.info('No codicon found for CompletionItemKind ' + s),
          (a = F.symbolProperty)),
        a
      )
    }
  ...
  ;(function (e) {
    ...
    X('Enum', 'enumeration'),
    X('EnumMember', 'enumeration member'),
    X('Event', 'event'),
    X('Field', 'field'),
    X('File', 'file'),
    X('Function', 'function'),
  ...
  ;(function (e) {
    const t = new Map()
    t.set(0, F.symbolFile),
      t.set(1, F.symbolModule),
      t.set(2, F.symbolNamespace),
      t.set(3, F.symbolPackage),
      t.set(4, F.symbolClass),
      t.set(5, F.symbolMethod),
      t.set(6, F.symbolProperty),
      t.set(7, F.symbolField),
      t.set(8, F.symbolConstructor),
      t.set(9, F.symbolEnum),
      t.set(10, F.symbolInterface),
      t.set(11, F.symbolFunction),
      t.set(12, F.symbolVariable),
      t.set(13, F.symbolConstant),
      t.set(14, F.symbolString),
      t.set(15, F.symbolNumber),
      t.set(16, F.symbolBoolean),
      t.set(17, F.symbolArray),
      t.set(18, F.symbolObject),
      t.set(19, F.symbolKey),
      t.set(20, F.symbolNull),
      t.set(21, F.symbolEnumMember),
      t.set(22, F.symbolStruct),
      t.set(23, F.symbolEvent),
      t.set(24, F.symbolOperator),
  ...
  ;(_t.CtrlCmd = 2048), (_t.Shift = 1024), (_t.Alt = 512), (_t.WinCtrl = 256)
  function rl() {
    return {
      editor: void 0,
      languages: void 0,
  ...
  class sl {
    ...
    set(t, n, i = 0) {
      ...
      if (r) (r.value = n), i !== 0 && this.touch(r, i)
        ...
        switch (
          ((r = { key: t, value: n, next: void 0, previous: void 0 }), i)
        ) {
          case 0:
            this.addItemLast(r)
            break
    ...
    forEach(t, n) {
      ...
      for (; r; ) {
        if (
          (n ? t.bind(n)(r.value, r.key, this) : t(r.value, r.key, this),
          this._state !== i)
        )
  ...
  function hl(e, t, n, i, r) {
    return ul(e, t, n, i, r) && cl(e, t, n, i, r)
  }
  class dl {
    constructor(t, n) {
    ...
    next(t) {
      ...
      do {
        ...
        if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            eo(t, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || hl(this._wordSeparators, t, n, r, s))
        )
          return i
      } while (i)
      return null
  ...
  function ml(e, t = 'Unreachable') {
    throw new Error(t)
  }
  function qt(e) {
    if (!e()) {
      debugger
      e(), Ae(new Se('Assertion Failed'))
    }
  }
  function Pr(e, t) {
    let n = 0
  ...
  class fl {
    static computeUnicodeHighlights(t, n, i) {
      const r = i ? i.startLineNumber : 1,
        ...
        a = new Br(n),
        u = a.getCandidateCodePoints()
      let o
      u === 'allNonBasicAscii'
        ? (o = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
        : (o = new RegExp(`${pl(Array.from(u))}`, 'g'))
      const l = new dl(null, o),
        c = []
      let d = !1,
        m,
        f = 0,
        w = 0,
        g = 0
      e: for (let S = r, x = s; S <= x; S++) {
        const T = t.getLineContent(S),
          A = T.length
        l.reset(0)
        do
          if (((m = l.next(T)), m)) {
            ...
            if (M > 0) {
              const k = T.charCodeAt(M - 1)
              pn(k) && M--
            }
            if (R + 1 < A) {
              const k = T.charCodeAt(R - 1)
              pn(k) && R++
            }
            const D = T.substring(M, R)
            let b = yn(M + 1, Ri, T, 0)
            b && b.endColumn <= M + 1 && (b = null)
            const p = a.shouldHighlightNonBasicASCII(D, b ? b.word : null)
            if (p !== 0) {
              p === 3 ? f++ : p === 2 ? w++ : p === 1 ? g++ : ml()
              const k = 1e3
              if (c.length >= k) {
                d = !0
                break e
              }
              c.push(new Y(S, M + 1, S, R + 1))
            }
          }
        while (m)
      }
      ...
      switch (i.shouldHighlightNonBasicASCII(t, null)) {
        ...
        case 3: {
          const s = t.codePointAt(0),
            ...
            u = Xe.getLocales().filter(
              (o) =>
                !Xe.getInstance(new Set([...n.allowedLocales, o])).isAmbiguous(
                  s,
                ),
            )
          return {
  ...
  function pl(e, t) {
    return `[${Xa(e.map((i) => String.fromCodePoint(i)).join(''))}]`
  }
  class Br {
    constructor(t) {
      ;(this.options = t),
        (this.allowedCodePoints = new Set(t.allowedCodePoints)),
        (this.ambiguousCharacters = Xe.getInstance(new Set(t.allowedLocales)))
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return 'allNonBasicAscii'
      const t = new Set()
      if (this.options.invisibleCharacters)
        for (const n of ze.codePoints) qr(String.fromCodePoint(n)) || t.add(n)
    ...
    shouldHighlightNonBasicASCII(t, n) {
      ...
      if (n)
        for (const a of n) {
          const u = a.codePointAt(0),
            o = no(a)
          ;(r = r || o),
            !o &&
              !this.ambiguousCharacters.isAmbiguous(u) &&
              !ze.isInvisibleCharacter(u) &&
              (s = !0)
        }
      return !r && s
        ? 0
...
` ||
  ...
  function wt(e, t, n = 0, i = e.length) {
    let r = n,
      s = i
    for (; r < s; ) {
  ...
  function Nn(e, t, n = 0, i = e.length) {
    let r = n,
      s = i
    for (; r < s; ) {
      const a = Math.floor((r + s) / 2)
  ...
  class O {
    static fromRangeInclusive(t) {
      return new O(t.startLineNumber, t.endLineNumber + 1)
    }
    static joinMany(t) {
      if (t.length === 0) return []
      let n = new Ee(t[0].slice())
      for (let i = 1; i < t.length; i++) n = n.getUnion(new Ee(t[i].slice()))
      return n.ranges
    }
    static join(t) {
    ...
    delta(t) {
      return new O(this.startLineNumber + t, this.endLineNumberExclusive + t)
    }
    deltaLength(t) {
      return new O(this.startLineNumber, this.endLineNumberExclusive + t)
    }
    get length() {
  ...
  class Ee {
    ...
    contains(t) {
      const n = lt(this._normalizedRanges, (i) => i.startLineNumber <= t)
    ...
    getUnion(t) {
      ...
      for (
        ;
        i < this._normalizedRanges.length || r < t._normalizedRanges.length;
        ...
        if (
          ...
          const u = this._normalizedRanges[i],
            o = t._normalizedRanges[r]
          u.startLineNumber < o.startLineNumber
            ? ((a = u), i++)
            : ((a = o), r++)
        } else
          i < this._normalizedRanges.length
            ? ((a = this._normalizedRanges[i]), i++)
            : ((a = t._normalizedRanges[r]), r++)
        s === null
          ? (s = a)
    ...
    subtractFrom(t) {
      const n = Nn(
          this._normalizedRanges,
          (a) => a.endLineNumberExclusive >= t.startLineNumber,
        ),
        i =
          wt(
            this._normalizedRanges,
            (a) => a.startLineNumber <= t.endLineNumberExclusive,
          ) + 1
      if (n === i) return new Ee([t])
      const r = []
      let s = t.startLineNumber
      for (let a = n; a < i; a++) {
        const u = this._normalizedRanges[a]
        u.startLineNumber > s && r.push(new O(s, u.startLineNumber)),
          (s = u.endLineNumberExclusive)
      }
      return (
  ...
  class ye {
    static inverse(t, n, i) {
      ...
      for (const o of t) {
        const l = new ye(
          new O(s, o.original.startLineNumber),
          new O(a, o.modified.startLineNumber),
        )
        l.modified.isEmpty || r.push(l),
          (s = o.original.endLineNumberExclusive),
          (a = o.modified.endLineNumberExclusive)
      }
      const u = new ye(new O(s, n + 1), new O(a, i + 1))
    ...
    static clip(t, n, i) {
      ...
      for (const s of t) {
        const a = s.original.intersect(n),
          u = s.modified.intersect(i)
        a && !a.isEmpty && u && !u.isEmpty && r.push(new ye(a, u))
      }
      return r
    }
    constructor(t, n) {
  ...
  class Ne extends ye {
    static fromRangeMappings(t) {
      const n = O.join(t.map((r) => O.fromRangeInclusive(r.originalRange))),
        i = O.join(t.map((r) => O.fromRangeInclusive(r.modifiedRange)))
      return new Ne(n, i, t)
    }
    constructor(t, n, i) {
  ...
  class qe {
    ...
    flip() {
      return new qe(this.modifiedRange, this.originalRange)
    }
    toTextEdit(t) {
      const n = t.getValueOfRange(this.modifiedRange)
      return new _l(this.originalRange, n)
    }
  }
  const wl = 3
  class vl {
    computeDiff(t, n, i) {
      ...
      for (const l of a.changes) {
        ...
        l.originalEndLineNumber === 0
          ...
          : (c = new O(l.originalStartLineNumber, l.originalEndLineNumber + 1))
        let d
        l.modifiedEndLineNumber === 0
          ...
          : (d = new O(l.modifiedStartLineNumber, l.modifiedEndLineNumber + 1))
        let m = new Ne(
          c,
          d,
          (r = l.charChanges) === null || r === void 0
            ? void 0
            : r.map(
                (f) =>
                  new qe(
        ...
        o &&
          ...
          ((m = new Ne(
            ...
            o.innerChanges && m.innerChanges
              ? o.innerChanges.concat(m.innerChanges)
              : void 0,
          )),
          u.pop()),
          u.push(m),
      ...
      return (
        qt(() =>
          Pr(
            u,
            (l, c) =>
              c.original.startLineNumber - l.original.endLineNumberExclusive ===
                c.modified.startLineNumber -
                  l.modified.endLineNumberExclusive &&
              l.original.endLineNumberExclusive < c.original.startLineNumber &&
              l.modified.endLineNumberExclusive < c.modified.startLineNumber,
          ),
        ),
        new Ot(u, [], a.quitEarly)
      )
    }
  }
  function Or(e, t, n, i) {
  ...
  let Vr = class {
    ...
    createCharSequence(t, n, i) {
      ...
      let u = 0
      for (let o = n; o <= i; o++) {
        const l = this.lines[o],
          c = t ? this._startColumns[o] : 1,
          d = t ? this._endColumns[o] : l.length + 1
        for (let m = c; m < d; m++)
          (r[u] = l.charCodeAt(m - 1)), (s[u] = o + 1), (a[u] = m), u++
        !t && o < i && ((r[u] = 10), (s[u] = o + 1), (a[u] = l.length + 1), u++)
      }
      return new yl(r, s, a)
    }
  }
  ...
  function xl(e) {
    ...
    for (let i = 1, r = e.length; i < r; i++) {
      const s = e[i],
        ...
        u = s.modifiedStart - (n.modifiedStart + n.modifiedLength)
      Math.min(a, u) < wl
        ? ((n.originalLength =
  ...
  class yt {
    ...
    static createFromDiffResult(t, n, i, r, s, a, u) {
      ...
      if (
        (n.originalLength === 0
          ? ((o = i.getStartLineNumber(n.originalStart) - 1), (l = 0))
          : ((o = i.getStartLineNumber(n.originalStart)),
            (l = i.getEndLineNumber(n.originalStart + n.originalLength - 1))),
        n.modifiedLength === 0
        ...
        if (f.getElements().length > 0 && w.getElements().length > 0) {
          let g = Or(f, w, s, !0).changes
          u && (g = xl(g)), (m = [])
          for (let S = 0, x = g.length; S < x; S++)
            m.push(ut.createFromDiffChange(g[S], f, w))
        }
      }
      return new yt(o, l, c, d, m)
    }
  }
  class Tl {
    constructor(t, n, i) {
      ;(this.shouldComputeCharChanges = i.shouldComputeCharChanges),
        ...
        (this.original = new Vr(t)),
        (this.modified = new Vr(n)),
        (this.continueLineDiff = jr(i.maxComputationTime)),
        (this.continueCharDiff = jr(
    ...
    computeDiff() {
      ...
      if (this.shouldIgnoreTrimWhitespace) {
        ...
        return { quitEarly: i, changes: u }
      }
      const r = []
      let s = 0,
        a = 0
      for (let u = -1, o = n.length; u < o; u++) {
        const l = u + 1 < o ? n[u + 1] : null,
          ...
          if (m !== f) {
            {
              let w = Dn(m, 1),
                g = Dn(f, 1)
              for (; w > 1 && g > 1; ) {
                const S = m.charCodeAt(w - 2),
                  x = f.charCodeAt(g - 2)
                if (S !== x) break
                w--, g--
              }
              ;(w > 1 || g > 1) &&
                this._pushTrimWhitespaceCharChange(r, s + 1, 1, w, a + 1, 1, g)
            }
            {
              let w = In(m, 1),
                g = In(f, 1)
              const S = m.length + 1,
                x = f.length + 1
              for (; w < S && g < x; ) {
                const T = m.charCodeAt(w - 1),
                  A = m.charCodeAt(g - 1)
                if (T !== A) break
                w++, g++
              }
              ;(w < S || g < x) &&
                this._pushTrimWhitespaceCharChange(r, s + 1, w, S, a + 1, g, x)
            }
          }
          s++, a++
        }
    ...
    _pushTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
      if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u)) return
      let o
      this.shouldComputeCharChanges && (o = [new ut(n, i, n, r, s, a, s, u)]),
        t.push(new yt(n, n, s, s, o))
    }
    _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
      ...
      return l.originalEndLineNumber === 0 || l.modifiedEndLineNumber === 0
        ...
        ? (this.shouldComputeCharChanges &&
            l.charChanges &&
            l.charChanges.push(new ut(n, i, n, r, s, a, s, u)),
          !0)
    ...
    static invert(t, n) {
      ...
      return (
        Do(t, (r, s) => {
          i.push(
            Z.fromOffsetPairs(
              r ? r.getEndExclusives() : me.zero,
              s
                ? s.getStarts()
                : new me(
                    n,
                    (r
                      ? r.seq2Range.endExclusive - r.seq1Range.endExclusive
                      : 0) + n,
                  ),
            ),
          )
  ...
  class me {
    ...
    delta(t) {
      return t === 0 ? this : new me(this.offset1 + t, this.offset2 + t)
    }
    equals(t) {
  ...
  ;(me.zero = new me(0, 0)),
    (me.max = new me(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER))
  class xt {
    isValid() {
      return !0
    }
  ...
  class ct {
    static getKey(t) {
      ...
      return (
        n === void 0 && ((n = this.chrKeys.size), this.chrKeys.set(t, n)), n
      )
    }
    constructor(t, n, i) {
      ;(this.range = t),
...
`)
    ...
    computeSimilarity(t) {
      ...
      for (let a = 0; a < s; a++)
        r += Math.abs(
          ((n = this.histogram[a]) !== null && n !== void 0 ? n : 0) -
            ((i = t.histogram[a]) !== null && i !== void 0 ? i : 0),
        )
  ...
  ct.chrKeys = new Map()
  class Al {
    compute(t, n, i = xt.instance, r) {
      if (t.length === 0 || n.length === 0) return De.trivial(t, n)
      const s = new zn(t.length, n.length),
        a = new zn(t.length, n.length),
        u = new zn(t.length, n.length)
      for (let w = 0; w < t.length; w++)
        for (let g = 0; g < n.length; g++) {
          if (!i.isValid()) return De.trivialTimedOut(t, n)
          const S = w === 0 ? 0 : s.get(w - 1, g),
            x = g === 0 ? 0 : s.get(w, g - 1)
          let T
          t.getElement(w) === n.getElement(g)
            ? (w === 0 || g === 0 ? (T = 0) : (T = s.get(w - 1, g - 1)),
              w > 0 &&
                g > 0 &&
                a.get(w - 1, g - 1) === 3 &&
                (T += u.get(w - 1, g - 1)),
              (T += r ? r(w, g) : 1))
            : (T = -1)
          const A = Math.max(S, x, T)
          if (A === T) {
            const M = w > 0 && g > 0 ? u.get(w - 1, g - 1) : 0
            u.set(w, g, M + 1), a.set(w, g, 3)
          } else
            A === S
              ? (u.set(w, g, 0), a.set(w, g, 1))
              : A === x && (u.set(w, g, 0), a.set(w, g, 2))
          s.set(w, g, A)
        }
      const o = []
      let l = t.length,
      ...
      function d(w, g) {
        ;(w + 1 !== l || g + 1 !== c) &&
          o.push(new Z(new V(w + 1, l), new V(g + 1, c))),
          (l = w),
          (c = g)
      }
      let m = t.length - 1,
      ...
      return d(-1, -1), o.reverse(), new De(o, !1)
    }
  }
  class Gr {
    compute(t, n, i = xt.instance) {
      if (t.length === 0 || n.length === 0) return De.trivial(t, n)
      const r = t,
        s = n
      function a(g, S) {
        for (
          ;
          g < r.length && S < s.length && r.getElement(g) === s.getElement(S);
      ...
      o.set(0, a(0, 0))
      const l = new Ll()
      l.set(0, o.get(0) === 0 ? null : new $r(null, 0, 0, o.get(0)))
      let c = 0
      e: for (;;) {
        if ((u++, !i.isValid())) return De.trivialTimedOut(r, s)
        const g = -Math.min(u, s.length + (u % 2)),
          S = Math.min(u, r.length + (u % 2))
        for (c = g; c <= S; c += 2) {
          const x = c === S ? -1 : o.get(c + 1),
            T = c === g ? -1 : o.get(c - 1) + 1,
            A = Math.min(Math.max(x, T), r.length),
            M = A - c
          if (A > r.length || M > s.length) continue
          const R = a(A, M)
          o.set(c, R)
          const D = A === x ? l.get(c + 1) : l.get(c - 1)
          if (
            (l.set(c, R !== A ? new $r(D, A, M, R - A) : D),
      ...
      for (;;) {
        const g = d ? d.x + d.length : 0,
          S = d ? d.y + d.length : 0
        if (
          ((g !== f || S !== w) && m.push(new Z(new V(g, f), new V(S, w))), !d)
        )
          break
  ...
  class Vt {
    constructor(t, n, i) {
      ...
      n.start > 0 &&
        ...
        ((n = new V(n.start - 1, n.endExclusive)), (r = !0)),
        (this.lineRange = n),
        (this.firstCharOffsetByLine[0] = 0)
      for (let s = this.lineRange.start; s < this.lineRange.endExclusive; s++) {
        let a = t[s],
          u = 0
        if (r) (u = a.length), (a = ''), (r = !1)
        else if (!i) {
          const o = a.trimStart()
          ;(u = a.length - o.length), (a = o.trimEnd())
        }
        this.additionalOffsetByLine.push(u)
        for (let o = 0; o < a.length; o++) this.elements.push(a.charCodeAt(o))
        s < t.length - 1 &&
          (this.elements.push(
            `
`.charCodeAt(0),
    ...
    getBoundaryScore(t) {
      const n = Jr(t > 0 ? this.elements[t - 1] : -1),
        i = Jr(t < this.elements.length ? this.elements[t] : -1)
      if (n === 7 && i === 8) return 0
      if (n === 8) return 150
      let r = 0
      return (
    ...
    translateOffset(t) {
      if (this.lineRange.isEmpty) return new Ce(this.lineRange.start + 1, 1)
      const n = wt(this.firstCharOffsetByLine, (i) => i <= t)
      return new Ce(
    ...
    translateRange(t) {
      return Y.fromPositions(
        this.translateOffset(t.start),
        this.translateOffset(t.endExclusive),
      )
    }
    findWordContaining(t) {
      if (t < 0 || t >= this.elements.length || !Un(this.elements[t])) return
      let n = t
      for (; n > 0 && Un(this.elements[n - 1]); ) n--
      let i = t
      for (; i < this.elements.length && Un(this.elements[i]); ) i++
      return new V(n, i)
    }
    countLinesIn(t) {
      return (
    ...
    extendToFullLines(t) {
      var n, i
      const r =
          (n = lt(this.firstCharOffsetByLine, (a) => a <= t.start)) !== null &&
          n !== void 0
            ? n
            : 0,
        s =
          (i = bl(this.firstCharOffsetByLine, (a) => t.endExclusive <= a)) !==
            null && i !== void 0
            ? i
            : this.elements.length
      return new V(r, s)
  ...
  const Cl = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
  function Xr(e) {
    return Cl[e]
  }
  function Jr(e) {
  ...
  function El(e, t, n, i, r, s) {
    let { moves: a, excludedChanges: u } = Ml(e, t, n, s)
    if (!s.isValid()) return []
    const o = e.filter((c) => !u.has(c)),
      l = Nl(o, i, r, t, n, s)
    return (
      zo(a, l),
      (a = Dl(a)),
...
`).length >= 15 && Rl(d, (f) => f.length >= 2) >= 2
  ...
  function Ml(e, t, n, i) {
    const r = [],
      s = e
        ...
        .map((o) => new ct(o.original, t, o)),
      a = new Set(
        e
          .filter((o) => o.original.isEmpty && o.modified.length >= 3)
          .map((o) => new ct(o.modified, n, o)),
      ),
      u = new Set()
    for (const o of s) {
      let l = -1,
  ...
  function Nl(e, t, n, i, r, s) {
    ...
    for (const m of e)
      for (
        ...
        u.add(w, { range: new O(f, f + 3) })
      }
    const o = []
    e.sort(Ht((m) => m.modified.startLineNumber, Ut))
    for (const m of e) {
      let f = []
      for (
        ...
        u.forEach(g, ({ range: T }) => {
          for (const M of f)
            if (
              M.originalLineRange.endLineNumberExclusive + 1 ===
                T.endLineNumberExclusive &&
              M.modifiedLineRange.endLineNumberExclusive + 1 ===
                S.endLineNumberExclusive
            ) {
              ;(M.originalLineRange = new O(
                M.originalLineRange.startLineNumber,
                T.endLineNumberExclusive,
              )),
                (M.modifiedLineRange = new O(
          ...
          const A = { modifiedLineRange: S, originalLineRange: T }
          o.push(A), x.push(A)
        }),
          (f = x)
      }
    ...
    o.sort(Ho(Ht((m) => m.modifiedLineRange.length, Ut)))
    const l = new Ee(),
      c = new Ee()
    for (const m of o) {
      const f =
          m.modifiedLineRange.startLineNumber -
          m.originalLineRange.startLineNumber,
        w = l.subtractFrom(m.modifiedLineRange),
        g = c.subtractFrom(m.originalLineRange).getWithDelta(f),
        S = w.getIntersection(g)
      for (const x of S.ranges) {
        if (x.length < 3) continue
        const T = x,
          A = x.delta(-f)
        a.push(new ye(A, T)), l.addRange(T), c.addRange(A)
      }
    }
    a.sort(Ht((m) => m.original.startLineNumber, Ut))
    const d = new vt(e)
    for (let m = 0; m < a.length; m++) {
      const f = a[m],
        w = d.findLastMonotonous(
          (D) => D.original.startLineNumber <= f.original.startLineNumber,
        ),
        g = lt(
          e,
          (D) => D.modified.startLineNumber <= f.modified.startLineNumber,
        ),
        S = Math.max(
          f.original.startLineNumber - w.original.startLineNumber,
          f.modified.startLineNumber - g.modified.startLineNumber,
        ),
        x = d.findLastMonotonous(
          (D) => D.original.startLineNumber < f.original.endLineNumberExclusive,
        ),
        T = lt(
          e,
          (D) => D.modified.startLineNumber < f.modified.endLineNumberExclusive,
        ),
        A = Math.max(
          x.original.endLineNumberExclusive - f.original.endLineNumberExclusive,
          T.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive,
        )
      let M
      for (M = 0; M < S; M++) {
        const D = f.original.startLineNumber - M - 1,
          b = f.modified.startLineNumber - M - 1
        if (
          D > i.length ||
          b > r.length ||
          l.contains(b) ||
      ...
      M > 0 &&
        (c.addRange(
          new O(f.original.startLineNumber - M, f.original.startLineNumber),
        ),
        l.addRange(
          new O(f.modified.startLineNumber - M, f.modified.startLineNumber),
        ))
      let R
      for (R = 0; R < A; R++) {
        const D = f.original.endLineNumberExclusive + R,
          b = f.modified.endLineNumberExclusive + R
        if (
          D > i.length ||
          b > r.length ||
          l.contains(b) ||
      ...
      R > 0 &&
        (c.addRange(
          new O(
            ...
            f.original.endLineNumberExclusive + R,
          ),
        ),
        l.addRange(
          new O(
            f.modified.endLineNumberExclusive,
            f.modified.endLineNumberExclusive + R,
          ),
        )),
        (M > 0 || R > 0) &&
          (a[m] = new ye(
            new O(
              f.original.startLineNumber - M,
              f.original.endLineNumberExclusive + R,
            ),
            new O(
              f.modified.startLineNumber - M,
              f.modified.endLineNumberExclusive + R,
            ),
          ))
    }
  ...
  function Qr(e, t, n) {
    ...
    const r = new Gr().compute(
      new Vt([e], new V(0, 1), !1),
      new Vt([t], new V(0, 1), !1),
      n,
    )
    let s = 0
    const a = Z.invert(r.diffs, e.length)
    for (const c of a)
    ...
    function u(c) {
      let d = 0
      for (let m = 0; m < e.length; m++) Hn(c.charCodeAt(m)) || d++
      return d
    }
  ...
  function Dl(e) {
    ...
    e.sort(Ht((n) => n.original.startLineNumber, Ut))
    const t = [e[0]]
      ...
      (t = t.filter((i) => {
        const r =
            n.findLastMonotonous(
              (u) =>
                u.original.startLineNumber < i.original.endLineNumberExclusive,
            ) || new ye(new O(1, 1), new O(1, 1)),
          s = lt(
            e,
            (u) =>
              u.modified.startLineNumber < i.modified.endLineNumberExclusive,
          )
        return r !== s
      })),
      t
  ...
  function Yr(e, t, n) {
    let i = n
    return (i = Zr(e, t, i)), (i = Zr(e, t, i)), (i = zl(e, t, i)), i
  }
  function Zr(e, t, n) {
    ...
    for (let s = 1; s < n.length; s++) {
      ...
      if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
        ...
        for (
          ...
          l <= o &&
          !(
            e.getElement(u.seq1Range.start - l) !==
              e.getElement(u.seq1Range.endExclusive - l) ||
            t.getElement(u.seq2Range.start - l) !==
              t.getElement(u.seq2Range.endExclusive - l)
          );
          l++
        );
        if ((l--, l === o)) {
          i[i.length - 1] = new Z(
            new V(a.seq1Range.start, u.seq1Range.endExclusive - o),
            new V(a.seq2Range.start, u.seq2Range.endExclusive - o),
          )
          continue
        }
        u = u.delta(-l)
      ...
      if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
        ...
        for (
          ...
          !(
            !e.isStronglyEqual(
              u.seq1Range.start + l,
              u.seq1Range.endExclusive + l,
            ) ||
            !t.isStronglyEqual(
              u.seq2Range.start + l,
              u.seq2Range.endExclusive + l,
            )
          );
          l++
        );
        if (l === o) {
          i[s + 1] = new Z(
            new V(u.seq1Range.start + o, a.seq1Range.endExclusive),
            new V(u.seq2Range.start + o, a.seq2Range.endExclusive),
          )
          continue
        }
        l > 0 && (u = u.delta(l))
  ...
  function zl(e, t, n) {
    ...
    for (let i = 0; i < n.length; i++) {
      ...
      s.seq1Range.isEmpty
        ? (n[i] = Kr(s, e, t, u, o))
        : s.seq2Range.isEmpty && (n[i] = Kr(s.swap(), t, e, o, u).swap())
    }
    return n
  }
  function Kr(e, t, n, i, r) {
    ...
    for (
      ;
      e.seq1Range.start + u < i.endExclusive &&
      e.seq2Range.endExclusive + u < r.endExclusive &&
      n.isStronglyEqual(e.seq2Range.start + u, e.seq2Range.endExclusive + u) &&
      u < 100;
    ...
    for (let c = -a; c <= u; c++) {
      const d = e.seq2Range.start + c,
        ...
        w =
          t.getBoundaryScore(f) + n.getBoundaryScore(d) + n.getBoundaryScore(m)
      w > l && ((l = w), (o = c))
    }
    return e.delta(o)
  }
  ...
  function Ul(e, t, n) {
    ...
    function a(o, l) {
      ...
      const c = e.findWordContaining(o.offset1),
        d = t.findWordContaining(o.offset2)
      if (!c || !d) return
      let m = new Z(c, d)
      ...
      for (; i.length > 0; ) {
        ...
        if (
          !(
            S.seq1Range.intersects(m.seq1Range) ||
            S.seq2Range.intersects(m.seq2Range)
          )
        )
          break
        const T = e.findWordContaining(S.seq1Range.start),
          A = t.findWordContaining(S.seq2Range.start),
          M = new Z(T, A),
          R = M.intersect(S)
        if (
          ((w += R.seq1Range.length),
          (g += R.seq2Range.length),
          (m = m.join(M)),
          m.seq1Range.endExclusive >= S.seq1Range.endExclusive)
        )
          i.shift()
        else break
      }
      w + g < ((m.seq1Range.length + m.seq2Range.length) * 2) / 3 && r.push(m),
        (s = m.getEndExclusives())
    }
    for (; i.length > 0; ) {
      const o = i.shift()
      o.seq1Range.isEmpty ||
        (a(o.getStarts(), o), a(o.getEndExclusives().delta(-1), o))
    }
    return Wl(n, r)
  }
  function Wl(e, t) {
  ...
  function Fl(e, t, n) {
    ...
    do {
      ...
      for (let u = 1; u < i.length; u++) {
        let c = function (m, f) {
          const w = new V(l.seq1Range.endExclusive, o.seq1Range.start)
          return (
        ...
        const o = i[u],
          l = a[a.length - 1]
        c(l, o)
          ? ((s = !0), (a[a.length - 1] = a[a.length - 1].join(o)))
          : a.push(o)
      }
      i = a
    } while (r++ < 10 && s)
  ...
  function Pl(e, t, n) {
    ...
    do {
      ...
      for (let o = 1; o < i.length; o++) {
        let d = function (f, w) {
          const g = new V(c.seq1Range.endExclusive, l.seq1Range.start)
          if (e.countLinesIn(g) > 5 || g.length > 500) return !1
          const x = e.getText(g).trim()
          if (x.length > 20 || x.split(/\r\n|\r|\n/).length > 1) return !1
          const T = e.countLinesIn(f.seq1Range),
            A = f.seq1Range.length,
            M = t.countLinesIn(f.seq2Range),
            R = f.seq2Range.length,
            D = e.countLinesIn(w.seq1Range),
            b = w.seq1Range.length,
            p = t.countLinesIn(w.seq2Range),
            k = w.seq2Range.length,
            H = 2 * 40 + 50
          function v(_) {
            return Math.min(_, H)
          }
          return (
            Math.pow(
              Math.pow(v(T * 40 + A), 1.5) + Math.pow(v(M * 40 + R), 1.5),
              1.5,
            ) +
              Math.pow(
                Math.pow(v(D * 40 + b), 1.5) + Math.pow(v(p * 40 + k), 1.5),
                1.5,
              ) >
            (H ** 1.5) ** 1.5 * 1.3
          )
        ...
        const l = i[o],
          c = u[u.length - 1]
        d(c, l)
          ? ((s = !0), (u[u.length - 1] = u[u.length - 1].join(l)))
          : u.push(l)
      }
      i = u
    } while (r++ < 10 && s)
      ...
      Io(i, (u, o, l) => {
        ...
        function d(x) {
          return (
            x.length > 0 &&
            x.trim().length <= 3 &&
            o.seq1Range.length + o.seq2Range.length > 100
          )
        }
        const m = e.extendToFullLines(o.seq1Range),
          f = e.getText(new V(m.start, o.seq1Range.start))
        d(f) && (c = c.deltaStart(-f.length))
        const w = e.getText(new V(o.seq1Range.endExclusive, m.endExclusive))
        d(w) && (c = c.deltaEnd(w.length))
        const g = Z.fromOffsetPairs(
            u ? u.getEndExclusives() : me.zero,
            l ? l.getStarts() : me.max,
          ),
          S = c.intersect(g)
        a.length > 0 && S.getStarts().equals(a[a.length - 1].getEndExclusives())
          ? (a[a.length - 1] = a[a.length - 1].join(S))
          : a.push(S)
      }),
      a
    )
  ...
  class es {
    ...
    getBoundaryScore(t) {
      const n = t === 0 ? 0 : ts(this.lines[t - 1]),
        i = t === this.lines.length ? 0 : ts(this.lines[t])
      return 1e3 - (n + i)
    }
    getText(t) {
...
`)
  ...
  class Bl {
    constructor() {
      ;(this.dynamicProgrammingDiffing = new Al()),
        (this.myersDiffingAlgorithm = new Gr())
    }
    computeDiff(t, n, i) {
      if (t.length <= 1 && Mo(t, n, (R, D) => R === D))
        return new Ot([], [], !1)
      if (
        ...
        return new Ot(
          [
            new Ne(new O(1, t.length + 1), new O(1, n.length + 1), [
              new qe(
                new Y(1, 1, t.length, t[t.length - 1].length + 1),
                new Y(1, 1, n.length, n[n.length - 1].length + 1),
              ),
            ]),
          ],
          [],
      ...
      const r =
          i.maxComputationTimeMs === 0
            ? xt.instance
            : new kl(i.maxComputationTimeMs),
        s = !i.ignoreTrimWhitespace,
        a = new Map()
      function u(R) {
        let D = a.get(R)
        return D === void 0 && ((D = a.size), a.set(R, D)), D
      }
      const o = t.map((R) => u(R.trim())),
        l = n.map((R) => u(R.trim())),
        c = new es(o, t),
        d = new es(l, n),
        m = (() =>
          c.length + d.length < 1700
            ? this.dynamicProgrammingDiffing.compute(c, d, r, (R, D) =>
                t[R] === n[D]
                  ? n[D].length === 0
                    ? 0.1
                    : 1 + Math.log(1 + n[D].length)
                  : 0.99,
              )
            : this.myersDiffingAlgorithm.compute(c, d, r))()
      let f = m.diffs,
        w = m.hitTimeout
      ;(f = Yr(c, d, f)), (f = Fl(c, d, f))
      const g = [],
        S = (R) => {
          if (s)
            for (let D = 0; D < R; D++) {
              const b = x + D,
                p = T + D
              if (t[b] !== n[p]) {
                const k = this.refineDiff(
                  t,
                  n,
                  new Z(new V(b, b + 1), new V(p, p + 1)),
                  r,
                  s,
                )
                for (const H of k.mappings) g.push(H)
                k.hitTimeout && (w = !0)
              }
            }
        }
      let x = 0,
        T = 0
      for (const R of f) {
        qt(() => R.seq1Range.start - x === R.seq2Range.start - T)
        const D = R.seq1Range.start - x
        S(D), (x = R.seq1Range.endExclusive), (T = R.seq2Range.endExclusive)
        const b = this.refineDiff(t, n, R, r, s)
        b.hitTimeout && (w = !0)
      ...
      let M = []
      return (
        i.computeMoves && (M = this.computeMoves(A, t, n, o, l, r, s)),
        qt(() => {
          function R(b, p) {
            if (b.lineNumber < 1 || b.lineNumber > p.length) return !1
            const k = p[b.lineNumber - 1]
          ...
          for (const b of A) {
            ...
            for (const p of b.innerChanges)
              if (
                !(
                  R(p.modifiedRange.getStartPosition(), n) &&
                  R(p.modifiedRange.getEndPosition(), n) &&
                  R(p.originalRange.getStartPosition(), t) &&
                  R(p.originalRange.getEndPosition(), t)
                )
              )
                return !1
            if (!D(b.modified, n) || !D(b.original, t)) return !1
          }
          return !0
        }),
        new Ot(A, M, w)
    ...
    computeMoves(t, n, i, r, s, a, u) {
      return El(t, n, i, r, s, a).map((c) => {
        const d = this.refineDiff(
            n,
            i,
            new Z(c.original.toOffsetRange(), c.modified.toOffsetRange()),
            a,
            u,
          ),
          m = ns(d.mappings, n, i, !0)
        return new gl(c, m)
      })
    }
    refineDiff(t, n, i, r, s) {
      const a = new Vt(t, i.seq1Range, s),
        u = new Vt(n, i.seq2Range, s),
        o =
      ...
      return (
        ...
        (l = Pl(a, u, l)),
        {
          mappings: l.map(
            (d) =>
              new qe(
                a.translateRange(d.seq1Range),
                u.translateRange(d.seq2Range),
              ),
          ),
  ...
  function ns(e, t, n, i = !1) {
    ...
    for (const s of No(
      e.map((a) => ql(a, t, n)),
      (a, u) =>
        a.original.overlapOrTouch(u.original) ||
        a.modified.overlapOrTouch(u.modified),
    )) {
      const a = s[0],
        u = s[s.length - 1]
      r.push(
    ...
    return (
      qt(() =>
        ...
        (r[0].modified.startLineNumber !== r[0].original.startLineNumber ||
          n.length - r[r.length - 1].modified.endLineNumberExclusive !==
            t.length - r[r.length - 1].original.endLineNumberExclusive)
          ? !1
          : Pr(
              r,
              (s, a) =>
  ...
  const is = { getLegacy: () => new vl(), getDefault: () => new Bl() }
  function Oe(e, t) {
  ...
  class ne {
    constructor(t, n, i, r = 1) {
      ;(this._rgbaBrand = void 0),
        ...
        (this.a = Oe(Math.max(Math.min(1, r), 0), 3))
    }
    static equals(t, n) {
  ...
  class ge {
    constructor(t, n, i, r) {
      ;(this._hslaBrand = void 0),
        ...
        (this.s = Oe(Math.max(Math.min(1, n), 0), 3)),
        (this.l = Oe(Math.max(Math.min(1, i), 0), 3)),
        (this.a = Oe(Math.max(Math.min(1, r), 0), 3))
    }
    static equals(t, n) {
    ...
    static fromRGBA(t) {
      ...
      if (d > 0) {
        switch (
          ((l = Math.min(c <= 0.5 ? d / (2 * c) : d / (2 - 2 * c), 1)), a)
        ) {
          case n:
            o = (i - r) / d + (i < r ? 6 : 0)
            break
    ...
    static toRGBA(t) {
      ...
      if (i === 0) a = u = o = r
        ...
        const l = r < 0.5 ? r * (1 + i) : r + i - r * i,
          c = 2 * r - l
        ;(a = ge._hue2rgb(c, l, n + 1 / 3)),
          (u = ge._hue2rgb(c, l, n)),
          (o = ge._hue2rgb(c, l, n - 1 / 3))
      }
      return new ne(
        Math.round(a * 255),
        Math.round(u * 255),
  ...
  class ht {
    constructor(t, n, i, r) {
      ;(this._hsvaBrand = void 0),
        (this.h = Math.max(Math.min(360, t), 0) | 0),
        (this.s = Oe(Math.max(Math.min(1, n), 0), 3)),
        (this.v = Oe(Math.max(Math.min(1, i), 0), 3)),
        (this.a = Oe(Math.max(Math.min(1, r), 0), 3))
    }
    static equals(t, n) {
    ...
    static fromRGBA(t) {
      ...
      return (
        u === 0
          ...
          ? (l = (r - n) / u + 2)
          : (l = (n - i) / u + 4),
        new ht(Math.round(l * 60), o, s, t.a)
      )
    }
    static toRGBA(t) {
  ...
  let te = class be {
    static fromHex(t) {
      return be.Format.CSS.parseHex(t) || be.red
    }
    static equals(t, n) {
    ...
    constructor(t) {
      if (t)
        if (t instanceof ne) this.rgba = t
        else if (t instanceof ge) (this._hsla = t), (this.rgba = ge.toRGBA(t))
        else if (t instanceof ht) (this._hsva = t), (this.rgba = ht.toRGBA(t))
    ...
    equals(t) {
      return (
        !!t &&
        ne.equals(this.rgba, t.rgba) &&
        ge.equals(this.hsla, t.hsla) &&
        ht.equals(this.hsva, t.hsva)
      )
    }
    getRelativeLuminance() {
      const t = be._relativeLuminanceForComponent(this.rgba.r),
        n = be._relativeLuminanceForComponent(this.rgba.g),
        i = be._relativeLuminanceForComponent(this.rgba.b),
    ...
    transparent(t) {
      ...
      return new be(new ne(n, i, r, s * t))
    }
    isTransparent() {
    ...
    toString() {
      return (
        this._toString || (this._toString = be.Format.CSS.format(this)),
        this._toString
      )
    }
  ...
  ;(te.white = new te(new ne(255, 255, 255, 1))),
    (te.black = new te(new ne(0, 0, 0, 1))),
    (te.red = new te(new ne(255, 0, 0, 1))),
    (te.blue = new te(new ne(0, 0, 255, 1))),
    (te.green = new te(new ne(0, 255, 0, 1))),
    (te.cyan = new te(new ne(0, 255, 255, 1))),
    (te.lightgrey = new te(new ne(211, 211, 211, 1))),
    (te.transparent = new te(new ne(0, 0, 0, 0))),
    (function (e) {
      ;(function (t) {
        ;(function (n) {
          function i(f) {
          ...
          function s(f) {
            return f.hsla.a === 1
              ? `hsl(${f.hsla.h}, ${(f.hsla.s * 100).toFixed(2)}%, ${(
                  f.hsla.l * 100
                ).toFixed(2)}%)`
          ...
          n.formatHSL = s
          function a(f) {
            return `hsla(${f.hsla.h}, ${(f.hsla.s * 100).toFixed(2)}%, ${(
              f.hsla.l * 100
            ).toFixed(2)}%, ${f.hsla.a.toFixed(2)})`
          }
          n.formatHSLA = a
          function u(f) {
          ...
          function l(f, w = !1) {
            return w && f.rgba.a === 1
              ...
              : `#${u(f.rgba.r)}${u(f.rgba.g)}${u(f.rgba.b)}${u(
                  Math.round(f.rgba.a * 255),
                )}`
          }
          n.formatHexA = l
          function c(f) {
          ...
          function d(f) {
            ...
            if (w === 7) {
              const g = 16 * m(f.charCodeAt(1)) + m(f.charCodeAt(2)),
                S = 16 * m(f.charCodeAt(3)) + m(f.charCodeAt(4)),
                x = 16 * m(f.charCodeAt(5)) + m(f.charCodeAt(6))
              return new e(new ne(g, S, x, 1))
            }
            if (w === 9) {
              const g = 16 * m(f.charCodeAt(1)) + m(f.charCodeAt(2)),
                S = 16 * m(f.charCodeAt(3)) + m(f.charCodeAt(4)),
                x = 16 * m(f.charCodeAt(5)) + m(f.charCodeAt(6)),
                T = 16 * m(f.charCodeAt(7)) + m(f.charCodeAt(8))
              return new e(new ne(g, S, x, T / 255))
            }
            if (w === 4) {
              const g = m(f.charCodeAt(1)),
                S = m(f.charCodeAt(2)),
                x = m(f.charCodeAt(3))
              return new e(new ne(16 * g + g, 16 * S + S, 16 * x + x))
            }
            if (w === 5) {
              const g = m(f.charCodeAt(1)),
                S = m(f.charCodeAt(2)),
                ...
                T = m(f.charCodeAt(4))
              return new e(
                new ne(16 * g + g, 16 * S + S, 16 * x + x, (16 * T + T) / 255),
              )
            }
            return null
          }
  ...
  function Ol(e, t) {
    if (!e) return
    const n = te.Format.CSS.parseHex(t)
    if (n)
      return { range: e, color: Wn(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function ss(e, t, n) {
    if (!e || t.length !== 1) return
    const r = t[0].values(),
      s = rs(r)
    return { range: e, color: Wn(s[0], s[1], s[2], n ? s[3] : 1) }
  }
  function as(e, t, n) {
    if (!e || t.length !== 1) return
    const r = t[0].values(),
      s = rs(r),
      a = new te(new ge(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1))
    return { range: e, color: Wn(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) }
  }
  function kt(e, t) {
  ...
  function Ql(e, t, n) {
    ...
    if (i) {
      ...
      if (a.endColumn > a.startColumn) {
        const u = { range: a, ...ls(i[1]), shouldBeInComments: !0 }
  ...
  function ls(e) {
    ...
    return (e = e.replace(Gl, '')), { text: e, hasSeparatorLine: t }
  }
  class Yl extends Fo {
    get uri() {
      return this._uri
    ...
    getWordAtPosition(t, n) {
      const i = yn(t.column, Mi(n), this._lines[t.lineNumber - 1], 0)
      return i
        ? new Y(t.lineNumber, i.startColumn, t.lineNumber, i.endColumn)
        : null
    }
    words(t) {
      const n = this._lines,
    ...
    _validatePosition(t) {
      if (!Ce.isIPosition(t)) throw new Error('bad position')
  ...
  class Je {
    ...
    _getModels() {
      const t = []
      return (
        Object.keys(this._models).forEach((n) => t.push(this._models[n])), t
      )
    }
    acceptNewModel(t) {
      this._models[t.url] = new Yl(_n.parse(t.url), t.lines, t.EOL, t.versionId)
    }
    ...
    async computeUnicodeHighlights(t, n, i) {
      ...
      return r
        ? fl.computeUnicodeHighlights(r, n, i)
        : {
            ranges: [],
            hasMore: !1,
    ...
    async computeDiff(t, n, i, r) {
      const s = this._getModel(t),
        a = this._getModel(n)
      return !s || !a ? null : Je.computeDiff(s, a, i, r)
    }
    static computeDiff(t, n, i, r) {
      const s = r === 'advanced' ? is.getDefault() : is.getLegacy(),
        a = t.getLinesContent(),
        u = n.getLinesContent(),
        o = s.computeDiff(a, u, i),
        l = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n)
      function c(d) {
        return d.map((m) => {
          var f
          return [
            ...
            (f = m.innerChanges) === null || f === void 0
              ? void 0
              : f.map((w) => [
    ...
    async computeMoreMinimalEdits(t, n, i) {
      ...
      n = n.slice(0).sort((o, l) => {
        if (o.range && l.range)
          return Y.compareRangesUsingStarts(o.range, l.range)
        const c = o.range ? 0 : 1,
          d = l.range ? 0 : 1
        return c - d
      })
      ...
      for (let o = 1; o < n.length; o++)
        Y.getEndPosition(n[u].range).equals(Y.getStartPosition(n[o].range))
          ? ((n[u].range = Y.fromPositions(
              Y.getStartPosition(n[u].range),
              Y.getEndPosition(n[o].range),
            )),
            (n[u].text += n[o].text))
          : (u++, (n[u] = n[o]))
      n.length = u + 1
      for (let { range: o, text: l, eol: c } of n) {
        if ((typeof c == 'number' && (a = c), Y.isEmpty(o) && !l)) continue
        const d = r.getValueInRange(o)
        if (((l = l.replace(/\r\n|\n|\r/g, r.eol)), d === l)) continue
        if (Math.max(l.length, d.length) > Je._diffLimit) {
          s.push({ range: o, text: l })
          continue
        }
        const m = mo(d, l, i),
          f = r.offsetAt(Y.lift(o).getStartPosition())
        for (const w of m) {
          const g = r.positionAt(f + w.originalStart),
            S = r.positionAt(f + w.originalStart + w.originalLength),
            x = {
              text: l.substr(w.modifiedStart, w.modifiedLength),
              range: {
    ...
    async textualSuggest(t, n, i, r) {
      ...
      e: for (const o of t) {
        ...
        if (l) {
          for (const c of l.words(a))
            if (
              !(c === n || !isNaN(Number(c))) &&
              (u.add(c), u.size > Je._suggestionsLimit)
            )
              break e
        }
      }
    ...
    async navigateValueSet(t, n, i, r, s) {
      ...
      return kn.INSTANCE.navigateValueSet(n, o, l, c, i)
    }
    loadForeignModule(t, n, i) {
      const a = {
        host: Wa(i, (u, o) => this._host.fhr(u, o)),
        getMirrorModels: () => this._getModels(),
      }
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(a, n)),
          Promise.resolve(ln(this._foreignModule)))
   ...
   *-----------------------------------------------------------------------------*/ function xe(
    ...
    if (typeof t == 'string')
      ...
      let a = t[0]
      for (let u = 1; u < t.length; u++) a += `{${u - 1}}` + t[u]
      return xe(a, ...s)
    } else
      (i = t.message),
        (n = i),
        t.comment &&
          t.comment.length > 0 &&
          (n += `/${
            Array.isArray(t.comment) ? t.comment.join('') : t.comment
          }`),
        (r = t.args ?? {})
    return Kl(i, r)
  }
  var Zl = /{([^}]+)}/g
  function Kl(e, t) {
    return Object.keys(t).length === 0 ? e : e.replace(Zl, (n, i) => t[i] ?? n)
  }
  var cs
  ;(function (e) {
    function t(n) {
  ...
  ;(function (e) {
    function t(i, r) {
      return (
        i === Number.MAX_VALUE && (i = jt.MAX_VALUE),
  ...
  ;(function (e) {
    function t(i, r, s, a) {
      if (E.uinteger(i) && E.uinteger(r) && E.uinteger(s) && E.uinteger(a))
        return { start: ie.create(i, r), end: ie.create(s, a) }
      if (ie.is(i) && ie.is(r)) return { start: i, end: r }
      throw new Error(
        `Range#create called with invalid arguments[${i}, ${r}, ${s}, ${a}]`,
      )
    }
    e.create = t
    function n(i) {
      let r = i
      return E.objectLiteral(r) && ie.is(r.start) && ie.is(r.end)
    }
    e.is = n
  })(j || (j = {}))
  var Gt
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        j.is(r.range) &&
        (E.string(r.uri) || E.undefined(r.uri))
      )
    }
    e.is = n
  })(Gt || (Gt = {}))
  ...
  ;(function (e) {
    ...
    function n(i) {
      const r = i
      return E.objectLiteral(r) && j.is(r.range) && Bn.is(r.color)
    }
    e.is = n
  })(ms || (ms = {}))
  var fs
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        E.string(r.label) &&
        (E.undefined(r.textEdit) || se.is(r)) &&
        (E.undefined(r.additionalTextEdits) ||
          E.typedArray(r.additionalTextEdits, se.is))
      )
    }
    e.is = n
  })(fs || (fs = {}))
  ...
  var ps
  ;(function (e) {
    function t(i, r, s, a, u, o) {
      const l = { startLine: i, endLine: r }
      return (
        E.defined(s) && (l.startCharacter = s),
        E.defined(a) && (l.endCharacter = a),
        E.defined(u) && (l.kind = u),
        E.defined(o) && (l.collapsedText = o),
        l
      )
    }
    e.create = t
  ...
  ;(function (e) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && Gt.is(r.location) && E.string(r.message)
    }
    e.is = n
  })(qn || (qn = {}))
  var gs
  ...
  ;(function (e) {
    function t(i, r, s, a, u, o) {
      ...
      return (
        ...
        E.defined(u) && (l.source = u),
        E.defined(o) && (l.relatedInformation = o),
        l
      )
    }
    e.create = t
    function n(i) {
      ...
      return (
        ...
        (E.undefined(s.codeDescription) ||
          E.string(
            (r = s.codeDescription) === null || r === void 0 ? void 0 : r.href,
          )) &&
        (E.string(s.source) || E.undefined(s.source)) &&
        (E.undefined(s.relatedInformation) ||
          E.typedArray(s.relatedInformation, qn.is))
      )
    }
    e.is = n
  })(Xt || (Xt = {}))
  ...
  ;(function (e) {
    function t(i, r, s) {
      const a = { label: i }
      return (
        r !== void 0 && (a.needsConfirmation = r),
  ...
  ;(function (e) {
    function t(s, a, u) {
      return { range: s, newText: a, annotationId: u }
    }
    e.replace = t
    function n(s, a, u) {
      return { range: { start: s, end: s }, newText: a, annotationId: u }
    }
    e.insert = n
    function i(s, a) {
    ...
    function r(s) {
      const a = s
      return se.is(a) && (On.is(a.annotationId) || mt.is(a.annotationId))
    }
    e.is = r
  })(ws || (ws = {}))
  var Vn
  ;(function (e) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && Jn.is(r.textDocument) && Array.isArray(r.edits)
    }
    e.is = n
  })(Vn || (Vn = {}))
  var jn
        ...
        (r.options === void 0 ||
          ((r.options.overwrite === void 0 || E.boolean(r.options.overwrite)) &&
            (r.options.ignoreIfExists === void 0 ||
              E.boolean(r.options.ignoreIfExists)))) &&
        (r.annotationId === void 0 || mt.is(r.annotationId))
      )
    }
    e.is = n
  })(jn || (jn = {}))
  ...
  ;(function (e) {
    function t(i, r, s, a) {
      let u = { kind: 'rename', oldUri: i, newUri: r }
      return (
        s !== void 0 &&
        ...
        (r.options === void 0 ||
          ((r.options.recursive === void 0 || E.boolean(r.options.recursive)) &&
            (r.options.ignoreIfNotExists === void 0 ||
              E.boolean(r.options.ignoreIfNotExists)))) &&
        (r.annotationId === void 0 || mt.is(r.annotationId))
      )
    }
    e.is = n
      ...
      return (
        ...
        (i.documentChanges === void 0 ||
          i.documentChanges.every((r) =>
            E.string(r.kind) ? jn.is(r) || Gn.is(r) || $n.is(r) : Vn.is(r),
          ))
      )
    }
    e.is = t
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.defined(r) &&
        E.string(r.uri) &&
        (r.version === null || E.integer(r.version))
      )
    }
    e.is = n
  })(Jn || (Jn = {}))
  ...
  ;(function (e) {
    function t(n) {
      const i = n
      return E.objectLiteral(n) && Ie.is(i.kind) && E.string(i.value)
    }
    e.is = t
  })(At || (At = {}))
  var he
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.string(r) ||
        (E.objectLiteral(r) && E.string(r.language) && E.string(r.value))
      )
    }
    e.is = n
  })(Jt || (Jt = {}))
  ...
  ;(function (e) {
    function t(n, i, r, s, a) {
      let u = { name: n, kind: i, location: { uri: s, range: r } }
  ...
  ;(function (e) {
    function t(i, r, s, a, u, o) {
      let l = { name: i, detail: r, kind: s, range: a, selectionRange: u }
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.defined(r) &&
        E.typedArray(r.diagnostics, Xt.is) &&
        (r.only === void 0 || E.typedArray(r.only, E.string)) &&
        (r.triggerKind === void 0 ||
          r.triggerKind === Yt.Invoked ||
          r.triggerKind === Yt.Automatic)
      )
    }
    e.is = n
  })(Hs || (Hs = {}))
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        r &&
        E.string(r.title) &&
        (r.diagnostics === void 0 || E.typedArray(r.diagnostics, Xt.is)) &&
        (r.kind === void 0 || E.string(r.kind)) &&
        (r.edit !== void 0 || r.command !== void 0) &&
        (r.command === void 0 || dt.is(r.command)) &&
        (r.isPreferred === void 0 || E.boolean(r.isPreferred)) &&
        (r.edit === void 0 || Xn.is(r.edit))
      )
    }
    e.is = n
  })(Us || (Us = {}))
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.defined(r) &&
        j.is(r.range) &&
        (E.undefined(r.command) || dt.is(r.command))
      )
    }
    e.is = n
  })(Ws || (Ws = {}))
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.defined(r) &&
        j.is(r.range) &&
        (E.undefined(r.target) || E.string(r.target))
      )
    }
    e.is = n
  })(Ps || (Ps = {}))
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        r != null &&
        j.is(r.range) &&
        (E.string(r.expression) || r.expression === void 0)
      )
    }
    e.is = n
  })(Gs || (Gs = {}))
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        (r.tooltip === void 0 || E.string(r.tooltip) || At.is(r.tooltip)) &&
        (r.location === void 0 || Gt.is(r.location)) &&
        (r.command === void 0 || dt.is(r.command))
      )
    }
    e.is = n
  ...
  ;(function (e) {
    ...
    function n(i) {
      ...
      return (
        (E.objectLiteral(r) &&
          ie.is(r.position) &&
          (E.string(r.label) || E.typedArray(r.label, ei.is)) &&
          (r.kind === void 0 || Kn.is(r.kind)) &&
          r.textEdits === void 0) ||
        (E.typedArray(r.textEdits, se.is) &&
          (r.tooltip === void 0 || E.string(r.tooltip) || At.is(r.tooltip)) &&
  ...
  ;(function (e) {
    function t(n) {
      const i = n
      return E.objectLiteral(i) && Pn.is(i.uri) && E.string(i.name)
    }
    e.is = t
  })(ta || (ta = {}))
  var na
  ;(function (e) {
    ...
    function i(s, a) {
      ...
      for (let c = o.length - 1; c >= 0; c--) {
        ...
        if (f <= l) u = u.substring(0, m) + d.newText + u.substring(f, u.length)
    ...
    function r(s, a) {
      ...
      let c = 0,
        d = 0,
        m = 0
      for (; c < o.length && d < l.length; )
        a(o[c], l[d]) <= 0 ? (s[m++] = o[c++]) : (s[m++] = l[d++])
...
` &&
      ...
      positionAt(e) {
        ...
        let t = this.getLineOffsets(),
          n = 0,
          i = t.length
        if (i === 0) return ie.create(0, e)
        for (; n < i; ) {
          let s = Math.floor((n + i) / 2)
          t[s] > e ? (i = s) : (n = s + 1)
        }
        let r = n - 1
        return ie.create(r, e - t[r])
      }
      offsetAt(e) {
        let t = this.getLineOffsets()
  ...
  ;(function (e) {
    ...
    function o(f) {
      return (
        t.call(f) === '[object Number]' && -2147483648 <= f && f <= 2147483647
      )
    }
    e.integer = o
    function l(f) {
  ...
  var ia = class ui {
      ...
      update(t, n) {
        for (let i of t)
          if (ui.isIncremental(i)) {
            ...
            const u = Math.max(r.start.line, 0),
              o = Math.max(r.end.line, 0)
            let l = this._lineOffsets
            const c = ra(i.text, !1, s)
            if (o - u === c.length)
              for (let m = 0, f = c.length; m < f; m++) l[m + u + 1] = c[m]
            else
              c.length < 1e4
                ? l.splice(u + 1, o - u, ...c)
                : (this._lineOffsets = l =
                    l.slice(0, u + 1).concat(c, l.slice(o + 1)))
      ...
      getLineOffsets() {
        return (
          this._lineOffsets === void 0 &&
            (this._lineOffsets = ra(this._content, !0)),
          this._lineOffsets
        )
      }
      positionAt(t) {
  ...
  ;(function (e) {
    function t(r, s, a, u) {
      return new ia(r, s, a, u)
    }
    e.create = t
    function n(r, s, a) {
      if (r instanceof ia) return r.update(s, a), r
      throw new Error(
    ...
    function i(r, s) {
      ...
      for (const c of u) {
        ...
        d > o && l.push(a.substring(o, d)),
          c.newText.length && l.push(c.newText),
          (o = r.offsetAt(c.range.end))
      }
      return l.push(a.substr(o)), l.join('')
    }
    e.applyEdits = i
  })(ti || (ti = {}))
  function ni(e, t) {
  ...
  function ra(e, t, n = 0) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      ;(s === 13 || s === 10) &&
        (s === 13 && r + 1 < e.length && e.charCodeAt(r + 1) === 10 && r++,
        i.push(n + r + 1))
    }
    return i
  }
  ...
  ;(function (e) {
    e.LATEST = {
      textDocument: {
        completion: {
          completionItem: { documentationFormat: [Ie.Markdown, Ie.PlainText] },
        },
        hover: { contentFormat: [Ie.Markdown, Ie.PlainText] },
      },
    }
  })(aa || (aa = {}))
  var ii
...
`.charCodeAt(0),
    ...
    uu = ' '.charCodeAt(0),
    cu = '	'.charCodeAt(0),
    hu = { 'text/x-handlebars-template': !0, 'text/html': !0 }
  function fe(e, t = 0, n = B.WithinContent, i = !1) {
    const r = new nu(e, t)
    let s = n,
      a = 0,
      u = z.Unknown,
    ...
    function S() {
      ...
      return M !== z.EOS &&
        T === r.pos() &&
        !(i && (M === z.StartTagClose || M === z.EndTagClose))
        ? (console.warn(
    ...
    function x() {
      const T = r.pos()
      if (r.eos()) return g(T, z.EOS)
      let A
      switch (s) {
        case B.WithinComment:
          return r.advanceIfChars([ft, ft, Re])
            ? ((s = B.WithinContent), g(T, z.EndCommentTag))
            : (r.advanceUntilChars([ft, ft, Re]), g(T, z.Comment))
        case B.WithinDoctype:
          return r.advanceIfChar(Re)
            ? ((s = B.WithinContent), g(T, z.EndDoctypeTag))
            : (r.advanceUntilChar(Re), g(T, z.Doctype))
        case B.WithinContent:
          if (r.advanceIfChar(Kt)) {
            if (!r.eos() && r.peekChar() === oa) {
              if (r.advanceIfChars([oa, ft, ft]))
                return (s = B.WithinComment), g(T, z.StartCommentTag)
              if (r.advanceIfRegExp(/^!doctype/i))
                return (s = B.WithinDoctype), g(T, z.StartDoctypeTag)
            }
            return r.advanceIfChar(ri)
              ? ((s = B.AfterOpeningEndTag), g(T, z.EndTagOpen))
              : ((s = B.AfterOpeningStartTag), g(T, z.StartTagOpen))
          }
          return r.advanceUntilChar(Kt), g(T, z.Content)
        case B.AfterOpeningEndTag:
          return f().length > 0
            ? ((s = B.WithinEndTag), g(T, z.EndTag))
            : r.skipWhitespace()
            ? g(
                T,
                z.Whitespace,
                xe('Tag name must directly follow the open bracket.'),
              )
            : ((s = B.WithinEndTag),
              r.advanceUntilChar(Re),
              T < r.pos() ? g(T, z.Unknown, xe('End tag name expected.')) : x())
        case B.WithinEndTag:
          if (r.skipWhitespace()) return g(T, z.Whitespace)
          if (r.advanceIfChar(Re))
            return (s = B.WithinContent), g(T, z.EndTagClose)
          if (i && r.peekChar() === Kt)
            return (
              (s = B.WithinContent),
              g(T, z.EndTagClose, xe('Closing bracket missing.'))
            )
          A = xe('Closing bracket expected.')
          break
        case B.AfterOpeningStartTag:
          return (
            ...
            (d = void 0),
            c.length > 0
              ? ((l = !1), (s = B.WithinTag), g(T, z.StartTag))
              : r.skipWhitespace()
              ? g(
                  T,
                  z.Whitespace,
              ...
              : ((s = B.WithinTag),
                r.advanceUntilChar(Re),
                T < r.pos()
                  ? g(T, z.Unknown, xe('Start tag name expected.'))
                  : x())
          )
        case B.WithinTag:
          return r.skipWhitespace()
            ? ((l = !0), g(T, z.Whitespace))
            : l && ((d = w()), d.length > 0)
            ? ((s = B.AfterAttributeName), (l = !1), g(T, z.AttributeName))
            : r.advanceIfChars([ri, Re])
            ? ((s = B.WithinContent), g(T, z.StartTagSelfClose))
            : r.advanceIfChar(Re)
            ? (c === 'script'
                ? m && hu[m]
                  ? (s = B.WithinContent)
            ...
            : i && r.peekChar() === Kt
            ? ((s = B.WithinContent),
              g(T, z.StartTagClose, xe('Closing bracket missing.')))
            : (r.advance(1),
              g(T, z.Unknown, xe('Unexpected character in tag.')))
        case B.AfterAttributeName:
          return r.skipWhitespace()
            ? ((l = !0), g(T, z.Whitespace))
            : r.advanceIfChar(iu)
            ? ((s = B.BeforeAttributeValue), g(T, z.DelimiterAssign))
            : ((s = B.WithinTag), x())
        case B.BeforeAttributeValue:
          if (r.skipWhitespace()) return g(T, z.Whitespace)
          let R = r.advanceIfRegExp(/^[^\s"'`=<>]+/)
          if (
            R.length > 0 &&
            (r.peekChar() === Re &&
              r.peekChar(-1) === ri &&
              (r.goBack(1), (R = R.substring(0, R.length - 1))),
            d === 'type' && (m = R),
            R.length > 0)
          )
            return (s = B.WithinTag), (l = !1), g(T, z.AttributeValue)
          const D = r.peekChar()
          return D === su || D === ru
            ? (r.advance(1),
              r.advanceUntilChar(D) && r.advance(1),
              d === 'type' && (m = r.getSource().substring(T + 1, r.pos() - 1)),
              (s = B.WithinTag),
              (l = !1),
              g(T, z.AttributeValue))
            : ((s = B.WithinTag), (l = !1), x())
        case B.WithinScriptContent:
          let b = 1
          for (; !r.eos(); ) {
            const p = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i)
            if (p.length === 0) return r.goToEnd(), g(T, z.Script)
            if (p === '<!--') b === 1 && (b = 2)
            else if (p === '-->') b = 1
            else if (p[1] !== '/') b === 2 && (b = 3)
            else if (b === 3) b = 2
          ...
          return (s = B.WithinContent), T < r.pos() ? g(T, z.Script) : x()
        case B.WithinStyleContent:
          return (
            r.advanceUntilRegExp(/<\/style/i),
            (s = B.WithinContent),
            T < r.pos() ? g(T, z.Styles) : x()
          )
      }
      return r.advance(1), (s = B.WithinContent), g(T, z.Unknown, A)
    }
    return {
      scan: S,
      getTokenType: () => u,
  ...
  var ua = class {
      ...
      findNodeBefore(e) {
        const t = la(this.children, (n) => e <= n.start) - 1
        if (t >= 0) {
    ...
    mu = class {
      ...
      parse(e, t) {
        const n = fe(e, void 0, void 0, !0),
          i = new ua(0, e.length, [], void 0)
        let r = i,
          s = -1,
          a,
          u = null,
        ...
        for (; o !== z.EOS; ) {
          switch (o) {
            case z.StartTagOpen:
              const l = new ua(n.getTokenOffset(), e.length, [], r)
              ...
              r.parent &&
                ...
                n.getTokenLength()
                  ? ((r.startTagEnd = n.getTokenEnd()),
                    r.tag &&
                      this.dataManager.isVoidElement(r.tag, t) &&
            ...
            case z.EndTagClose:
              let c = r
              for (; !c.isSameTag(a) && c.parent; ) c = c.parent
              if (c.parent) {
                for (; r !== c; ) (r.end = s), (r.closed = !1), (r = r.parent)
                ;(r.closed = !0),
                  (r.endTagStart = s),
                  (r.end = n.getTokenEnd()),
                  (r = r.parent)
...
`,
  ...
  function Lt(e, t) {
    ...
    return (pu <= n && n <= gu) || (bu <= n && n <= _u) || (wu <= n && n <= vu)
  }
  function en(e) {
    return typeof e < 'u'
  }
      ...
      const i = (s) => {
          s.forEach((a) => {
            a.name.toLowerCase() === t &&
              ...
              a.valueSet &&
                this._valueSetMap[a.valueSet] &&
                this._valueSetMap[a.valueSet].forEach((u) => {
                  n.push(u)
                }))
          })
        },
  ...
  var xu = class {
      ...
      async computeCompletions(e, t) {
        ...
        for (const i of this.atributeCompletions) {
          const r = ku(e.getText(i.range))
          if (Au(r))
            if (r === '.' || r === '..') n.isIncomplete = !0
            else {
              const s = Su(i.value, r, i.range),
                a = await this.providePathSuggestions(i.value, s, e, t)
              for (const u of a) n.items.push(u)
            }
        }
        return n
      }
      async providePathSuggestions(e, t, n, i) {
        ...
        if (s)
          try {
            const a = [],
              u = await this.readDirectory(s)
            for (const [o, l] of u)
              o.charCodeAt(0) !== Tu && a.push(Lu(o, l === ii.Directory, t))
            return a
          } catch {}
        return []
      }
    ...
    Tu = '.'.charCodeAt(0)
  function ku(e) {
    return Ve(e, "'") || Ve(e, '"') ? e.slice(1, -1) : e
  }
  function Au(e) {
    return !(Ve(e, 'http') || Ve(e, 'https') || Ve(e, '//'))
  }
  function Su(e, t, n) {
    let i
    ...
    if (r === -1) i = Cu(n, 1, -1)
      ...
      const s = t.slice(r + 1),
        a = Ct(n.end, -1 - s.length),
        u = s.indexOf(' ')
      let o
      u !== -1 ? (o = Ct(a, u)) : (o = Ct(n.end, -1)), (i = j.create(a, o))
    }
    return i
  }
  function Lu(e, t, n) {
    return t
      ...
      : { label: e, kind: he.File, textEdit: se.replace(n, e) }
  }
  function Ct(e, t) {
    return ie.create(e.line, e.character + t)
  }
  function Cu(e, t, n) {
    const i = Ct(e.start, t),
      r = Ct(e.end, n)
    return j.create(i, r)
  }
  var Eu = class {
    ...
    async doComplete2(e, t, n, i, r) {
      ...
      try {
        ...
        return {
          isIncomplete: u.isIncomplete || o.isIncomplete,
          items: o.items.concat(u.items),
        }
      } finally {
    ...
    _doComplete(e, t, n, i) {
      const r = { isIncomplete: !1, items: [] },
        ...
        a = this.dataManager
          .getDataProviders()
          .filter(
            (y) => y.isApplicable(e.languageId) && (!i || i[y.getId()] !== !1),
          ),
        u = this.dataManager.getVoidElements(a),
        o = this.doesSupportMarkdown(),
        l = e.getText(),
        c = e.offsetAt(t),
        d = n.findNodeBefore(c)
      if (!d) return r
      const m = fe(l, d.start)
      let f = '',
        w
      function g(y, C = c) {
        return (
          y > c && (y = c), { start: e.positionAt(y), end: e.positionAt(C) }
        )
      }
      function S(y, C) {
        const N = g(y, C)
        return (
          a.forEach((I) => {
            I.provideTags().forEach((P) => {
              r.items.push({
                label: P.name,
                kind: he.Property,
                documentation: Qe(P, void 0, o),
                textEdit: se.replace(N, P.name),
      ...
      function x(y) {
        let C = y
        for (; C > 0; ) {
          const N = l.charAt(C - 1)
          if (
            `
\r`.indexOf(N) >= 0
          )
            return l.substring(C, y)
          if (!tn(N)) return null
          C--
        }
        return l.substring(0, y)
      }
      function T(y, C, N = c) {
        const I = g(y, N),
          P = da(l, N, B.WithinEndTag, z.EndTagClose) ? '' : '>'
        let U = d
        for (C && (U = U.parent); U; ) {
          const W = U.tag
          if (W && (!U.closed || (U.endTagStart && U.endTagStart > c))) {
            const G = {
                label: '/' + W,
                kind: he.Property,
                filterText: '/' + W,
                textEdit: se.replace(I, '/' + W + P),
                insertTextFormat: Te.PlainText,
              },
              $ = x(U.start),
              le = x(y - 1)
            if ($ !== null && le !== null && $ !== le) {
              const ke = $ + '</' + W + P
              ;(G.textEdit = se.replace(g(y - 1 - le.length), ke)),
                (G.filterText = le + '</' + W)
            }
            return r.items.push(G), r
          }
          U = U.parent
        }
        return (
            ...
            a.forEach((W) => {
              W.provideTags().forEach((G) => {
                r.items.push({
                  label: '/' + G.name,
                  kind: he.Property,
                  documentation: Qe(G, void 0, o),
                  filterText: '/' + G.name + P,
                  textEdit: se.replace(I, '/' + G.name + P),
                  insertTextFormat: Te.PlainText,
                })
              })
            }),
      ...
      const A = (y, C) => {
        ...
        if (!this.dataManager.isVoidElement(C, u)) {
          const N = e.positionAt(y)
          r.items.push({
            label: '</' + C + '>',
            kind: he.Property,
            filterText: '</' + C + '>',
            textEdit: se.insert(N, '$0</' + C + '>'),
      ...
      function M(y, C) {
        return S(y, C), T(y, !0, C), r
      }
      function R() {
        const y = Object.create(null)
        return (
          d.attributeNames.forEach((C) => {
            y[C] = !0
          }),
          y
        )
      ...
      function D(y, C = c) {
        let N = c
        for (; N < C && l[N] !== '<'; ) N++
        const I = l.substring(y, C),
          P = g(y, N)
        let U = ''
        if (!da(l, C, B.AfterAttributeName, z.DelimiterAssign)) {
          const G =
            (i == null ? void 0 : i.attributeDefaultValue) ?? 'doublequotes'
          G === 'empty'
            ? (U = '=$1')
            : G === 'singlequotes'
            ? (U = "='$1'")
          ...
          a.forEach((G) => {
            G.provideAttributes(f).forEach(($) => {
              ...
              $.valueSet !== 'v' &&
                ...
                r.items.push({
                  label: $.name,
                  kind: $.valueSet === 'handler' ? he.Function : he.Value,
                  documentation: Qe($, void 0, o),
                  textEdit: se.replace(P, le),
                  insertTextFormat: Te.Snippet,
                  command: ke,
                })
            })
      ...
      function b(y, C) {
        ...
        I[N] = `${N}$1="$2"`
        function P(U) {
          U.attributeNames.forEach((W) => {
            Ve(W, N) && !I[W] && !C[W] && (I[W] = W + '="$1"')
          }),
            U.children.forEach((W) => P(W))
        }
        n && n.roots.forEach((U) => P(U)),
          Object.keys(I).forEach((U) =>
            r.items.push({
              label: U,
              kind: he.Value,
              textEdit: se.replace(y, I[U]),
              insertTextFormat: Te.Snippet,
            }),
          )
      }
      function p(y, C = c) {
        ...
        if (c > y && c <= C && Ru(l[y])) {
          ...
          const G = Mu(l, c, U),
            $ = Nu(l, c, W)
          ;(N = g(G, $)),
            (P = c >= U && c <= W ? l.substring(U, c) : ''),
            (I = !1)
        } else (N = g(y, C)), (P = l.substring(y, c)), (I = !0)
        if (s.length > 0) {
        ...
        return (
          a.forEach((U) => {
            U.provideValues(f, w).forEach((W) => {
              const G = I ? '"' + W.name + '"' : W.name
              r.items.push({
                label: W.name,
                filterText: G,
                kind: he.Unit,
                documentation: Qe(W, void 0, o),
      ...
      function k(y) {
        return c === m.getTokenEnd() &&
          ((L = m.scan()), L === y && m.getTokenOffset() === c)
          ? m.getTokenEnd()
          : c
      }
      function H() {
      ...
      function v() {
        ...
        for (; y >= 0 && Lt(l, y); ) y--, C--
        if (y >= 0 && l[y] === '&') {
          const N = j.create(ie.create(t.line, C - 1), t)
          for (const I in St)
            if (fu(I, ';')) {
              const P = '&' + I
              r.items.push({
                label: P,
                kind: he.Keyword,
                documentation: xe("Character entity representing '{0}'", St[I]),
                textEdit: se.replace(N, P),
                insertTextFormat: Te.PlainText,
              })
            }
        }
      ...
      let L = m.scan()
      for (; L !== z.EOS && m.getTokenOffset() <= c; ) {
        switch (L) {
          case z.StartTagOpen:
            if (m.getTokenEnd() === c) {
              const y = k(z.StartTag)
              return t.line === 0 && _(c, y), M(c, y)
            }
            break
          case z.StartTag:
          ...
          case z.AttributeName:
            if (m.getTokenOffset() <= c && c <= m.getTokenEnd())
              return D(m.getTokenOffset(), m.getTokenEnd())
            w = m.getTokenText()
            break
          case z.DelimiterAssign:
            if (m.getTokenEnd() === c) {
              const y = k(z.AttributeValue)
              return p(c, y)
            }
            break
          case z.AttributeValue:
          ...
          case z.EndTag:
            if (c <= m.getTokenEnd()) {
              ...
              for (; y >= 0; ) {
                const C = l.charAt(y)
                if (C === '/') return T(y, !1, m.getTokenEnd())
                if (!tn(C)) break
                y--
              }
            }
            break
          case z.StartTagClose:
            if (c <= m.getTokenEnd() && f) return A(m.getTokenEnd(), f)
            break
          case z.Content:
    ...
    doQuoteComplete(e, t, n, i) {
      ...
      if (
        ...
        let c = l.scan()
        for (; c !== z.EOS && l.getTokenEnd() <= r; ) {
          if (c === z.AttributeName && l.getTokenEnd() === r - 1)
            return (
              (c = l.scan()),
              c !== z.DelimiterAssign ||
              ((c = l.scan()), c === z.Unknown || c === z.AttributeValue)
                ? null
                : u
            )
          c = l.scan()
    ...
    doTagComplete(e, t, n) {
      ...
      if (r === '>') {
        ...
        if (
          a &&
          a.tag &&
          !this.dataManager.isVoidElement(a.tag, s) &&
          a.start < i &&
          (!a.endTagStart || a.endTagStart > i)
        ) {
          const u = fe(e.getText(), a.start)
          let o = u.scan()
          for (; o !== z.EOS && u.getTokenEnd() <= i; ) {
            if (o === z.StartTagClose && u.getTokenEnd() === i)
              return `$0</${a.tag}>`
            o = u.scan()
          }
        }
        ...
        if (s && s.tag) {
          ...
          let u = a.scan()
          for (; u !== z.EOS && a.getTokenEnd() <= i; ) {
            if (u === z.EndTagOpen && a.getTokenEnd() === i)
          ...
          (n =
            (t =
              (e = this.lsOptions.clientCapabilities.textDocument) == null
                ...
                : e.completion) == null
              ? void 0
              : t.completionItem) == null
            ? void 0
            : n.documentationFormat
        this.supportsMarkdown =
          Array.isArray(i) && i.indexOf(Ie.Markdown) !== -1
      }
  ...
  var Du = class {
    ...
    doHover(e, t, n, i) {
      const r = this.convertContents.bind(this),
        ...
        u = n.findNodeAt(a),
        o = e.getText()
      if (!u || !u.tag) return null
      const l = this.dataManager
        .getDataProviders()
        .filter((D) => D.isApplicable(e.languageId))
      function c(D, b, p) {
        for (const k of l) {
          let H = null
          if (
            (k.provideTags().forEach((v) => {
              if (v.name.toLowerCase() === D.toLowerCase()) {
                let _ = Qe(v, i, s)
                _ || (_ = { kind: s ? 'markdown' : 'plaintext', value: '' }),
      ...
      function d(D, b, p) {
        for (const k of l) {
          let H = null
          if (
            (k.provideAttributes(D).forEach((v) => {
              if (b === v.name && v.description) {
                const _ = Qe(v, i, s)
                _ ? (H = { contents: _, range: p }) : (H = null)
              }
            }),
            H)
          )
      ...
      function m(D, b, p, k) {
        for (const H of l) {
          let v = null
          if (
            (H.provideValues(D, b).forEach((_) => {
              if (p === _.name && _.description) {
                const L = Qe(_, i, s)
                L ? (v = { contents: L, range: k }) : (v = null)
              }
            }),
            v)
          )
      ...
      function f(D, b) {
        ...
        for (const k in St) {
          ...
          const v = '&' + k
          if (p === v) {
            let _ = St[k].charCodeAt(0).toString(16).toUpperCase(),
              L = 'U+'
            if (_.length < 4) {
              const C = 4 - _.length
              let N = 0
      ...
      function w(D, b) {
        const p = fe(e.getText(), b)
        let k = p.scan()
        for (
          ;
          k !== z.EOS &&
          (p.getTokenEnd() < a || (p.getTokenEnd() === a && k !== D));

        )
          k = p.scan()
        return k === D && a <= p.getTokenEnd()
          ? {
      ...
      function g() {
        ...
        if (D >= 0 && o[D] === '&') {
          ...
          return (
            o[p] === ';'
              ? (H = j.create(ie.create(t.line, b), ie.create(t.line, k + 1)))
              : (H = j.create(ie.create(t.line, b), ie.create(t.line, k))),
            H
          )
        }
        return null
      ...
      function S(D) {
        let b = a - 1,
          p = '&'
        for (; b >= 0 && Lt(D, b); ) b--
        for (b = b + 1; Lt(D, b); ) (p += D[b]), (b += 1)
        return (p += ';'), p
      }
      if (u.endTagStart && a >= u.endTagStart) {
        const D = w(z.EndTag, u.endTagStart)
        return D ? c(u.tag, D) : null
      }
      const x = w(z.StartTag, u.start)
      if (x) return c(u.tag, x)
      const T = w(z.AttributeName, u.start)
      if (T) {
        const D = u.tag,
          b = e.getText(T)
        return d(D, b, T)
      ...
      if (A) return f(o, A)
      function M(D, b) {
        const p = fe(e.getText(), D)
        let k = p.scan(),
          H
        for (; k !== z.EOS && p.getTokenEnd() <= b; )
          (k = p.scan()), k === z.AttributeName && (H = p.getTokenText())
        return H
      }
      const R = w(z.AttributeValue, u.start)
      if (R) {
        const D = u.tag,
          b = Iu(e.getText(R)),
          p = M(u.start, e.offsetAt(R.start))
        if (p) return m(D, p, b, R)
      }
      return null
    }
    convertContents(e) {
    ...
    doesSupportMarkdown() {
      ...
      if (!en(this.supportsMarkdown)) {
        ...
        const i =
          (n =
            (t =
              (e = this.lsOptions.clientCapabilities) == null
                ? void 0
                : e.textDocument) == null
              ? void 0
              : t.hover) == null
        ...
        function (r) {
          ...
          ;(s.prototype.clone_empty = function () {
            ...
            (s.prototype.item = function (o) {
              return o < 0
                ? this.__items[this.__items.length + o]
                : this.__items[o]
            }),
            (s.prototype.has_match = function (o) {
              for (var l = this.__items.length - 1; l >= 0; l--)
                if (this.__items[l].match(o)) return !0
              return !1
            }),
            (s.prototype.set_indent = function (o, l) {
              this.is_empty() &&
            ...
            (s.prototype._allow_wrap = function () {
              if (this._should_wrap()) {
                ...
                return (
                  ...
                  (this.__character_count = this.__wrap_point_character_count),
                  o.__items[0] === ' ' &&
                    (o.__items.splice(0, 1), (o.__character_count -= 1)),
                  !0
                )
              }
              return !1
...
`)
              l !== -1
                ? (this.__character_count = o.length - l)
          ...
          function a(o, l) {
            ;(this.__cache = ['']),
              ...
              o.indent_with_tabs ||
                (this.__indent_string = new Array(o.indent_size + 1).join(
                  o.indent_char,
                )),
              (l = l || ''),
              o.indent_level > 0 &&
                (l = new Array(o.indent_level + 1).join(this.__indent_string)),
          ...
          ;(a.prototype.get_indent_size = function (o, l) {
            ...
            (a.prototype.__add_column = function () {
              ...
              this.__indent_size &&
                ...
                ((l = Math.floor(o / this.__indent_size)),
                (o -= l * this.__indent_size),
                (c = new Array(l + 1).join(this.__indent_string))),
                o && (c += new Array(o + 1).join(' ')),
                this.__cache.push(c)
            })
          function u(o, l) {
            ;(this.__indent_cache = new a(o, l)),
              (this.raw = !1),
...
` && (c = c.replace(/[\n]/g, o)),
            ...
            (u.prototype.set_indent = function (o, l) {
              return (
                (o = o || 0),
                (l = l || 0),
                this.next_line.set_indent(o, l),
                this.__lines.length > 1
                  ? (this.current_line.set_indent(o, l), !0)
        ...
        function (r) {
          ...
          ;(s.prototype._get_array = function (o, l) {
            ...
            (s.prototype._get_boolean = function (o, l) {
              var c = this.raw_options[o],
                d = c === void 0 ? !!l : !!c
              return d
            }),
            (s.prototype._get_characters = function (o, l) {
              var c = this.raw_options[o],
                d = l || ''
              return (
                typeof c == 'string' &&
...
`,
            ...
            (s.prototype._get_number = function (o, l) {
              var c = this.raw_options[o]
              ;(l = parseInt(l, 10)), isNaN(l) && (l = 0)
              var d = parseInt(c, 10)
              return isNaN(d) && (d = l), d
            }),
            (s.prototype._get_selection = function (o, l, c) {
...
You passed in: '` +
            ...
            (s.prototype._get_selection_list = function (o, l, c) {
              if (!l || l.length === 0)
...
You passed in: '` +
            ...
            (s.prototype._is_valid_selection = function (o, l) {
              return (
                o.length &&
                l.length &&
                !o.some(function (c) {
          ...
          function a(o, l) {
            ...
            o = u(o)
            var d
            for (d in o) d !== l && (c[d] = o[d])
            if (l && o[l]) for (d in o[l]) c[d] = o[l][d]
            return c
          }
          function u(o) {
            var l = {},
          ...
          ;(r.exports.Options = s),
            (r.exports.normalizeOpts = u),
            (r.exports.mergeOpts = a)
        },
        ,
        function (r) {
          ...
          ;(a.prototype.restart = function () {
            ...
            (a.prototype.next = function () {
              ...
              return (
                this.hasNext() &&
                  ((u = this.__input.charAt(this.__position)),
                  (this.__position += 1)),
                u
              )
            }),
            (a.prototype.peek = function (u) {
              ...
              return (
                ...
                u >= 0 &&
                  ...
                  (o = this.__input.charAt(u)),
                o
              )
            }),
            (a.prototype.__match = function (u, o) {
              u.lastIndex = o
              var l = u.exec(this.__input)
              return l && !(s && u.sticky) && l.index !== o && (l = null), l
            }),
            (a.prototype.test = function (u, o) {
              return (
                (o = o || 0),
                (o += this.__position),
                o >= 0 && o < this.__input_length ? !!this.__match(u, o) : !1
              )
            }),
            (a.prototype.testChar = function (u, o) {
              var l = this.peek(o)
              return (u.lastIndex = 0), l !== null && u.test(l)
            }),
            (a.prototype.match = function (u) {
              var o = this.__match(u, this.__position)
              return o ? (this.__position += o[0].length) : (o = null), o
            }),
            (a.prototype.read = function (u, o, l) {
              var c = '',
                d
              return (
                u && ((d = this.match(u)), d && (c += d[0])),
                o && (d || !u) && (c += this.readUntil(o, l)),
                c
              )
            }),
            (a.prototype.readUntil = function (u, o) {
              var l = '',
                c = this.__position
              ...
              return (
                d
                  ? ((c = d.index), o && (c += d[0].length))
                  : (c = this.__input_length),
                (l = this.__input.substring(this.__position, c)),
                (this.__position = c),
                l
              )
            }),
            (a.prototype.readUntilAfter = function (u) {
              return this.readUntil(u, !0)
            }),
            (a.prototype.get_regexp = function (u, o) {
              var l = null,
                c = 'g'
              return (
                o && s && (c = 'y'),
                typeof u == 'string' && u !== ''
                  ? (l = new RegExp(u, c))
                  : u && (l = new RegExp(u.source, c)),
                l
              )
            }),
            (a.prototype.get_literal_regexp = function (u) {
              return RegExp(u.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'))
            }),
            (a.prototype.peekUntilAfter = function (u) {
              var o = this.__position,
                l = this.readUntilAfter(u)
              return (this.__position = o), l
            }),
            (a.prototype.lookBack = function (u) {
              var o = this.__position - 1
              return (
                o >= u.length &&
                this.__input.substring(o - u.length, o).toLowerCase() === u
              )
            }),
        ...
        function (r) {
          function s(a, u) {
            ;(a = typeof a == 'string' ? a : a.source),
              ...
              (this.__directives_block_pattern = new RegExp(
                a + / beautify( \w+[:]\w+)+ /.source + u,
                'g',
              )),
              (this.__directive_pattern = / (\w+)[:](\w+)/g),
              (this.__directives_end_ignore_pattern = new RegExp(
                a + /\sbeautify\signore:end\s/.source + u,
                'g',
              ))
          }
          ;(s.prototype.get_directives = function (a) {
            ...
            for (var o = this.__directive_pattern.exec(a); o; )
              (u[o[1]] = o[2]), (o = this.__directive_pattern.exec(a))
            return u
          }),
        ...
        function (r, s, a) {
          ...
          ;(T.prototype.eatString = function (A) {
            var M = ''
            for (this._ch = this._input.next(); this._ch; ) {
              if (((M += this._ch), this._ch === '\\')) M += this._input.next()
              else if (
...
`
            ...
            (T.prototype.eatWhitespace = function (A) {
              for (
                var M = w.test(this._input.peek()), R = 0;
                ...
                (this._ch = this._input.next()),
                  A &&
                    this._ch ===
                      `
` &&
                    (R === 0 || R < this._options.max_preserve_newlines) &&
                    (R++, this._output.add_new_line(!0))
              return M
            }),
            (T.prototype.foundNestedPseudoClass = function () {
              for (var A = 0, M = 1, R = this._input.peek(M); R; ) {
                if (R === '{') return !0
                if (R === '(') A += 1
                else if (R === ')') {
                  if (A === 0) return !1
                ...
                M++, (R = this._input.peek(M))
              }
              return !1
            }),
            (T.prototype.print_string = function (A) {
              this._output.set_indent(this._indentLevel),
                (this._output.non_breaking_space = !0),
                this._output.add_token(A)
            }),
            (T.prototype.preserveSingleSpace = function (A) {
...
`,
              ...
              var R = A.match(/^[\t ]*/)[0]
              ;(this._output = new o(this._options, R)),
                (this._input = new l(A)),
                (this._indentLevel = 0),
                (this._nestedLevel = 0),
                (this._ch = null)
              for (
                ...
                if (this._ch === '/' && this._input.peek() === '*') {
                  ...
                  var I = this._input.read(S),
                    P = d.get_directives(I)
                  P &&
                    P.ignore === 'start' &&
                  ...
                  if ((this.preserveSingleSpace(C), this._input.peek() === '{'))
                    ...
                    W.match(/[ :]$/) &&
                      ...
                      D === 0 && W.indexOf(':') !== -1
                        ...
                        ? ((this._nestedLevel += 1),
                          W in this.CONDITIONAL_GROUP_RULE && (k = !0))
                        : D === 0 && !p && (H = !0)
                  }
                else if (this._ch === '#' && this._input.peek() === '{')
                  this.preserveSingleSpace(C),
                    this.print_string(this._ch + this.eatString('}'))
                else if (this._ch === '{')
                  p && ((p = !1), this.outdent()),
                    (H = !1),
                    k
                      ? ((k = !1), (b = this._indentLevel >= this._nestedLevel))
                  ...
                  for (
                    var G = 0;
                    G < this.NON_SEMICOLON_NEWLINE_PROPERTY.length;
                    G++
                  )
                    if (
                      this._input.lookBack(
                        this.NON_SEMICOLON_NEWLINE_PROPERTY[G],
                      )
                    ) {
                      L = !0
                      break
                  ...
                  if (this._input.lookBack('url'))
                    ...
                    var le = !1
                    this._input.lookBack('with') && (le = !0),
                      this.preserveSingleSpace(C || le),
                      this.print_string(this._ch),
                      p && N === '$' && this._options.selector_separator_newline
...
` &&
              ...
              var oi = this._output.get_code(M)
              return oi
            }),
...
You passed in: '` +
        ...
        function (r, s, a) {
          ...
          ;(m.prototype.tokenize = function () {
            ...
            for (
              var f, w = new o(d.START, ''), g = null, S = [], x = new l();
              w.type !== d.EOF;

            ) {
              for (f = this._get_next_token(w, g); this._is_comment(f); )
                x.add(f), (f = this._get_next_token(w, g))
              x.isEmpty() || ((f.comments_before = x), (x = new l())),
                (f.parent = g),
                this._is_opening(f)
                  ? (S.push(g), (g = f))
                  : g &&
        ...
        function (r) {
          ...
          ;(s.prototype.restart = function () {
            ...
            (s.prototype.next = function () {
              ...
              return (
                this.hasNext() &&
                  ((a = this.__tokens[this.__position]),
                  (this.__position += 1)),
                a
              )
            }),
            (s.prototype.peek = function (a) {
              ...
              return (
                (a = a || 0),
                (a += this.__position),
                a >= 0 && a < this.__tokens_length && (u = this.__tokens[a]),
                u
              )
            }),
        ...
        function (r, s, a) {
          ...
          ;(o.prototype = new u()),
            (o.prototype.__set_whitespace_patterns = function (l, c) {
              ;(l += '\\t '),
                (c += '\\n\\r'),
            ...
            (o.prototype.__split = function (l, c) {
              ...
              for (var d = 0, m = [], f = l.exec(c); f; )
                m.push(c.substring(d, f.index)),
                  ...
                  (f = l.exec(c))
              return (
                d < c.length ? m.push(c.substring(d, c.length)) : m.push(''), m
              )
            }),
        ...
        function (r) {
          ...
          ;(s.prototype.read = function () {
            ...
            (s.prototype.until_after = function (a) {
              ...
              return (
                (u._until_after = !0),
                (u._until_pattern = this._input.get_regexp(a)),
                u._update(),
                u
              )
            }),
            ...
            (s.prototype.starting_with = function (a) {
              var u = this._create()
              return (
                (u._starting_pattern = this._input.get_regexp(a, !0)),
                u._update(),
                u
              )
            }),
            (s.prototype.matching = function (a) {
              var u = this._create()
              return (
                (u._match_pattern = this._input.get_regexp(a, !0)),
                u._update(),
                u
              )
            }),
        ...
        function (r, s, a) {
          ...
          ;(l.prototype = new u()),
            ...
            (l.prototype.read = function () {
              ...
              return (
                this._until_after &&
                  (c += this._input.readUntilAfter(this._until_pattern)),
                c
              )
            }),
            (l.prototype.__set_templated_pattern = function () {
              var c = []
              this._disabled.php ||
                c.push(this.__patterns.php._starting_pattern.source),
                this._disabled.handlebars ||
                  c.push(this.__patterns.handlebars._starting_pattern.source),
                this._disabled.erb ||
                  c.push(this.__patterns.erb._starting_pattern.source),
                ...
                this._disabled.smarty ||
                  c.push(this.__patterns.smarty._starting_pattern.source),
        ...
        function (r, s, a) {
          ...
          ;(f.prototype.current_line_has_match = function (b) {
            ...
            (f.prototype.print_preserved_newlines = function (b) {
              ...
              for (var k = 0; k < p; k++) this.print_newline(k > 0)
              return p !== 0
            }),
          ...
          var w = function (b) {
              for (
                var p = null, k = b.next;
                k.type !== c.EOF && b.closed !== k;

              ) {
                if (k.type === c.ATTRIBUTE && k.text === 'type') {
                  k.next &&
                    k.next.type === c.EQUALS &&
                    k.next.next &&
                    k.next.next.type === c.VALUE &&
                    (p = k.next.next.text)
                  break
                }
                k = k.next
              ...
              return p.closed
                ? (b === 'script'
                  ...
                  k.search('text/css') > -1
                    ...
                    ? (H = 'javascript')
                    : k.search(/(text|application|dojo)\/(x-)?(html)/) > -1
                    ? (H = 'html')
                    : k.search(/test\/null/) > -1 && (H = 'null'),
                  H)
                : null
            }
          function S(b, p) {
          ...
          ;(T.prototype.get_parser_token = function () {
            ...
            (T.prototype.record_tag = function (b) {
              var p = new x(this._current_frame, b, this._printer.indent_level)
              this._current_frame = p
            }),
            (T.prototype._try_pop_frame = function (b) {
              var p = null
              return (
                b &&
                  ((p = b.parser_token),
            ...
            (T.prototype._get_frame = function (b, p) {
              for (
                var k = this._current_frame;
                k && b.indexOf(k.tag) === -1;

              ) {
                if (p && p.indexOf(k.tag) !== -1) {
                  k = null
                  break
                }
                k = k.parent
            ...
            (T.prototype.try_pop = function (b, p) {
              var k = this._get_frame([b], p)
              return this._try_pop_frame(k)
            }),
            (T.prototype.indent_to_tag = function (b) {
...
`,
            ...
            var k = b.match(/^[\t ]*/)[0],
              H = { text: '', type: '' },
              v = new M(),
              _ = new f(this._options, k),
              L = new l(b, this._options).tokenize()
            this._tag_stack = new T(_)
            for (var y = null, C = L.next(); C.type !== c.EOF; )
              C.type === c.TAG_OPEN || C.type === c.COMMENT
                ? ((y = this._handle_tag_open(_, C, v, H, L)), (v = y))
                : C.type === c.ATTRIBUTE ||
                  C.type === c.EQUALS ||
                  C.type === c.VALUE ||
                  (C.type === c.TEXT && !v.tag_complete)
                ? (y = this._handle_inside_tag(_, C, v, H))
                : C.type === c.TAG_CLOSE
                ? (y = this._handle_tag_close(_, C, v))
                : C.type === c.TEXT
                ? (y = this._handle_text(_, C, v))
                : C.type === c.CONTROL_FLOW_OPEN
                ? (y = this._handle_control_flow_open(_, C))
                : C.type === c.CONTROL_FLOW_CLOSE
                ? (y = this._handle_control_flow_close(_, C))
                : _.add_raw_token(C),
                (H = y),
                (C = L.next())
            var N = _._output.get_code(p)
            return N
          }),
            (A.prototype._handle_control_flow_open = function (b, p) {
              var k = { text: p.text, type: p.type }
              return (
            ...
            (A.prototype._handle_control_flow_close = function (b, p) {
              var k = { text: p.text, type: p.type }
              return (
                b.deindent(),
                p.newlines
            ...
            (A.prototype._handle_tag_close = function (b, p, k) {
              ...
              return (
                ...
                k.is_unformatted
                  ? b.add_raw_token(p)
                  : (k.tag_start_char === '<' &&
                      (b.set_space_before_token(p.text[0] === '/', !0),
                      this._is_wrap_attributes_force_expand_multiline &&
                        k.has_wrapped_attrs &&
                        b.print_newline(!1)),
                    b.print_token(p)),
                k.indent_content &&
                  !(k.is_unformatted || k.is_content_unformatted) &&
                  (b.indent(), (k.indent_content = !1)),
                !k.is_inline_element &&
                  !(k.is_unformatted || k.is_content_unformatted) &&
                  b.set_wrap_point(),
                H
            ...
            (A.prototype._handle_inside_tag = function (b, p, k, H) {
              var v = k.has_wrapped_attrs,
              ...
              return (
                ...
                k.is_unformatted
                  ? b.add_raw_token(p)
                  : k.tag_start_char === '{' && p.type === c.TEXT
                  ? b.print_preserved_newlines(p)
                    ? ((p.newlines = 0), b.add_raw_token(p))
                    : b.print_token(p)
                  : (p.type === c.ATTRIBUTE
                      ? b.set_space_before_token(!0)
                      : (p.type === c.EQUALS ||
                          (p.type === c.VALUE &&
                            p.previous.type === c.EQUALS)) &&
                        b.set_space_before_token(!1),
                    p.type === c.ATTRIBUTE &&
                      k.tag_start_char === '<' &&
                      ((this._is_wrap_attributes_preserve ||
                        this._is_wrap_attributes_preserve_aligned) &&
                        (b.traverse_whitespace(p), (v = v || p.newlines !== 0)),
                      this._is_wrap_attributes_force &&
                        k.attr_count >=
                          this._options.wrap_attributes_min_attrs &&
                        (H.type !== c.TAG_OPEN ||
                          this._is_wrap_attributes_force_expand_multiline) &&
                        (b.print_newline(!1), (v = !0))),
                    b.print_token(p),
                    (v = v || b.previous_token_wrapped()),
                    (k.has_wrapped_attrs = v)),
                _
              )
            }),
            (A.prototype._handle_text = function (b, p, k) {
              var H = { text: p.text, type: 'TK_CONTENT' }
              return (
                k.custom_beautifier_name
                  ? this._print_custom_beatifier_text(b, p, k)
                  : k.is_unformatted || k.is_content_unformatted
                  ? b.add_raw_token(p)
                  : (b.traverse_whitespace(p), b.print_token(p)),
                H
              )
            }),
            (A.prototype._print_custom_beatifier_text = function (b, p, k) {
              var H = this
              if (p.text !== '') {
                var v = p.text,
                  _,
                  ...
                  y = '',
                  C = ''
                k.custom_beautifier_name === 'javascript' &&
                typeof this._js_beautify == 'function'
                  ? (_ = this._js_beautify)
                  : k.custom_beautifier_name === 'css' &&
                    typeof this._css_beautify == 'function'
                  ? (_ = this._css_beautify)
                  : k.custom_beautifier_name === 'html' &&
                    (_ = function (G, $) {
                      var le = new A(G, $, H._js_beautify, H._css_beautify)
                      return le.beautify()
                    }),
...
` +
            ...
            (A.prototype._handle_tag_open = function (b, p, k, H, v) {
              ...
              if (
                ...
                !_.is_start_tag
                  ...
                  : (b.traverse_whitespace(p),
                    this._set_tag_position(b, p, _, k, H),
                ...
                do
                  (y = v.peek(L)),
                    y.type === c.ATTRIBUTE && (_.attr_count += 1),
                    (L += 1)
          ...
          var M = function (b, p) {
            if (
              ...
              ;(this.tag_start_char = p.text[0]),
                ...
                this.tag_start_char === '<'
                  ? ((k = p.text.match(/^<([^\s>]*)/)),
                    (this.tag_check = k ? k[1] : ''))
                  : ((k = p.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
                    (this.tag_check = k ? k[1] : ''),
                    (p.text.startsWith('{{#>') || p.text.startsWith('{{~#>')) &&
                      this.tag_check[0] === '>' &&
                      (this.tag_check === '>' && p.next !== null
                        ? (this.tag_check = p.next.text.split(' ')[0])
                        : (this.tag_check = p.text.split('>')[1]))),
                (this.tag_check = this.tag_check.toLowerCase()),
                p.type === c.COMMENT && (this.tag_complete = !0),
          ...
          ;(A.prototype._get_tag_open_token = function (b) {
            var p = new M(this._tag_stack.get_parser_token(), b)
            return (
              (p.alignment_size = this._options.wrap_attributes_indent_size),
              (p.is_end_tag =
                p.is_end_tag || S(p.tag_check, this._options.void_elements)),
              (p.is_empty_element =
                p.tag_complete || (p.is_start_tag && p.is_end_tag)),
              (p.is_unformatted =
                !p.tag_complete && S(p.tag_check, this._options.unformatted)),
              (p.is_content_unformatted =
                !p.is_empty_element &&
                S(p.tag_check, this._options.content_unformatted)),
              (p.is_inline_element =
                S(p.tag_name, this._options.inline) ||
            ...
            (A.prototype._set_tag_position = function (b, p, k, H, v) {
              if (
                (k.is_empty_element ||
                  (k.is_end_tag
                    ? (k.start_tag_token = this._tag_stack.try_pop(k.tag_name))
                    : (this._do_optional_end_element(k) &&
                        (k.is_inline_element || b.print_newline(!1)),
                      this._tag_stack.record_tag(k),
                      (k.tag_name === 'script' || k.tag_name === 'style') &&
                        !(k.is_unformatted || k.is_content_unformatted) &&
                        (k.custom_beautifier_name = g(k.tag_check, p)))),
                S(k.tag_check, this._options.extra_liners) &&
                  (b.print_newline(!1),
                  b._output.just_added_blankline() || b.print_newline(!0)),
                k.is_empty_element)
              ) {
...
`) === -1) ||
                  (k.is_inline_element ||
                    k.is_unformatted ||
                    b.print_newline(!1),
                  this._calcluate_parent_multiline(b, k))
              } else if (k.is_end_tag) {
                var L = !1
                ;(L = k.start_tag_token && k.start_tag_token.multiline_content),
                  (L =
                    L ||
                    (!k.is_inline_element &&
                      !(H.is_inline_element || H.is_unformatted) &&
                      !(v.type === c.TAG_CLOSE && k.start_tag_token === H) &&
                      v.type !== 'TK_CONTENT')),
                  (k.is_content_unformatted || k.is_unformatted) && (L = !1),
                  L && b.print_newline(!1)
              } else
                (k.indent_content = !k.custom_beautifier_name),
                  k.tag_start_char === '<' &&
                    (k.tag_name === 'html'
                      ? (k.indent_content = this._options.indent_inner_html)
                      : k.tag_name === 'head'
                      ? (k.indent_content =
                  ...
                  !(k.is_inline_element || k.is_unformatted) &&
                    (v.type !== 'TK_CONTENT' || k.is_content_unformatted) &&
                    b.print_newline(!1),
                  this._calcluate_parent_multiline(b, k)
            }),
            (A.prototype._calcluate_parent_multiline = function (b, p) {
              p.parent &&
          ...
          var R = [
            ...
            D = ['a', 'audio', 'del', 'ins', 'map', 'noscript', 'video']
          ;(A.prototype._do_optional_end_element = function (b) {
            ...
            if (!(b.is_empty_element || !b.is_start_tag || !b.parent)) {
              if (b.tag_name === 'body')
                ...
                b.parent.tag_name === 'p' &&
                R.indexOf(b.tag_name) !== -1
              ) {
                var k = b.parent.parent
                ;(!k || D.indexOf(k.tag_name) === -1) &&
              ...
              return (b.parent = this._tag_stack.get_parser_token()), p
            }
          }),
        ...
        function (r, s, a) {
          var u = a(9).Tokenizer,
            ...
            f = new l(/<\!--/, /-->/),
            w = function (g, S) {
              u.call(this, g, S), (this._current_tag_name = '')
              var x = new c(this._input).read_options(this._options),
                T = new d(this._input)
              if (
                ((this.__patterns = {
                  word: x.until(/[\n\r\t <]/),
                  word_control_flow_close_excluded: x.until(/[\n\r\t <}]/),
                  single_quote: x.until_after(/'/),
                  double_quote: x.until_after(/"/),
                  attribute: x.until(/[\n\r\t =>]|\/>/),
                  element_name: x.until(/[\n\r\t >\/]/),
                  angular_control_flow_start: T.matching(
                    /\@[a-zA-Z]+[^({]*[({]/,
                  ),
                  handlebars_comment:
                    T.starting_with(/{{!--/).until_after(/--}}/),
          ...
          ;(w.prototype = new u()),
            ...
            (w.prototype._is_closing = function (g, S) {
              return (
                (g.type === m.TAG_CLOSE &&
                  S &&
                  (((g.text === '>' || g.text === '/>') && S.text[0] === '<') ||
                    (g.text === '}}' &&
                      S.text[0] === '{' &&
                      S.text[1] === '{'))) ||
            ...
            (w.prototype._get_next_token = function (g, S) {
              var x = null
              this._readWhitespace()
              var T = this._input.peek()
              return T === null
                ? this._create_token(m.EOF, '')
                : ((x = x || this._read_open_handlebars(T, S)),
                  (x = x || this._read_attribute(T, g, S)),
                  (x = x || this._read_close(T, S)),
                  (x = x || this._read_control_flows(T, S)),
                  (x = x || this._read_raw_content(T, g, S)),
                  (x = x || this._read_content_word(T, S)),
                  (x = x || this._read_comment_or_cdata(T)),
                  (x = x || this._read_processing(T)),
                  (x = x || this._read_open(T, S)),
            ...
            (w.prototype._read_comment_or_cdata = function (g) {
              ...
              if (g === '<') {
                ...
                A === '!' &&
                  ((x = this.__patterns.comment.read()),
                  x
                    ? ((T = f.get_directives(x)),
                      T &&
                        T.ignore === 'start' &&
                        (x += f.readIgnored(this._input)))
                    : (x = this.__patterns.cdata.read())),
                  x &&
                    ((S = this._create_token(m.COMMENT, x)), (S.directives = T))
              }
              return S
            }),
            (w.prototype._read_processing = function (g) {
              ...
              if (g === '<') {
                var A = this._input.peek(1)
                ;(A === '!' || A === '?') &&
                  ((x = this.__patterns.conditional_comment.read()),
                  (x = x || this.__patterns.processing.read())),
                  x &&
                    ((S = this._create_token(m.COMMENT, x)), (S.directives = T))
              }
              return S
            }),
            (w.prototype._read_open = function (g, S) {
              var x = null,
                T = null
              return (
                (!S || S.type === m.CONTROL_FLOW_OPEN) &&
                  g === '<' &&
                  ((x = this._input.next()),
                  this._input.peek() === '/' && (x += this._input.next()),
                  (x += this.__patterns.element_name.read()),
                  (T = this._create_token(m.TAG_OPEN, x))),
                T
              )
            }),
            (w.prototype._read_open_handlebars = function (g, S) {
              var x = null,
                T = null
              return (
                (!S || S.type === m.CONTROL_FLOW_OPEN) &&
                  ...
                  this._input.peek(1) === '{' &&
                  (this._input.peek(2) === '!'
                    ? ((x = this.__patterns.handlebars_comment.read()),
                      (x = x || this.__patterns.handlebars.read()),
                      (T = this._create_token(m.COMMENT, x)))
                    : ((x = this.__patterns.handlebars_open.read()),
                      (T = this._create_token(m.TAG_OPEN, x)))),
                T
              )
            }),
            (w.prototype._read_control_flows = function (g, S) {
              var x = '',
                T = null
              if (
              ...
              if (g === '@') {
                if (
                  ((x = this.__patterns.angular_control_flow_start.read()),
                  x === '')
                )
                  return T
                for (
                  var A = x.endsWith('(') ? 1 : 0, M = 0;
                  !(x.endsWith('{') && A === M);
                ...
                T = this._create_token(m.CONTROL_FLOW_OPEN, x)
              } else
                g === '}' &&
                  S &&
                  S.type === m.CONTROL_FLOW_OPEN &&
                  ((x = this._input.next()),
                  (T = this._create_token(m.CONTROL_FLOW_CLOSE, x)))
              return T
            }),
            (w.prototype._read_close = function (g, S) {
              var x = null,
                T = null
              return (
                S &&
                  S.type === m.TAG_OPEN &&
                  (S.text[0] === '<' &&
                  (g === '>' || (g === '/' && this._input.peek(1) === '>'))
                    ? ((x = this._input.next()),
                      g === '/' && (x += this._input.next()),
                      (T = this._create_token(m.TAG_CLOSE, x)))
                    : S.text[0] === '{' &&
                      g === '}' &&
                      this._input.peek(1) === '}' &&
                      (this._input.next(),
                      this._input.next(),
                      (T = this._create_token(m.TAG_CLOSE, '}}')))),
                T
              )
            }),
            (w.prototype._read_attribute = function (g, S, x) {
              var T = null,
                A = ''
              if (x && x.text[0] === '<')
                if (g === '=')
                  T = this._create_token(m.EQUALS, this._input.next())
                else if (g === '"' || g === "'") {
                  var M = this._input.next()
                  g === '"'
                    ? (M += this.__patterns.double_quote.read())
                    : (M += this.__patterns.single_quote.read()),
                    (T = this._create_token(m.VALUE, M))
                } else
                  (A = this.__patterns.attribute.read()),
                    A &&
                      (S.type === m.EQUALS
                        ? (T = this._create_token(m.VALUE, A))
                        : (T = this._create_token(m.ATTRIBUTE, A)))
              return T
            }),
            ...
            (w.prototype._read_raw_content = function (g, S, x) {
              var T = ''
              if (x && x.text[0] === '{')
                T = this.__patterns.handlebars_raw_close.read()
              else if (
                S.type === m.TAG_CLOSE &&
                S.opened.text[0] === '<' &&
                S.text[0] !== '/'
              ) {
                var A = S.opened.text.substr(1).toLowerCase()
                if (A === 'script' || A === 'style') {
                  var M = this._read_comment_or_cdata(g)
                  if (M) return (M.type = m.TEXT), M
              ...
              return T ? this._create_token(m.TEXT, T) : null
            }),
            (w.prototype._read_content_word = function (g, S) {
              var x = ''
              if (
                (this._options.unformatted_content_delimiter &&
                  g === this._options.unformatted_content_delimiter[0] &&
                  (x = this.__patterns.unformatted_content_delimiter.read()),
                x ||
                  (x =
                    S && S.type === m.CONTROL_FLOW_OPEN
                ...
                return this._create_token(m.TEXT, x)
            }),
  ...
  function Wu(e, t, n) {
    ...
    const a = n.tabSize || 4
    if (t) {
      let l = e.offsetAt(t.start),
        c = l
      for (; c > 0 && ga(i, c - 1); ) c--
      c === 0 || pa(i, c - 1) ? (l = c) : c < l && (l = c + 1)
      let d = e.offsetAt(t.end),
        m = d
      for (; m < i.length && ga(i, m); ) m++
      ;(m === i.length || pa(i, m)) && (d = m),
        (t = j.create(e.positionAt(l), e.positionAt(d)))
      const f = i.substring(0, l)
      if (new RegExp(/.*[<][^>]*$/).test(f))
        return (i = i.substring(l, d)), [{ range: t, newText: i }]
      if (((r = d === i.length), (i = i.substring(l, d)), l !== 0)) {
        const w = e.offsetAt(ie.create(t.start.line, 0))
        s = Bu(e.getText(), w, n)
      }
    } else t = j.create(ie.create(0, 0), e.positionAt(i.length))
    const u = {
      indent_size: a,
      indent_char: n.insertSpaces ? ' ' : '	',
      indent_empty_lines: pe(n, 'indentEmptyLines', !1),
      wrap_line_length: pe(n, 'wrapLineLength', 120),
      unformatted: si(n, 'unformatted', void 0),
      content_unformatted: si(n, 'contentUnformatted', void 0),
      ...
      end_with_newline: r && pe(n, 'endWithNewline', !1),
      extra_liners: si(n, 'extraLiners', void 0),
...
`,
    ...
    let o = Uu(Fu(i), u)
    if (s > 0) {
      const l = n.insertSpaces ? ca(' ', a * s) : ca('	', s)
      ;(o = o
        .split(
          `
`,
...
`.indexOf(e.charAt(t)) !== -1
        ...
        470: (r) => {
          ...
          function a(o, l) {
            for (
              ...
              if (g < o.length) c = o.charCodeAt(g)
              else {
                if (c === 47) break
                c = 47
              }
          ...
          var u = {
            resolve: function () {
              for (
                var o, l = '', c = !1, d = arguments.length - 1;
                d >= -1 && !c;
                d--
              ) {
                var m
                d >= 0
                  ? (m = arguments[d])
                  : (o === void 0 && (o = process.cwd()), (m = o)),
                  s(m),
                  m.length !== 0 &&
                    ((l = m + '/' + l), (c = m.charCodeAt(0) === 47))
              }
              return (
                (l = a(l, !c)),
                c ? (l.length > 0 ? '/' + l : '/') : l.length > 0 ? l : '.'
              )
            },
            ...
            join: function () {
              ...
              return o === void 0 ? '.' : u.normalize(o)
            },
            relative: function (o, l) {
              if (
                (s(o),
                s(l),
                o === l || (o = u.resolve(o)) === (l = u.resolve(l)))
              )
                return ''
              for (var c = 1; c < o.length && o.charCodeAt(c) === 47; ++c);
              for (
                var d = o.length, m = d - c, f = 1;
                f < l.length && l.charCodeAt(f) === 47;
                ++f
              );
              for (
                var w = l.length - f, g = m < w ? m : w, S = -1, x = 0;
                x <= g;
                ++x
              ) {
                if (x === g) {
                  if (w > g) {
                    if (l.charCodeAt(f + x) === 47) return l.slice(f + x + 1)
                    if (x === 0) return l.slice(f + x)
                  } else
                    m > g &&
                      (o.charCodeAt(c + x) === 47
                        ? (S = x)
                ...
                var T = o.charCodeAt(c + x)
                if (T !== l.charCodeAt(f + x)) break
                T === 47 && (S = x)
              }
              var A = ''
              for (x = c + S + 1; x <= d; ++x)
                (x !== d && o.charCodeAt(x) !== 47) ||
                  (A.length === 0 ? (A += '..') : (A += '/..'))
              return A.length > 0
                ? A + l.slice(f + S)
                : ((f += S), l.charCodeAt(f) === 47 && ++f, l.slice(f))
            },
            ...
            basename: function (o, l) {
              ...
              if (l !== void 0 && l.length > 0 && l.length <= o.length) {
                ...
                return (
                  d === m ? (m = g) : m === -1 && (m = o.length), o.slice(d, m)
                )
              }
              for (c = o.length - 1; c >= 0; --c)
            ...
            extname: function (o) {
              s(o)
              for (
                var l = -1, c = 0, d = -1, m = !0, f = 0, w = o.length - 1;
                w >= 0;
                --w
              ) {
                var g = o.charCodeAt(w)
                if (g !== 47)
                  d === -1 && ((m = !1), (d = w + 1)),
                    g === 46
                      ? l === -1
            ...
            parse: function (o) {
              ...
              m ? ((l.root = '/'), (c = 1)) : (c = 0)
              for (
                var f = -1, w = 0, g = -1, S = !0, x = o.length - 1, T = 0;
                x >= c;
                --x
              )
                if ((d = o.charCodeAt(x)) !== 47)
                  g === -1 && ((S = !1), (g = x + 1)),
                    d === 46
                      ? f === -1
                        ? (f = x)
              ...
              return (
                ...
                (T === 1 && f === g - 1 && f === w + 1)
                  ? g !== -1 &&
                    (l.base = l.name =
                      w === 0 && m ? o.slice(1, g) : o.slice(w, g))
                  : (w === 0 && m
                      ? ((l.name = o.slice(1, f)), (l.base = o.slice(1, g)))
                      : ((l.name = o.slice(w, f)), (l.base = o.slice(w, g))),
                    (l.ext = o.slice(f, g))),
                w > 0 ? (l.dir = o.slice(0, w - 1)) : m && (l.dir = '/'),
                l
              )
            },
            sep: '/',
    ...
    ;(() => {
      ...
      class m {
        constructor(_, L, y, C, N, I = !1) {
          ...
          typeof _ == 'object'
            ...
            : ((this.scheme = (function (P, U) {
                return P || U ? P : 'file'
              })(_, I)),
              (this.authority = L || l),
              (this.path = (function (P, U) {
                switch (P) {
                  case 'https':
                  case 'http':
                  case 'file':
        ...
        with(_) {
          if (!_) return this
          let { scheme: L, authority: y, path: C, query: N, fragment: I } = _
          return (
            L === void 0 ? (L = this.scheme) : L === null && (L = l),
            y === void 0 ? (y = this.authority) : y === null && (y = l),
            C === void 0 ? (C = this.path) : C === null && (C = l),
            N === void 0 ? (N = this.query) : N === null && (N = l),
            I === void 0 ? (I = this.fragment) : I === null && (I = l),
            L === this.scheme &&
            y === this.authority &&
            C === this.path &&
            N === this.query &&
        ...
        static file(_) {
          ...
          if ((r && (_ = _.replace(/\\/g, c)), _[0] === c && _[1] === c)) {
            const y = _.indexOf(c, 2)
            y === -1
              ? ((L = _.substring(2)), (_ = c))
              : ((L = _.substring(2, y)), (_ = _.substring(y) || c))
          }
          return new w('file', L, _, l, l)
        }
        static from(_) {
          ...
          if (_) {
            if (_ instanceof m) return _
            {
              ...
              return (
                ...
                (L._fsPath = _._sep === f ? _.fsPath : null),
                L
              )
            }
          }
      ...
      class w extends m {
        ...
        toJSON() {
          const L = { $mid: 1 }
          return (
            this._fsPath && ((L.fsPath = this._fsPath), (L._sep = f)),
      ...
      function S(v, _, L) {
        ...
        for (let N = 0; N < v.length; N++) {
          ...
          if (
            ...
            C !== -1 &&
              ((y += encodeURIComponent(v.substring(C, N))), (C = -1)),
              y !== void 0 && (y += v.charAt(N))
          else {
            y === void 0 && (y = v.substr(0, N))
            const P = g[I]
            P !== void 0
              ? (C !== -1 &&
                  ((y += encodeURIComponent(v.substring(C, N))), (C = -1)),
        ...
        return (
          C !== -1 && (y += encodeURIComponent(v.substring(C))),
          y !== void 0 ? y : v
        )
      }
      function x(v) {
        ...
        for (let L = 0; L < v.length; L++) {
          const y = v.charCodeAt(L)
          y === 35 || y === 63
            ? (_ === void 0 && (_ = v.substr(0, L)), (_ += g[y]))
            : _ !== void 0 && (_ += v[L])
        }
        return _ !== void 0 ? _ : v
      }
      ...
      function A(v, _) {
        const L = _ ? x : S
        let y = '',
          { scheme: C, authority: N, path: I, query: P, fragment: U } = v
        if (
          (C && ((y += C), (y += ':')),
          (N || C === 'file') && ((y += c), (y += c)),
          N)
          ...
          if (W !== -1) {
            ...
            ;(N = N.substr(W + 1)),
              ...
              W === -1
                ? (y += L(G, !1, !1))
                : ((y += L(G.substr(0, W), !1, !1)),
                  (y += ':'),
                  (y += L(G.substr(W + 1), !1, !0))),
              (y += '@')
          }
          ;(N = N.toLowerCase()),
            (W = N.lastIndexOf(':')),
            W === -1
              ? (y += L(N, !1, !0))
              : ((y += L(N.substr(0, W), !1, !0)), (y += N.substr(W)))
        }
        if (I) {
          if (
            I.length >= 3 &&
            ...
            const W = I.charCodeAt(1)
            W >= 65 &&
              W <= 90 &&
              (I = `/${String.fromCharCode(W + 32)}:${I.substr(3)}`)
          } else if (I.length >= 2 && I.charCodeAt(1) === 58) {
            const W = I.charCodeAt(0)
            W >= 65 &&
              W <= 90 &&
              (I = `${String.fromCharCode(W + 32)}:${I.substr(2)}`)
          }
          y += L(I, !0, !1)
        }
        return (
      ...
      function M(v) {
        try {
          ...
          return v.length > 3 ? v.substr(0, 3) + M(v.substr(3)) : v
        }
      }
      const R = /(%[0-9A-Za-z][0-9A-Za-z])+/g
      function D(v) {
        return v.match(R) ? v.replace(R, (_) => M(_)) : v
      }
      var b = n(470)
      const p = b.posix || b,
        k = '/'
      var H
      ;(function (v) {
        ;(v.joinPath = function (_, ...L) {
          return _.with({ path: p.join(_.path, ...L) })
        }),
          (v.resolvePath = function (_, ...L) {
            let y = _.path,
              C = !1
            y[0] !== k && ((y = k + y), (C = !0))
            let N = p.resolve(y, ...L)
            return (
              C && N[0] === k && !_.authority && (N = N.substring(1)),
              _.with({ path: N })
            )
          }),
          (v.dirname = function (_) {
            if (_.path.length === 0 || _.path === k) return _
            let L = p.dirname(_.path)
            return (
              L.length === 1 && L.charCodeAt(0) === 46 && (L = ''),
              _.with({ path: L })
            )
          }),
  ...
  var { URI: qu, Utils: bc } = ba
  function ai(e) {
    const t = e[0],
      n = e[e.length - 1]
    return (
      t === n && (t === "'" || t === '"') && (e = e.substring(1, e.length - 1)),
      e
    )
  }
  function Ou(e, t) {
  ...
  function Vu(e, t, n, i) {
    ...
    return /^\#/i.test(t)
      ? e + t
      : /^\/\//i.test(t)
      ? (Ve(e, 'https://') ? 'https' : 'http') + ':' + t.replace(/^\s*/g, '')
      : n
  ...
  function ju(e, t, n, i, r, s) {
    const a = ai(n)
    if (!Ou(a, e.languageId)) return
    a.length < n.length && (i++, r--)
    const u = Vu(e.uri, a, t, s)
    if (!u) return
    const o = $u(u, e)
  ...
  function $u(e, t) {
    try {
      ...
      return (
        ...
        n.scheme === 'file' &&
        n.fragment &&
        !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === Gu)
  ...
  var Xu = class {
    ...
    findDocumentLinks(e, t) {
      ...
      for (; r !== z.EOS; ) {
        switch (r) {
          case z.StartTag:
            ;(a = i.getTokenText().toLowerCase()), o || (u = a === 'base')
            break
          case z.AttributeName:
          ...
          case z.AttributeValue:
            if (a && s && this.dataManager.isPathAttribute(a, s)) {
              ...
              if (!u) {
                const d = ju(e, t, c, i.getTokenOffset(), i.getTokenEnd(), o)
                d && n.push(d)
              }
              u &&
                typeof o > 'u' &&
                ((o = ai(c)), o && t && (o = t.resolveReference(o, e.uri))),
                (u = !1),
                (s = void 0)
            } else if (s === 'id') {
              const c = ai(i.getTokenText())
  ...
  function Ju(e, t, n) {
    ...
    if (!r.tag) return []
    const s = [],
      a = va(z.StartTag, e, r.start),
      u = typeof r.endTagStart == 'number' && va(z.EndTag, e, r.endTagStart)
    return (
      ((a && wa(a, t)) || (u && wa(u, t))) &&
        (a && s.push({ kind: Qt.Read, range: a }),
        u && s.push({ kind: Qt.Read, range: u })),
      s
    )
  }
  function _a(e, t) {
  ...
  function wa(e, t) {
    return _a(e.start, t) && _a(t, e.end)
  }
  function va(e, t, n) {
  ...
  function xa(e, t, n) {
    const i = Yu(t),
      ...
      s = Zn.create(i, void 0, Qn.Field, r, r)
    n.push(s),
      t.children.forEach((a) => {
        s.children ?? (s.children = []), xa(e, a, s.children)
      })
  }
  function Yu(e) {
    let t = e.tag
      ...
      limitRanges(e, t) {
        ...
        for (let c = 0; c < e.length; c++) {
          ...
          if (!n) (n = d), a(c, 0)
            ...
            if (d.endLine <= n.endLine) i.push(n), (n = d), a(c, i.length)
        ...
        for (; r !== z.EOS; ) {
          switch (r) {
            case z.StartTag: {
              ...
              a.push({ startLine: m, tagName: d }), (u = d)
              break
            }
            case z.EndTag: {
              u = i.getTokenText()
            ...
            case z.StartTagClose:
              if (!u || !this.dataManager.isVoidElement(u, n)) break
            case z.EndTagClose:
            case z.StartTagSelfClose: {
              let d = a.length - 1
              for (; d >= 0 && a[d].tagName !== u; ) d--
              if (d >= 0) {
                const m = a[d]
                a.length = d
                const f = e.positionAt(i.getTokenOffset()).line,
                  w = m.startLine,
                  g = f - 1
                g > w && o !== w && l({ startLine: w, endLine: g })
              }
              break
            }
            case z.Comment: {
              ...
              if (f)
                if (f[1]) a.push({ startLine: d, tagName: '' })
                else {
                  let w = a.length - 1
                  for (; w >= 0 && a[w].tagName.length; ) w--
                  if (w >= 0) {
                    const g = a[w]
                    a.length = w
                    const S = d
                    ;(d = g.startLine),
                      S > d &&
                        o !== d &&
                        l({ startLine: d, endLine: S, kind: $t.Region })
                  }
                }
              else {
                ...
                d < w && l({ startLine: d, endLine: w, kind: $t.Comment })
              }
              break
            }
          }
    ...
    nc = class {
      ...
      getSelectionRange(e, t, n) {
        ...
        for (let a = i.length - 1; a >= 0; a--) {
          ...
          ;(!r || u[0] !== r[0] || u[1] !== r[1]) &&
            (s = Zt.create(
              j.create(t.positionAt(i[a][0]), t.positionAt(i[a][1])),
              s,
            )),
            (r = u)
        }
        return s || (s = Zt.create(j.create(e, e))), s
      }
        ...
        return !r.startTagEnd || !r.endTagStart
          ...
          : (s.unshift([r.start, r.end]),
            r.start < i && i < r.startTagEnd
              ...
              : (i >= r.endTagStart + 2 &&
                  s.unshift([r.endTagStart + 2, r.end - 1]),
                s))
      }
      ...
      getAttributeLevelRanges(e, t, n) {
        const i = j.create(e.positionAt(t.start), e.positionAt(t.end)),
          r = e.getText(i),
          s = n - t.start,
          a = fe(r)
        let u = a.scan()
        ...
        for (; u !== z.EOS; ) {
          switch (u) {
            case z.AttributeName: {
              ...
              s <= a.getTokenEnd() &&
                l.unshift([a.getTokenOffset(), a.getTokenEnd()]),
                (c = !0),
                (d = a.getTokenOffset())
              break
            }
            case z.AttributeValue: {
              ...
              s >= a.getTokenOffset() &&
                ...
                ((m[0] === '"' && m[m.length - 1] === '"') ||
                  (m[0] === "'" && m[m.length - 1] === "'")) &&
                  s >= a.getTokenOffset() + 1 &&
                  s <= a.getTokenEnd() - 1 &&
                  l.unshift([a.getTokenOffset() + 1, a.getTokenEnd() - 1]),
                l.push([d, a.getTokenEnd()]))
              break
            }
          }
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
    ...
    rc = class {
      ...
      setDataProviders(e, t) {
        ;(this.dataProviders = []),
          e && this.dataProviders.push(new ha('html5', ic)),
      ...
      isVoidElement(e, t) {
        return !!e && du(t, e.toLowerCase(), (n, i) => n.localeCompare(i)) >= 0
      }
      getVoidElements(e) {
        const t = Array.isArray(e)
            ? e
            : this.getDataProviders().filter((i) => i.isApplicable(e)),
          n = []
        return (
          t.forEach((i) => {
            i.provideTags()
  ...
  function oc(e = ac) {
    ...
    return {
      ...
      format: Wu,
      findDocumentHighlights: Ju,
      findDocumentLinks: u.findDocumentLinks.bind(u),
      findDocumentSymbols: Qu,
      findDocumentSymbols2: ya,
  ...
  var uc = class {
    constructor(e, t) {
      ...
      const n = this._languageSettings.data,
        i = n == null ? void 0 : n.useDefaultDataProvider,
        r = []
      if (n != null && n.dataProviders)
        for (const s in n.dataProviders) r.push(lc(s, n.dataProviders[s]))
      this._languageService = oc({
    ...
    _getTextDocument(e) {
      ...
      for (let n of t)
        if (n.uri.toString() === e)
          return ti.create(e, this._languageId, n.version, n.getValue())
      return null
    }
  }
  self.onmessage = () => {
