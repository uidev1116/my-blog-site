import { H as F } from './vendor-b4af7ed9.js'
/*!-----------------------------------------------------------------------------
    ...
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let o of $(n))
        !v.call(t, o) &&
          ...
          b(t, o, {
            get: () => n[o],
            enumerable: !(e = x(n, o)) || e.enumerable,
          })
    return t
  },
  E = (t, n, _) => (g(t, n, 'default'), _ && g(_, n, 'default')),
  r = {}
E(r, F)
var d = [
    'assign',
  ...
  D = { close: '[>\\]]', id: 'auto', open: '[<\\[]' },
  k = { close: '\\}', id: 'dollar', open1: '\\$', open2: '\\{' },
  p = { close: '\\]', id: 'bracket', open1: '\\[', open2: '=' }
function l(t) {
  return {
    brackets: [
      ['<', '>'],
...
function i(t, n) {
  const _ = `_${t.id}_${n.id}`,
    e = (c) => c.replace(/__id__/g, _),
    o = (c) => {
...
function m(t) {
  ...
  return {
    ...
    tokenizer: { ...n.tokenizer, ..._.tokenizer, ...e.tokenizer },
  }
}
var C = { conf: l(a), language: i(a, k) },
  w = { conf: l(u), language: i(u, k) },
  T = { conf: l(a), language: i(a, p) },
  h = { conf: l(u), language: i(u, p) },
  S = { conf: A(), language: m(k) },
  P = { conf: A(), language: m(p) }
export {
