import { H as Lt } from './vendor-b4af7ed9.js'
/*!-----------------------------------------------------------------------------
    ...
    if ((r && typeof r == 'object') || typeof r == 'function')
      for (let t of Rt(r))
        !Mt.call(e, t) &&
          ...
          Ot(e, t, {
            get: () => r[t],
            enumerable: !(n = Nt(r, t)) || n.enumerable,
          })
    return e
  },
  Dt = (e, r, i) => (le(e, r, 'default'), i && le(i, r, 'default')),
  f = {}
Dt(f, Lt)
var Ft = 2 * 60 * 1e3,
  Ut = class {
    ...
    _getClient() {
      return (
        ...
        this._client ||
          ((this._worker = f.editor.createWebWorker({
...
;(function (e) {
  function r(n, t) {
    return (
      n === Number.MAX_VALUE && (n = W.MAX_VALUE),
      t === Number.MAX_VALUE && (t = W.MAX_VALUE),
      { line: n, character: t }
    )
  }
  e.create = r
...
;(function (e) {
  function r(n, t, o, s) {
    ...
    if (O.is(n) && O.is(t)) return { start: n, end: t }
    throw new Error(
      `Range#create called with invalid arguments[${n}, ${t}, ${o}, ${s}]`,
    )
  }
  e.create = r
  function i(n) {
...
;(function (e) {
  function r(n, t, o, s) {
    return { red: n, green: t, blue: o, alpha: s }
  }
  e.create = r
  function i(n) {
    const t = n
...
;(function (e) {
  function r(n, t, o) {
    return { label: n, textEdit: t, additionalTextEdits: o }
  }
  e.create = r
  function i(n) {
    const t = n
    return (
      a.objectLiteral(t) &&
      a.string(t.label) &&
      (a.undefined(t.textEdit) || T.is(t)) &&
      (a.undefined(t.additionalTextEdits) ||
        a.typedArray(t.additionalTextEdits, T.is))
    )
  }
  e.is = i
})(ve || (ve = {}))
...
;(function (e) {
  function r(n, t, o, s, u, g) {
    ...
    return (
      ...
      a.defined(g) && (c.relatedInformation = g),
      c
    )
  }
  e.create = r
  function i(n) {
    ...
    return (
      ...
      (a.undefined(o.codeDescription) ||
        a.string(
          (t = o.codeDescription) === null || t === void 0 ? void 0 : t.href,
        )) &&
      (a.string(o.source) || a.undefined(o.source)) &&
      (a.undefined(o.relatedInformation) ||
        a.typedArray(o.relatedInformation, G.is))
    )
  }
  e.is = i
})(z || (z = {}))
...
;(function (e) {
  ...
  function i(n) {
    ...
    return (
      ...
      (t.annotationId === void 0 || j.is(t.annotationId))
    )
  }
  e.is = i
})(C || (C = {}))
...
;(function (e) {
  function r(n, t, o, s) {
    let u = { kind: 'rename', oldUri: n, newUri: t }
    return (
      o !== void 0 &&
  ...
  function r(i) {
    ...
    return (
      ...
      (n.documentChanges === void 0 ||
        n.documentChanges.every((t) =>
          a.string(t.kind) ? C.is(t) || ee.is(t) || te.is(t) : K.is(t),
        ))
    )
  }
  e.is = r
...
;(function (e) {
  function r(i) {
    ...
    return (
      n &&
      (a.string(n.detail) || n.detail === void 0) &&
...
;(function (e) {
  function r(i, n, t, o, s) {
    let u = { name: i, kind: n, location: { uri: o, range: t } }
...
;(function (e) {
  function r(i, n, t, o) {
    return o !== void 0
      ? { name: i, kind: n, location: { uri: t, range: o } }
      : { name: i, kind: n, location: { uri: t } }
  }
  e.create = r
})(xe || (xe = {}))
var ye
;(function (e) {
  function r(n, t, o, s, u, g) {
    let c = { name: n, detail: t, kind: o, range: s, selectionRange: u }
...
;(function (e) {
  ...
  function i(n) {
    ...
    return (
      a.defined(t) &&
      a.typedArray(t.diagnostics, z.is) &&
...
;(function (e) {
  ...
  function i(n) {
    ...
    return (
      t &&
      a.string(t.title) &&
      (t.diagnostics === void 0 || a.typedArray(t.diagnostics, z.is)) &&
      (t.kind === void 0 || a.string(t.kind)) &&
      (t.edit !== void 0 || t.command !== void 0) &&
      (t.command === void 0 || U.is(t.command)) &&
      (t.isPreferred === void 0 || a.boolean(t.isPreferred)) &&
      (t.edit === void 0 || ne.is(t.edit))
    )
  }
  e.is = i
})(Se || (Se = {}))
...
;(function (e) {
  ...
  function i(n) {
    ...
    return (
      a.defined(t) &&
      m.is(t.range) &&
      (a.undefined(t.command) || U.is(t.command))
    )
  }
  e.is = i
})(Be || (Be = {}))
...
;(function (e) {
  ...
  function i(n) {
    ...
    return (
      a.objectLiteral(t) &&
      (t.tooltip === void 0 || a.string(t.tooltip) || S.is(t.tooltip)) &&
...
;(function (e) {
  ...
  function i(n) {
    ...
    return (
      (a.objectLiteral(t) &&
        O.is(t.position) &&
        (a.string(t.label) || a.typedArray(t.label, ae.is)) &&
        (t.kind === void 0 || se.is(t.kind)) &&
        t.textEdits === void 0) ||
      (a.typedArray(t.textEdits, T.is) &&
        (t.tooltip === void 0 || a.string(t.tooltip) || S.is(t.tooltip)) &&
...
;(function (e) {
  ...
  function n(o, s) {
    ...
    for (let v = g.length - 1; v >= 0; v--) {
      let d = g[v],
        k = o.offsetAt(d.range.start),
        p = o.offsetAt(d.range.end)
      if (p <= c) u = u.substring(0, k) + d.newText + u.substring(p, u.length)
  ...
  function t(o, s) {
    ...
    for (; v < g.length; ) o[k++] = g[v++]
    for (; d < c.length; ) o[k++] = c[d++]
    return o
  }
})(ot || (ot = {}))
var Tt = class {
...
` &&
    ...
    offsetAt(e) {
      ...
      let i = r[e.line],
        n = e.line + 1 < r.length ? r[e.line + 1] : this._content.length
...
var jt = class {
  constructor(e, r, i) {
    ...
    const n = (o) => {
        ...
        ;(this._listener[o.uri.toString()] = o.onDidChangeContent(() => {
          window.clearTimeout(u),
            (u = window.setTimeout(() => this._doValidate(o.uri, s), 500))
        })),
    ...
    this._disposables.push(f.editor.onDidCreateModel(n)),
      this._disposables.push(f.editor.onWillDisposeModel(t)),
...
var Pt = class {
  ...
  provideCompletionItems(e, r, i, n) {
    ...
    return this._worker(t)
      .then((o) => o.doComplete(t.toString(), R(r)))
      .then((o) => {
        if (!o) return
        const s = e.getWordUntilPosition(r),
          u = new f.Range(
            r.lineNumber,
            s.startColumn,
            r.lineNumber,
            ...
            return (
              c.textEdit &&
                (Vt(c.textEdit)
                  ...
                  : (v.range = w(c.textEdit.range)),
                (v.insertText = c.textEdit.newText)),
              c.additionalTextEdits &&
                (v.additionalTextEdits = c.additionalTextEdits.map(B)),
              c.insertTextFormat === oe.Snippet &&
                (v.insertTextRules =
                  f.languages.CompletionItemInsertTextRule.InsertAsSnippet),
              v
            )
          })
...
var Wt = class {
  ...
  provideHover(e, r, i) {
    ...
    return this._worker(n)
      .then((t) => t.doHover(n.toString(), R(r)))
      .then((t) => {
        if (t) return { range: w(t.range), contents: zt(t.contents) }
      })
  }
}
function Ht(e) {
...
var hn = class {
  ...
  provideDocumentHighlights(e, r, i) {
    const n = e.uri
    return this._worker(n)
      .then((t) => t.findDocumentHighlights(n.toString(), R(r)))
      .then((t) => {
        if (t) return t.map((o) => ({ range: w(o.range), kind: Xt(o.kind) }))
      })
  }
}
function Xt(e) {
...
var _n = class {
  ...
  provideDefinition(e, r, i) {
    const n = e.uri
    return this._worker(n)
      .then((t) => t.findDefinition(n.toString(), R(r)))
      .then((t) => {
        if (t) return [mt(t)]
      })
  }
...
function mt(e) {
  return { uri: f.Uri.parse(e.uri), range: w(e.range) }
}
var kn = class {
    constructor(e) {
      this._worker = e
    ...
    provideReferences(e, r, i, n) {
      const t = e.uri
      return this._worker(t)
        .then((o) => o.findReferences(t.toString(), R(r)))
        .then((o) => {
          if (o) return o.map(mt)
        })
    }
  },
  bn = class {
    ...
    provideRenameEdits(e, r, i, n) {
      const t = e.uri
      return this._worker(t)
        .then((o) => o.doRename(t.toString(), R(r), i))
        .then((o) => qt(o))
    }
  }
function qt(e) {
  ...
  for (let i in e.changes) {
    ...
    for (let t of e.changes[i])
      r.push({
        resource: n,
        versionId: void 0,
        textEdit: { range: w(t.range), text: t.newText },
      })
  }
  return { edits: r }
}
var Jt = class {
  ...
  provideDocumentSymbols(e, r) {
    ...
    return this._worker(i)
      .then((n) => n.findDocumentSymbols(i.toString()))
      .then((n) => {
        if (n)
          return n.map((t) =>
            $t(t)
...
var wn = class {
    ...
    provideLinks(e, r) {
      const i = e.uri
      return this._worker(i)
        .then((n) => n.findDocumentLinks(i.toString()))
        .then((n) => {
          if (n)
            return {
              links: n.map((t) => ({ range: w(t.range), url: t.target })),
            }
        })
    }
  },
  Qt = class {
    ...
    provideDocumentFormattingEdits(e, r, i) {
      const n = e.uri
      return this._worker(n).then((t) =>
        t.format(n.toString(), null, kt(r)).then((o) => {
          if (!(!o || o.length === 0)) return o.map(B)
        }),
      )
    }
  },
  Yt = class {
    ...
    provideDocumentRangeFormattingEdits(e, r, i, n) {
      ...
      return this._worker(t).then((o) =>
        o.format(t.toString(), vt(r), kt(i)).then((s) => {
          if (!(!s || s.length === 0)) return s.map(B)
        }),
      )
    }
  }
...
var Gt = class {
    ...
    provideDocumentColors(e, r) {
      const i = e.uri
      return this._worker(i)
        .then((n) => n.findDocumentColors(i.toString()))
        .then((n) => {
          if (n) return n.map((t) => ({ color: t.color, range: w(t.range) }))
        })
    }
    provideColorPresentations(e, r, i) {
      ...
      return this._worker(n)
        .then((t) =>
          t.getColorPresentations(n.toString(), r.color, vt(r.range)),
        )
        .then((t) => {
          if (t)
            return t.map((o) => {
              let s = { label: o.label }
              return (
                o.textEdit && (s.textEdit = B(o.textEdit)),
                o.additionalTextEdits &&
                  (s.additionalTextEdits = o.additionalTextEdits.map(B)),
                s
              )
            })
        })
  ...
  Zt = class {
    ...
    provideFoldingRanges(e, r, i) {
      const n = e.uri
      return this._worker(n)
        .then((t) => t.getFoldingRanges(n.toString(), r))
        .then((t) => {
          if (t)
            return t.map((o) => {
...
var Ct = class {
  ...
  provideSelectionRanges(e, r, i) {
    const n = e.uri
    return this._worker(n)
      .then((t) => t.getSelectionRanges(n.toString(), r.map(R)))
      .then((t) => {
        if (t)
          return t.map((o) => {
            const s = []
            for (; o; ) s.push({ range: w(o.range) }), (o = o.parent)
            return s
          })
      })
  }
...
function en(e, r = !1) {
  ...
  function k(l, A) {
    ...
    for (; L < l || !A; ) {
      ...
      if (b >= 48 && b <= 57) I = I * 16 + b - 48
      else if (b >= 65 && b <= 70) I = I * 16 + b - 65 + 10
      else if (b >= 97 && b <= 102) I = I * 16 + b - 97 + 10
      else break
      n++, L++
    }
    return L < l && (I = -1), I
  ...
  function N() {
    ...
    else for (n++; n < e.length && M(e.charCodeAt(n)); ) n++
    if (n < e.length && e.charCodeAt(n) === 46)
      if ((n++, n < e.length && M(e.charCodeAt(n))))
        for (n++; n < e.length && M(e.charCodeAt(n)); ) n++
      else return (d = 3), e.substring(l, n)
    let A = n
    if (n < e.length && (e.charCodeAt(n) === 69 || e.charCodeAt(n) === 101))
      if (
        (n++,
        ((n < e.length && e.charCodeAt(n) === 43) || e.charCodeAt(n) === 45) &&
          n++,
        n < e.length && M(e.charCodeAt(n)))
      ) {
        for (n++; n < e.length && M(e.charCodeAt(n)); ) n++
        A = n
      } else d = 3
...
`
  ...
  function ce() {
    ...
    if ($(l)) {
      do n++, (t += String.fromCharCode(l)), (l = e.charCodeAt(n))
      while ($(l))
      return (s = 15)
    }
    if (x(l))
...
`)),
    ...
    switch (l) {
      ...
      case 47:
        ...
        if (e.charCodeAt(n + 1) === 42) {
          ...
          for (; n < L; ) {
            ...
            n++,
              x(b) && (b === 13 && e.charCodeAt(n) === 10 && n++, u++, (c = n))
          }
      ...
      case 45:
        if (
          ((t += String.fromCharCode(l)), n++, n === i || !M(e.charCodeAt(n)))
        )
          return (s = 16)
      case 48:
      case 49:
      ...
      case 57:
        return (t += N()), (s = 11)
      default:
        for (; n < i && It(l); ) n++, (l = e.charCodeAt(n))
        if (o !== n) {
...
` + ' '.repeat(r),
  ...
  new Array(D).fill(0).map((e, r) => '\r' + ' '.repeat(r)),
  new Array(D).fill(0).map(
    (e, r) =>
      `\r
` + ' '.repeat(r),
...
var dt = 'delimiter.bracket.json',
  gt = 'delimiter.array.json',
  rn = 'delimiter.colon.json',
  on = 'delimiter.comma.json',
  sn = 'keyword.json',
  an = 'keyword.json',
  un = 'string.value.json',
  cn = 'number.json',
  ln = 'string.key.json',
  fn = 'comment.block.json',
  dn = 'comment.line.json',
  y = class bt {
    constructor(r, i) {
    ...
    equals(r) {
      return r === this
        ...
        : this.scanError === r.scanError &&
          ...
          y.equals(this.parents, r.parents)
    }
    getStateData() {
      return this._state
    }
...
function gn(e, r, i, n = 0) {
  ...
  const s = tn(r)
  let u = i.lastWasColon,
    g = i.parents
  const c = { tokens: [], endState: i.clone() }
  for (;;) {
    let v = n + s.getPosition(),
      d = ''
    const k = s.scan()
    if (k === 17) break
    ...
    switch ((o && (v -= t), (o = t > 0), k)) {
      case 1:
        ;(g = y.push(g, 0)), (d = dt), (u = !1)
        break
      case 2:
        ;(g = y.pop(g)), (d = dt), (u = !1)
        break
      case 3:
        ;(g = y.push(g, 1)), (d = gt), (u = !1)
        break
      case 4:
        ;(g = y.pop(g)), (d = gt), (u = !1)
        break
    ...
    ;(c.endState = new wt(i.getStateData(), s.getTokenError(), u, g)),
      c.tokens.push({ startIndex: v, scopes: d })
  }
  return c
}
var E
  ...
  function t() {
    ...
    At(i),
      u.documentFormattingEdits &&
        i.push(
          f.languages.registerDocumentFormattingEditProvider(s, new Qt(E)),
        ),
      u.documentRangeFormattingEdits &&
        i.push(
          f.languages.registerDocumentRangeFormattingEditProvider(s, new Yt(E)),
        ),
      u.completionItems &&
        i.push(
      ...
      u.hovers && i.push(f.languages.registerHoverProvider(s, new Wt(E))),
      u.documentSymbols &&
        i.push(f.languages.registerDocumentSymbolProvider(s, new Jt(E))),
      u.tokens && i.push(f.languages.setTokensProvider(s, nn(!0))),
      u.colors && i.push(f.languages.registerColorProvider(s, new Gt(E))),
      u.foldingRanges &&
        i.push(f.languages.registerFoldingRangeProvider(s, new Zt(E))),
      u.diagnostics && i.push(new pn(s, E, e)),
      u.selectionRanges &&
        i.push(f.languages.registerSelectionRangeProvider(s, new Ct(E)))
  }
