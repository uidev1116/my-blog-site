import { H as tt } from './vendor-b4af7ed9.js'
/*!-----------------------------------------------------------------------------
    ...
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let t of it(n))
        !ot.call(e, t) &&
          ...
          rt(e, t, {
            get: () => n[t],
            enumerable: !(r = nt(n, t)) || r.enumerable,
          })
    return e
  },
  at = (e, n, i) => (Y(e, n, 'default'), i && Y(i, n, 'default')),
  d = {}
at(d, tt)
var st = 2 * 60 * 1e3,
  ut = class {
...
;(function (e) {
  function n(r, t, o, s, u, f) {
    let c = { name: r, detail: t, kind: o, range: s, selectionRange: u }
...
;(function (e) {
  ...
  function r(o, s) {
    ...
    for (let g = f.length - 1; g >= 0; g--) {
      ...
      if (l <= c) u = u.substring(0, b) + _.newText + u.substring(l, u.length)
...
;(function (e) {
  ...
  e.number = s
  function u(l, N, et) {
    return n.call(l) === '[object Number]' && N <= l && l <= et
  }
  e.numberRange = u
  function f(l) {
    return (
            ...
            return (
              c.textEdit &&
                (ht(c.textEdit)
                  ...
                  : (g.range = m(c.textEdit.range)),
                (g.insertText = c.textEdit.newText)),
              c.additionalTextEdits &&
                (g.additionalTextEdits = c.additionalTextEdits.map(D)),
              c.insertTextFormat === Q.Snippet &&
                (g.insertTextRules =
...
var mt = class {
  ...
  provideHover(e, n, i) {
    ...
    return this._worker(r)
      ...
      .then((t) => {
        if (t) return { range: m(t.range), contents: bt(t.contents) }
      })
  }
}
function _t(e) {
...
var wt = class {
  ...
  provideDocumentHighlights(e, n, i) {
    ...
    return this._worker(r)
      ...
      .then((t) => {
        if (t) return t.map((o) => ({ range: m(o.range), kind: kt(o.kind) }))
      })
  }
}
function kt(e) {
...
function Ye(e) {
  return {
    ...
    tags: e.tags ?? [],
    children: (e.children ?? []).map((n) => Ye(n)),
  }
}
function Ze(e) {
  ...
  Pt = class {
    ...
    provideDocumentFormattingEdits(e, n, i) {
      ...
      return this._worker(r).then((t) =>
        t.format(r.toString(), null, Te(n)).then((o) => {
  ...
  Dt = class {
    ...
    provideDocumentRangeFormattingEdits(e, n, i, r) {
      ...
      return this._worker(t).then((o) =>
        o.format(t.toString(), Ge(n), Te(i)).then((s) => {
...
var Mt = class {
    ...
    provideColorPresentations(e, n, i) {
      ...
      return this._worker(r)
        .then((t) =>
          t.getColorPresentations(r.toString(), n.color, Ge(n.range)),
        )
        .then((t) => {
          if (t)
            return t.map((o) => {
...
function Ot(e) {
  ...
  function o() {
    ...
    Ke(i),
      ...
      u.hovers && i.push(d.languages.registerHoverProvider(s, new mt(t))),
      u.documentHighlights &&
        i.push(d.languages.registerDocumentHighlightProvider(s, new wt(t))),
      u.definitions &&
        i.push(d.languages.registerDefinitionProvider(s, new xt(t))),
      u.references &&
        i.push(d.languages.registerReferenceProvider(s, new It(t))),
      u.documentSymbols &&
        i.push(d.languages.registerDocumentSymbolProvider(s, new At(t))),
      u.rename && i.push(d.languages.registerRenameProvider(s, new Et(t))),
      u.colors && i.push(d.languages.registerColorProvider(s, new Mt(t))),
      u.foldingRanges &&
        i.push(d.languages.registerFoldingRangeProvider(s, new Ct(t))),
      u.diagnostics && i.push(new dt(s, t, e.onDidChange)),
      u.selectionRanges &&
        i.push(d.languages.registerSelectionRangeProvider(s, new Ft(t))),
      u.documentFormattingEdits &&
        i.push(
          d.languages.registerDocumentFormattingEditProvider(s, new Pt(t)),
        ),
      u.documentRangeFormattingEdits &&
        i.push(
          d.languages.registerDocumentRangeFormattingEditProvider(s, new Dt(t)),
        )
  }
