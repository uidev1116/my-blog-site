import { H as ft } from './vendor-b4af7ed9.js'
/*!-----------------------------------------------------------------------------
    ...
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let t of vt(n))
        !pt.call(e, t) &&
          ...
          gt(e, t, {
            get: () => n[t],
            enumerable: !(r = ht(n, t)) || r.enumerable,
          })
    return e
  },
  mt = (e, n, i) => (T(e, n, 'default'), i && T(i, n, 'default')),
  c = {}
mt(c, ft)
var _t = 2 * 60 * 1e3,
  Ge = class {
...
;(function (e) {
  function n(r, t, o, s) {
    ...
    if (b.is(r) && b.is(t)) return { start: r, end: t }
    throw new Error(
...
;(function (e) {
  function n(r, t, o, s, u, f) {
    const d = { startLine: r, endLine: t }
    return (
      a.defined(o) && (d.startCharacter = o),
      a.defined(s) && (d.endCharacter = s),
      a.defined(u) && (d.kind = u),
      a.defined(f) && (d.collapsedText = f),
      d
    )
  }
  e.create = n
...
;(function (e) {
  function n(r, t, o, s, u, f) {
    ...
    return (
      a.defined(o) && (d.severity = o),
      a.defined(s) && (d.code = s),
      a.defined(u) && (d.source = u),
      a.defined(f) && (d.relatedInformation = f),
      d
    )
  }
  e.create = n
...
;(function (e) {
  ...
  function i(r) {
    ...
    return (
      ...
      (t.annotationId === void 0 || L.is(t.annotationId))
    )
  }
  e.is = i
})(H || (H = {}))
...
;(function (e) {
  function n(r, t, o, s, u, f) {
    let d = { name: r, detail: t, kind: o, range: s, selectionRange: u }
...
;(function (e) {
  ...
  function i(r) {
    ...
    return (
      a.defined(t) &&
      a.typedArray(t.diagnostics, F.is) &&
...
;(function (e) {
  ...
  function i(r) {
    ...
    return (
      t &&
      a.string(t.title) &&
      (t.diagnostics === void 0 || a.typedArray(t.diagnostics, F.is)) &&
      (t.kind === void 0 || a.string(t.kind)) &&
      (t.edit !== void 0 || t.command !== void 0) &&
      (t.command === void 0 || I.is(t.command)) &&
...
;(function (e) {
  ...
  function i(r) {
    ...
    return (
      a.defined(t) &&
      h.is(t.range) &&
      (a.undefined(t.command) || I.is(t.command))
    )
  }
  e.is = i
})(Ae || (Ae = {}))
...
;(function (e) {
  ...
  function i(r) {
    ...
    return (
      a.objectLiteral(t) &&
      (t.tooltip === void 0 || a.string(t.tooltip) || P.is(t.tooltip)) &&
...
;(function (e) {
  ...
  function r(o, s) {
    ...
    for (let g = f.length - 1; g >= 0; g--) {
      let _ = f[g],
        w = o.offsetAt(_.range.start),
        l = o.offsetAt(_.range.end)
      if (l <= d) u = u.substring(0, w) + _.newText + u.substring(l, u.length)
  ...
  function t(o, s) {
    ...
    for (; g < f.length; ) o[w++] = f[g++]
    for (; _ < d.length; ) o[w++] = d[_++]
    return o
  }
})(Be || (Be = {}))
var wt = class {
...
;(function (e) {
  ...
  e.number = s
  function u(l, N, lt) {
    return n.call(l) === '[object Number]' && N <= l && l <= lt
  }
  e.numberRange = u
  function f(l) {
    return (
      n.call(l) === '[object Number]' && -2147483648 <= l && l <= 2147483647
    )
  }
  e.integer = f
  function d(l) {
            ...
            return (
              d.textEdit &&
                (It(d.textEdit)
                  ...
                  : (g.range = m(d.textEdit.range)),
                (g.insertText = d.textEdit.newText)),
              d.additionalTextEdits &&
                (g.additionalTextEdits = d.additionalTextEdits.map(D)),
...
var Te = class {
  ...
  provideHover(e, n, i) {
    ...
    return this._worker(r)
      ...
      .then((t) => {
        if (t) return { range: m(t.range), contents: Rt(t.contents) }
      })
  }
}
function At(e) {
...
var Ye = class {
  ...
  provideDocumentHighlights(e, n, i) {
    ...
    return this._worker(r)
      ...
      .then((t) => {
        if (t) return t.map((o) => ({ range: m(o.range), kind: Pt(o.kind) }))
      })
  }
}
function Pt(e) {
...
function Ze(e) {
  return { uri: c.Uri.parse(e.uri), range: m(e.range) }
}
var Nt = class {
    constructor(e) {
      this._worker = e
    ...
    provideLinks(e, n) {
      ...
      return this._worker(i)
        ...
        .then((r) => {
          if (r)
            return {
              links: r.map((t) => ({ range: m(t.range), url: t.target })),
            }
        })
    }
  },
  it = class {
    ...
    provideDocumentFormattingEdits(e, n, i) {
      ...
      return this._worker(r).then((t) =>
        t.format(r.toString(), null, at(n)).then((o) => {
          if (!(!o || o.length === 0)) return o.map(D)
        }),
      )
    }
  },
  ot = class {
    ...
    provideDocumentRangeFormattingEdits(e, n, i, r) {
      ...
      return this._worker(t).then((o) =>
        o.format(t.toString(), Je(n), at(i)).then((s) => {
...
var St = class {
    ...
    provideDocumentColors(e, n) {
      ...
      return this._worker(i)
        ...
        .then((r) => {
          if (r) return r.map((t) => ({ color: t.color, range: m(t.range) }))
        })
    }
    provideColorPresentations(e, n, i) {
      ...
      return this._worker(r)
        .then((t) =>
          t.getColorPresentations(r.toString(), n.color, Je(n.range)),
        )
        .then((t) => {
          if (t)
            return t.map((o) => {
              let s = { label: o.label }
              return (
                o.textEdit && (s.textEdit = D(o.textEdit)),
                o.additionalTextEdits &&
                  (s.additionalTextEdits = o.additionalTextEdits.map(D)),
                s
              )
            })
        })
...
function Ot(e) {
  ...
  let r = e.languageId
  c.languages.registerCompletionItemProvider(r, new ct(i)),
    c.languages.registerHoverProvider(r, new Te(i)),
    c.languages.registerDocumentHighlightProvider(r, new Ye(i)),
    c.languages.registerLinkProvider(r, new nt(i)),
    c.languages.registerFoldingRangeProvider(r, new st(i)),
    c.languages.registerDocumentSymbolProvider(r, new et(i)),
    c.languages.registerSelectionRangeProvider(r, new ut(i)),
    c.languages.registerRenameProvider(r, new Ke(i)),
    r === 'html' &&
      (c.languages.registerDocumentFormattingEditProvider(r, new it(i)),
      c.languages.registerDocumentRangeFormattingEditProvider(r, new ot(i)))
}
function Ut(e) {
  const n = [],
    i = [],
  ...
  function o() {
    ...
    dt(i),
      u.completionItems &&
        i.push(c.languages.registerCompletionItemProvider(s, new ct(t))),
      u.hovers && i.push(c.languages.registerHoverProvider(s, new Te(t))),
      u.documentHighlights &&
        i.push(c.languages.registerDocumentHighlightProvider(s, new Ye(t))),
      u.links && i.push(c.languages.registerLinkProvider(s, new nt(t))),
      u.documentSymbols &&
        i.push(c.languages.registerDocumentSymbolProvider(s, new et(t))),
      u.rename && i.push(c.languages.registerRenameProvider(s, new Ke(t))),
      u.foldingRanges &&
        i.push(c.languages.registerFoldingRangeProvider(s, new st(t))),
      u.selectionRanges &&
        i.push(c.languages.registerSelectionRangeProvider(s, new ut(t))),
      u.documentFormattingEdits &&
        i.push(
          c.languages.registerDocumentFormattingEditProvider(s, new it(t)),
        ),
      u.documentRangeFormattingEdits &&
        i.push(
          c.languages.registerDocumentRangeFormattingEditProvider(s, new ot(t)),
        )
  }
...
export {
  ...
  Ye as DocumentHighlightAdapter,
