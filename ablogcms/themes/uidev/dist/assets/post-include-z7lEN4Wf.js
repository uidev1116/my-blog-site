import { g as $i, c as Bi } from './preload-helper-CqCcXmTM.js'
var Hn = { exports: {} }
/*!
 ...
 */ ;(function (W) {
  ;(function (x, G) {
            ...
            : ((t = $(e)),
              t
                ? ((n = Q.call(t, 'constructor') && t.constructor),
                  typeof n == 'function' && st.call(n) === Xe)
                : !0)
        },
    ...
    ;(function () {
            ...
            (K = function (g, v) {
              ...
              return (
                ...
                T & 1 || (!q.sortDetached && v.compareDocumentPosition(g) === T)
                  ? g === u || (g.ownerDocument == Te && V.contains(Te, g))
                    ? -1
                    : v === u || (v.ownerDocument == Te && V.contains(Te, v))
                    ? 1
                    : i
      ...
      ;(V.matches = function (a, l) {
        return V(a, null, null, l)
      }),
        (V.matchesSelector = function (a, l) {
          ...
          return V(l, u, null, [a]).length > 0
        }),
        (V.contains = function (a, l) {
        ...
        (t = r.expr =
          {
            ...
            pseudos: {
              ...
              lang: pe(function (a) {
                return (
                  rt.test(a || '') || V.error('unsupported lang: ' + a),
      ...
      function ot(a, l) {
        ...
        return l ? C.length : C ? V.error(a) : _(a, S).slice(0)
      }
      function gt(a) {
      ...
      function Fi(a, l, p) {
        for (var g = 0, v = l.length; g < v; g++) V(a, l[g], p)
        return p
      }
      ...
      ;(q.sortStable = b.split('').sort(K).join('') === b),
        ...
        (V.setDocument = Ae),
        (V.tokenize = ot),
        (V.escape = r.escapeSelector),
        (V.getText = r.text),
        (V.isXML = r.isXMLDoc),
        (V.selectors = r.expr),
        (V.support = r.support),
        (V.uniqueSort = r.uniqueSort)
    })()
                    ...
                    P = function () {
                      ...
                      if (!(y < f)) {
                        ...
                        ;(ye =
                          ...
                          H(ye)
                            ? m
                              ? ye.call(K, d(f, b, Re, m), d(f, b, ut, m))
                              : (f++,
                                ye.call(
                                  K,
                                  d(f, b, Re, m),
    ...
    function at() {
      L.removeEventListener('DOMContentLoaded', at),
    ...
    (L.readyState !== 'loading' && !L.documentElement.doScroll)
      ...
      : (L.addEventListener('DOMContentLoaded', at),
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e
            return (
              Ke.test(t.type) && t.click && X(t, 'input') && ct(t, 'click', !0),
              !1
            )
          },
          trigger: function (e) {
          ...
          if (((W.isLastAjaxSuccess = !0), x == 'replace'))
            switch (G) {
              ...
              default:
                ...
                var st = Q.children().first().unwrap()
                J(st.parent().get(0))
            }
          else
            switch (G) {
