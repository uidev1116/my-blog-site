const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      './HighlitingCodeUnit-DhIFl-NV.js',
      './preload-helper-CqCcXmTM.js',
    ]),
) => i.map((i) => d[i])
import { g as tc, _ as rc } from './preload-helper-CqCcXmTM.js'
var Bi = { exports: {} },
  br = {},
  Hi = { exports: {} },
  L = {}
...
function qi(e, n, t) {
  ...
  return { $$typeof: Sc, type: e, key: u, ref: o, props: l, _owner: _c.current }
}
br.Fragment = kc
br.jsx = qi
br.jsxs = qi
...
function dt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    su ||
      ((su = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, ef)))
}
function It(e) {
  function n(l) {
    return dt(l, e)
...
function Ju(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Ko(e, r), n & 4 && -1 < qc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zt(l)
        if (
          (u !== null && Ns(u),
  ...
  nl = A({}, Gt, {
    ...
    movementX: function (e) {
      return 'movementX' in e
        ...
        : (e !== pt &&
            (pt && e.type === 'mousemove'
              ? ((Cl = e.screenX - pt.screenX), (xl = e.screenY - pt.screenY))
              : (xl = Cl = 0),
            (pt = e)),
          Cl)
    },
...
var Nf = He && 'TextEvent' in window && !_t,
  Ds = He && (!no || (_t && 8 < _t && 11 >= _t)),
  qo = ' ',
  bo = !1
function Is(e, n) {
  switch (e) {
...
function ti() {
  Ct && (Ct.detachEvent('onpropertychange', $s), (Ft = Ct = null))
}
function $s(e) {
  if (e.propertyName === 'value' && tl(Ft)) {
    var n = []
    js(n, Ft, e, Yu(e)), gs(Rf, n)
  }
}
function Mf(e, n, t) {
  e === 'focusin'
    ? (ti(), (Ct = n), (Ft = t), Ct.attachEvent('onpropertychange', $s))
    : e === 'focusout' && ti()
}
function Df(e) {
...
var vu = typeof setTimeout == 'function' ? setTimeout : void 0,
  ...
  Kf =
    typeof queueMicrotask == 'function'
      ...
      : typeof ci < 'u'
      ? function (e) {
          return ci.resolve(null).then(e).catch(Yf)
        }
      : vu
function Yf(e) {
  setTimeout(function () {
  ...
  function w(f, a, d, h) {
    ...
    if (x === null) {
      for (; P < d.length; P++)
        (x = m(f, d[P], h)),
          x !== null &&
            ((a = u(x, a, P)), C === null ? (E = x) : (C.sibling = x), (C = x))
      return j && yn(f, P), E
    }
...
function Eu(e, n, t, r) {
  ...
  typeof u == 'object' && u !== null
    ? (l.context = _e(u))
    : ((u = fe(n) ? Cn : re.current), (l.context = qn(e, u))),
...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    xr(e, n), xa(n, t, r), Eu(n, t, r, l), (r = !0)
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps
    o.props = i
...
function Oa(e, n, t) {
  ...
  if (u) {
    ...
    return (
      ...
      i !== null ? (u = an(i, u)) : ((u = _n(u, o, t, null)), (u.flags |= 2)),
      (u.return = n),
      (r.return = n),
      (r.sibling = u),
      (n.child = r),
...
function Re(e, n, t, r) {
  ...
  Xt(e, t, r),
    (!(R & 2) || e !== Z) &&
      ...
      de(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((rt = W() + 500), ul && mn()))
}
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qo(t), n === 1))
      e.tag === 0 ? Zf(ji.bind(null, e)) : Js(ji.bind(null, e)),
        Kf(function () {
          !(R & 6) && mn()
        }),
        (t = null)
...
hs = Co
ys = zn
var zd = { usingClientEntryPoint: !1, Events: [Zt, jn, ll, ms, vs, Co] },
  ht = {
...
function Rd(e, n, t) {
  const r = ec(n, t)
  n._reactRoot && n._reactRoot.unmount(),
    (n._reactRoot = r),
    r.render(Wl.jsx(Zn.StrictMode, { children: e }))
}
function Od(e) {
  const n = e.querySelectorAll('.js-highlighting-code-unit')
  if (n.length === 0) return
  const t = Zn.lazy(() =>
    rc(
      () => import('./HighlitingCodeUnit-DhIFl-NV.js'),
      __vite__mapDeps([0, 1]),
      import.meta.url,
    ),
  )
  n.forEach((r) => {
    const {
      ...
      i = { id: l, defaultCode: u, defaultLanguage: o || 'text' }
    Rd(Wl.jsx(Zn.Suspense, { children: Wl.jsx(t, { ...i }) }), r)
  })
}
ACMS.Ready(() => {
...
export { Dd as W, Wl as j, Zn as r }
