import { F as mt, E as at, C as gt } from './vendor-b4af7ed9.js'
var it = { exports: {} },
  ot = { exports: {} }
      ...
      (l = n[T]),
        ...
        b
          ? ((p = l.localName || p),
            ...
            D !== S &&
              (l.prefix === 'xmlns' && (p = l.name), u.setAttributeNS(b, p, S)))
          : ((D = u.getAttribute(p)), D !== S && u.setAttribute(p, S))
...
var ht = {
    ...
    SELECT: function (u, o) {
      if (!o.hasAttribute('multiple')) {
        for (var n = -1, l = 0, p = u.firstChild, b, S; p; )
          if (((S = p.nodeName && p.nodeName.toUpperCase()), S === 'OPTGROUP'))
            (b = p), (p = b.firstChild)
          else {
            if (S === 'OPTION') {
  ...
  return function (n, l, p) {
    ...
    function f(x, w) {
      if (x.nodeType === J)
        for (var P = x.firstChild; P; ) {
          var N = void 0
          w && (N = S(P)) ? m(N) : (X(P), P.firstChild && f(P, w)),
            (P = P.nextSibling)
        }
    }
    function g(x, w, P) {
    ...
    function r(x, w) {
      var P = w.firstChild,
        ...
        Y
      t: for (; P; ) {
        for (q = P.nextSibling, O = S(P); N; ) {
          if (((U = N.nextSibling), P.isSameNode && P.isSameNode(N))) {
            ;(P = q), (N = U)
            continue t
          }
          G = S(N)
          ...
          if (
            (R === P.nodeType &&
              (R === J
                ...
                : (R === dt || R == lt) &&
                  ((W = !0),
                  N.nodeValue !== P.nodeValue && (N.nodeValue = P.nodeValue))),
            W)
          ) {
            ;(P = q), (N = U)
            continue t
...
Q.off = function (o, n, l) {
  ...
  p.forEach(function (b) {
    nt.forEach(function (S, D) {
      S.element === o &&
        S.query === n &&
        S.event === b &&
        (o.removeEventListener(b, S.listener, S.capture), nt.splice(D, 1))
    })
  })
}
;(function (u, o) {
        ...
        n(A, [
          ...
          },
          {
            ...
            value: function (s, d, m) {
              ...
              if (h)
                for (var P = 0, N = h.length; P < N; P += 1) {
                  var O = h[P]
                  O = O.replace(
                    /([\w\-\.ぁ-んァ-ヶ亜-熙]+):exist/,
                    '($1):exist',
...
B.triggerEvent = Xt
var Mt = function (o) {
  for (var n = o.split('&'), l = {}, p = 0, b = n.length, S, D, T; p < b; p++)
    (S = n[p].split('=')),
      S[0] !== void 0 &&
        ((D = S[0]),
        (T = S[1] !== void 0 ? S.slice(1).join('=') : D),
  ...
  ;(function (o) {
    ...
    ;(r.prototype = {
      ...
      then: function (a, i) {
        ...
        return (
          this.state_ === S || this.state_ === D ? y(d, c) : this.then_.push(c),
          c.then
        )
      },
      catch: function (a) {
...
;(function (u, o) {
  ...
  function D(g, _, h) {
    return _ && S(g.prototype, _), h && S(g, h), g
  }
  function T(g, _) {
          ...
          !w ||
            ...
            (!t.isBeingZoomed &&
              ...
              (N === 0
                ...
                : N === -90
                ? t._calcGravity(-w.beta, -w.gamma)
                : N === 180 && t._calcGravity(-w.gamma, -w.beta)))
        }
        return (
