...
` +
  ...
  function es(e) {
    return e instanceof ts
      ? !0
      : e instanceof Error && e.name === _t && e.message === _t
  }
  class ts extends Error {
    constructor() {
      super(_t), (this.name = this.message)
    }
  }
  ...
  ;(function (e) {
    function t(_) {
      return (
        _ && typeof _ == 'object' && typeof _[Symbol.iterator] == 'function'
      )
    }
    e.is = t
    ...
    e.from = l
    function* o(_) {
      for (let N = _.length - 1; N >= 0; N--) yield _[N]
    }
    e.reverse = o
    function u(_) {
    ...
    e.first = c
    function f(_, N) {
      for (const p of _) if (N(p)) return !0
      return !1
    }
    e.some = f
    function h(_, N) {
      for (const p of _) if (N(p)) return p
    }
    e.find = h
    function* d(_, N) {
      for (const p of _) N(p) && (yield p)
    }
    e.filter = d
    function* m(_, N) {
      let p = 0
      for (const R of _) yield N(R, p++)
    }
    e.map = m
    function* g(..._) {
      for (const N of _) yield* N
    }
    e.concat = g
    function x(_, N, p) {
      let R = p
      for (const y of _) R = N(R, y)
      return R
    }
    e.reduce = x
    function* v(_, N, p = _.length) {
      for (
        N < 0 && (N += _.length),
    ...
    e.slice = v
    function L(_, N = Number.POSITIVE_INFINITY) {
      const p = []
      if (N === 0) return [p, _]
    ...
    async function S(_) {
      const N = []
      for await (const p of _) N.push(p)
  ...
  ;(function (e) {
    ...
    function n(w) {
      return (b, C = null, A) => {
        ...
        return (
          (T = w(
            (q) => {
              if (!k) return T ? T.dispose() : (k = !0), b.call(C, q)
            },
            null,
            A,
          )),
    ...
    e.once = n
    function r(w, b, C) {
      return c((A, k = null, T) => w((q) => A.call(k, b(q)), null, T), C)
    }
    e.map = r
    function s(w, b, C) {
      return c(
    ...
    e.forEach = s
    function i(w, b, C) {
      return c((A, k = null, T) => w((q) => b(q) && A.call(k, q), null, T), C)
    }
    e.filter = i
    function l(w) {
      return w
    ...
    function o(...w) {
      return (b, C = null, A) => {
        const k = rs(...w.map((T) => T((q) => b.call(C, q))))
        return f(k, A)
      }
    }
    e.any = o
    ...
    function h(w, b, C = 100, A = !1, k = !1, T, q) {
      let X,
        Y,
        He,
        gt = 0,
      ...
      const ya = {
          ...
          onWillAddFirstListener() {
            X = w((Ea) => {
              gt++,
                ...
                typeof C == 'number'
                  ? (clearTimeout(He), (He = setTimeout(Ae, C)))
                  : He === void 0 && ((He = 0), queueMicrotask(Ae))
            })
          },
        ...
        bt = new se(ya)
      return q == null || q.add(bt), bt.event
    }
    e.debounce = h
    function d(w, b = 0, C) {
      return e.debounce(
    ...
    function x(w, b = !1, C = [], A) {
      ...
      A && A.add(T)
      const q = () => {
          k == null || k.forEach((Y) => X.fire(Y)), (k = null)
        },
        X = new se({
          onWillAddFirstListener() {
            T || ((T = w((Y) => X.fire(Y))), A && A.add(T))
          },
    ...
    class S {
      ...
      filter(b) {
        return this.steps.push((C) => (b(C) ? C : L)), this
      }
      reduce(b, C) {
        let A = C
      ...
      latch(b = (C, A) => C === A) {
        ...
        return (
          this.steps.push((k) => {
            const T = C || !b(k, A)
            return (C = !1), (A = k), T ? k : L
          }),
          this
        )
      }
      evaluate(b) {
        for (const C of this.steps) if (((b = C(b)), b === L)) break
        return b
      }
    }
    function _(w, b, C = (A) => A) {
      const A = (...X) => q.fire(C(...X)),
        k = () => w.on(b, A),
        T = () => w.removeListener(b, A),
        q = new se({ onWillAddFirstListener: k, onDidRemoveLastListener: T })
      return q.event
    }
    e.fromNodeEventEmitter = _
    function N(w, b, C = (A) => A) {
      const A = (...X) => q.fire(C(...X)),
        k = () => w.addEventListener(b, A),
        T = () => w.removeEventListener(b, A),
        q = new se({ onWillAddFirstListener: k, onDidRemoveLastListener: T })
      return q.event
    }
    ...
    class E {
      constructor(b, C) {
        ...
        ;(this.emitter = new se(A)), C && C.add(this.emitter)
      }
      beginUpdate(b) {
        this._counter++
      }
    ...
    function G(w) {
      return (b, C, A) => {
        ...
        const q = {
          ...
          endUpdate() {
            k--, k === 0 && (w.reportChanges(), T && ((T = !1), b.call(C)))
          },
        ...
        return A instanceof ye ? A.add(X) : Array.isArray(A) && A.push(X), X
      }
    }
  ...
  class Ee {
    constructor(t) {
      ;(this.listenerCount = 0),
        ...
        (this.durations = []),
        (this.name = `${t}_${Ee._idPool++}`),
        Ee.all.add(this)
    }
    start(t) {
      ;(this._stopWatch = new tt()), (this.listenerCount = t)
    }
    stop() {
      if (this._stopWatch) {
  ...
  class pt {
    static create() {
      var t
      const n = new Error()
      return new pt((t = n.stack) !== null && t !== void 0 ? t : '')
    }
    constructor(t) {
      this.value = t
    }
...
`),
  ...
  class se {
            ...
            ? new ls(
                ...
                (i =
                  (s = this._options) === null || s === void 0
                    ? void 0
                    : s.leakWarningThreshold) !== null && i !== void 0
                  ? i
                  : as,
              )
            : void 0),
        (this._perfMon =
          !((l = this._options) === null || l === void 0) && l._profName
            ? new Ee(this._options._profName)
            : void 0),
        (this._deliveryQueue =
        ...
        ((t = this._event) !== null && t !== void 0) ||
          (this._event = (n, r, s) => {
            ...
            if (
              ...
              const x = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`
              console.warn(x)
              const v =
                  (i = this._leakageMon.getMostFrequentStack()) !== null &&
                  i !== void 0
                    ? i
                    : ['UNKNOWN stack', -1],
                L = new us(
                  `${x}. HINT: Stack shows most frequent listener (${v[1]}-times)`,
                  v[0],
                )
              return (
                (
              ...
              this._listeners
                ? this._listeners instanceof vt
                  ? (((h = this._deliveryQueue) !== null && h !== void 0) ||
                      (this._deliveryQueue = new hs()),
                    (this._listeners = [this._listeners, d]))
                  : this._listeners.push(d)
                : ((u =
                    (o = this._options) === null || o === void 0
                      ? void 0
                      : o.onWillAddFirstListener) === null ||
                    u === void 0 ||
                    u.call(o, this),
                  (this._listeners = d),
                  (f =
            ...
            return s instanceof ye ? s.add(g) : Array.isArray(s) && s.push(g), g
          }),
        this._event
      )
    }
    ...
    fire(t) {
      ...
      if (
        ...
        if (this._listeners instanceof vt) this._deliver(this._listeners, t)
        else {
  ...
  function wt(e) {
    const t = []
    for (const n of ds(e)) typeof e[n] == 'function' && t.push(n)
    return t
  }
  function ms(e, t) {
    const n = (s) =>
  ...
  const Le = globalThis
  let Q
  typeof Le.vscode < 'u' && typeof Le.vscode.process < 'u'
    ? (Q = Le.vscode.process)
    : typeof process < 'u' &&
      typeof ((Lt = process == null ? void 0 : process.versions) === null ||
      Lt === void 0
        ? void 0
        : Lt.node) == 'string' &&
      (Q = process)
  const xs =
    typeof ((Nt = Q == null ? void 0 : Q.versions) === null || Nt === void 0
      ? void 0
      : Nt.electron) == 'string' && (Q == null ? void 0 : Q.type) === 'renderer'
  if (typeof Q == 'object') {
    ;(St = Q.platform === 'win32'),
      (Ct = Q.platform === 'darwin'),
      (At = Q.platform === 'linux'),
      At && Q.env.SNAP && Q.env.SNAP_REVISION,
    ...
    if (e)
      try {
        ...
        ;(nt = t.locale),
          (en = t.osLocale),
          (Rt = n || Me),
          (_s = t._translationsConfigFile)
      } catch {}
  } else
    typeof navigator == 'object' && !xs
      ? ((ie = navigator.userAgent),
        (St = ie.indexOf('Windows') >= 0),
        (Ct = ie.indexOf('Macintosh') >= 0),
        (ie.indexOf('Macintosh') >= 0 ||
          ie.indexOf('iPad') >= 0 ||
          ie.indexOf('iPhone') >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (At = ie.indexOf('Linux') >= 0),
        (ie == null ? void 0 : ie.indexOf('Mobi')) >= 0,
        H({ key: 'ensureLoaderPluginIsLoaded', comment: ['{Locked}'] }, '_'),
        (nt = Me),
        (Rt = nt),
  ...
  const ze = St,
    ps = Ct,
    ue = ie,
    vs = typeof Le.postMessage == 'function' && !Le.importScripts
  ;(() => {
    if (vs) {
      const e = []
  ...
  const ws = !!(ue && ue.indexOf('Chrome') >= 0)
  ue && ue.indexOf('Firefox') >= 0,
    !ws && ue && ue.indexOf('Safari') >= 0,
    ue && ue.indexOf('Edg/') >= 0,
  ...
  class Ns {
    constructor(t, n) {
      ;(this.lastCache = void 0),
        ...
        typeof t == 'function'
          ? ((this._fn = t), (this._computeKey = Ls))
  ...
  ;(ke = Ne),
    (Ne.ambiguousCharacterData = new tn(() =>
      JSON.parse(
    ...
    (Ne.cache = new Ns({ getCacheKey: JSON.stringify }, (e) => {
      function t(c) {
        const f = new Map()
      ...
      const s = ke.ambiguousCharacterData.value
    ...
    (Ne._locales = new tn(() =>
      Object.keys(ke.ambiguousCharacterData.value).filter(
        (e) => !e.startsWith('_'),
      ),
    ))
  class de {
  ...
  class Bs {
    ...
    sendMessage(t, n) {
      ...
      return new Promise((s, i) => {
        ;(this._pendingReplies[r] = { resolve: s, reject: i }),
          this._send(new Ds(this._workerId, r, t, n))
      })
    }
    listen(t, n) {
      let r = null
      const s = new se({
        onWillAddFirstListener: () => {
          ;(r = String(++this._lastSentReq)),
            ...
            this._send(new Ts(this._workerId, r, t, n))
        },
        onDidRemoveLastListener: () => {
          this._pendingEmitters.delete(r),
            this._send(new Is(this._workerId, r)),
            (r = null)
        },
      })
      return s.event
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.method, t.args).then(
        ...
        (s) => {
          s.detail instanceof Error && (s.detail = Zt(s.detail)),
            this._send(new rn(this._workerId, n, void 0, Zt(s)))
        },
      )
    }
    _handleSubscribeEventMessage(t) {
      const n = t.req,
        r = this._handler.handleEvent(
          ...
          this._send(new Vs(this._workerId, n, s))
        })
  ...
  function sn(e) {
    return e[0] === 'o' && e[1] === 'n' && nn(e.charCodeAt(2))
  }
  function an(e) {
    return /^onDynamic/.test(e) && nn(e.charCodeAt(9))
  }
  function qs(e, t, n) {
    const r = (l) =>
        function () {
  ...
  class Us {
    ...
    _handleMessage(t, n) {
      if (t === Ps) return this.initialize(n[0], n[1], n[2], n[3])
    ...
    initialize(t, n, r, s) {
      ...
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(o)),
          Promise.resolve(wt(this._requestHandler)))
        : (n &&
  ...
  function Hs(e, t) {
    t = ln(149417, t)
    for (let n = 0, r = e.length; n < r; n++) t = ln(e.charCodeAt(n), t)
    return t
  }
  class on {
    constructor(t) {
  ...
  function Ws(e, t, n) {
    return new ge(new on(e), new on(t)).ComputeDiff(n).changes
  }
  class Fe {
    static Assert(t, n) {
  ...
  class ge {
    constructor(t, n, r = null) {
      ...
      const [s, i, l] = ge._getElements(t),
        [o, u, c] = ge._getElements(n)
    ...
    static _getElements(t) {
      ...
      if (ge._isStringArray(n)) {
        ...
        for (let s = 0, i = n.length; s < i; s++) r[s] = Hs(n[s], 0)
        return [n, r, !0]
      }
    ...
    ElementsAreStrictEqual(t, n) {
      ...
      const r = ge._getStrictElement(this._originalSequence, t),
        s = ge._getStrictElement(this._modifiedSequence, n)
      return r === s
    }
    ...
    ComputeDiffRecursive(t, n, r, s, i) {
      ...
      if (!i[0]) {
        ...
        return (
          i[0]
            ? (d = [new me(c + 1, n - (c + 1) + 1, f + 1, s - (f + 1) + 1)])
            : (d = this.ComputeDiffRecursive(c + 1, n, f + 1, s, i)),
          this.ConcatenateChanges(h, d)
        )
      }
      return [new me(t, n - t + 1, r, s - r + 1)]
    }
    WALKTRACE(t, n, r, s, i, l, o, u, c, f, h, d, m, g, x, v, L, S) {
      let _ = null,
        N = null,
        p = new un(),
        R = n,
      ...
      for (let E = 1; E <= g / 2 + 1; E++) {
        ...
        for (let b = f; b <= h; b += 2) {
          ...
          if (
            ((v[b] = u),
            u + c > B + G && ((B = u), (G = c)),
            !y && Math.abs(b - _) <= E - 1 && u >= L[b])
          )
            return (
              (i[0] = u),
              (l[0] = c),
              C <= L[b] && 1447 > 0 && E <= 1447 + 1
                ? this.WALKTRACE(
                    S,
                    f,
                    h,
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(B, w)
        )
          return (
            (o[0] = !0),
            (i[0] = B),
        ...
        for (let b = d; b <= m; b += 2) {
          ...
          if (((L[b] = u), y && Math.abs(b - S) <= E && u <= v[b]))
            return (
              (i[0] = u),
              (l[0] = c),
              C >= v[b] && 1447 > 0 && E <= 1447 + 1
                ? this.WALKTRACE(
                    S,
                    f,
                    h,
    ...
    ConcatenateChanges(t, n) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
        ...
        return (
          Pe.Copy(t, 0, s, 0, t.length - 1),
          (s[t.length - 1] = r[0]),
          Pe.Copy(n, 1, s, t.length, n.length - 1),
          s
        )
      } else {
        const s = new Array(t.length + n.length)
        return (
          Pe.Copy(t, 0, s, 0, t.length), Pe.Copy(n, 0, s, t.length, n.length), s
        )
      }
    }
  ...
  function Js(e, t) {
    if (e === null || typeof e != 'object') throw new cn(t, 'Object', e)
  }
  function $(e, t) {
    if (typeof e != 'string') throw new cn(t, 'string', e)
  }
  const xe = $s === 'win32'
  function P(e) {
    return e === j || e === K
  ...
  const Z = {
      ...
      isAbsolute(e) {
        ...
        return (
          P(n) ||
          (t > 2 && pe(n) && e.charCodeAt(1) === _e && P(e.charCodeAt(2)))
        )
      },
      join(...e) {
      ...
      toNamespacedPath(e) {
        ...
        if (t.charCodeAt(0) === K) {
          if (t.charCodeAt(1) === K) {
            ...
            if (n !== Qs && n !== be) return `\\\\?\\UNC\\${t.slice(2)}`
          }
        } else if (
          pe(t.charCodeAt(0)) &&
          t.charCodeAt(1) === _e &&
      ...
      parse(e) {
        ...
        } else if (pe(s) && e.charCodeAt(1) === _e) {
    ...
    ee = {
      resolve(...e) {
        ...
        for (let r = e.length - 1; r >= -1 && !n; r--) {
          const s = r >= 0 ? e[r] : Ys()
          $(s, 'path'),
            s.length !== 0 && ((t = `${s}/${t}`), (n = s.charCodeAt(0) === j))
        }
        return (t = st(t, !n, '/', Mt)), n ? `/${t}` : t.length > 0 ? t : '.'
      },
      normalize(e) {
        if (($(e, 'path'), e.length === 0)) return '.'
        const t = e.charCodeAt(0) === j,
          n = e.charCodeAt(e.length - 1) === j
        return (
          (e = st(e, !t, '/', Mt)),
          e.length === 0
            ? t
      ...
      isAbsolute(e) {
        return $(e, 'path'), e.length > 0 && e.charCodeAt(0) === j
      },
      join(...e) {
        if (e.length === 0) return '.'
        let t
      ...
      relative(e, t) {
        ...
        if (c === o)
          if (l > o) {
            if (t.charCodeAt(i + c) === j) return t.slice(i + c + 1)
            if (c === 0) return t.slice(i + c)
          } else
            s > o && (e.charCodeAt(n + c) === j ? (u = c) : c === 0 && (u = 0))
        let f = ''
        for (c = n + u + 1; c <= r; ++c)
          (c === r || e.charCodeAt(c) === j) &&
            (f += f.length === 0 ? '..' : '/..')
  ...
  ;(ee.win32 = Z.win32 = Z),
    (ee.posix = Z.posix = ee),
    xe ? Z.normalize : ee.normalize,
    xe ? Z.resolve : ee.resolve,
    xe ? Z.relative : ee.relative,
    xe ? Z.dirname : ee.dirname,
    xe ? Z.basename : ee.basename,
    xe ? Z.extname : ee.extname,
    xe ? Z.sep : ee.sep
  const Zs = /^\w[\w\d+.-]*$/,
    Ks = /^\//,
    ei = /^\/\//
  ...
  class Se {
    ...
    with(t) {
      ...
      return (
        ...
        r === void 0 ? (r = this.authority) : r === null && (r = W),
        s === void 0 ? (s = this.path) : s === null && (s = W),
        i === void 0 ? (i = this.query) : i === null && (i = W),
        l === void 0 ? (l = this.fragment) : l === null && (l = W),
        n === this.scheme &&
        r === this.authority &&
        s === this.path &&
        i === this.query &&
    ...
    static file(t) {
      let n = W
      if ((ze && (t = t.replace(/\\/g, ae)), t[0] === ae && t[1] === ae)) {
    ...
    static joinPath(t, ...n) {
      ...
      return (
        ze && t.scheme === 'file'
          ? (r = Se.file(Z.join(kt(t, !0), ...n)).path)
          : (r = ee.join(t.path, ...n)),
        t.with({ path: r })
      )
    }
      ...
      if (t) {
        if (t instanceof Se) return t
        {
          ...
          return (
            ...
            (s._fsPath =
              t._sep === fn && (r = t.fsPath) !== null && r !== void 0
                ? r
                : null),
            s
          )
  ...
  class Te extends Se {
    ...
    toString(t = !1) {
      return t
        ? Ft(this, !0)
        : (this._formatted || (this._formatted = Ft(this, !1)), this._formatted)
    }
    toJSON() {
      const t = { $mid: 1 }
      return (
        this._fsPath && ((t.fsPath = this._fsPath), (t._sep = fn)),
  ...
  function mn(e, t, n) {
    ...
    for (let i = 0; i < e.length; i++) {
      ...
      if (
        ...
        o !== void 0
          ? (s !== -1 &&
              ((r += encodeURIComponent(e.substring(s, i))), (s = -1)),
            (r += o))
          : s === -1 && (s = i)
      }
    }
    return (
      s !== -1 && (r += encodeURIComponent(e.substring(s))),
      r !== void 0 ? r : e
    )
  }
  function ii(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const r = e.charCodeAt(n)
      r === 35 || r === 63
        ? (t === void 0 && (t = e.substr(0, n)), (t += dn[r]))
        : t !== void 0 && (t += e[n])
    }
    return t !== void 0 ? t : e
  }
  ...
  function gn(e) {
    try {
      ...
      return e.length > 3 ? e.substr(0, 3) + gn(e.substr(3)) : e
    }
  }
  const bn = /(%[0-9A-Za-z][0-9A-Za-z])+/g
  function it(e) {
    return e.match(bn) ? e.replace(bn, (t) => gn(t)) : e
  }
  class J {
    constructor(t, n) {
  ...
  function bi(e = '') {
    let t = '(-?\\d*\\.\\d\\w*)|([^'
    for (const n of gi) e.indexOf(n) >= 0 || (t += '\\' + n)
  ...
  const wn = new ss()
  wn.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
  function Pt(e, t, n, r, s) {
    if (((t = vn(t)), s || (s = Ke.first(wn)), n.length > s.maxLen)) {
      let c = e - s.maxLen / 2
      return (
        c < 0 ? (c = 0) : (r += c),
  ...
  class Dt {
    constructor(t) {
      ...
      ;(this._defaultValue = n),
        (this._asciiMap = Dt._createAsciiMap(n)),
        (this._map = new Map())
    }
  ...
  function wi() {
    if ($e === null) {
      $e = new Dt(0)
      const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`
      for (let n = 0; n < e.length; n++) $e.set(e.charCodeAt(n), 1)
      const t = '.,;:'
      for (let n = 0; n < t.length; n++) $e.set(t.charCodeAt(n), 2)
    }
    return $e
  }
  class ot {
      ...
      for (let i = 1, l = t.getLineCount(); i <= l; i++) {
        ...
        for (; c < u; ) {
          ...
          if (d === 13) {
            ...
            _ === 1 && (s.push(ot._createLink(r, o, i, f, c)), (L = !0))
          } else if (d === 12) {
            let _
            S === 91 ? ((g = !0), (_ = 0)) : (_ = r.get(S)),
              _ === 1 ? (L = !0) : (d = 13)
          } else (d = n.nextState(d, S)), d === 0 && (L = !0)
          L && ((d = 1), (m = !1), (g = !1), (v = !1), (f = c + 1), (h = S)),
            c++
        }
        d === 13 && s.push(ot._createLink(r, o, i, f, u))
      }
      return s
    }
  }
  ...
  class Vt {
    ...
    valueSetReplace(t, n, r) {
      ...
      return s >= 0
        ? ((s += r ? 1 : -1),
          s < 0 ? (s = t.length - 1) : (s %= t.length),
          t[s])
        : null
    }
  }
  Vt.INSTANCE = new Vt()
  const Ln = Object.freeze(function (e, t) {
  ...
  ;(function (e) {
    function t(n) {
      return n === e.None || n === e.Cancelled || n instanceof ct
        ? !0
        : !n || typeof n != 'object'
        ? !1
  ...
  class Ni {
    ...
    get token() {
      return this._token || (this._token = new ct()), this._token
    }
    cancel() {
      this._token
        ? this._token instanceof ct && this._token.cancel()
    ...
    dispose(t = !1) {
      ...
      t && this.cancel(),
        ...
        this._token
          ? this._token instanceof ct && this._token.dispose()
          : (this._token = ut.None)
    }
  }
  class It {
  ...
  ;(function () {
    ...
    for (const s of t) {
      ...
      if (
        (r[l] || ((r[l] = !0), (Ci[o] = l), (Ai[o.toLowerCase()] = l)), !n[u])
      ) {
        if (((n[u] = !0), !c))
          throw new Error(
            `String representation missing for key code ${u} around scan code ${o}`,
          )
        ht.define(u, c), Bt.define(u, d || c), qt.define(u, m || d || c)
      }
      f && (Si[f] = u)
    }
  })()
  ...
  ;(function (e) {
    ...
    H('Enum', 'enumeration'),
    H('EnumMember', 'enumeration member'),
    H('Event', 'event'),
    H('Field', 'field'),
    H('File', 'file'),
    H('Function', 'function'),
  ...
  class Di {
    ...
    set(t, n, r = 0) {
      ...
      if (s) (s.value = n), r !== 0 && this.touch(s, r)
        ...
        switch (
          ((s = { key: t, value: n, next: void 0, previous: void 0 }), r)
        ) {
          case 0:
            this.addItemLast(s)
            break
    ...
    [((Cr = Symbol.toStringTag), Symbol.iterator)]() {
      return this.entries()
    }
    trimOld(t) {
  ...
  function Ui(e, t, n, r, s) {
    return Bi(e, t, n, r, s) && qi(e, t, n, r, s)
  }
  class Hi {
    constructor(t, n) {
    ...
    next(t) {
      ...
      do {
        ...
        if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
          if (i === 0) {
            Ms(t, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Ui(this._wordSeparators, t, n, s, i))
        )
          return r
      } while (r)
      return null
  ...
  function Wi(e, t = 'Unreachable') {
    throw new Error(t)
  }
  function ft(e) {
    if (!e()) {
      debugger
      e(), Ze(new oe('Assertion Failed'))
    }
  }
  function Er(e, t) {
    let n = 0
  ...
  class zi {
    static computeUnicodeHighlights(t, n, r) {
      ...
      o === 'allNonBasicAscii'
        ? (u = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
        : (u = new RegExp(`${$i(Array.from(o))}`, 'g'))
      const c = new Hi(null, u),
        f = []
      let h = !1,
        d,
        m = 0,
      ...
      switch (r.shouldHighlightNonBasicASCII(t, null)) {
        ...
        case 3: {
          const i = t.codePointAt(0),
            ...
            o = Ne.getLocales().filter(
              (u) =>
                !Ne.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(
                  i,
                ),
            )
          return {
  ...
  function $i(e, t) {
    return `[${Ss(e.map((r) => String.fromCodePoint(r)).join(''))}]`
  }
  class Mr {
    constructor(t) {
      ;(this.options = t),
        (this.allowedCodePoints = new Set(t.allowedCodePoints)),
        (this.ambiguousCharacters = Ne.getInstance(new Set(t.allowedLocales)))
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return 'allNonBasicAscii'
      const t = new Set()
      if (this.options.invisibleCharacters)
        for (const n of de.codePoints) kr(String.fromCodePoint(n)) || t.add(n)
...
` ||
  ...
  class V {
    ...
    constructor(t, n) {
      if (((this.start = t), (this.endExclusive = n), t > n))
        throw new oe(`Invalid range: ${this.toString()}`)
    }
    get isEmpty() {
    ...
    clip(t) {
      if (this.isEmpty)
        throw new oe(`Invalid clipping range: ${this.toString()}`)
  ...
  class D {
    ...
    static joinMany(t) {
      ...
      for (let r = 1; r < t.length; r++) n = n.getUnion(new ce(t[r].slice()))
      return n.ranges
    }
    static join(t) {
  ...
  class ce {
    ...
    subtractFrom(t) {
      ...
      if (n === r) return new ce([t])
      const s = []
      let i = t.startLineNumber
      for (let l = n; l < r; l++) {
        const o = this._normalizedRanges[l]
        o.startLineNumber > i && s.push(new D(i, o.startLineNumber)),
          (i = o.endLineNumberExclusive)
      }
      return (
        i < t.endLineNumberExclusive &&
          s.push(new D(i, t.endLineNumberExclusive)),
        new ce(s)
      )
    }
    toString() {
  ...
  class he extends le {
    static fromRangeMappings(t) {
      const n = D.join(t.map((s) => D.fromRangeInclusive(s.originalRange))),
        r = D.join(t.map((s) => D.fromRangeInclusive(s.modifiedRange)))
      return new he(n, r, t)
    }
    constructor(t, n, r) {
    ...
    computeDiff(t, n, r) {
      ...
      for (const c of l.changes) {
        ...
        c.originalEndLineNumber === 0
          ...
          : (f = new D(c.originalStartLineNumber, c.originalEndLineNumber + 1))
        let h
        c.modifiedEndLineNumber === 0
          ...
          : (h = new D(c.modifiedStartLineNumber, c.modifiedEndLineNumber + 1))
        let d = new he(
          f,
          h,
    ...
    static createFromDiffResult(t, n, r, s, i, l, o) {
      ...
      if (
        ...
        if (m.getElements().length > 0 && g.getElements().length > 0) {
          let x = Fr(m, g, i, !0).changes
          o && (x = Yi(x)), (d = [])
          for (let v = 0, L = x.length; v < L; v++)
            d.push(Be.createFromDiffChange(x[v], m, g))
        }
      }
      return new Xe(u, c, f, h, d)
    }
  }
  class Zi {
    constructor(t, n, r) {
      ;(this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.original = new Pr(t)),
        (this.modified = new Pr(n)),
        (this.continueLineDiff = Dr(r.maxComputationTime)),
        (this.continueCharDiff = Dr(
        ...
        for (; i < f && l < h; ) {
          ...
          if (d !== m) {
            ...
            }
            {
              ...
              ;(g < v || x < L) &&
                this._pushTrimWhitespaceCharChange(s, i + 1, g, v, l + 1, x, L)
            }
          }
          i++, l++
        }
    ...
    _pushTrimWhitespaceCharChange(t, n, r, s, i, l, o) {
      ...
      let u
      this.shouldComputeCharChanges && (u = [new Be(n, r, n, s, i, l, i, o)]),
        t.push(new Xe(n, n, i, i, u))
    }
    _mergeTrimWhitespaceCharChange(t, n, r, s, i, l, o) {
      ...
      return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
        ...
        ? (this.shouldComputeCharChanges &&
            c.charChanges &&
            c.charChanges.push(new Be(n, r, n, s, i, l, i, o)),
          !0)
  ...
  class Ki {
    constructor(t) {
      if (
        ...
        throw new oe('timeout must be positive')
    }
    isValid() {
...
`)
  ...
  class ea {
    compute(t, n, r = Qe.instance, s) {
      ...
      const i = new jt(t.length, n.length),
        l = new jt(t.length, n.length),
        o = new jt(t.length, n.length)
        ...
        for (let x = 0; x < n.length; x++) {
          ...
          t.getElement(g) === n.getElement(x)
            ? (g === 0 || x === 0 ? (S = 0) : (S = i.get(g - 1, x - 1)),
              ...
              (S += s ? s(g, x) : 1))
            : (S = -1)
          const _ = Math.max(v, L, S)
          if (_ === S) {
            const N = g > 0 && x > 0 ? o.get(g - 1, x - 1) : 0
            o.set(g, x, N + 1), l.set(g, x, 3)
          } else
            _ === v
              ? (o.set(g, x, 0), l.set(g, x, 1))
              : _ === L && (o.set(g, x, 0), l.set(g, x, 2))
          i.set(g, x, _)
        }
      const u = []
      let c = t.length,
  ...
  class Tr {
    compute(t, n, r = Qe.instance) {
      ...
      u.set(0, l(0, 0))
      const c = new na()
      c.set(0, u.get(0) === 0 ? null : new Vr(null, 0, 0, u.get(0)))
      let f = 0
      e: for (;;) {
        ...
        for (f = x; f <= v; f += 2) {
          const L = f === v ? -1 : u.get(f + 1),
            S = f === x ? -1 : u.get(f - 1) + 1,
            _ = Math.min(Math.max(L, S), s.length),
            N = _ - f
          if (_ > s.length || N > i.length) continue
          const p = l(_, N)
          u.set(f, p)
          const R = _ === L ? c.get(f + 1) : c.get(f - 1)
          if (
            (c.set(f, p !== _ ? new Vr(R, _, N, p - _) : R),
      ...
      for (;;) {
        const x = h ? h.x + h.length : 0,
          v = h ? h.y + h.length : 0
        if (
          ((x !== m || v !== g) && d.push(new z(new V(x, m), new V(v, g))), !h)
        )
          break
...
`.charCodeAt(0),
    ...
    getBoundaryScore(t) {
      const n = Br(t > 0 ? this.elements[t - 1] : -1),
        r = Br(t < this.elements.length ? this.elements[t] : -1)
      if (n === 7 && r === 8) return 0
      if (n === 8) return 150
      let s = 0
      return (
    ...
    translateOffset(t) {
      ...
      const n = Ge(this.firstCharOffsetByLine, (r) => r <= t)
      return new J(
    ...
    findWordContaining(t) {
      if (t < 0 || t >= this.elements.length || !Qt(this.elements[t])) return
      let n = t
      for (; n > 0 && Qt(this.elements[n - 1]); ) n--
      let r = t
      for (; r < this.elements.length && Qt(this.elements[r]); ) r++
      return new V(n, r)
    }
    countLinesIn(t) {
      return (
    ...
    extendToFullLines(t) {
      var n, r
      const s =
          (n = Ie(this.firstCharOffsetByLine, (l) => l <= t.start)) !== null &&
          n !== void 0
            ? n
            : 0,
        i =
          (r = Gi(this.firstCharOffsetByLine, (l) => t.endExclusive <= l)) !==
            null && r !== void 0
            ? r
            : this.elements.length
      return new V(s, i)
  ...
  const ra = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
  function Ir(e) {
    return ra[e]
  }
  function Br(e) {
  ...
  function sa(e, t, n, r, s, i) {
    let { moves: l, excludedChanges: o } = aa(e, t, n, i)
    if (!i.isValid()) return []
...
`).length >= 15 && ia(h, (m) => m.length >= 2) >= 2
  ...
  function aa(e, t, n, r) {
    const s = [],
      i = e
        ...
        .map((u) => new qe(u.original, t, u)),
      l = new Set(
        e
          .filter((u) => u.original.isEmpty && u.modified.length >= 3)
          .map((u) => new qe(u.modified, n, u)),
      ),
      o = new Set()
    for (const u of i) {
      let c = -1,
  ...
  function la(e, t, n, r, s, i) {
    ...
    for (const d of e)
      for (
        ...
        o.add(g, { range: new D(m, m + 3) })
      }
    const u = []
    e.sort(at((d) => d.modified.startLineNumber, lt))
    for (const d of e) {
      let m = []
      for (
        ...
        o.forEach(x, ({ range: S }) => {
          for (const N of m)
            if (
              ...
              ;(N.originalLineRange = new D(
                N.originalLineRange.startLineNumber,
                S.endLineNumberExclusive,
              )),
                (N.modifiedLineRange = new D(
    ...
    u.sort(hi(at((d) => d.modifiedLineRange.length, lt)))
    const c = new ce(),
      f = new ce()
    for (const d of u) {
      const m =
    ...
    l.sort(at((d) => d.original.startLineNumber, lt))
    const h = new je(e)
    for (let d = 0; d < l.length; d++) {
      const m = l[d],
        ...
        _ = Math.max(
          L.original.endLineNumberExclusive - m.original.endLineNumberExclusive,
          S.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive,
        )
      let N
      for (N = 0; N < v; N++) {
        const R = m.original.startLineNumber - N - 1,
          y = m.modified.startLineNumber - N - 1
        if (
          R > r.length ||
          y > s.length ||
          c.contains(y) ||
      ...
      N > 0 &&
        (f.addRange(
          new D(m.original.startLineNumber - N, m.original.startLineNumber),
        ),
        c.addRange(
          new D(m.modified.startLineNumber - N, m.modified.startLineNumber),
        ))
      let p
      for (p = 0; p < _; p++) {
      ...
      p > 0 &&
        ...
        (N > 0 || p > 0) &&
          (l[d] = new le(
            new D(
              m.original.startLineNumber - N,
              m.original.endLineNumberExclusive + p,
            ),
            new D(
              m.modified.startLineNumber - N,
              m.modified.endLineNumberExclusive + p,
            ),
          ))
    }
  ...
  function qr(e, t, n) {
    ...
    function o(f) {
      let h = 0
      for (let d = 0; d < e.length; d++) Xt(f.charCodeAt(d)) || h++
      return h
    }
  ...
  function oa(e) {
    ...
    e.sort(at((n) => n.original.startLineNumber, lt))
    const t = [e[0]]
  ...
  function Ur(e, t, n) {
    let r = n
    return (r = Hr(e, t, r)), (r = Hr(e, t, r)), (r = ca(e, t, r)), r
  }
  function Hr(e, t, n) {
  ...
  function ca(e, t, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      ...
      i.seq1Range.isEmpty
        ? (n[r] = Wr(i, e, t, o, u))
        : i.seq2Range.isEmpty && (n[r] = Wr(i.swap(), t, e, u, o).swap())
    }
    return n
  }
  function Wr(e, t, n, r, s) {
    ...
    for (let f = -l; f <= o; f++) {
      const h = e.seq2Range.start + f,
        ...
        g =
          t.getBoundaryScore(m) + n.getBoundaryScore(h) + n.getBoundaryScore(d)
      g > c && ((c = g), (u = f))
    }
    return e.delta(u)
  }
  ...
  function ga(e, t, n) {
    ...
    do {
      ...
      for (let u = 1; u < r.length; u++) {
        let h = function (m, g) {
          ...
          if (e.countLinesIn(x) > 5 || x.length > 500) return !1
          const L = e.getText(x).trim()
          if (L.length > 20 || L.split(/\r\n|\r|\n/).length > 1) return !1
          const S = e.countLinesIn(m.seq1Range),
            _ = m.seq1Range.length,
            N = t.countLinesIn(m.seq2Range),
            p = m.seq2Range.length,
            R = e.countLinesIn(g.seq1Range),
            y = g.seq1Range.length,
            E = t.countLinesIn(g.seq2Range),
            B = g.seq2Range.length,
            G = 2 * 40 + 50
          function w(b) {
            return Math.min(b, G)
          }
          return (
            Math.pow(
              Math.pow(w(S * 40 + _), 1.5) + Math.pow(w(N * 40 + p), 1.5),
              1.5,
            ) +
              Math.pow(
                Math.pow(w(R * 40 + y), 1.5) + Math.pow(w(E * 40 + B), 1.5),
                1.5,
              ) >
            (G ** 1.5) ** 1.5 * 1.3
          )
    ...
    return (
      ui(r, (o, u, c) => {
        ...
        const x = z.fromOffsetPairs(
            o ? o.getEndExclusives() : ne.zero,
            c ? c.getStarts() : ne.max,
          ),
          v = f.intersect(x)
        l.length > 0 && v.getStarts().equals(l[l.length - 1].getEndExclusives())
          ? (l[l.length - 1] = l[l.length - 1].join(v))
          : l.push(v)
      }),
      l
    )
  ...
  class zr {
    ...
    getBoundaryScore(t) {
      const n = t === 0 ? 0 : $r(this.lines[t - 1]),
        r = t === this.lines.length ? 0 : $r(this.lines[t])
      return 1e3 - (n + r)
    }
    getText(t) {
...
`)
  ...
  class ba {
    constructor() {
      ;(this.dynamicProgrammingDiffing = new ea()),
        (this.myersDiffingAlgorithm = new Tr())
    }
    computeDiff(t, n, r) {
      if (t.length <= 1 && ai(t, n, (p, R) => p === R))
        return new dt([], [], !1)
      if (
        ...
        return new dt(
          [
            new he(new D(1, t.length + 1), new D(1, n.length + 1), [
              new ve(
      ...
      const u = t.map((p) => o(p.trim())),
        ...
        d = (() =>
          f.length + h.length < 1700
            ...
            : this.myersDiffingAlgorithm.compute(f, h, s))()
      let m = d.diffs,
        g = d.hitTimeout
      ;(m = Ur(f, h, m)), (m = ma(f, h, m))
      const x = [],
        v = (p) => {
          if (i)
            for (let R = 0; R < p; R++) {
              ...
              if (t[y] !== n[E]) {
                ...
                for (const G of B.mappings) x.push(G)
                B.hitTimeout && (g = !0)
              }
            }
        }
      let L = 0,
        S = 0
      for (const p of m) {
        ft(() => p.seq1Range.start - L === p.seq2Range.start - S)
        const R = p.seq1Range.start - L
        v(R), (L = p.seq1Range.endExclusive), (S = p.seq2Range.endExclusive)
      ...
      let N = []
      return (
        r.computeMoves && (N = this.computeMoves(_, t, n, u, c, s, i)),
        ft(() => {
          function p(y, E) {
            if (y.lineNumber < 1 || y.lineNumber > E.length) return !1
            const B = E[y.lineNumber - 1]
  ...
  const Gr = { getLegacy: () => new Qi(), getDefault: () => new ba() }
  function we(e, t) {
  ...
  class re {
    constructor(t, n, r, s) {
      ;(this._hslaBrand = void 0),
        ...
        (this.l = we(Math.max(Math.min(1, r), 0), 3)),
        (this.a = we(Math.max(Math.min(1, s), 0), 3))
    }
    static equals(t, n) {
  ...
  class Ue {
    constructor(t, n, r, s) {
      ;(this._hsvaBrand = void 0),
        (this.h = Math.max(Math.min(360, t), 0) | 0),
        (this.s = we(Math.max(Math.min(1, n), 0), 3)),
        (this.v = we(Math.max(Math.min(1, r), 0), 3)),
        (this.a = we(Math.max(Math.min(1, s), 0), 3))
    }
    static equals(t, n) {
    ...
    static fromRGBA(t) {
      ...
      return (
        o === 0
          ...
          ? (c = (s - n) / o + 2)
          : (c = (n - r) / o + 4),
        new Ue(Math.round(c * 60), u, i, t.a)
      )
    }
    static toRGBA(t) {
  ...
  class I {
    ...
    get hsva() {
      return this._hsva ? this._hsva : Ue.fromRGBA(this.rgba)
    }
    constructor(t) {
      if (t)
        if (t instanceof O) this.rgba = t
        else if (t instanceof re) (this._hsla = t), (this.rgba = re.toRGBA(t))
        else if (t instanceof Ue) (this._hsva = t), (this.rgba = Ue.toRGBA(t))
        ...
        ;(function (n) {
          ...
          function c(m, g = !1) {
            return g && m.rgba.a === 1
              ...
              : `#${o(m.rgba.r)}${o(m.rgba.g)}${o(m.rgba.b)}${o(
          ...
          function h(m) {
            ...
            if (g === 7) {
              const x = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)),
                ...
                L = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6))
              return new e(new O(x, v, L, 1))
            }
            if (g === 9) {
              const x = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)),
                v = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)),
              ...
              return new e(new O(x, v, L, S / 255))
            }
            if (g === 4) {
              const x = d(m.charCodeAt(1)),
                v = d(m.charCodeAt(2)),
                L = d(m.charCodeAt(3))
              return new e(new O(16 * x + x, 16 * v + v, 16 * L + L))
            }
            if (g === 5) {
              const x = d(m.charCodeAt(1)),
                v = d(m.charCodeAt(2)),
                ...
                S = d(m.charCodeAt(4))
              return new e(
                new O(16 * x + x, 16 * v + v, 16 * L + L, (16 * S + S) / 255),
              )
            }
            return null
          }
  ...
  function xa(e, t) {
    ...
    if (n)
      return { range: e, color: Jt(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function Xr(e, t, n) {
  ...
  function Ca(e, t, n) {
    ...
    if (r) {
      ...
      if (l.endColumn > l.startColumn) {
        const o = { range: l, ...Yr(r[1]), shouldBeInComments: !0 }
  ...
  function Yr(e) {
    ...
    return (e = e.replace(wa, '')), { text: e, hasSeparatorLine: t }
  }
  class Aa extends mi {
    get uri() {
      return this._uri
    ...
    getWordAtPosition(t, n) {
      const r = Pt(t.column, vn(n), this._lines[t.lineNumber - 1], 0)
      return r
  ...
  class Ce {
    ...
    acceptNewModel(t) {
      this._models[t.url] = new Aa(Se.parse(t.url), t.lines, t.EOL, t.versionId)
    }
    ...
    async computeUnicodeHighlights(t, n, r) {
      ...
      return s
        ? zi.computeUnicodeHighlights(s, n, r)
        : {
            ranges: [],
            hasMore: !1,
    ...
    static computeDiff(t, n, r, s) {
      const i = s === 'advanced' ? Gr.getDefault() : Gr.getLegacy(),
        l = t.getLinesContent(),
        o = n.getLinesContent(),
