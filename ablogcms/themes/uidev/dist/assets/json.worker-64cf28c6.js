...
var Hc = (et, Ve, Re) =>
  Ve in et
    ? Wc(et, Ve, { enumerable: !0, configurable: !0, writable: !0, value: Re })
    : (et[Ve] = Re)
var Ke = (et, Ve, Re) => (Hc(et, typeof Ve != 'symbol' ? Ve + '' : Ve, Re), Re)
;(function () {
  'use strict'
  class et {
    constructor() {
...
` +
  ...
  ;(function (e) {
    function t(b) {
      return (
        b && typeof b == 'object' && typeof b[Symbol.iterator] == 'function'
      )
    }
    e.is = t
    ...
    e.from = a
    function* l(b) {
      for (let w = b.length - 1; w >= 0; w--) yield b[w]
    }
    e.reverse = l
    function o(b) {
    ...
    e.some = h
    function f(b, w) {
      for (const v of b) if (w(v)) return v
    }
    e.find = f
    function* d(b, w) {
      for (const v of b) w(v) && (yield v)
    }
    e.filter = d
    function* m(b, w) {
      let v = 0
      for (const L of b) yield w(L, v++)
    }
    e.map = m
    function* g(...b) {
      for (const w of b) yield* w
    }
    e.concat = g
    function p(b, w, v) {
      let L = v
      for (const R of b) L = w(L, R)
      return L
    }
    e.reduce = p
    function* x(b, w, v = b.length) {
      for (
        w < 0 && (w += b.length),
    ...
    e.slice = x
    function _(b, w = Number.POSITIVE_INFINITY) {
      const v = []
      if (w === 0) return [v, b]
      const L = b[Symbol.iterator]()
      for (let R = 0; R < w; R++) {
        const C = L.next()
        if (C.done) return [v, e.empty()]
        v.push(C.value)
      }
      return [
        v,
    ...
    async function S(b) {
      const w = []
      for await (const v of b) w.push(v)
  ...
  class lo {
    ...
    _insert(t, n) {
      const r = new H(t)
      if (this._first === H.Undefined) (this._first = r), (this._last = r)
      else if (n) {
        const s = this._last
    ...
    _remove(t) {
      if (t.prev !== H.Undefined && t.next !== H.Undefined) {
        ...
        t.prev === H.Undefined && t.next === H.Undefined
          ...
          : t.next === H.Undefined
          ? ((this._last = this._last.prev), (this._last.next = H.Undefined))
          : t.prev === H.Undefined &&
            ((this._first = this._first.next), (this._first.prev = H.Undefined))
      this._size -= 1
    }
    *[Symbol.iterator]() {
      let t = this._first
  ...
  ;(function (e) {
    e.None = () => Tt.None
    function t(N, y) {
      return f(N, () => {}, 0, void 0, !0, void 0, y)
    }
    e.defer = t
    function n(N) {
      return (y, k = null, E) => {
        ...
        return (
          (I = N(
            (F) => {
              if (!T) return I ? I.dispose() : (T = !0), y.call(k, F)
            },
            null,
            E,
          )),
    ...
    e.once = n
    function r(N, y, k) {
      return u((E, T = null, I) => N((F) => E.call(T, y(F)), null, I), k)
    }
    e.map = r
    function i(N, y, k) {
      return u(
    ...
    e.forEach = i
    function s(N, y, k) {
      return u((E, T = null, I) => N((F) => y(F) && E.call(T, F), null, I), k)
    }
    e.filter = s
    function a(N) {
      return N
    ...
    function l(...N) {
      return (y, k = null, E) => {
        const T = oo(...N.map((I) => I((F) => y.call(k, F))))
        return h(T, E)
      }
    }
    e.any = l
    ...
    function h(N, y) {
      return y instanceof Array ? y.push(N) : y && y.add(N), N
    }
    function f(N, y, k = 100, E = !1, T = !1, I, F) {
      let j,
        W,
        J,
        $e = 0,
      ...
      const qc = {
          ...
          onWillAddFirstListener() {
            j = N((Uc) => {
              $e++,
                ...
                typeof k == 'number'
                  ? (clearTimeout(J), (J = setTimeout(lt, k)))
                  : J === void 0 && ((J = 0), queueMicrotask(lt))
            })
          },
        ...
        _n = new _e(qc)
      return F == null || F.add(_n), _n.event
    }
    e.debounce = f
    function d(N, y = 0, k) {
      return e.debounce(
    ...
    e.latch = m
    function g(N, y, k) {
      return [e.filter(N, y, k), e.filter(N, (E) => !y(E), k)]
    }
    e.split = g
    function p(N, y = !1, k = [], E) {
      let T = k.slice(),
        I = N((W) => {
          T ? T.push(W) : j.fire(W)
        })
      E && E.add(I)
      const F = () => {
          T == null || T.forEach((W) => j.fire(W)), (T = null)
        },
        j = new _e({
          onWillAddFirstListener() {
            I || ((I = N((W) => j.fire(W))), E && E.add(I))
          },
    ...
    class S {
      ...
      forEach(y) {
        return this.steps.push((k) => (y(k), k)), this
      }
      filter(y) {
        return this.steps.push((k) => (y(k) ? k : _)), this
      }
      reduce(y, k) {
        let E = k
        return this.steps.push((T) => ((E = y(E, T)), E)), this
      }
      latch(y = (k, E) => k === E) {
        let k = !0,
          E
        return (
          this.steps.push((T) => {
            const I = k || !y(T, E)
            return (k = !1), (E = T), I ? T : _
          }),
          this
        )
      }
      evaluate(y) {
        for (const k of this.steps) if (((y = k(y)), y === _)) break
        return y
      }
    }
    function b(N, y, k = (E) => E) {
      const E = (...j) => F.fire(k(...j)),
        T = () => N.on(y, E),
        I = () => N.removeListener(y, E),
        F = new _e({ onWillAddFirstListener: T, onDidRemoveLastListener: I })
      return F.event
    }
    e.fromNodeEventEmitter = b
    function w(N, y, k = (E) => E) {
      const E = (...j) => F.fire(k(...j)),
        T = () => N.addEventListener(y, E),
        I = () => N.removeEventListener(y, E),
        F = new _e({ onWillAddFirstListener: T, onDidRemoveLastListener: I })
      return F.event
    }
    e.fromDOMEventEmitter = w
    function v(N) {
      return new Promise((y) => n(N)(y))
    }
    e.toPromise = v
    function L(N) {
      const y = new _e()
    ...
    class C {
      constructor(y, k) {
        ...
        ;(this.emitter = new _e(E)), k && k.add(this.emitter)
      }
      beginUpdate(y) {
        this._counter++
      }
    ...
    function P(N, y) {
      return new C(N, y).emitter.event
    }
    e.fromObservable = P
    function D(N) {
      return (y, k, E) => {
        ...
        const F = {
          ...
          endUpdate() {
            T--, T === 0 && (N.reportChanges(), I && ((I = !1), y.call(k)))
          },
        ...
        N.addObserver(F), N.reportChanges()
        const j = {
          dispose() {
            N.removeObserver(F)
          },
        }
        return E instanceof ft ? E.add(j) : Array.isArray(E) && E.push(j), j
      }
    }
  ...
  class ht {
    constructor(t) {
      ;(this.listenerCount = 0),
        ...
        (this.durations = []),
        (this.name = `${t}_${ht._idPool++}`),
        ht.all.add(this)
    }
    start(t) {
      ;(this._stopWatch = new Zt()), (this.listenerCount = t)
    }
    stop() {
      if (this._stopWatch) {
  ...
  ;(ht.all = new Set()), (ht._idPool = 0)
  let co = -1
  class fo {
    constructor(t, n, r = Math.random().toString(18).slice(2, 5)) {
  ...
  class Sn {
    static create() {
      var t
      const n = new Error()
      return new Sn((t = n.stack) !== null && t !== void 0 ? t : '')
    }
    constructor(t) {
      this.value = t
    }
...
`),
  ...
  class _e {
      ...
      ;(this._size = 0),
        ...
        (this._leakageMon =
          ...
          n.leakWarningThreshold
            ? new fo(
                (r = t == null ? void 0 : t.onListenerError) !== null &&
                r !== void 0
                  ? r
                  : Re,
                (s =
                  (i = this._options) === null || i === void 0
                    ? void 0
                    : i.leakWarningThreshold) !== null && s !== void 0
                  ? s
                  : co,
              )
            : void 0),
        (this._perfMon =
          !((a = this._options) === null || a === void 0) && a._profName
            ? new ht(this._options._profName)
            : void 0),
        (this._deliveryQueue =
        ...
        ((t = this._event) !== null && t !== void 0) ||
          (this._event = (n, r, i) => {
            ...
            if (
              ...
              const p = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`
              console.warn(p)
              const x =
            ...
            this._leakageMon &&
              ...
              ((d.stack = Sn.create()),
              (m = this._leakageMon.check(d.stack, this._size + 1))),
              this._listeners
                ? this._listeners instanceof An
                  ? (((f = this._deliveryQueue) !== null && f !== void 0) ||
                      (this._deliveryQueue = new po()),
                    (this._listeners = [this._listeners, d]))
                  : this._listeners.push(d)
                : ((o =
                    (l = this._options) === null || l === void 0
                      ? void 0
                      : l.onWillAddFirstListener) === null ||
                    o === void 0 ||
                    o.call(l, this),
                  (this._listeners = d),
                  (h =
            ...
            return i instanceof ft ? i.add(g) : Array.isArray(i) && i.push(g), g
          }),
        this._event
      )
    }
      ...
      if (this._size === 1) {
        ;(this._listeners = void 0),
          (s =
            (i = this._options) === null || i === void 0
              ? void 0
              : i.onDidRemoveLastListener) === null ||
            s === void 0 ||
            s.call(i, this),
          (this._size = 0)
        return
        ...
        for (let h = 0; h < a.length; h++)
          a[h]
            ...
            : o &&
              ...
              u < this._deliveryQueue.i && this._deliveryQueue.i--)
        a.length = u
      }
    }
    _deliver(t, n) {
    ...
    fire(t) {
      ...
      if (
        ...
        (i = this._perfMon) === null || i === void 0 || i.start(this._size),
        this._listeners)
      )
        if (this._listeners instanceof An) this._deliver(this._listeners, t)
        else {
  ...
  function kn(e) {
    const t = []
    for (const n of vo(e)) typeof e[n] == 'function' && t.push(n)
    return t
  }
  function xo(e, t) {
    const n = (i) =>
  ...
  typeof tt.vscode < 'u' && typeof tt.vscode.process < 'u'
    ? (oe = tt.vscode.process)
    : typeof process < 'u' &&
      typeof ((Rn = process == null ? void 0 : process.versions) === null ||
      Rn === void 0
        ? void 0
        : Rn.node) == 'string' &&
      (oe = process)
  const Lo =
    typeof ((Mn = oe == null ? void 0 : oe.versions) === null || Mn === void 0
      ? void 0
      : Mn.electron) == 'string' &&
    (oe == null ? void 0 : oe.type) === 'renderer'
  if (typeof oe == 'object') {
    ;(En = oe.platform === 'win32'),
      (Cn = oe.platform === 'darwin'),
      (Tn = oe.platform === 'linux'),
      Tn && oe.env.SNAP && oe.env.SNAP_REVISION,
      oe.env.CI || oe.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
      (Yt = dt),
      (Pn = dt)
    ...
    if (e)
      try {
        ...
        ;(Yt = t.locale),
          (Ir = t.osLocale),
          (Pn = n || dt),
          (wo = t._translationsConfigFile)
      } catch {}
  } else
    typeof navigator == 'object' && !Lo
      ? ((we = navigator.userAgent),
        (En = we.indexOf('Windows') >= 0),
        (Cn = we.indexOf('Macintosh') >= 0),
        (we.indexOf('Macintosh') >= 0 ||
          we.indexOf('iPad') >= 0 ||
          we.indexOf('iPhone') >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (Tn = we.indexOf('Linux') >= 0),
        (we == null ? void 0 : we.indexOf('Mobi')) >= 0,
        z({ key: 'ensureLoaderPluginIsLoaded', comment: ['{Locked}'] }, '_'),
        (Yt = dt),
        (Pn = Yt),
        (Ir = navigator.language))
      : console.error('Unable to resolve platform.')
  const Pt = En,
    No = Cn,
    Ee = we,
    So = typeof tt.postMessage == 'function' && !tt.importScripts
  ;(() => {
    if (So) {
      const e = []
  ...
  const Ao = !!(Ee && Ee.indexOf('Chrome') >= 0)
  Ee && Ee.indexOf('Firefox') >= 0,
    !Ao && Ee && Ee.indexOf('Safari') >= 0,
    Ee && Ee.indexOf('Edg/') >= 0,
  ...
  class Ro {
    constructor(t, n) {
      ;(this.lastCache = void 0),
        ...
        typeof t == 'function'
          ? ((this._fn = t), (this._computeKey = ko))
  ...
  class nt {
    static getInstance(t) {
      return mt.cache.get(Array.from(t))
    }
    static getLocales() {
      return mt._locales.value
    }
    constructor(t) {
  ...
  ;(mt = nt),
    (nt.ambiguousCharacterData = new Fr(() =>
      JSON.parse(
    ...
    (nt.cache = new Ro({ getCacheKey: JSON.stringify }, (e) => {
      function t(u) {
        const h = new Map()
      ...
      const i = mt.ambiguousCharacterData.value
    ...
    (nt._locales = new Fr(() =>
      Object.keys(mt.ambiguousCharacterData.value).filter(
        (e) => !e.startsWith('_'),
      ),
    ))
  class qe {
    ...
    static getData() {
      return this._data || (this._data = new Set(qe.getRawData())), this._data
    }
    static isInvisibleCharacter(t) {
      return qe.getData().has(t)
    }
  ...
  class jo {
    ...
    sendMessage(t, n) {
      ...
      return new Promise((i, s) => {
        ;(this._pendingReplies[r] = { resolve: i, reject: s }),
          this._send(new Bo(this._workerId, r, t, n))
      })
    }
    listen(t, n) {
      let r = null
      const i = new _e({
        ...
        onDidRemoveLastListener: () => {
          this._pendingEmitters.delete(r),
            this._send(new Uo(this._workerId, r)),
            (r = null)
        },
      })
      return i.event
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.method, t.args).then(
        (i) => {
          this._send(new Dr(this._workerId, n, i, void 0))
        },
        (i) => {
          i.detail instanceof Error && (i.detail = Tr(i.detail)),
            this._send(new Dr(this._workerId, n, void 0, Tr(i)))
        },
      )
    }
    _handleSubscribeEventMessage(t) {
      const n = t.req,
        r = this._handler.handleEvent(
          ...
          this._send(new qo(this._workerId, n, i))
        })
  ...
  class Ho {
    ...
    _handleMessage(t, n) {
      if (t === Oo) return this.initialize(n[0], n[1], n[2], n[3])
    ...
    initialize(t, n, r, i) {
      ...
      const l = Wo(
        i,
        (o, u) => this._protocol.sendMessage(o, u),
        (o, u) => this._protocol.listen(o, u),
      )
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(l)),
          Promise.resolve(kn(this._requestHandler)))
        : (n &&
          ...
          new Promise((o, u) => {
            ...
            h(
              ...
              (f) => {
                if (
                  ((this._requestHandler = f.create(l)), !this._requestHandler)
                ) {
                  u(new Error('No RequestHandler!'))
                  return
                }
                o(kn(this._requestHandler))
              },
              u,
            )
          }))
  ...
  function Go(e, t, n) {
    return new je(new qr(e), new qr(t)).ComputeDiff(n).changes
  }
  class gt {
    static Assert(t, n) {
  ...
  class je {
    ...
    static _getElements(t) {
      ...
      if (je._isStringArray(n)) {
        ...
        for (let i = 0, s = n.length; i < s; i++) r[i] = zo(n[i], 0)
        return [n, r, !0]
      }
    ...
    ElementsAreStrictEqual(t, n) {
      ...
      const r = je._getStrictElement(this._originalSequence, t),
        i = je._getStrictElement(this._modifiedSequence, n)
      return r === i
    }
    ...
    ComputeDiffRecursive(t, n, r, i, s) {
      ...
      const a = [0],
        l = [0],
        o = this.ComputeRecursionPoint(t, n, r, i, a, l, s),
        u = a[0],
        h = l[0]
      if (o !== null) return o
      if (!s[0]) {
        ...
        return (
          s[0]
            ? (d = [new Ue(u + 1, n - (u + 1) + 1, h + 1, i - (h + 1) + 1)])
            : (d = this.ComputeDiffRecursive(u + 1, n, h + 1, i, s)),
          this.ConcatenateChanges(f, d)
        )
      }
      return [new Ue(t, n - t + 1, r, i - r + 1)]
    }
    WALKTRACE(t, n, r, i, s, a, l, o, u, h, f, d, m, g, p, x, _, S) {
      let b = null,
        w = null,
        v = new Ur(),
        L = n,
      ...
      do {
        ...
        N === L || (N < R && u[N - 1] < u[N + 1])
          ? ((f = u[N + 1]),
            (g = f - C - i),
            f < P && v.MarkNextChange(),
            (P = f),
            v.AddModifiedElement(f + 1, g),
            (C = N + 1 - t))
          : ((f = u[N - 1] + 1),
            (g = f - C - i),
            f < P && v.MarkNextChange(),
            (P = f - 1),
            v.AddOriginalElement(f, g + 1),
            (C = N - 1 - t)),
          D >= 0 &&
            ((u = this.m_forwardHistory[D]),
            (t = u[0]),
            (L = 1),
            (R = u.length - 1))
      } while (--D >= -1)
      if (((b = v.getReverseChanges()), S[0])) {
        let N = m[0] + 1,
          y = x[0] + 1
        if (b !== null && b.length > 0) {
          const k = b[b.length - 1]
          ;(N = Math.max(N, k.getOriginalEnd())),
            (y = Math.max(y, k.getModifiedEnd()))
        }
        w = [new Ue(N, d - N + 1, y, p - y + 1)]
      } else {
        ;(v = new Ur()),
          (L = a),
          (R = l),
        ...
        do {
          ...
          N === L || (N < R && h[N - 1] >= h[N + 1])
            ? ((f = h[N + 1] - 1),
              ...
              f > P && v.MarkNextChange(),
              (P = f + 1),
              v.AddOriginalElement(f + 1, g + 1),
              (C = N + 1 - s))
            : ((f = h[N - 1]),
              (g = f - C - o),
              f > P && v.MarkNextChange(),
              (P = f),
              v.AddModifiedElement(f + 1, g + 1),
              (C = N - 1 - s)),
            D >= 0 &&
    ...
    ComputeRecursionPoint(t, n, r, i, s, a, l) {
      ...
      for (let C = 1; C <= g / 2 + 1; C++) {
        let P = 0,
          D = 0
        ;(h = this.ClipDiagonalBound(S - C, C, S, p)),
          (f = this.ClipDiagonalBound(S + C, C, S, p))
        for (let y = h; y <= f; y += 2) {
          y === h || (y < f && x[y - 1] < x[y + 1])
            ? (o = x[y + 1])
            : (o = x[y - 1] + 1),
          ...
          if (
            ((x[y] = o),
            o + u > P + D && ((P = o), (D = u)),
            !R && Math.abs(y - b) <= C - 1 && o >= _[y])
          )
            return (
              (s[0] = o),
              (a[0] = u),
              k <= _[y] && 1447 > 0 && C <= 1447 + 1
                ? this.WALKTRACE(
                    S,
                    h,
                    f,
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(P, N)
        )
          return (
            (l[0] = !0),
            (s[0] = P),
            ...
            N > 0 && 1447 > 0 && C <= 1447 + 1
              ...
              : (t++, r++, [new Ue(t, n - t + 1, r, i - r + 1)])
          )
        ;(d = this.ClipDiagonalBound(b - C, C, b, p)),
          (m = this.ClipDiagonalBound(b + C, C, b, p))
        for (let y = d; y <= m; y += 2) {
          y === d || (y < m && _[y - 1] >= _[y + 1])
            ? (o = _[y + 1] - 1)
            : (o = _[y - 1]),
          ...
          if (((_[y] = o), R && Math.abs(y - S) <= C && o <= x[y]))
            return (
              (s[0] = o),
              (a[0] = u),
              k >= x[y] && 1447 > 0 && C <= 1447 + 1
                ? this.WALKTRACE(
                    S,
                    h,
                    f,
        ...
        if (C <= 1447) {
          ...
          ;(y[0] = S - h + 1),
            pt.Copy2(x, h, y, 1, f - h + 1),
            this.m_forwardHistory.push(y),
            (y = new Int32Array(m - d + 2)),
            (y[0] = b - d + 1),
            pt.Copy2(_, d, y, 1, m - d + 1),
      ...
      for (let n = t.length - 1; n >= 0; n--) {
        ...
        for (let f = 1; ; f++) {
          ...
          if (
            d < i ||
            m < s ||
            (a && !this.OriginalElementsAreEqual(d, d + r.originalLength)) ||
            (l && !this.ModifiedElementsAreEqual(m, m + r.modifiedLength))
          )
            break
          const p =
            (d === i && m === s ? 5 : 0) +
    ...
    ConcatenateChanges(t, n) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
        ...
        return (
          pt.Copy(t, 0, i, 0, t.length - 1),
          (i[t.length - 1] = r[0]),
          pt.Copy(n, 1, i, t.length, n.length - 1),
          i
        )
      } else {
        const i = new Array(t.length + n.length)
        return (
          pt.Copy(t, 0, i, 0, t.length), pt.Copy(n, 0, i, t.length, n.length), i
        )
      }
    }
  ...
  let bt
  const Fn = globalThis.vscode
  if (typeof Fn < 'u' && typeof Fn.process < 'u') {
    const e = Fn.process
    bt = {
      get platform() {
        return e.platform
    ...
    typeof process < 'u'
      ...
      : (bt = {
          get platform() {
            return Pt ? 'win32' : No ? 'darwin' : 'linux'
          },
          get arch() {},
          get env() {
            return {}
  ...
  function tl(e, t) {
    if (e === null || typeof e != 'object') throw new jr(t, 'Object', e)
  }
  function Y(e, t) {
    if (typeof e != 'string') throw new jr(t, 'string', e)
  }
  const ze = Xo === 'win32'
  function O(e) {
    return e === se || e === fe
        ...
        if (!(a === u - 1 || l === 1))
          if (l === 2) {
            if (
              i.length < 2 ||
              s !== 2 ||
              i.charCodeAt(i.length - 1) !== We ||
              i.charCodeAt(i.length - 2) !== We
            ) {
              if (i.length > 2) {
  ...
  const ce = {
      resolve(...e) {
        ...
        for (let i = e.length - 1; i >= -1; i--) {
          let s
          if (i >= 0) {
            if (((s = e[i]), Y(s, 'path'), s.length === 0)) continue
          } else
            t.length === 0
              ? (s = Kt())
              : ((s = Jo[`=${t}`] || Kt()),
          ...
          if (a === 1) O(h) && ((l = 1), (u = !0))
            ...
            if (((u = !0), O(s.charCodeAt(1)))) {
              let f = 2,
                d = f
              for (; f < a && !O(s.charCodeAt(f)); ) f++
              if (f < a && f !== d) {
                const m = s.slice(d, f)
                for (d = f; f < a && O(s.charCodeAt(f)); ) f++
                if (f < a && f !== d) {
                  for (d = f; f < a && !O(s.charCodeAt(f)); ) f++
                  ;(f === a || f !== d) &&
                    ((o = `\\\\${m}\\${s.slice(d, f)}`), (l = f))
      ...
      normalize(e) {
        ...
        if (O(s))
          if (((i = !0), O(e.charCodeAt(1)))) {
            let l = 2,
              o = l
            for (; l < t && !O(e.charCodeAt(l)); ) l++
            if (l < t && l !== o) {
              const u = e.slice(o, l)
              for (o = l; l < t && O(e.charCodeAt(l)); ) l++
              if (l < t && l !== o) {
                for (o = l; l < t && !O(e.charCodeAt(l)); ) l++
          ...
          Ge(s) &&
            ...
            ((r = e.slice(0, 2)),
            (n = 2),
            t > 2 && O(e.charCodeAt(2)) && ((i = !0), (n = 3)))
        let a = n < t ? en(e.slice(n), !i, '\\', O) : ''
        return (
          a.length === 0 && !i && (a = '.'),
          a.length > 0 && O(e.charCodeAt(t - 1)) && (a += '\\'),
          r === void 0 ? (i ? `\\${a}` : a) : i ? `${r}\\${a}` : `${r}${a}`
        )
      },
      isAbsolute(e) {
        Y(e, 'path')
        ...
        return (
          O(n) ||
          (t > 2 && Ge(n) && e.charCodeAt(1) === He && O(e.charCodeAt(2)))
        )
      },
      join(...e) {
        ...
        if (typeof n == 'string' && O(n.charCodeAt(0))) {
          ...
          s > 1 &&
            O(n.charCodeAt(1)) &&
            (++i, s > 2 && (O(n.charCodeAt(2)) ? ++i : (r = !1)))
        }
        if (r) {
          for (; i < t.length && O(t.charCodeAt(i)); ) i++
          i >= 2 && (t = `\\${t.slice(i)}`)
        }
      ...
      relative(e, t) {
        ...
        if (n === r || ((e = n.toLowerCase()), (t = r.toLowerCase()), e === t))
          return ''
        let i = 0
        for (; i < e.length && e.charCodeAt(i) === fe; ) i++
        let s = e.length
        for (; s - 1 > i && e.charCodeAt(s - 1) === fe; ) s--
        const a = s - i
        let l = 0
        for (; l < t.length && t.charCodeAt(l) === fe; ) l++
        let o = t.length
        for (; o - 1 > l && t.charCodeAt(o - 1) === fe; ) o--
        const u = o - l,
          h = a < u ? a : u
        let f = -1,
          d = 0
        ...
        if (d !== h) {
          ...
          if (u > h) {
            if (t.charCodeAt(l + d) === fe) return r.slice(l + d + 1)
            if (d === 2) return r.slice(l + d)
          }
          a > h && (e.charCodeAt(i + d) === fe ? (f = d) : d === 2 && (f = 3)),
            f === -1 && (f = 0)
        }
        let m = ''
        for (d = i + f + 1; d <= s; ++d)
          (d === s || e.charCodeAt(d) === fe) &&
            (m += m.length === 0 ? '..' : '\\..')
        return (
          (l += f),
          m.length > 0
            ? `${m}${r.slice(l, o)}`
            : (r.charCodeAt(l) === fe && ++l, r.slice(l, o))
        )
      },
      toNamespacedPath(e) {
        ...
        if (t.charCodeAt(0) === fe) {
          if (t.charCodeAt(1) === fe) {
            ...
            if (n !== el && n !== We) return `\\\\?\\UNC\\${t.slice(2)}`
          }
        } else if (
          Ge(t.charCodeAt(0)) &&
          t.charCodeAt(1) === He &&
      ...
      dirname(e) {
        ...
        if (O(i)) {
          ...
          Ge(i) &&
            e.charCodeAt(1) === He &&
            ((n = t > 2 && O(e.charCodeAt(2)) ? 3 : 2), (r = n))
        let s = -1,
          a = !0
        for (let l = t - 1; l >= r; --l)
          if (O(e.charCodeAt(l))) {
      ...
      parse(e) {
        ...
        let r = 0,
          i = e.charCodeAt(0)
        if (n === 1)
          return O(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t)
        if (O(i)) {
          if (((r = 1), O(e.charCodeAt(1)))) {
            let f = 2,
              d = f
            for (; f < n && !O(e.charCodeAt(f)); ) f++
            if (f < n && f !== d) {
              for (d = f; f < n && O(e.charCodeAt(f)); ) f++
              if (f < n && f !== d) {
                for (d = f; f < n && !O(e.charCodeAt(f)); ) f++
                f === n ? (r = f) : f !== d && (r = f + 1)
              }
        ...
        } else if (Ge(i) && e.charCodeAt(1) === He) {
          if (n <= 2) return (t.root = t.dir = e), t
          if (((r = 2), O(e.charCodeAt(2)))) {
    ...
    he = {
      resolve(...e) {
        ...
        for (let r = e.length - 1; r >= -1 && !n; r--) {
          const i = r >= 0 ? e[r] : nl()
          Y(i, 'path'),
            i.length !== 0 && ((t = `${i}/${t}`), (n = i.charCodeAt(0) === se))
        }
        return (t = en(t, !n, '/', Vn)), n ? `/${t}` : t.length > 0 ? t : '.'
      },
      normalize(e) {
        if ((Y(e, 'path'), e.length === 0)) return '.'
        const t = e.charCodeAt(0) === se,
          n = e.charCodeAt(e.length - 1) === se
        return (
          (e = en(e, !t, '/', Vn)),
          e.length === 0
            ? t
      ...
      isAbsolute(e) {
        return Y(e, 'path'), e.length > 0 && e.charCodeAt(0) === se
      },
      join(...e) {
        if (e.length === 0) return '.'
        let t
      ...
      relative(e, t) {
        if (
          (Y(e, 'from'),
          Y(t, 'to'),
          e === t || ((e = he.resolve(e)), (t = he.resolve(t)), e === t))
        )
          return ''
        const n = 1,
          r = e.length,
        ...
        if (u === l)
          if (a > l) {
            ...
            i > l && (e.charCodeAt(n + u) === se ? (o = u) : u === 0 && (o = 0))
        let h = ''
        for (u = n + o + 1; u <= r; ++u)
          (u === r || e.charCodeAt(u) === se) &&
            (h += h.length === 0 ? '..' : '/..')
  ...
  ;(he.win32 = ce.win32 = ce),
    (he.posix = ce.posix = he),
    ze ? ce.normalize : he.normalize,
    ze ? ce.resolve : he.resolve,
    ze ? ce.relative : he.relative,
    ze ? ce.dirname : he.dirname,
    ze ? ce.basename : he.basename,
    ze ? ce.extname : he.extname,
    ze ? ce.sep : he.sep
  const rl = /^\w[\w\d+.-]*$/,
    il = /^\//,
    sl = /^\/\//
  ...
  let Dn = class wn {
    ...
    with(t) {
      ...
      return (
        ...
        i === void 0 ? (i = this.path) : i === null && (i = G),
        s === void 0 ? (s = this.query) : s === null && (s = G),
        a === void 0 ? (a = this.fragment) : a === null && (a = G),
        n === this.scheme &&
        r === this.authority &&
        i === this.path &&
        s === this.query &&
    ...
    static file(t) {
      let n = G
      if ((Pt && (t = t.replace(/\\/g, Le)), t[0] === Le && t[1] === Le)) {
        const r = t.indexOf(Le, 2)
        r === -1
          ? ((n = t.substring(2)), (t = Le))
          : ((n = t.substring(2, r)), (t = t.substring(r) || Le))
      }
      return new vt('file', n, t, G, G)
    }
    static from(t, n) {
      return new vt(t.scheme, t.authority, t.path, t.query, t.fragment, n)
    }
    static joinPath(t, ...n) {
      if (!t.path)
      ...
      return (
        Pt && t.scheme === 'file'
          ? (r = wn.file(ce.join(On(t, !0), ...n)).path)
          : (r = he.join(t.path, ...n)),
        t.with({ path: r })
      )
    }
  ...
  class vt extends Dn {
    ...
    toString(t = !1) {
      return t
        ? Bn(this, !0)
        : (this._formatted || (this._formatted = Bn(this, !1)), this._formatted)
    }
    toJSON() {
      const t = { $mid: 1 }
      return (
  ...
  function cl(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const r = e.charCodeAt(n)
      r === 35 || r === 63
        ? (t === void 0 && (t = e.substr(0, n)), (t += zr[r]))
        : t !== void 0 && (t += e[n])
    }
    return t !== void 0 ? t : e
  }
  ...
  function Bn(e, t) {
    const n = t ? cl : Gr
    let r = '',
      { scheme: i, authority: s, path: a, query: l, fragment: o } = e
    if (
      (i && ((r += i), (r += ':')),
      (s || i === 'file') && ((r += Le), (r += Le)),
      s)
      ...
      if (u !== -1) {
        ...
        ;(s = s.substr(u + 1)),
          ...
          u === -1
            ? (r += n(h, !1, !1))
            : ((r += n(h.substr(0, u), !1, !1)),
              (r += ':'),
              (r += n(h.substr(u + 1), !1, !0))),
          (r += '@')
      }
      ;(s = s.toLowerCase()),
        (u = s.lastIndexOf(':')),
        u === -1
          ? (r += n(s, !1, !0))
          : ((r += n(s.substr(0, u), !1, !0)), (r += s.substr(u)))
    }
    if (a) {
      if (a.length >= 3 && a.charCodeAt(0) === 47 && a.charCodeAt(2) === 58) {
        ...
        u >= 65 &&
          u <= 90 &&
          (a = `/${String.fromCharCode(u + 32)}:${a.substr(3)}`)
      } else if (a.length >= 2 && a.charCodeAt(1) === 58) {
        const u = a.charCodeAt(0)
        u >= 65 &&
          u <= 90 &&
          (a = `${String.fromCharCode(u + 32)}:${a.substr(2)}`)
      }
      r += n(a, !0, !1)
    }
    return (
  ...
  function Jr(e) {
    try {
      ...
      return e.length > 3 ? e.substr(0, 3) + Jr(e.substr(3)) : e
    }
  }
  const Xr = /(%[0-9A-Za-z][0-9A-Za-z])+/g
  function tn(e) {
    return e.match(Xr) ? e.replace(Xr, (t) => Jr(t)) : e
  }
  let Ce = class ut {
      constructor(t, n) {
    ...
    X = class ee {
      ...
      static intersectRanges(t, n) {
        ...
        const l = n.startLineNumber,
          ...
          h = n.endColumn
        return (
          r < l ? ((r = l), (i = o)) : r === l && (i = Math.max(i, o)),
          s > u ? ((s = u), (a = h)) : s === u && (a = Math.min(a, h)),
          r > s || (r === s && i > a) ? null : new ee(r, i, s, a)
        )
      }
      equalsRange(t) {
  ...
  class bl {
    ...
    getPrefixSum(t) {
      return t < 0 ? 0 : ((t = xt(t)), this._getPrefixSum(t))
    }
    _getPrefixSum(t) {
      ...
      for (const r of n)
        this._acceptDeleteRange(r.range),
          this._acceptInsertText(
            new Ce(r.range.startLineNumber, r.range.startColumn),
            r.text,
          )
  ...
  function _l(e = '') {
    let t = '(-?\\d*\\.\\d\\w*)|([^'
    for (const n of yl) e.indexOf(n) >= 0 || (t += '\\' + n)
  ...
  const ei = new lo()
  ei.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
  function $n(e, t, n, r, i) {
    if (((t = Kr(t)), i || (i = Xt.first(ei)), n.length > i.maxLen)) {
      let u = e - i.maxLen / 2
      return (
        u < 0 ? (u = 0) : (r += u),
        (n = n.substring(u, e + i.maxLen / 2)),
        $n(e, t, n, r, i)
      )
    }
    const s = Date.now(),
  ...
  class qn {
    constructor(t) {
      ...
      ;(this._defaultValue = n),
        (this._asciiMap = qn._createAsciiMap(n)),
        (this._map = new Map())
    }
  ...
  function Al() {
    if (It === null) {
      It = new qn(0)
      const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`
      for (let n = 0; n < e.length; n++) It.set(e.charCodeAt(n), 1)
      const t = '.,;:'
      for (let n = 0; n < t.length; n++) It.set(t.charCodeAt(n), 2)
    }
    return It
  }
  class sn {
      ...
      for (let s = 1, a = t.getLineCount(); s <= a; s++) {
        ...
        for (; u < o; ) {
          ...
          if (d === 13) {
            ...
            b === 1 && (i.push(sn._createLink(r, l, s, h, u)), (_ = !0))
          } else if (d === 12) {
            let b
            S === 91 ? ((g = !0), (b = 0)) : (b = r.get(S)),
              b === 1 ? (_ = !0) : (d = 13)
          } else (d = n.nextState(d, S)), d === 0 && (_ = !0)
          _ && ((d = 1), (m = !1), (g = !1), (x = !1), (h = u + 1), (f = S)),
            u++
        }
        d === 13 && i.push(sn._createLink(r, l, s, h, o))
      }
      return i
    }
  }
  ...
  jn.INSTANCE = new jn()
  const ti = Object.freeze(function (e, t) {
  ...
  ;(function (e) {
    function t(n) {
      return n === e.None || n === e.Cancelled || n instanceof on
        ? !0
        : !n || typeof n != 'object'
        ? !1
    ...
    ;(e.isCancellationToken = t),
      (e.None = Object.freeze({
        ...
        onCancellationRequested: Nn.None,
      })),
      (e.Cancelled = Object.freeze({
        isCancellationRequested: !0,
        onCancellationRequested: ti,
      }))
  })(an || (an = {}))
  class on {
    constructor() {
  ...
  ;(function () {
    const e = '',
      ...
      r = []
    for (const i of t) {
      const [s, a, l, o, u, h, f, d, m] = i
      if (
        (r[a] || ((r[a] = !0), (El[l] = a), (Cl[l.toLowerCase()] = a)), !n[o])
      ) {
        if (((n[o] = !0), !u))
          throw new Error(
            `String representation missing for key code ${o} around scan code ${l}`,
          )
        ln.define(o, u), Hn.define(o, d || u), zn.define(o, m || d || u)
      }
      h && (Ml[h] = o)
    }
  })()
  ...
  ;(function (e) {
    ...
    function s(l) {
      return Hn.strToKeyCode(l) || zn.strToKeyCode(l)
    }
  ...
  ;(Ft.CtrlCmd = 2048), (Ft.Shift = 1024), (Ft.Alt = 512), (Ft.WinCtrl = 256)
  function Ol() {
    return {
      editor: void 0,
      languages: void 0,
  ...
  class Bl {
    ...
    set(t, n, r = 0) {
      ...
      if (i) (i.value = n), r !== 0 && this.touch(i, r)
        ...
        switch (
          ((i = { key: t, value: n, next: void 0, previous: void 0 }), r)
        ) {
          case 0:
            this.addItemLast(i)
            break
    ...
    forEach(t, n) {
      ...
      for (; i; ) {
        if (
          (n ? t.bind(n)(i.value, i.key, this) : t(i.value, i.key, this),
          this._state !== r)
        )
  ...
  function Hl(e, t, n, r, i) {
    return jl(e, t, n, r, i) && Wl(e, t, n, r, i)
  }
  class zl {
    constructor(t, n) {
    ...
    next(t) {
      ...
      do {
        ...
        if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            Fo(t, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Hl(this._wordSeparators, t, n, i, s))
        )
          return r
      } while (r)
      return null
  ...
  function Gl(e, t = 'Unreachable') {
    throw new Error(t)
  }
  function un(e) {
    if (!e()) {
      debugger
      e(), Re(new Me('Assertion Failed'))
    }
  }
  function ls(e, t) {
    let n = 0
  ...
  class Jl {
    static computeUnicodeHighlights(t, n, r) {
      ...
      l === 'allNonBasicAscii'
        ? (o = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
        : (o = new RegExp(`${Xl(Array.from(l))}`, 'g'))
      const u = new zl(null, o),
        h = []
      let f = !1,
        d,
        m = 0,
        g = 0,
        p = 0
      e: for (let x = i, _ = s; x <= _; x++) {
        const S = t.getLineContent(x),
          b = S.length
        u.reset(0)
        do
          if (((d = u.next(S)), d)) {
            let w = d.index,
              v = d.index + d[0].length
            if (w > 0) {
              const P = S.charCodeAt(w - 1)
              In(P) && w--
            }
            if (v + 1 < b) {
              const P = S.charCodeAt(v - 1)
              In(P) && v++
            }
            const L = S.substring(w, v)
            let R = $n(w + 1, Yr, S, 0)
            R && R.endColumn <= w + 1 && (R = null)
            const C = a.shouldHighlightNonBasicASCII(L, R ? R.word : null)
            if (C !== 0) {
              C === 3 ? m++ : C === 2 ? g++ : C === 1 ? p++ : Gl()
              const P = 1e3
              if (h.length >= P) {
                f = !0
                break e
              }
              h.push(new X(x, w + 1, x, v + 1))
            }
          }
        while (d)
      }
          ...
          const s = t.codePointAt(0),
            ...
            l = nt
              ...
              .filter(
                (o) =>
                  !nt
                    .getInstance(new Set([...n.allowedLocales, o]))
                    .isAmbiguous(s),
              )
          return {
            kind: 0,
  ...
  function Xl(e, t) {
    return `[${Mo(e.map((r) => String.fromCodePoint(r)).join(''))}]`
  }
  class us {
    constructor(t) {
      ;(this.options = t),
        (this.allowedCodePoints = new Set(t.allowedCodePoints)),
        (this.ambiguousCharacters = nt.getInstance(new Set(t.allowedLocales)))
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return 'allNonBasicAscii'
      const t = new Set()
      if (this.options.invisibleCharacters)
        for (const n of qe.codePoints) cs(String.fromCodePoint(n)) || t.add(n)
...
` ||
  ...
  class q {
    static addRange(t, n) {
      ...
      if (r === i) n.splice(r, 0, t)
        ...
        const s = Math.min(t.start, n[r].start),
          a = Math.max(t.endExclusive, n[i - 1].endExclusive)
        n.splice(r, i - r, new q(s, a))
      }
    }
    static tryCreate(t, n) {
      if (!(t > n)) return new q(t, n)
    }
    static ofLength(t) {
      return new q(0, t)
    }
  ...
  function Vt(e, t, n = 0, r = e.length) {
    let i = n,
      s = r
    for (; i < s; ) {
  ...
  function Zn(e, t, n = 0, r = e.length) {
    let i = n,
      s = r
    for (; i < s; ) {
      const a = Math.floor((i + s) / 2)
  ...
  class B {
    ...
    static joinMany(t) {
      ...
      let n = new Te(t[0].slice())
      for (let r = 1; r < t.length; r++) n = n.getUnion(new Te(t[r].slice()))
      return n.ranges
    }
    static join(t) {
      ...
      for (let i = 1; i < t.length; i++)
        (n = Math.min(n, t[i].startLineNumber)),
          (r = Math.max(r, t[i].endLineNumberExclusive))
      return new B(n, r)
    }
    static ofLength(t, n) {
      return new B(t, t + n)
  ...
  class Te {
    ...
    addRange(t) {
      ...
      const n = Zn(
          ...
          (i) => i.endLineNumberExclusive >= t.startLineNumber,
        ),
        r =
          Vt(
            this._normalizedRanges,
    ...
    contains(t) {
      const n = yt(this._normalizedRanges, (r) => r.startLineNumber <= t)
    ...
    getUnion(t) {
      ...
      for (
        ;
        r < this._normalizedRanges.length || i < t._normalizedRanges.length;

      ) {
        let a = null
        if (
          r < this._normalizedRanges.length &&
          i < t._normalizedRanges.length
        ) {
          const l = this._normalizedRanges[r],
            o = t._normalizedRanges[i]
          l.startLineNumber < o.startLineNumber
            ? ((a = l), r++)
            : ((a = o), i++)
        } else
          r < this._normalizedRanges.length
            ? ((a = this._normalizedRanges[r]), r++)
            : ((a = t._normalizedRanges[i]), i++)
        s === null
          ? (s = a)
      ...
      return s !== null && n.push(s), new Te(n)
    }
    subtractFrom(t) {
      const n = Zn(
          this._normalizedRanges,
      ...
      if (n === r) return new Te([t])
      const i = []
      let s = t.startLineNumber
      for (let a = n; a < r; a++) {
        const l = this._normalizedRanges[a]
        l.startLineNumber > s && i.push(new B(s, l.startLineNumber)),
    ...
    getWithDelta(t) {
      return new Te(this._normalizedRanges.map((n) => n.delta(t)))
    }
  }
  class Yl {
    constructor(t, n) {
  ...
  class Ne {
    static inverse(t, n, r) {
      ...
      for (const o of t) {
        const u = new Ne(
          new B(s, o.original.startLineNumber),
          new B(a, o.modified.startLineNumber),
        )
        u.modified.isEmpty || i.push(u),
          (s = o.original.endLineNumberExclusive),
          (a = o.modified.endLineNumberExclusive)
      }
      const l = new Ne(new B(s, n + 1), new B(a, r + 1))
    ...
    static clip(t, n, r) {
      ...
      for (const s of t) {
        const a = s.original.intersect(n),
          l = s.modified.intersect(r)
        a && !a.isEmpty && l && !l.isEmpty && i.push(new Ne(a, l))
      }
      return i
    }
    constructor(t, n) {
  ...
  class De extends Ne {
    static fromRangeMappings(t) {
      const n = B.join(t.map((i) => B.fromRangeInclusive(i.originalRange))),
        r = B.join(t.map((i) => B.fromRangeInclusive(i.modifiedRange)))
      return new De(n, r, t)
    }
    constructor(t, n, r) {
    ...
    withInnerChangesFromLineRanges() {
      return new De(this.original, this.modified, [this.toRangeMapping()])
    }
  }
  class Je {
    constructor(t, n) {
    ...
    toTextEdit(t) {
      ...
      return new Yl(this.originalRange, n)
    }
  }
  const Kl = 3
  class eu {
    computeDiff(t, n, r) {
      ...
      for (const u of a.changes) {
        ...
        u.originalEndLineNumber === 0
          ...
          : (h = new B(u.originalStartLineNumber, u.originalEndLineNumber + 1))
        let f
        u.modifiedEndLineNumber === 0
          ...
          : (f = new B(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1))
        let d = new De(
          h,
          f,
        ...
        o &&
          (o.modified.endLineNumberExclusive === d.modified.startLineNumber ||
            o.original.endLineNumberExclusive === d.original.startLineNumber) &&
          ((d = new De(
            o.original.join(d.original),
            o.modified.join(d.modified),
            o.innerChanges && d.innerChanges
              ? o.innerChanges.concat(d.innerChanges)
              : void 0,
          )),
          l.pop()),
          l.push(d),
      ...
      return (
        ...
        new cn(l, [], a.quitEarly)
      )
    }
  }
  function fs(e, t, n, r) {
    return new je(e, t, n).ComputeDiff(r)
  }
  let hs = class {
    constructor(t) {
      const n = [],
    ...
    createCharSequence(t, n, r) {
      ...
      for (let o = n; o <= r; o++) {
        const u = this.lines[o],
          h = t ? this._startColumns[o] : 1,
          f = t ? this._endColumns[o] : u.length + 1
        for (let d = h; d < f; d++)
  ...
  class _t {
    ...
    static createFromDiffChange(t, n, r) {
      const i = n.getStartLineNumber(t.originalStart),
        ...
        o = r.getStartLineNumber(t.modifiedStart),
  ...
  class Ot {
    ...
    static createFromDiffResult(t, n, r, i, s, a, l) {
      ...
      if (
        (n.originalLength === 0
          ? ((o = r.getStartLineNumber(n.originalStart) - 1), (u = 0))
          : ((o = r.getStartLineNumber(n.originalStart)),
  ...
  class ru {
    constructor(t, n, r) {
      ;(this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.original = new hs(t)),
        (this.modified = new hs(n)),
        (this.continueLineDiff = ds(r.maxComputationTime)),
        (this.continueCharDiff = ds(
          ...
          if (d !== m) {
            {
              let g = Yn(d, 1),
                p = Yn(m, 1)
              for (; g > 1 && p > 1; ) {
                const x = d.charCodeAt(g - 2),
                  _ = m.charCodeAt(p - 2)
                if (x !== _) break
                g--, p--
              }
              ;(g > 1 || p > 1) &&
                this._pushTrimWhitespaceCharChange(i, s + 1, 1, g, a + 1, 1, p)
            }
            {
              let g = Kn(d, 1),
                p = Kn(m, 1)
              ...
              ;(g < x || p < _) &&
                this._pushTrimWhitespaceCharChange(i, s + 1, g, x, a + 1, p, _)
            }
          }
          s++, a++
        }
    ...
    _pushTrimWhitespaceCharChange(t, n, r, i, s, a, l) {
      if (this._mergeTrimWhitespaceCharChange(t, n, r, i, s, a, l)) return
      let o
      this.shouldComputeCharChanges && (o = [new _t(n, r, n, i, s, a, s, l)]),
        t.push(new Ot(n, n, s, s, o))
    }
    _mergeTrimWhitespaceCharChange(t, n, r, i, s, a, l) {
      ...
      return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0
        ...
        ? (this.shouldComputeCharChanges &&
            u.charChanges &&
            u.charChanges.push(new _t(n, r, n, i, s, a, s, l)),
          !0)
  ...
  class Oe {
    static trivial(t, n) {
      return new Oe([new Q(q.ofLength(t.length), q.ofLength(n.length))], !1)
    }
    static trivialTimedOut(t, n) {
      return new Oe([new Q(q.ofLength(t.length), q.ofLength(n.length))], !0)
    }
    constructor(t, n) {
  ...
  class Q {
    ...
    static fromOffsetPairs(t, n) {
      return new Q(new q(t.offset1, n.offset1), new q(t.offset2, n.offset2))
    }
    constructor(t, n) {
    ...
    delta(t) {
      return t === 0
        ? this
        : new Q(this.seq1Range.delta(t), this.seq2Range.delta(t))
    }
    deltaStart(t) {
      return t === 0
        ? this
        : new Q(this.seq1Range.deltaStart(t), this.seq2Range.deltaStart(t))
    }
    deltaEnd(t) {
      return t === 0
        ? this
        : new Q(this.seq1Range.deltaEnd(t), this.seq2Range.deltaEnd(t))
    }
    intersect(t) {
...
`)
      ...
      for (let a = 0; a < s; a++)
        i += Math.abs(
          ((n = this.histogram[a]) !== null && n !== void 0 ? n : 0) -
            ((r = t.histogram[a]) !== null && r !== void 0 ? r : 0),
        )
  ...
  wt.chrKeys = new Map()
  class su {
    compute(t, n, r = Bt.instance, i) {
      if (t.length === 0 || n.length === 0) return Oe.trivial(t, n)
      const s = new er(t.length, n.length),
        a = new er(t.length, n.length),
        l = new er(t.length, n.length)
      for (let g = 0; g < t.length; g++)
        for (let p = 0; p < n.length; p++) {
          if (!r.isValid()) return Oe.trivialTimedOut(t, n)
          const x = g === 0 ? 0 : s.get(g - 1, p),
            _ = p === 0 ? 0 : s.get(g, p - 1)
          let S
          t.getElement(g) === n.getElement(p)
            ? (g === 0 || p === 0 ? (S = 0) : (S = s.get(g - 1, p - 1)),
              g > 0 &&
                p > 0 &&
                a.get(g - 1, p - 1) === 3 &&
                (S += l.get(g - 1, p - 1)),
              (S += i ? i(g, p) : 1))
            : (S = -1)
          const b = Math.max(x, _, S)
          if (b === S) {
            const w = g > 0 && p > 0 ? l.get(g - 1, p - 1) : 0
            l.set(g, p, w + 1), a.set(g, p, 3)
          } else
            b === x
              ? (l.set(g, p, 0), a.set(g, p, 1))
              : b === _ && (l.set(g, p, 0), a.set(g, p, 2))
          s.set(g, p, b)
        }
      const o = []
      let u = t.length,
      ...
      function f(g, p) {
        ;(g + 1 !== u || p + 1 !== h) &&
          o.push(new Q(new q(g + 1, u), new q(p + 1, h))),
          (u = g),
          (h = p)
      }
      let d = t.length - 1,
      ...
      return f(-1, -1), o.reverse(), new Oe(o, !1)
    }
  }
  class ms {
    compute(t, n, r = Bt.instance) {
      if (t.length === 0 || n.length === 0) return Oe.trivial(t, n)
      const i = t,
        s = n
      function a(p, x) {
        for (
          ;
          p < i.length && x < s.length && i.getElement(p) === s.getElement(x);
      ...
      o.set(0, a(0, 0))
      const u = new ou()
      u.set(0, o.get(0) === 0 ? null : new gs(null, 0, 0, o.get(0)))
      let h = 0
      e: for (;;) {
        if ((l++, !r.isValid())) return Oe.trivialTimedOut(i, s)
        const p = -Math.min(l, s.length + (l % 2)),
          x = Math.min(l, i.length + (l % 2))
        for (h = p; h <= x; h += 2) {
          const _ = h === x ? -1 : o.get(h + 1),
            S = h === p ? -1 : o.get(h - 1) + 1,
            b = Math.min(Math.max(_, S), i.length),
            w = b - h
          if (b > i.length || w > s.length) continue
          const v = a(b, w)
          o.set(h, v)
          const L = b === _ ? u.get(h + 1) : u.get(h - 1)
          if (
            (u.set(h, v !== b ? new gs(L, b, w, v - b) : L),
            o.get(h) === i.length && o.get(h) - h === s.length)
          )
            break e
        }
      }
      ...
      for (;;) {
        const p = f ? f.x + f.length : 0,
          x = f ? f.y + f.length : 0
        if (
          ((p !== m || x !== g) && d.push(new Q(new q(p, m), new q(x, g))), !f)
        )
          break
        ;(m = f.x), (g = f.y), (f = f.prev)
      }
      return d.reverse(), new Oe(d, !1)
    }
  }
  class gs {
    constructor(t, n, r, i) {
...
`.charCodeAt(0),
    ...
    getBoundaryScore(t) {
      const n = bs(t > 0 ? this.elements[t - 1] : -1),
        r = bs(t < this.elements.length ? this.elements[t] : -1)
      if (n === 7 && r === 8) return 0
      if (n === 8) return 150
      let i = 0
      return (
    ...
    translateOffset(t) {
      ...
      const n = Vt(this.firstCharOffsetByLine, (r) => r <= t)
      return new Ce(
    ...
    findWordContaining(t) {
      if (t < 0 || t >= this.elements.length || !nr(this.elements[t])) return
      let n = t
      for (; n > 0 && nr(this.elements[n - 1]); ) n--
      let r = t
      for (; r < this.elements.length && nr(this.elements[r]); ) r++
      return new q(n, r)
    }
    countLinesIn(t) {
      return (
    ...
    extendToFullLines(t) {
      var n, r
      const i =
          (n = yt(this.firstCharOffsetByLine, (a) => a <= t.start)) !== null &&
          n !== void 0
            ? n
            : 0,
        s =
          (r = Zl(this.firstCharOffsetByLine, (a) => t.endExclusive <= a)) !==
            null && r !== void 0
            ? r
            : this.elements.length
      return new q(i, s)
  ...
  const lu = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
  function ps(e) {
    return lu[e]
  }
  function bs(e) {
  ...
  function uu(e, t, n, r, i, s) {
    let { moves: a, excludedChanges: l } = fu(e, t, n, s)
    if (!s.isValid()) return []
    const o = e.filter((h) => !l.has(h)),
      u = hu(o, r, i, t, n, s)
    return (
      gl(a, u),
      (a = du(a)),
...
`).length >= 15 && cu(f, (m) => m.length >= 2) >= 2
  ...
  function fu(e, t, n, r) {
    const i = [],
      s = e
        ...
        .map((o) => new wt(o.original, t, o)),
      a = new Set(
        e
          .filter((o) => o.original.isEmpty && o.modified.length >= 3)
          .map((o) => new wt(o.modified, n, o)),
      ),
      l = new Set()
    for (const o of s) {
      let u = -1,
  ...
  function hu(e, t, n, r, i, s) {
    ...
    for (const d of e)
      for (
        ...
        l.add(g, { range: new B(m, m + 3) })
      }
    const o = []
    e.sort(nn((d) => d.modified.startLineNumber, rn))
    for (const d of e) {
      let m = []
      for (
        ...
        const p = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`,
          x = new B(g, g + 3),
          _ = []
        l.forEach(p, ({ range: S }) => {
          for (const w of m)
            if (
              w.originalLineRange.endLineNumberExclusive + 1 ===
                S.endLineNumberExclusive &&
              w.modifiedLineRange.endLineNumberExclusive + 1 ===
                x.endLineNumberExclusive
            ) {
              ;(w.originalLineRange = new B(
                w.originalLineRange.startLineNumber,
                S.endLineNumberExclusive,
              )),
                (w.modifiedLineRange = new B(
          ...
          const b = { modifiedLineRange: x, originalLineRange: S }
          o.push(b), _.push(b)
        }),
          (m = _)
      }
    ...
    o.sort(pl(nn((d) => d.modifiedLineRange.length, rn)))
    const u = new Te(),
      h = new Te()
    for (const d of o) {
      const m =
        ...
        g = u.subtractFrom(d.modifiedLineRange),
        p = h.subtractFrom(d.originalLineRange).getWithDelta(m),
        x = g.getIntersection(p)
      for (const _ of x.ranges) {
        if (_.length < 3) continue
        const S = _,
          b = _.delta(-m)
        a.push(new Ne(b, S)), u.addRange(S), h.addRange(b)
      }
    }
    a.sort(nn((d) => d.original.startLineNumber, rn))
    const f = new Dt(e)
    for (let d = 0; d < a.length; d++) {
      const m = a[d],
        g = f.findLastMonotonous(
          (L) => L.original.startLineNumber <= m.original.startLineNumber,
        ),
        p = yt(
          e,
          (L) => L.modified.startLineNumber <= m.modified.startLineNumber,
        ),
        x = Math.max(
          m.original.startLineNumber - g.original.startLineNumber,
          m.modified.startLineNumber - p.modified.startLineNumber,
        ),
        _ = f.findLastMonotonous(
          (L) => L.original.startLineNumber < m.original.endLineNumberExclusive,
        ),
        S = yt(
          e,
          (L) => L.modified.startLineNumber < m.modified.endLineNumberExclusive,
        ),
        b = Math.max(
      ...
      let w
      for (w = 0; w < x; w++) {
        const L = m.original.startLineNumber - w - 1,
          R = m.modified.startLineNumber - w - 1
        if (
          L > r.length ||
          R > i.length ||
          u.contains(R) ||
      ...
      w > 0 &&
        (h.addRange(
          new B(m.original.startLineNumber - w, m.original.startLineNumber),
        ),
        u.addRange(
          new B(m.modified.startLineNumber - w, m.modified.startLineNumber),
        ))
      let v
      for (v = 0; v < b; v++) {
        const L = m.original.endLineNumberExclusive + v,
          R = m.modified.endLineNumberExclusive + v
        if (
          L > r.length ||
          R > i.length ||
          u.contains(R) ||
      ...
      v > 0 &&
        (h.addRange(
          new B(
            ...
            m.original.endLineNumberExclusive + v,
          ),
        ),
        u.addRange(
          new B(
            m.modified.endLineNumberExclusive,
            m.modified.endLineNumberExclusive + v,
          ),
        )),
        (w > 0 || v > 0) &&
          (a[d] = new Ne(
  ...
  function vs(e, t, n) {
    ...
    const i = new ms().compute(
      new fn([e], new q(0, 1), !1),
      new fn([t], new q(0, 1), !1),
      n,
    )
    let s = 0
    const a = Q.invert(i.diffs, e.length)
    for (const h of a)
    ...
    function l(h) {
      let f = 0
      for (let d = 0; d < e.length; d++) tr(h.charCodeAt(d)) || f++
      return f
    }
  ...
  function du(e) {
    ...
    e.sort(nn((n) => n.original.startLineNumber, rn))
    const t = [e[0]]
      ...
      (t = t.filter((r) => {
        const i =
            n.findLastMonotonous(
              (l) =>
                l.original.startLineNumber < r.original.endLineNumberExclusive,
            ) || new Ne(new B(1, 1), new B(1, 1)),
          s = yt(
            e,
            (l) =>
              l.modified.startLineNumber < r.modified.endLineNumberExclusive,
          )
        return i !== s
      })),
      t
  ...
  function xs(e, t, n) {
    let r = n
    return (r = ys(e, t, r)), (r = ys(e, t, r)), (r = gu(e, t, r)), r
  }
  function ys(e, t, n) {
    ...
    for (let s = 1; s < n.length; s++) {
      ...
      if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
        ...
        if ((u--, u === o)) {
          r[r.length - 1] = new Q(
            new q(a.seq1Range.start, l.seq1Range.endExclusive - o),
            new q(a.seq2Range.start, l.seq2Range.endExclusive - o),
          )
          continue
        }
        l = l.delta(-u)
    ...
    for (let s = 0; s < r.length - 1; s++) {
      ...
      if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
        ...
        if (u === o) {
          r[s + 1] = new Q(
            new q(l.seq1Range.start + o, a.seq1Range.endExclusive),
            new q(l.seq2Range.start + o, a.seq2Range.endExclusive),
          )
          continue
        }
        u > 0 && (l = l.delta(u))
  ...
  function gu(e, t, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      ...
      s.seq1Range.isEmpty
        ? (n[r] = _s(s, e, t, l, o))
        : s.seq2Range.isEmpty && (n[r] = _s(s.swap(), t, e, o, l).swap())
    }
    return n
  }
  function _s(e, t, n, r, i) {
    ...
    for (
      ;
      e.seq1Range.start - a >= r.start &&
      e.seq2Range.start - a >= i.start &&
    ...
    for (
      ;
      e.seq1Range.start + l < r.endExclusive &&
      e.seq2Range.endExclusive + l < i.endExclusive &&
    ...
    for (let h = -a; h <= l; h++) {
      const f = e.seq2Range.start + h,
        ...
        g =
          t.getBoundaryScore(m) + n.getBoundaryScore(f) + n.getBoundaryScore(d)
      g > u && ((u = g), (o = h))
    }
    return e.delta(o)
  }
  ...
  function bu(e, t, n) {
    const r = Q.invert(n, e.length),
      i = []
    let s = new me(0, 0)
    function a(o, u) {
      if (o.offset1 < s.offset1 || o.offset2 < s.offset2) return
      const h = e.findWordContaining(o.offset1),
        f = t.findWordContaining(o.offset2)
      if (!h || !f) return
      let d = new Q(h, f)
      const m = d.intersect(u)
      let g = m.seq1Range.length,
        p = m.seq2Range.length
      for (; r.length > 0; ) {
        const x = r[0]
        if (
          !(
            x.seq1Range.intersects(d.seq1Range) ||
            x.seq2Range.intersects(d.seq2Range)
          )
        )
          break
        const S = e.findWordContaining(x.seq1Range.start),
          b = t.findWordContaining(x.seq2Range.start),
          w = new Q(S, b),
          v = w.intersect(x)
        if (
          ((g += v.seq1Range.length),
          (p += v.seq2Range.length),
          (d = d.join(w)),
      ...
      g + p < ((d.seq1Range.length + d.seq2Range.length) * 2) / 3 && i.push(d),
        (s = d.getEndExclusives())
    }
    for (; r.length > 0; ) {
      const o = r.shift()
      o.seq1Range.isEmpty ||
  ...
  function xu(e, t, n) {
    ...
    do {
      ...
      for (let l = 1; l < r.length; l++) {
        let h = function (d, m) {
          const g = new q(u.seq1Range.endExclusive, o.seq1Range.start)
          return (
  ...
  function yu(e, t, n) {
    ...
    do {
      ...
      for (let o = 1; o < r.length; o++) {
        let f = function (m, g) {
          const p = new q(h.seq1Range.endExclusive, u.seq1Range.start)
          if (e.countLinesIn(p) > 5 || p.length > 500) return !1
          const _ = e.getText(p).trim()
          if (_.length > 20 || _.split(/\r\n|\r|\n/).length > 1) return !1
          const S = e.countLinesIn(m.seq1Range),
            b = m.seq1Range.length,
            w = t.countLinesIn(m.seq2Range),
            v = m.seq2Range.length,
            L = e.countLinesIn(g.seq1Range),
            R = g.seq1Range.length,
            C = t.countLinesIn(g.seq2Range),
            P = g.seq2Range.length,
            D = 2 * 40 + 50
          function N(y) {
            return Math.min(y, D)
          }
          return (
            Math.pow(
              Math.pow(N(S * 40 + b), 1.5) + Math.pow(N(w * 40 + v), 1.5),
              1.5,
            ) +
              Math.pow(
                Math.pow(N(L * 40 + R), 1.5) + Math.pow(N(C * 40 + P), 1.5),
                1.5,
              ) >
            (D ** 1.5) ** 1.5 * 1.3
          )
    ...
    return (
      ml(r, (l, o, u) => {
        ...
        const d = e.extendToFullLines(o.seq1Range),
          m = e.getText(new q(d.start, o.seq1Range.start))
        f(m) && (h = h.deltaStart(-m.length))
        const g = e.getText(new q(o.seq1Range.endExclusive, d.endExclusive))
        f(g) && (h = h.deltaEnd(g.length))
        const p = Q.fromOffsetPairs(
            l ? l.getEndExclusives() : me.zero,
            u ? u.getStarts() : me.max,
          ),
          x = h.intersect(p)
  ...
  class ws {
    ...
    getBoundaryScore(t) {
      const n = t === 0 ? 0 : Ls(this.lines[t - 1]),
        r = t === this.lines.length ? 0 : Ls(this.lines[t])
      return 1e3 - (n + r)
    }
    getText(t) {
...
`)
  ...
  class _u {
    constructor() {
      ;(this.dynamicProgrammingDiffing = new su()),
        (this.myersDiffingAlgorithm = new ms())
    }
    computeDiff(t, n, r) {
      if (t.length <= 1 && fl(t, n, (v, L) => v === L))
        return new cn([], [], !1)
      if (
        ...
        return new cn(
          [
            new De(new B(1, t.length + 1), new B(1, n.length + 1), [
              new Je(
                new X(1, 1, t.length, t[t.length - 1].length + 1),
                new X(1, 1, n.length, n[n.length - 1].length + 1),
              ),
            ]),
          ],
          [],
      ...
      const i =
          r.maxComputationTimeMs === 0
            ? Bt.instance
            : new iu(r.maxComputationTimeMs),
        s = !r.ignoreTrimWhitespace,
        a = new Map()
      function l(v) {
        let L = a.get(v)
        return L === void 0 && ((L = a.size), a.set(v, L)), L
      }
      const o = t.map((v) => l(v.trim())),
        u = n.map((v) => l(v.trim())),
        h = new ws(o, t),
        f = new ws(u, n),
        d = (() =>
          h.length + f.length < 1700
            ? this.dynamicProgrammingDiffing.compute(h, f, i, (v, L) =>
                t[v] === n[L]
                  ? n[L].length === 0
                    ? 0.1
                    : 1 + Math.log(1 + n[L].length)
                  : 0.99,
              )
            : this.myersDiffingAlgorithm.compute(h, f, i))()
      let m = d.diffs,
        g = d.hitTimeout
      ;(m = xs(h, f, m)), (m = xu(h, f, m))
      const p = [],
        x = (v) => {
          if (s)
            for (let L = 0; L < v; L++) {
              const R = _ + L,
                C = S + L
              if (t[R] !== n[C]) {
                const P = this.refineDiff(
                  t,
                  n,
                  new Q(new q(R, R + 1), new q(C, C + 1)),
                  i,
                  s,
                )
      ...
      let _ = 0,
        S = 0
      for (const v of m) {
        un(() => v.seq1Range.start - _ === v.seq2Range.start - S)
        const L = v.seq1Range.start - _
        x(L), (_ = v.seq1Range.endExclusive), (S = v.seq2Range.endExclusive)
        const R = this.refineDiff(t, n, v, i, s)
        R.hitTimeout && (g = !0)
        for (const C of R.mappings) p.push(C)
      }
      x(t.length - _)
      const b = Ns(p, t, n)
      let w = []
      return (
        r.computeMoves && (w = this.computeMoves(b, t, n, o, u, i, s)),
        un(() => {
          function v(R, C) {
            if (R.lineNumber < 1 || R.lineNumber > C.length) return !1
            const P = C[R.lineNumber - 1]
            return !(R.column < 1 || R.column > P.length + 1)
          }
          function L(R, C) {
            return !(
              R.startLineNumber < 1 ||
              R.startLineNumber > C.length + 1 ||
              R.endLineNumberExclusive < 1 ||
              R.endLineNumberExclusive > C.length + 1
            )
          }
          for (const R of b) {
            if (!R.innerChanges) return !1
            for (const C of R.innerChanges)
              if (
                !(
                  v(C.modifiedRange.getStartPosition(), n) &&
                  v(C.modifiedRange.getEndPosition(), n) &&
                  v(C.originalRange.getStartPosition(), t) &&
                  v(C.originalRange.getEndPosition(), t)
                )
              )
                return !1
            if (!L(R.modified, n) || !L(R.original, t)) return !1
          }
          return !0
        }),
        new cn(b, w, g)
    ...
    computeMoves(t, n, r, i, s, a, l) {
      return uu(t, n, r, i, s, a).map((h) => {
        const f = this.refineDiff(
          ...
          d = Ns(f.mappings, n, r, !0)
        return new Ql(h, d)
      })
    }
    refineDiff(t, n, r, i, s) {
      const a = new fn(t, r.seq1Range, s),
        l = new fn(n, r.seq2Range, s),
        o =
          a.length + l.length < 500
            ? this.dynamicProgrammingDiffing.compute(a, l, i)
            : this.myersDiffingAlgorithm.compute(a, l, i)
      let u = o.diffs
      return (
        (u = xs(a, l, u)),
        (u = bu(a, l, u)),
  ...
  function Ns(e, t, n, r = !1) {
    ...
    for (const s of hl(
      e.map((a) => wu(a, t, n)),
      (a, l) =>
        a.original.overlapOrTouch(l.original) ||
        a.modified.overlapOrTouch(l.modified),
    )) {
      const a = s[0],
        l = s[s.length - 1]
      i.push(
  ...
  const Ss = { getLegacy: () => new eu(), getDefault: () => new _u() }
  function Xe(e, t) {
  ...
  class ie {
    constructor(t, n, r, i = 1) {
      ;(this._rgbaBrand = void 0),
        ...
        (this.a = Xe(Math.max(Math.min(1, i), 0), 3))
    }
    static equals(t, n) {
  ...
  class ve {
    constructor(t, n, r, i) {
      ;(this._hslaBrand = void 0),
        ...
        (this.l = Xe(Math.max(Math.min(1, r), 0), 3)),
        (this.a = Xe(Math.max(Math.min(1, i), 0), 3))
    }
    static equals(t, n) {
    ...
    static fromRGBA(t) {
      ...
      if (f > 0) {
        switch (
          ((u = Math.min(h <= 0.5 ? f / (2 * h) : f / (2 - 2 * h), 1)), a)
        ) {
          case n:
            o = (r - i) / f + (r < i ? 6 : 0)
            break
    ...
    static toRGBA(t) {
      ...
      if (r === 0) a = l = o = i
        ...
        const u = i < 0.5 ? i * (1 + r) : i + r - i * r,
          h = 2 * i - u
        ;(a = ve._hue2rgb(h, u, n + 1 / 3)),
          (l = ve._hue2rgb(h, u, n)),
          (o = ve._hue2rgb(h, u, n - 1 / 3))
      }
      return new ie(
        Math.round(a * 255),
        Math.round(l * 255),
  ...
  class Lt {
    constructor(t, n, r, i) {
      ;(this._hsvaBrand = void 0),
        (this.h = Math.max(Math.min(360, t), 0) | 0),
        (this.s = Xe(Math.max(Math.min(1, n), 0), 3)),
        (this.v = Xe(Math.max(Math.min(1, r), 0), 3)),
        (this.a = Xe(Math.max(Math.min(1, i), 0), 3))
    }
    static equals(t, n) {
    ...
    static fromRGBA(t) {
      ...
      return (
        l === 0
          ...
          ? (u = (i - n) / l + 2)
          : (u = (n - r) / l + 4),
        new Lt(Math.round(u * 60), o, s, t.a)
      )
    }
    static toRGBA(t) {
      const { h: n, s: r, v: i, a: s } = t,
        a = i * r,
  ...
  let te = class ye {
    ...
    get hsla() {
      return this._hsla ? this._hsla : ve.fromRGBA(this.rgba)
    }
    get hsva() {
    ...
    constructor(t) {
      if (t)
        ...
        else if (t instanceof ve) (this._hsla = t), (this.rgba = ve.toRGBA(t))
        else if (t instanceof Lt) (this._hsva = t), (this.rgba = Lt.toRGBA(t))
    ...
    equals(t) {
      return (
        ...
        ve.equals(this.hsla, t.hsla) &&
        Lt.equals(this.hsva, t.hsva)
      )
    }
    getRelativeLuminance() {
      const t = ye._relativeLuminanceForComponent(this.rgba.r),
        n = ye._relativeLuminanceForComponent(this.rgba.g),
        r = ye._relativeLuminanceForComponent(this.rgba.b),
    ...
    transparent(t) {
      ...
      return new ye(new ie(n, r, i, s * t))
    }
    isTransparent() {
    ...
    toString() {
      return (
        this._toString || (this._toString = ye.Format.CSS.format(this)),
        this._toString
      )
    }
    static getLighterColor(t, n, r) {
      ...
      r = r || 0.5
      const i = t.getRelativeLuminance(),
  ...
  ;(te.white = new te(new ie(255, 255, 255, 1))),
    (te.black = new te(new ie(0, 0, 0, 1))),
    (te.red = new te(new ie(255, 0, 0, 1))),
    (te.blue = new te(new ie(0, 0, 255, 1))),
    (te.green = new te(new ie(0, 255, 0, 1))),
    (te.cyan = new te(new ie(0, 255, 255, 1))),
    (te.lightgrey = new te(new ie(211, 211, 211, 1))),
    (te.transparent = new te(new ie(0, 0, 0, 0))),
    (function (e) {
      ;(function (t) {
        ;(function (n) {
          function r(m) {
          ...
          function s(m) {
            return m.hsla.a === 1
              ? `hsl(${m.hsla.h}, ${(m.hsla.s * 100).toFixed(2)}%, ${(
                  m.hsla.l * 100
                ).toFixed(2)}%)`
          ...
          n.formatHSL = s
          function a(m) {
            return `hsla(${m.hsla.h}, ${(m.hsla.s * 100).toFixed(2)}%, ${(
              m.hsla.l * 100
            ).toFixed(2)}%, ${m.hsla.a.toFixed(2)})`
          }
          n.formatHSLA = a
          function l(m) {
          ...
          function u(m, g = !1) {
            return g && m.rgba.a === 1
              ...
              : `#${l(m.rgba.r)}${l(m.rgba.g)}${l(m.rgba.b)}${l(
                  Math.round(m.rgba.a * 255),
                )}`
          }
          n.formatHexA = u
          function h(m) {
          ...
          function f(m) {
            ...
            if (g === 7) {
              const p = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)),
                x = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)),
                _ = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6))
              return new e(new ie(p, x, _, 1))
            }
            if (g === 9) {
              const p = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)),
                x = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)),
              ...
              return new e(new ie(p, x, _, S / 255))
            }
            if (g === 4) {
              const p = d(m.charCodeAt(1)),
                x = d(m.charCodeAt(2)),
                _ = d(m.charCodeAt(3))
              return new e(new ie(16 * p + p, 16 * x + x, 16 * _ + _))
            }
            if (g === 5) {
              const p = d(m.charCodeAt(1)),
                x = d(m.charCodeAt(2)),
                ...
                S = d(m.charCodeAt(4))
              return new e(
                new ie(16 * p + p, 16 * x + x, 16 * _ + _, (16 * S + S) / 255),
              )
            }
            return null
          }
  ...
  function Lu(e, t) {
    ...
    if (n)
      return { range: e, color: rr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function ks(e, t, n) {
    if (!e || t.length !== 1) return
    const i = t[0].values(),
      s = As(i)
    return { range: e, color: rr(s[0], s[1], s[2], n ? s[3] : 1) }
  }
  function Rs(e, t, n) {
    if (!e || t.length !== 1) return
    const i = t[0].values(),
      s = As(i),
      a = new te(new ve(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1))
    return { range: e, color: rr(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) }
  }
  function qt(e, t) {
  ...
  function Eu(e, t, n) {
    ...
    if (r) {
      ...
      if (a.endColumn > a.startColumn) {
        const l = { range: a, ...Es(r[1]), shouldBeInComments: !0 }
  ...
  function Es(e) {
    ...
    return (e = e.replace(Au, '')), { text: e, hasSeparatorLine: t }
  }
  class Cu extends xl {
    get uri() {
      return this._uri
    ...
    getWordAtPosition(t, n) {
      const r = $n(t.column, Kr(n), this._lines[t.lineNumber - 1], 0)
      return r
        ? new X(t.lineNumber, r.startColumn, t.lineNumber, r.endColumn)
        : null
    }
    words(t) {
      const n = this._lines,
  ...
  class rt {
    ...
    acceptNewModel(t) {
      this._models[t.url] = new Cu(Dn.parse(t.url), t.lines, t.EOL, t.versionId)
    }
    ...
    async computeUnicodeHighlights(t, n, r) {
      ...
      return i
        ? Jl.computeUnicodeHighlights(i, n, r)
        : {
            ranges: [],
            hasMore: !1,
    ...
    async computeDiff(t, n, r, i) {
      const s = this._getModel(t),
        a = this._getModel(n)
      return !s || !a ? null : rt.computeDiff(s, a, r, i)
    }
    static computeDiff(t, n, r, i) {
      const s = i === 'advanced' ? Ss.getDefault() : Ss.getLegacy(),
        a = t.getLinesContent(),
        l = n.getLinesContent(),
        o = s.computeDiff(a, l, r),
    ...
    async computeMoreMinimalEdits(t, n, r) {
      ...
      for (let o = 1; o < n.length; o++)
        X.getEndPosition(n[l].range).equals(X.getStartPosition(n[o].range))
          ? ((n[l].range = X.fromPositions(
              X.getStartPosition(n[l].range),
              X.getEndPosition(n[o].range),
            )),
            (n[l].text += n[o].text))
          : (l++, (n[l] = n[o]))
      n.length = l + 1
      for (let { range: o, text: u, eol: h } of n) {
        if ((typeof h == 'number' && (a = h), X.isEmpty(o) && !u)) continue
        const f = i.getValueInRange(o)
        if (((u = u.replace(/\r\n|\n|\r/g, i.eol)), f === u)) continue
        if (Math.max(u.length, f.length) > rt._diffLimit) {
          s.push({ range: o, text: u })
          continue
        }
        const d = Go(f, u, r),
          m = i.offsetAt(X.lift(o).getStartPosition())
        for (const g of d) {
          const p = i.positionAt(m + g.originalStart),
            x = i.positionAt(m + g.originalStart + g.originalLength),
            _ = {
      ...
      e: for (const o of t) {
        ...
        if (u) {
          for (const h of u.words(a))
            if (
              !(h === n || !isNaN(Number(h))) &&
              (l.add(h), l.size > rt._suggestionsLimit)
            )
              break e
        }
      }
    ...
    async navigateValueSet(t, n, r, i, s) {
      ...
      return jn.INSTANCE.navigateValueSet(n, o, u, h, r)
    }
    loadForeignModule(t, n, r) {
      const a = {
        host: xo(r, (l, o) => this._host.fhr(l, o)),
        getMirrorModels: () => this._getModels(),
      }
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(a, n)),
          Promise.resolve(kn(this._foreignModule)))
   ...
   *-----------------------------------------------------------------------------*/ function sr(
    ...
    function d(b, w) {
      let v = 0,
        L = 0
      for (; v < b || !w; ) {
        let R = e.charCodeAt(r)
        if (R >= 48 && R <= 57) L = L * 16 + R - 48
        else if (R >= 65 && R <= 70) L = L * 16 + R - 65 + 10
        else if (R >= 97 && R <= 102) L = L * 16 + R - 97 + 10
        else break
        r++, v++
      }
      return v < b && (L = -1), L
    ...
    function g() {
      ...
      if (r < e.length && e.charCodeAt(r) === 46)
        if ((r++, r < e.length && Nt(e.charCodeAt(r))))
...
`
            ...
            case 117:
              const R = d(4, !0)
              R >= 0 ? (b += String.fromCharCode(R)) : (f = 4)
              break
            default:
              f = 5
          }
    ...
    function x() {
      ...
      if (ar(b)) {
        do r++, (i += String.fromCharCode(b)), (b = e.charCodeAt(r))
        while (ar(b))
        return (a = 15)
      }
      if (Ut(b))
...
`)),
      ...
      switch (b) {
        ...
        case 47:
          ...
          if (e.charCodeAt(r + 1) === 47) {
            for (r += 2; r < n && !Ut(e.charCodeAt(r)); ) r++
          ...
          if (e.charCodeAt(r + 1) === 42) {
            ...
            let L = !1
            for (; r < v; ) {
              const R = e.charCodeAt(r)
              if (R === 42 && e.charCodeAt(r + 1) === 47) {
                ;(r += 2), (L = !0)
                break
              }
              r++,
                Ut(R) &&
                  (R === 13 && e.charCodeAt(r) === 10 && r++, l++, (u = r))
            }
            return L || (r++, (f = 1)), (i = e.substring(w, r)), (a = 13)
          }
  ...
  var xe = new Array(20).fill(0).map((e, t) => ' '.repeat(t)),
    St = 200,
    Ps = {
      ' ': {
        '\n': new Array(St).fill(0).map(
          (e, t) =>
            `
` + ' '.repeat(t),
        ),
        '\r': new Array(St).fill(0).map((e, t) => '\r' + ' '.repeat(t)),
        '\r\n': new Array(St).fill(0).map(
          (e, t) =>
            `\r
` + ' '.repeat(t),
...
`,
  ...
  function Pu(e, t, n) {
    let r, i, s, a, l
    if (t) {
      for (a = t.offset, l = a + t.length, s = a; s > 0 && !Is(e, s - 1); ) s--
      let v = l
      for (; v < e.length && !Is(e, v); ) v++
      ;(i = e.substring(s, v)), (r = Iu(i, n))
    ...
    let h = 0,
      ...
      d
    n.insertSpaces
      ? (d = xe[n.tabSize || 4] ?? At(xe[1], n.tabSize || 4))
      : (d = '	')
    const m = d === '	' ? '	' : ' '
    let g = sr(i, !1),
      p = !1
    function x() {
      if (h > 1) return At(o, h) + At(d, r + f)
      const v = d.length * (r + f)
      return !u || v > Ps[m][o].length
        ? o + At(d, r + f)
        : v <= 0
        ? o
        : Ps[m][o][v]
    ...
    function _() {
      let v = g.scan()
      for (h = 0; v === 15 || v === 14; )
        v === 14 && n.keepLines ? (h += 1) : v === 14 && (h = 1), (v = g.scan())
      return (p = v === 16 || g.getTokenError() !== 0), v
    }
    const S = []
    function b(v, L, R) {
      !p &&
        (!t || (L < l && R > a)) &&
        e.substring(L, R) !== v &&
        S.push({ offset: L, length: R - L, content: v })
    }
    let w = _()
    if ((n.keepLines && h > 0 && b(At(o, h), 0, 0), w !== 17)) {
      let v = g.getTokenOffset() + s,
        L = d.length * r < 20 && n.insertSpaces ? xe[d.length * r] : At(d, r)
      b(L, s, v)
    }
    for (; w !== 17; ) {
      let v = g.getTokenOffset() + g.getTokenLength() + s,
        L = _(),
        R = '',
        C = !1
      for (; h === 0 && (L === 12 || L === 13); ) {
        ...
        b(xe[1], v, D),
          (v = g.getTokenOffset() + g.getTokenLength() + s),
          (C = L === 12),
          (R = C ? x() : ''),
          (L = _())
      }
      if (L === 2)
        w !== 1 && f--,
          (n.keepLines && h > 0) || (!n.keepLines && w !== 1)
            ? (R = x())
            : n.keepLines && (R = xe[1])
      else if (L === 4)
        w !== 3 && f--,
          (n.keepLines && h > 0) || (!n.keepLines && w !== 3)
            ? (R = x())
            : n.keepLines && (R = xe[1])
      else {
        switch (w) {
          ...
          case 1:
            f++,
              (n.keepLines && h > 0) || !n.keepLines ? (R = x()) : (R = xe[1])
            break
          case 5:
            ;(n.keepLines && h > 0) || !n.keepLines ? (R = x()) : (R = xe[1])
            break
          ...
          case 13:
            ...
            break
          case 6:
            n.keepLines && h > 0 ? (R = x()) : C || (R = xe[1])
            break
          case 10:
            n.keepLines && h > 0 ? (R = x()) : L === 6 && !C && (R = '')
            break
          case 7:
          case 8:
          case 9:
      ...
      L === 17 &&
        (n.keepLines && h > 0 ? (R = x()) : (R = n.insertFinalNewline ? o : ''))
      const P = g.getTokenOffset() + s
      b(R, v, P), (w = L)
    }
    return S
  }
...
`.indexOf(e.charAt(t)) !== -1
  ...
  function Ou(e, t, n = hn.DEFAULT) {
    ...
    const u = a(t.onObjectBegin),
      h = o(t.onObjectProperty),
      f = s(t.onObjectEnd),
      d = a(t.onArrayBegin),
      m = s(t.onArrayEnd),
      g = o(t.onLiteralValue),
      p = l(t.onSeparator),
      x = s(t.onComment),
      _ = l(t.onError),
      S = n && n.disallowComments,
    ...
    function v(y, k = [], E = []) {
      if ((_(y), k.length + E.length > 0)) {
        let T = r.getToken()
        for (; T !== 17; ) {
          if (k.indexOf(T) !== -1) {
            w()
            break
          } else if (E.indexOf(T) !== -1) break
          T = w()
        }
      }
    }
    function L(y) {
      ...
      return y ? g(k) : (h(k), i.push(k)), w(), !0
    }
    function R() {
      switch (r.getToken()) {
        case 11:
          const y = r.getTokenValue()
          let k = Number(y)
          isNaN(k) && (v(2), (k = 0)), g(k)
          break
        case 7:
    ...
    function P() {
      ...
      for (; r.getToken() !== 2 && r.getToken() !== 17; ) {
        if (r.getToken() === 5) {
          if ((y || v(4, [], []), p(','), w(), r.getToken() === 2 && b)) break
        } else y && v(6, [], [])
        C() || v(4, [], [2, 5]), (y = !0)
      }
      return f(), r.getToken() !== 2 ? v(7, [2], []) : w(), !0
    }
    function D() {
      d(), w()
      let y = !0,
      ...
      for (; r.getToken() !== 4 && r.getToken() !== 17; ) {
        if (r.getToken() === 5) {
          if ((k || v(4, [], []), p(','), w(), r.getToken() === 4 && b)) break
        } else k && v(6, [], [])
        y ? (i.push(0), (y = !1)) : i[i.length - 1]++,
          N() || v(4, [], [4, 5]),
          (k = !0)
      }
      return m(), y || i.pop(), r.getToken() !== 4 ? v(8, [4], []) : w(), !0
    }
    function N() {
      switch (r.getToken()) {
        case 3:
  ...
  function kt(e, t) {
    ...
    if (Array.isArray(e)) {
      ...
      for (n = 0; n < e.length; n++) if (!kt(e[n], t[n])) return !1
    } else {
      const i = []
      for (r in e) i.push(r)
      i.sort()
      ...
      for (n = 0; n < i.length; n++) if (!kt(e[i[n]], t[i[n]])) return !1
    }
    return !0
  }
  function le(e) {
  ...
  ;(function (e) {
    function t(r, i) {
      return (
        r === Number.MAX_VALUE && (r = mn.MAX_VALUE),
        i === Number.MAX_VALUE && (i = mn.MAX_VALUE),
        { line: r, character: i }
      )
    }
    e.create = t
  ...
  ;(function (e) {
    function t(r, i, s, a) {
      ...
      if (Z.is(r) && Z.is(i)) return { start: r, end: i }
      throw new Error(
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        ...
        ($.is(i.originSelectionRange) || A.undefined(i.originSelectionRange))
      )
    }
    e.is = n
  })(Ws || (Ws = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      const i = r
      return A.objectLiteral(i) && $.is(i.range) && ur.is(i.color)
    }
    e.is = n
  })(Hs || (Hs = {}))
  var zs
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        A.objectLiteral(i) &&
        A.string(i.label) &&
        (A.undefined(i.textEdit) || Ie.is(i)) &&
        (A.undefined(i.additionalTextEdits) ||
          A.typedArray(i.additionalTextEdits, Ie.is))
      )
    }
    e.is = n
  })(zs || (zs = {}))
  ...
  ;(function (e) {
    function t(r, i, s, a, l, o) {
      ...
      return (
        A.defined(s) && (u.startCharacter = s),
        A.defined(a) && (u.endCharacter = a),
        A.defined(l) && (u.kind = l),
        A.defined(o) && (u.collapsedText = o),
        u
      )
    }
    e.create = t
  ...
  ;(function (e) {
    ...
    function n(r) {
      let i = r
      return A.defined(i) && Rt.is(i.location) && A.string(i.message)
    }
    e.is = n
  })(cr || (cr = {}))
  var ge
  ...
  ;(function (e) {
    function t(r, i, s, a, l, o) {
      ...
      return (
        A.defined(s) && (u.severity = s),
        A.defined(a) && (u.code = a),
        A.defined(l) && (u.source = l),
        A.defined(o) && (u.relatedInformation = o),
        u
      )
    }
    e.create = t
    function n(r) {
      ...
      return (
        ...
        $.is(s.range) &&
        A.string(s.message) &&
        (A.number(s.severity) || A.undefined(s.severity)) &&
        (A.integer(s.code) || A.string(s.code) || A.undefined(s.code)) &&
        (A.undefined(s.codeDescription) ||
          A.string(
            (i = s.codeDescription) === null || i === void 0 ? void 0 : i.href,
          )) &&
        (A.string(s.source) || A.undefined(s.source)) &&
        (A.undefined(s.relatedInformation) ||
          A.typedArray(s.relatedInformation, cr.is))
      )
    }
    e.is = n
  })(Be || (Be = {}))
  ...
  ;(function (e) {
    ...
    function i(s) {
      const a = s
      return A.objectLiteral(a) && A.string(a.newText) && $.is(a.range)
    }
    e.is = i
  })(Ie || (Ie = {}))
  var fr
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        A.objectLiteral(i) &&
        A.string(i.label) &&
        (A.boolean(i.needsConfirmation) || i.needsConfirmation === void 0) &&
        (A.string(i.description) || i.description === void 0)
      )
    }
    e.is = n
  })(fr || (fr = {}))
  ...
  ;(function (e) {
    ...
    function i(s) {
      const a = s
      return Ie.is(a) && (fr.is(a.annotationId) || Et.is(a.annotationId))
    }
    e.is = i
  })(Qs || (Qs = {}))
  var hr
  ;(function (e) {
    ...
    function n(r) {
      let i = r
      return A.defined(i) && br.is(i.textDocument) && Array.isArray(i.edits)
    }
    e.is = n
  })(hr || (hr = {}))
  var dr
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        ...
        A.string(i.uri) &&
        (i.options === void 0 ||
          ((i.options.overwrite === void 0 || A.boolean(i.options.overwrite)) &&
            (i.options.ignoreIfExists === void 0 ||
              A.boolean(i.options.ignoreIfExists)))) &&
        (i.annotationId === void 0 || Et.is(i.annotationId))
      )
    }
    e.is = n
  })(dr || (dr = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        ...
        A.string(i.uri) &&
        (i.options === void 0 ||
          ((i.options.recursive === void 0 || A.boolean(i.options.recursive)) &&
      ...
      return (
        ...
        (r.documentChanges === void 0 ||
          r.documentChanges.every((i) =>
            A.string(i.kind) ? dr.is(i) || mr.is(i) || gr.is(i) : hr.is(i),
          ))
      )
    }
    e.is = t
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        A.defined(i) &&
        A.string(i.uri) &&
        (i.version === null || A.integer(i.version))
      )
    }
    e.is = n
  })(br || (br = {}))
  ...
  ;(function (e) {
    function t(n) {
      const r = n
      return A.objectLiteral(n) && st.is(r.kind) && A.string(r.value)
    }
    e.is = t
  })(Ht || (Ht = {}))
  var pe
  ...
  ;(function (e) {
    ...
    function n(r) {
      const i = r
      return i && A.string(i.newText) && $.is(i.insert) && $.is(i.replace)
    }
    e.is = n
  })(ta || (ta = {}))
  var na
  ...
  ;(function (e) {
    function t(n) {
      ...
      return (
        ...
        (Ht.is(r.contents) ||
          gn.is(r.contents) ||
          A.typedArray(r.contents, gn.is)) &&
        (n.range === void 0 || $.is(n.range))
      )
    }
    e.is = t
  })(sa || (sa = {}))
  ...
  ;(function (e) {
    function t(n, r, ...i) {
      ...
      return (
        ...
        A.defined(i) ? (s.parameters = i) : (s.parameters = []),
        s
      )
    }
    e.create = t
  ...
  ;(function (e) {
    function t(n, r, i, s, a) {
      let l = { name: n, kind: r, location: { uri: s, range: i } }
  ...
  ;(function (e) {
    function t(r, i, s, a, l, o) {
      let u = { name: r, detail: i, kind: s, range: a, selectionRange: l }
    ...
    function n(r) {
      ...
      return (
        ...
        $.is(i.range) &&
        $.is(i.selectionRange) &&
        (i.detail === void 0 || A.string(i.detail)) &&
        (i.deprecated === void 0 || A.boolean(i.deprecated)) &&
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        A.defined(i) &&
        A.typedArray(i.diagnostics, Be.is) &&
        (i.only === void 0 || A.typedArray(i.only, A.string)) &&
        (i.triggerKind === void 0 ||
          i.triggerKind === pn.Invoked ||
          i.triggerKind === pn.Automatic)
      )
    }
    e.is = n
  })(ga || (ga = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        i &&
        A.string(i.title) &&
        (i.diagnostics === void 0 || A.typedArray(i.diagnostics, Be.is)) &&
        (i.kind === void 0 || A.string(i.kind)) &&
        (i.edit !== void 0 || i.command !== void 0) &&
        (i.command === void 0 || Mt.is(i.command)) &&
        (i.isPreferred === void 0 || A.boolean(i.isPreferred)) &&
        (i.edit === void 0 || pr.is(i.edit))
      )
    }
    e.is = n
  })(pa || (pa = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        A.defined(i) &&
        $.is(i.range) &&
        (A.undefined(i.command) || Mt.is(i.command))
      )
    }
    e.is = n
  })(ba || (ba = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      const i = r
      return i != null && $.is(i.range) && A.string(i.text)
    }
    e.is = n
  })(La || (La = {}))
  var Na
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        i != null &&
        $.is(i.range) &&
        A.boolean(i.caseSensitiveLookup) &&
        (A.string(i.variableName) || i.variableName === void 0)
      )
    }
    e.is = n
  })(Na || (Na = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        i != null &&
        $.is(i.range) &&
        (A.string(i.expression) || i.expression === void 0)
      )
    }
    e.is = n
  })(Sa || (Sa = {}))
  ...
  ;(function (e) {
    ...
    function n(r) {
      const i = r
      return A.defined(i) && $.is(r.stoppedLocation)
    }
    e.is = n
  })(Aa || (Aa = {}))
  var xr
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        A.objectLiteral(i) &&
        (i.tooltip === void 0 || A.string(i.tooltip) || Ht.is(i.tooltip)) &&
        (i.location === void 0 || Rt.is(i.location)) &&
        (i.command === void 0 || Mt.is(i.command))
      )
    }
    e.is = n
  ...
  ;(function (e) {
    ...
    function n(r) {
      ...
      return (
        (A.objectLiteral(i) &&
          Z.is(i.position) &&
          (A.string(i.label) || A.typedArray(i.label, yr.is)) &&
          (i.kind === void 0 || xr.is(i.kind)) &&
          i.textEdits === void 0) ||
        (A.typedArray(i.textEdits, Ie.is) &&
          (i.tooltip === void 0 || A.string(i.tooltip) || Ht.is(i.tooltip)) &&
          (i.paddingLeft === void 0 || A.boolean(i.paddingLeft)) &&
          (i.paddingRight === void 0 || A.boolean(i.paddingRight)))
      )
    }
    e.is = n
  })(ka || (ka = {}))
  ...
  ;(function (e) {
    function t(n) {
      const r = n
      return A.objectLiteral(r) && lr.is(r.uri) && A.string(r.name)
    }
    e.is = t
  })(Ia || (Ia = {}))
  var Fa
  ;(function (e) {
    ...
    function n(s) {
      ...
      return !!(
        A.defined(a) &&
        A.string(a.uri) &&
        (A.undefined(a.languageId) || A.string(a.languageId)) &&
        A.uinteger(a.lineCount) &&
        A.func(a.getText) &&
        A.func(a.positionAt) &&
        A.func(a.offsetAt)
      )
    ...
    function i(s, a) {
      ...
      for (; h < o.length && f < u.length; )
        a(o[h], u[f]) <= 0 ? (s[d++] = o[h++]) : (s[d++] = u[f++])
      for (; h < o.length; ) s[d++] = o[h++]
...
` &&
  ...
  ;(function (e) {
    ...
    function o(m) {
      return (
        t.call(m) === '[object Number]' && -2147483648 <= m && m <= 2147483647
      )
    }
    e.integer = o
    function u(m) {
      ...
      update(t, n) {
        for (let r of t)
          if (Cr.isIncremental(r)) {
            ...
            const l = Math.max(i.start.line, 0),
              o = Math.max(i.end.line, 0)
            let u = this._lineOffsets
            const h = Da(r.text, !1, s)
            if (o - l === h.length)
              for (let d = 0, m = h.length; d < m; d++) u[d + l + 1] = h[d]
            else
              h.length < 1e4
                ? u.splice(l + 1, o - l, ...h)
                : (this._lineOffsets = u =
                    u.slice(0, l + 1).concat(h, u.slice(o + 1)))
  ...
  ;(function (e) {
    function t(i, s, a, l) {
      return new Va(i, s, a, l)
    }
    e.create = t
    function n(i, s, a) {
      if (i instanceof Va) return i.update(s, a), i
      throw new Error(
    ...
    function r(i, s) {
      ...
      for (const h of l) {
        ...
        f > o && u.push(a.substring(o, f)),
          h.newText.length && u.push(h.newText),
          (o = i.offsetAt(h.range.end))
      }
  ...
  var Gu = /{([^}]+)}/g
  function Ju(e, t) {
    return Object.keys(t).length === 0 ? e : e.replace(Gu, (n, r) => t[r] ?? n)
  }
  var Xu = {
      'color-hex': {
        errorMessage: M(
  ...
  var tc = {
    ...
    nc = class ro {
      ...
      include(t) {
        return (
          (this.focusOffset === -1 || Ua(t, this.focusOffset)) &&
          t !== this.exclude
        )
      }
      newSub() {
  ...
  var ja = class {
    ...
    getNodeFromOffset(e, t = !1) {
      if (this.root) return $u(this.root, e, t)
    }
    visit(e) {
      if (this.root) {
        const t = (n) => {
          ...
          const i = n.children
          if (Array.isArray(i))
            for (let s = 0; s < i.length && r; s++) r = t(i[s])
          return r
        }
        t(this.root)
      }
    ...
    validate(e, t, n = ge.Warning, r) {
      if (this.root && t) {
        const i = new ue()
        return (
          ae(this.root, t, i, zt.instance, new qa(r ?? Wa(t))),
          i.problems.map((s) => {
            const a = $.create(
              e.positionAt(s.location.offset),
              e.positionAt(s.location.offset + s.location.length),
            )
            return Be.create(a, s.message, s.severity ?? n, s.code)
          })
        )
      }
    }
    getMatchingSchemas(e, t = -1, n) {
      if (this.root && e) {
        const r = new nc(t, n),
          i = Wa(e),
          s = new qa(i)
        return ae(this.root, e, new ue(), r, s), r.schemas
      }
      return []
    }
  }
  function Wa(e, t = ke.v2020_12) {
    let n = e.$schema
    return n ? tc[n] ?? t : t
  }
  function ae(e, t, n, r, i) {
    ...
    function a() {
      ...
      function f(b) {
        return (
          s.type === b ||
          (b === 'integer' && s.type === 'number' && s.isInteger)
        )
      }
      if (
        (Array.isArray(t.type)
          ? t.type.some(f) ||
            n.problems.push({
              ...
              message:
                t.errorMessage ||
                M('Incorrect type. Expected one of {0}.', t.type.join(', ')),
            })
          : t.type &&
            (f(t.type) ||
              n.problems.push({
                ...
                message:
                  t.errorMessage ||
                  M('Incorrect type. Expected "{0}".', t.type),
              })),
        ...
        for (const b of t.allOf) {
          const w = new ue(),
            v = r.newSub()
          ae(s, be(b), w, v, i), n.merge(w), r.merge(v)
        }
      const d = be(t.not)
      if (d) {
        const b = new ue(),
        ...
        ae(s, d, b, w, i),
          b.hasProblems() ||
            n.problems.push({
              location: { offset: s.offset, length: s.length },
              message:
                t.errorMessage || M('Matches a schema that is not allowed.'),
            })
        for (const v of w.schemas) (v.inverted = !v.inverted), r.add(v)
      }
      const m = (b, w) => {
        const v = []
        let L
        for (const R of b) {
          const C = be(R),
            P = new ue(),
            D = r.newSub()
          if ((ae(s, C, P, D, i), P.hasProblems() || v.push(C), !L))
            L = { schema: C, validationResult: P, matchingSchemas: D }
          else if (!w && !P.hasProblems() && !L.validationResult.hasProblems())
            L.matchingSchemas.merge(D),
              (L.validationResult.propertiesMatches += P.propertiesMatches),
              (L.validationResult.propertiesValueMatches +=
                P.propertiesValueMatches),
              L.validationResult.mergeProcessedProperties(P)
          else {
            const N = P.compare(L.validationResult)
            N > 0
              ? (L = { schema: C, validationResult: P, matchingSchemas: D })
              : N === 0 &&
                (L.matchingSchemas.merge(D),
                L.validationResult.mergeEnumValues(P))
          }
        }
        return (
          v.length > 1 &&
      ...
      if ((x && p(x, be(t.then), be(t.else)), Array.isArray(t.enum))) {
        ...
        ;(n.enumValues = t.enum),
          ...
          w ||
            n.problems.push({
              location: { offset: s.offset, length: s.length },
              code: U.EnumValueMismatch,
              message:
                t.errorMessage ||
                M(
                  'Value is not accepted. Valid values: {0}.',
                  t.enum.map((v) => JSON.stringify(v)).join(', '),
                ),
            })
      }
      if (Se(t.const)) {
        ...
        kt(b, t.const)
          ...
          : (n.problems.push({
              ...
              message:
                t.errorMessage ||
                M('Value must be {0}.', JSON.stringify(t.const)),
            }),
            (n.enumValueMatch = !1)),
      ...
      if (_ || t.deprecated) {
        _ = _ || M('Value is deprecated')
        let b =
          ((S = s.parent) == null ? void 0 : S.type) === 'property'
            ? s.parent
            : s
        n.problems.push({
    ...
    function l(f) {
      ...
      function m(w) {
        var L
        const v = /^(-?\d+)(?:\.(\d+))?(?:e([-+]\d+))?$/.exec(w.toString())
        return (
          v && {
            value: Number(v[1] + (v[2] || '')),
            multiplier:
              (((L = v[2]) == null ? void 0 : L.length) || 0) -
              (parseInt(v[3]) || 0),
          }
        )
      }
      if (le(t.multipleOf)) {
        let w = -1
        if (Number.isInteger(t.multipleOf)) w = d % t.multipleOf
        else {
          let v = m(t.multipleOf),
            L = m(d)
          if (v && L) {
            const R = 10 ** Math.abs(L.multiplier - v.multiplier)
            L.multiplier < v.multiplier ? (L.value *= R) : (v.value *= R),
              (w = L.value % v.value)
          }
        }
        w !== 0 &&
      ...
      le(x) &&
        ...
        n.problems.push({
          location: { offset: f.offset, length: f.length },
          message: M('Value is below the exclusive minimum of {0}.', x),
        })
      ...
      le(_) &&
        ...
        n.problems.push({
          location: { offset: f.offset, length: f.length },
          message: M('Value is above the exclusive maximum of {0}.', _),
        })
      ...
      le(S) &&
        ...
        n.problems.push({
          location: { offset: f.offset, length: f.length },
          message: M('Value is below the minimum of {0}.', S),
        })
    ...
    function o(f) {
      if (
        ...
        const d = dn(t.pattern)
        ;(d != null && d.test(f.value)) ||
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message:
              t.patternErrorMessage ||
              t.errorMessage ||
              M('String does not match the pattern of "{0}".', t.pattern),
          })
      }
      if (t.format)
        switch (t.format) {
          ...
          case 'uri-reference':
            {
              ...
              if (!f.value) m = M('URI expected.')
                ...
                g
                  ? !g[2] &&
                    t.format === 'uri' &&
                    (m = M('URI with a scheme is expected.'))
                  : (m = M('URI is expected.'))
              }
              m &&
                n.problems.push({
    ...
    function u(f) {
      let d, m
      i.schemaDraft >= ke.v2020_12
        ? ((d = t.prefixItems), (m = Array.isArray(t.items) ? void 0 : t.items))
        : ((d = Array.isArray(t.items) ? t.items : void 0),
          (m = Array.isArray(t.items) ? t.additionalItems : t.items))
      let g = 0
      if (d !== void 0) {
        ...
        for (; g < _; g++) {
          const S = d[g],
            ...
            w = new ue(),
            v = f.items[g]
          v && (ae(v, b, w, r, i), n.mergePropertyMatch(w)),
            n.processedProperties.add(String(g))
        }
      }
      if (m !== void 0 && g < f.items.length)
        if (typeof m == 'boolean')
          ...
          for (; g < f.items.length; g++) {
            const _ = new ue()
            ae(f.items[g], m, _, r, i),
              n.mergePropertyMatch(_),
              n.processedProperties.add(String(g))
          }
      ...
      if (p) {
        ...
        for (let S = 0; S < f.items.length; S++) {
          const b = f.items[S],
            w = new ue()
          ae(b, p, w, zt.instance, i),
            w.hasProblems() ||
              (_++,
              i.schemaDraft >= ke.v2020_12 &&
                n.processedProperties.add(String(S)))
        }
        _ === 0 &&
          !le(t.minContains) &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message:
              t.errorMessage || M('Array does not contain required item.'),
          }),
          le(t.minContains) &&
            _ < t.minContains &&
            n.problems.push({
      ...
      if (x !== void 0)
        for (let _ = 0; _ < f.items.length; _++) {
          if (!n.processedProperties.has(String(_)))
            if (x === !1)
              ...
              const S = new ue()
              ae(f.items[_], t.unevaluatedItems, S, r, i),
      ...
      if (
        ...
        let _ = function () {
          for (let b = 0; b < S.length - 1; b++) {
            const w = S[b]
            for (let v = b + 1; v < S.length; v++) if (kt(w, S[v])) return !0
          }
          return !1
        }
        const S = ot(f)
    ...
    function h(f) {
        ...
        for (const b of t.required)
          if (!d[b]) {
            const w =
              ...
              v = w
                ? { offset: w.offset, length: w.length }
      ...
      if (t.properties)
        for (const b of Object.keys(t.properties)) {
          g(b)
          const w = t.properties[b],
            v = d[b]
          if (v)
            if (Pe(w))
              if (w) n.propertiesMatches++, n.propertiesValueMatches++
              else {
                const L = v.parent
                n.problems.push({
                  location: {
                  ...
                  message:
                    t.errorMessage || M('Property {0} is not allowed.', b),
                })
              }
            else {
              const L = new ue()
              ae(v, w, L, r, i), n.mergePropertyMatch(L)
            }
        }
                  ...
                  if (Pe(C))
                    if (C) n.propertiesMatches++, n.propertiesValueMatches++
                      ...
                      n.problems.push({
                        ...
                        message:
                          t.errorMessage ||
                          M('Property {0} is not allowed.', L),
                      })
                    }
                  else {
                    const P = new ue()
                    ae(R, C, P, r, i), n.mergePropertyMatch(P)
                  }
                }
              }
            v.forEach(g)
          ...
          if (w) {
            if (p === !1) {
              ...
              n.problems.push({
                ...
                message: t.errorMessage || M('Property {0} is not allowed.', b),
              })
            } else if (p !== !0) {
              const v = new ue()
              ae(w, p, v, r, i), n.mergePropertyMatch(v)
            }
          }
        }
            ...
            if (v) {
              if (x === !1) {
                ...
                n.problems.push({
                  ...
                  message:
                    t.errorMessage || M('Property {0} is not allowed.', w),
                })
              } else if (x !== !0) {
                const L = new ue()
                ae(v, x, L, r, i), n.mergePropertyMatch(L)
              }
            }
          }
        b.forEach(g)
      ...
      if (
        ...
        for (const b in t.dependentRequired) {
          const w = d[b],
            v = t.dependentRequired[b]
          w && Array.isArray(v) && S(b, v)
        }
      if (t.dependentSchemas)
        for (const b in t.dependentSchemas) {
          const w = d[b],
            v = t.dependentSchemas[b]
          w && Qe(v) && S(b, v)
        }
      if (t.dependencies)
        for (const b in t.dependencies) d[b] && S(b, t.dependencies[b])
      const _ = be(t.propertyNames)
      if (_)
        for (const b of f.properties) {
          const w = b.keyNode
          w && ae(w, _, n, zt.instance, i)
        }
      function S(b, w) {
        if (Array.isArray(w))
          for (const v of w)
          ...
          if (v) {
            const L = new ue()
            ae(f, v, L, r, i), n.mergePropertyMatch(L)
          }
        }
      }
    }
  ...
  function ic(e, t) {
    ...
    function o(L, R, C, P, D = ge.Error) {
      if (n.length === 0 || C !== r) {
        const N = $.create(e.positionAt(C), e.positionAt(P))
        n.push(Be.create(N, L, D, R, e.languageId)), (r = C)
      }
    }
    function u(L, R, C = void 0, P = [], D = []) {
      let N = s.getTokenOffset(),
        y = s.getTokenOffset() + s.getTokenLength()
      if (N === y && N > 0) {
        for (N--; N > 0 && /\s/.test(i.charAt(N)); ) N--
        y = N + 1
      }
      if ((o(L, R, N, y), C && f(C, !1), P.length + D.length > 0)) {
        let k = s.getToken()
        for (; k !== 17; ) {
          if (P.indexOf(k) !== -1) {
            l()
    ...
    function h() {
      switch (s.getTokenError()) {
        case 4:
          return (
            u(M('Invalid unicode sequence in string.'), U.InvalidUnicode), !0
          )
        case 5:
          return (
            u(
              M('Invalid escape character in string.'),
              U.InvalidEscapeCharacter,
            ),
            !0
          )
        case 3:
          return u(M('Unexpected end of number.'), U.UnexpectedEndOfNumber), !0
        case 1:
          return (
            u(M('Unexpected end of comment.'), U.UnexpectedEndOfComment), !0
          )
        case 2:
          return u(M('Unexpected end of string.'), U.UnexpectedEndOfString), !0
        case 6:
          return (
            u(
              M(
    ...
    function f(L, R) {
      return (
        (L.length = s.getTokenOffset() + s.getTokenLength() - L.offset),
        R && l(),
        L
      )
    }
    function d(L) {
      ...
      const R = new Zu(L, s.getTokenOffset())
      l()
      let C = !1
      for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
        if (s.getToken() === 5) {
          C || u(M('Value expected'), U.ValueExpected)
          const D = s.getTokenOffset()
          if ((l(), s.getToken() === 4)) {
            C && o(M('Trailing comma'), U.TrailingComma, D, D + 1)
            continue
          }
        } else C && u(M('Expected comma'), U.CommaExpected)
        const P = b(R)
        P
          ? R.items.push(P)
          : u(M('Value expected'), U.ValueExpected, void 0, [], [4, 5]),
          (C = !0)
      }
      return s.getToken() !== 4
        ? u(
            M('Expected comma or closing bracket'),
            U.CommaOrCloseBacketExpected,
            R,
          )
        : f(R, !0)
    }
    const m = new Lr(void 0, 0, 0)
    function g(L, R) {
      const C = new Ku(L, s.getTokenOffset(), m)
      let P = x(C)
      if (!P)
        if (s.getToken() === 16) {
          u(
            M('Property keys must be doublequoted'),
            U.PropertyKeysMustBeDoublequoted,
          )
          const N = new Lr(C, s.getTokenOffset(), s.getTokenLength())
          ;(N.value = s.getTokenValue()), (P = N), l()
        } else return
      if (((C.keyNode = P), P.value !== '//')) {
        const N = R[P.value]
        N
          ? (o(
      ...
      if (s.getToken() === 6) (C.colonOffset = s.getTokenOffset()), l()
      else if (
        (u(M('Colon expected'), U.ColonExpected),
        s.getToken() === 10 &&
          e.positionAt(P.offset + P.length).line <
            e.positionAt(s.getTokenOffset()).line)
      )
        return (C.length = P.length), C
      const D = b(C)
      return D
        ? ((C.valueNode = D), (C.length = D.offset + D.length - C.offset), C)
        : u(M('Value expected'), U.ValueExpected, C, [], [2, 5])
    }
    function p(L) {
      if (s.getToken() !== 1) return
      const R = new ec(L, s.getTokenOffset()),
        C = Object.create(null)
      l()
      let P = !1
      for (; s.getToken() !== 2 && s.getToken() !== 17; ) {
        if (s.getToken() === 5) {
          P || u(M('Property expected'), U.PropertyExpected)
          const N = s.getTokenOffset()
          if ((l(), s.getToken() === 2)) {
            P && o(M('Trailing comma'), U.TrailingComma, N, N + 1)
            continue
          }
        } else P && u(M('Expected comma'), U.CommaExpected)
        const D = g(R, C)
        D
          ? R.properties.push(D)
          : u(M('Property expected'), U.PropertyExpected, void 0, [], [2, 5]),
          (P = !0)
      }
      return s.getToken() !== 2
        ? u(
            M('Expected comma or closing brace'),
            U.CommaOrCloseBraceExpected,
            R,
          )
        : f(R, !0)
    }
    function x(L) {
      ...
      const R = new Lr(L, s.getTokenOffset())
      return (R.value = s.getTokenValue()), f(R, !0)
    }
    function _(L) {
      if (s.getToken() !== 11) return
      const R = new Yu(L, s.getTokenOffset())
      if (s.getTokenError() === 0) {
        const C = s.getTokenValue()
        try {
          const P = JSON.parse(C)
          if (!le(P)) return u(M('Invalid number format.'), U.Undefined, R)
          R.value = P
        } catch {
          return u(M('Invalid number format.'), U.Undefined, R)
        }
        R.isInteger = C.indexOf('.') === -1
      }
      return f(R, !0)
    }
    function S(L) {
      switch (s.getToken()) {
        case 7:
          return f(new Qu(L, s.getTokenOffset()), !0)
        case 8:
          return f(new Ba(L, !0, s.getTokenOffset()), !0)
        case 9:
          return f(new Ba(L, !1, s.getTokenOffset()), !0)
        default:
          return
      }
    }
    function b(L) {
      return d(L) || p(L) || x(L) || _(L) || S(L)
    }
    let w
    return (
      l() !== 17 &&
        ((w = b(w)),
        w
          ? s.getToken() !== 17 && u(M('End of file expected.'), U.Undefined)
          : u(M('Expected a JSON object, array or literal.'), U.Undefined)),
      new ja(w, n, a)
    )
  }
  function Sr(e, t, n) {
...
`
        for (let a = 0; a < i.length; a++) {
          const l = i[a]
          ;(s += r + JSON.stringify(l) + ': ' + Sr(e[l], r, n)),
            a < i.length - 1 && (s += ','),
            (s += `
`)
        }
  ...
  var sc = class {
      ...
      doComplete(e, t, n) {
        ...
        if (
          ...
          let f = s - l.length
          f > 0 && i[f - 1] === '"' && f--, (o = $.create(e.positionAt(f), t))
        }
        const u = new Map(),
          h = {
            add: (f) => {
              ...
              const m = u.get(d)
              if (m)
                m.documentation || (m.documentation = f.documentation),
                  m.detail || (m.detail = f.detail),
                  m.labelDetails || (m.labelDetails = f.labelDetails)
              else {
                if (((d = d.replace(/[\n]/g, '↵')), d.length > 60)) {
                  const g = d.substr(0, 57).trim() + '...'
                  u.has(g) || (d = g)
                }
                ;(f.textEdit = Ie.replace(o, f.insertText)),
                  (f.label = d),
                  u.set(d, f),
                  r.items.push(f)
              }
        ...
        return this.schemaService.getSchemaForResource(e.uri, n).then((f) => {
          ...
          if (a && a.type === 'string') {
            ...
            _ &&
              ...
              ((m = !_.valueNode),
              (p = _),
              (g = i.substr(a.offset + 1, a.length - 2)),
              _ && (a = _.parent))
          }
          if (a && a.type === 'object') {
            if (a.offset === s) return r
            a.properties.forEach((w) => {
              ;(!p || p !== w) && u.set(w.keyNode.value, vr.create('__'))
            })
            let S = ''
            m && (S = this.evaluateSeparatorAfter(e, e.offsetAt(o.end))),
              f
                ? this.getPropertyCompletions(f, n, a, m, S, h)
                : this.getSchemaLessPropertyCompletions(n, a, g, h)
            const b = Nr(a)
            this.contributions.forEach((w) => {
              const v = w.collectPropertyCompletions(
                e.uri,
                b,
                l,
                m,
          ...
          return (
            f
              ? this.getValueCompletions(f, n, a, s, e, h, x)
              : this.getSchemaLessValueCompletions(n, a, s, e, h),
            this.contributions.length > 0 &&
              this.getContributedValueCompletions(n, a, s, e, h, d),
            this.promiseConstructor.all(d).then(() => {
              if (h.getNumberOfProposals() === 0) {
                ...
                a &&
                  (a.type === 'string' ||
                    ...
                    a.type === 'null') &&
                  (_ = a.offset + a.length)
                const S = this.evaluateSeparatorAfter(e, _)
                this.addFillerValueCompletions(x, S, h)
              }
              return r
            })
          )
              ...
              Object.keys(o).forEach((h) => {
                ...
                if (
                  ...
                  const d = {
                    ...
                    documentation:
                      this.fromMarkup(f.markdownDescription) ||
                      f.description ||
                      '',
                  }
                  f.suggestSortText !== void 0 &&
                    (d.sortText = f.suggestSortText),
                    d.insertText &&
                      jt(d.insertText, `$1${i}`) &&
                      (d.command = {
                        title: 'Suggest',
            ...
            if (
              ...
              if (u.enum)
                for (let f = 0; f < u.enum.length; f++) {
                  ...
                  f < u.markdownEnumDescriptions.length
                    ? (d = this.fromMarkup(u.markdownEnumDescriptions[f]))
                    : u.enumDescriptions &&
                      f < u.enumDescriptions.length &&
                      (d = u.enumDescriptions[f]),
                    h(u.enum[f], d)
                }
              u.const && h(u.const)
            }
      ...
      getSchemaLessValueCompletions(e, t, n, r, i) {
        ...
        const a = this.evaluateSeparatorAfter(r, s),
          l = (o) => {
            o.parent &&
              !Ua(o.parent, n, !0) &&
              i.add({
              ...
              o.type === 'boolean' &&
                this.addBooleanValueCompletion(!o.value, a, i)
          }
      ...
      getValueCompletions(e, t, n, r, i, s, a) {
        ...
        if (n && (o !== void 0 || n.type === 'array')) {
          const h = this.evaluateSeparatorAfter(i, l),
            f = t.getMatchingSchemas(e.schema, n.offset, u)
          for (const d of f)
              ...
              if (n.type === 'array' && d.schema.items) {
                ...
                if (d.schema.uniqueItems) {
                  ...
                  n.children.forEach((p) => {
                    p.type !== 'array' &&
                      p.type !== 'object' &&
                      g.add(this.getLabelForValue(ot(p)))
                  }),
                    (m = {
                      ...s,
                      add(p) {
                ...
                if (Array.isArray(d.schema.items)) {
                  ...
                  g < d.schema.items.length &&
                    this.addSchemaValueCompletions(d.schema.items[g], h, m, a)
                } else this.addSchemaValueCompletions(d.schema.items, h, m, a)
              }
              if (o !== void 0) {
                let m = !1
          ...
          o === '$schema' && !n.parent && this.addDollarSchemaCompletions(h, s),
            a.boolean &&
              (this.addBooleanValueCompletion(!0, h, s),
              this.addBooleanValueCompletion(!1, h, s)),
            a.null && this.addNullValueCompletion(h, s)
        }
      }
      getContributedValueCompletions(e, t, n, r, i, s) {
        if (!t)
          ...
          ((t.type === 'string' ||
            ...
            t.type === 'null') &&
            (t = t.parent),
          t && t.type === 'property' && n > (t.colonOffset || 0))
        ) {
          const a = t.keyNode.value,
            l = t.valueNode
      ...
      addSchemaValueCompletions(e, t, n, r) {
        typeof e == 'object' &&
          ...
          Array.isArray(e.allOf) &&
            e.allOf.forEach((i) => this.addSchemaValueCompletions(i, t, n, r)),
          Array.isArray(e.anyOf) &&
            e.anyOf.forEach((i) => this.addSchemaValueCompletions(i, t, n, r)),
          Array.isArray(e.oneOf) &&
            e.oneOf.forEach((i) => this.addSchemaValueCompletions(i, t, n, r)))
      }
      addDefaultValueCompletions(e, t, n, r = 0) {
        ...
        if (Se(e.default)) {
          ...
          this.doesSupportsLabelDetails()
            ? (l.labelDetails = { description: M('Default value') })
            : (l.detail = M('Default value')),
            n.add(l),
            (i = !0)
        }
          ...
          Array.isArray(e.defaultSnippets) &&
            e.defaultSnippets.forEach((s) => {
              ...
              if (Se(l)) {
                ...
                ;(u = this.getInsertTextForSnippetValue(l, t)),
                  (h = this.getFilterTextForSnippetValue(l)),
                  (o = o || this.getLabelForSnippetValue(l))
...
` + m,
      ...
      addDollarSchemaCompletions(e, t) {
        this.schemaService
          .getRegisteredSchemaIds((r) => r === 'http' || r === 'https')
          .forEach((r) => {
            r.startsWith('http://json-schema.org/draft-') && (r = r + '#'),
              t.add({
                kind: pe.Module,
        ...
        if (t) {
          ...
          if (
            (t.enum &&
              ...
              (l += t.enum.length)),
            Se(t.const) &&
              (a || (a = this.getInsertTextForGuessedValue(t.const, '')), l++),
            Se(t.default) &&
              (a || (a = this.getInsertTextForGuessedValue(t.default, '')),
              l++),
            Array.isArray(t.examples) &&
              t.examples.length &&
              (a || (a = this.getInsertTextForGuessedValue(t.examples[0], '')),
              (l += t.examples.length)),
            l === 0)
          ) {
            let o = Array.isArray(t.type) ? t.type[0] : t.type
            switch (
              (o || (t.properties ? (o = 'object') : t.items && (o = 'array')),
              o)
            ) {
              case 'boolean':
                a = '$1'
...
\r\v":{[,]}`.indexOf(r.charAt(n)) === -1;
        ...
        for (let s = i.length - 1; s >= 0; s--) {
          ...
          if (n > a.offset + a.length)
            return (
              ...
              r.scan() === 5 && n >= r.getTokenOffset() + r.getTokenLength()
                ? s + 1
                : s
            )
      ...
      doesSupportMarkdown() {
        ...
        if (!Se(this.supportsMarkdown)) {
          const r =
            (n =
              (t =
                (e = this.clientCapabilities.textDocument) == null
                  ? void 0
                  : e.completion) == null
                ? void 0
          ...
          this.supportsMarkdown =
            Array.isArray(r) && r.indexOf(st.Markdown) !== -1
        }
      ...
      doesSupportsCommitCharacters() {
        var e, t, n
        return (
          Se(this.supportsCommitCharacters) ||
          ...
          if (u && i) {
            ...
            h.every((x) => {
              if (
                ...
                (d =
                  d ||
                  x.schema.markdownDescription ||
                  Ar(x.schema.description)),
                x.schema.enum)
              ) {
                const _ = x.schema.enum.indexOf(ot(i))
                x.schema.markdownEnumDescriptions
                  ? (m = x.schema.markdownEnumDescriptions[_])
                  : x.schema.enumDescriptions &&
                    (m = Ar(x.schema.enumDescriptions[_])),
                  m &&
                    ((g = x.schema.enum[_]),
...
$3`,
  ...
  var lc = class {
      ...
      configure(e) {
        e &&
          ...
          (this.commentSeverity = e.allowComments ? void 0 : ge.Error))
      }
      doValidation(e, t, n, r) {
        ...
        const i = [],
          ...
          l = (o) => {
            let u =
                n != null && n.trailingCommas ? vn(n.trailingCommas) : ge.Error,
              h =
                n != null && n.comments ? vn(n.comments) : this.commentSeverity,
              f =
                n != null && n.schemaValidation
                  ? vn(n.schemaValidation)
                  : ge.Warning,
              d =
                n != null && n.schemaRequest ? vn(n.schemaRequest) : ge.Warning
            if (o) {
              const m = (g, p) => {
                if (t.root && d) {
                  const x = t.root,
                    _ = x.type === 'object' ? x.properties[0] : void 0
                  if (_ && _.keyNode.value === '$schema') {
                    const S = _.valueNode || _,
                      b = $.create(
                        e.positionAt(S.offset),
                        e.positionAt(S.offset + S.length),
                      )
              ...
              if (o.errors.length) m(o.errors[0], U.SchemaResolveError)
              else if (f) {
                for (const p of o.warnings) m(p, U.SchemaUnsupportedFeature)
                const g = t.validate(
                  e,
                  o.schema,
                  f,
                  n == null ? void 0 : n.schemaDraft,
                )
                g && g.forEach(a)
              }
              Ha(o.schema) && (h = void 0), za(o.schema) && (u = void 0)
            }
            for (const m of t.syntaxErrors) {
              if (m.code === U.TrailingComma) {
            ...
            if (typeof h == 'number') {
              const m = M('Comments are not permitted in JSON.')
              t.comments.forEach((g) => {
                a(Be.create(g, m, h, U.CommentNotPermitted))
              })
            }
            return i
          }
        if (r) {
          const o = r.id || 'schemaservice://untitled/' + uc++
          return this.jsonSchemaService
            .registerExternalSchema({ uri: o, schema: r })
            .getResolvedSchema()
            .then((h) => l(h))
        }
        return this.jsonSchemaService
  ...
  function Ha(e) {
    if (e && typeof e == 'object') {
      if (Pe(e.allowComments)) return e.allowComments
      if (e.allOf)
  ...
  function za(e) {
    if (e && typeof e == 'object') {
      if (Pe(e.allowTrailingCommas)) return e.allowTrailingCommas
      const t = e
      if (Pe(t.allowsTrailingCommas)) return t.allowsTrailingCommas
      if (e.allOf)
  ...
  function K(e) {
    return e < Ga
      ...
      : e <= cc
      ? e - Ga
      : (e < xn && (e += xn - fc), e >= xn && e <= hc ? e - xn + 10 : 0)
  }
  function dc(e) {
    if (e[0] === '#')
      switch (e.length) {
  ...
  var mc = class {
    ...
    findDocumentSymbols(e, t, n = { resultLimit: Number.MAX_VALUE }) {
      ...
      const s = e.uri
      if (
        (s === 'vscode://defaultsettings/keybindings.json' ||
          jt(s.toLowerCase(), '/user/keybindings.json')) &&
        r.type === 'array'
      ) {
        const f = []
          ...
          if (d.type === 'object') {
            for (const m of d.properties)
              if (m.keyNode.value === 'key' && m.valueNode) {
                const g = Rt.create(e.uri, Ze(e, d))
                if (
                  (f.push({
                    name: Ja(m.valueNode),
                    kind: Fe.Function,
                  ...
                  return (
                    n && n.onResultLimitExceeded && n.onResultLimitExceeded(s),
                    f
                  )
              }
          }
      ...
      const u = [],
        h = (f, d) => {
          f.type === 'array'
            ...
            : f.type === 'object' &&
              f.properties.forEach((m) => {
                const g = m.valueNode
                if (g)
                  if (i > 0) {
                    i--
                    const p = Rt.create(e.uri, Ze(e, m)),
                      x = d ? d + '.' + m.keyNode.value : m.keyNode.value
                    u.push({
          ...
          ? f.items.forEach((m, g) => {
              if (m)
                if (i > 0) {
                  ...
                  d.push(S), l.push({ result: S.children, node: m })
                } else u = !0
            })
          : f.type === 'object' &&
            f.properties.forEach((m) => {
              ...
              if (g)
                if (i > 0) {
                  ...
                  d.push(S), l.push({ result: _, node: g })
                } else u = !0
            })
      }
      for (; o < l.length; ) {
        ...
        if (r) {
          let s =
            n && typeof n.resultLimit == 'number'
              ? n.resultLimit
              : Number.MAX_VALUE
          const a = t.getMatchingSchemas(r.schema),
            l = {}
          for (const o of a)
            if (
              !o.inverted &&
              o.schema &&
              (o.schema.format === 'color' ||
                o.schema.format === 'color-hex') &&
              o.node &&
              o.node.type === 'string'
            ) {
              const u = String(o.node.offset)
              if (!l[u]) {
                const h = dc(ot(o.node))
                if (h) {
                  const f = Ze(e, o.node)
    ...
    getColorPresentations(e, t, n, r) {
      const i = [],
        s = Math.round(n.red * 255),
        a = Math.round(n.green * 255),
      ...
      return (
        n.alpha === 1
          ? (u = `#${o(s)}${o(a)}${o(l)}`)
          : (u = `#${o(s)}${o(a)}${o(l)}${o(Math.round(n.alpha * 255))}`),
        i.push({ label: u, textEdit: Ie.replace(r, JSON.stringify(u)) }),
        i
      )
    }
  }
  function Ze(e, t) {
    return $.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length))
  }
  function Ja(e) {
    return ot(e) || M('<empty>')
  }
  ...
  for (const e in kr.schemas) {
    const t = kr.schemas[e]
  ...
  ;(() => {
    var e = {
        470: (i) => {
          ...
          var l = {
            resolve: function () {
              for (
                var o, u = '', h = !1, f = arguments.length - 1;
                f >= -1 && !h;
                f--
              ) {
                var d
                f >= 0
                  ? (d = arguments[f])
                  : (o === void 0 && (o = process.cwd()), (d = o)),
                  s(d),
                  d.length !== 0 &&
                    ((u = d + '/' + u), (h = d.charCodeAt(0) === 47))
              }
              return (
                (u = a(u, !h)),
                h ? (u.length > 0 ? '/' + u : '/') : u.length > 0 ? u : '.'
              )
            },
            ...
            relative: function (o, u) {
              if (
                (s(o),
                s(u),
                o === u || (o = l.resolve(o)) === (u = l.resolve(u)))
              )
                return ''
              for (var h = 1; h < o.length && o.charCodeAt(h) === 47; ++h);
              for (
                var f = o.length, d = f - h, m = 1;
                m < u.length && u.charCodeAt(m) === 47;
                ++m
              );
              for (
                var g = u.length - m, p = d < g ? d : g, x = -1, _ = 0;
                _ <= p;
                ++_
              ) {
                if (_ === p) {
                ...
                var S = o.charCodeAt(h + _)
                if (S !== u.charCodeAt(m + _)) break
                S === 47 && (x = _)
              }
              var b = ''
              for (_ = h + x + 1; _ <= f; ++_)
                (_ !== f && o.charCodeAt(_) !== 47) ||
                  (b.length === 0 ? (b += '..') : (b += '/..'))
              return b.length > 0
                ? b + u.slice(m + x)
                : ((m += x), u.charCodeAt(m) === 47 && ++m, u.slice(m))
            },
            ...
            basename: function (o, u) {
              ...
              if (u !== void 0 && u.length > 0 && u.length <= o.length) {
                ...
                return (
                  f === d ? (d = p) : d === -1 && (d = o.length), o.slice(f, d)
                )
              }
              for (h = o.length - 1; h >= 0; --h)
              ...
              return d === -1 ? '' : o.slice(f, d)
            },
            extname: function (o) {
              s(o)
              for (
                var u = -1, h = 0, f = -1, d = !0, m = 0, g = o.length - 1;
                g >= 0;
                --g
              ) {
            ...
            parse: function (o) {
              ...
              d ? ((u.root = '/'), (h = 1)) : (h = 0)
              for (
                var m = -1, g = 0, p = -1, x = !0, _ = o.length - 1, S = 0;
                _ >= h;
                --_
              )
                if ((f = o.charCodeAt(_)) !== 47)
                  p === -1 && ((x = !1), (p = _ + 1)),
                    f === 46
                      ? m === -1
                        ? (m = _)
              ...
              return (
                ...
                (S === 1 && m === p - 1 && m === g + 1)
                  ? p !== -1 &&
                    (u.base = u.name =
                      g === 0 && d ? o.slice(1, p) : o.slice(g, p))
                  : (g === 0 && d
                      ? ((u.name = o.slice(1, m)), (u.base = o.slice(1, p)))
                      : ((u.name = o.slice(g, m)), (u.base = o.slice(g, p))),
                    (u.ext = o.slice(m, p))),
                g > 0 ? (u.dir = o.slice(0, g - 1)) : d && (u.dir = '/'),
                u
              )
            },
            sep: '/',
    ...
    ;(() => {
      ...
      class d {
        constructor(y, k, E, T, I, F = !1) {
          ...
          typeof y == 'object'
            ...
            : ((this.scheme = (function (j, W) {
                return j || W ? j : 'file'
              })(y, F)),
              (this.authority = k || u),
              (this.path = (function (j, W) {
                switch (j) {
                  case 'https':
                  case 'http':
                  case 'file':
        ...
        static isUri(y) {
          return (
            y instanceof d ||
            (!!y &&
              typeof y.authority == 'string' &&
              typeof y.fragment == 'string' &&
              typeof y.path == 'string' &&
              typeof y.query == 'string' &&
              typeof y.scheme == 'string' &&
              typeof y.fsPath == 'string' &&
              typeof y.with == 'function' &&
              typeof y.toString == 'function')
          )
        }
        get fsPath() {
          return S(this, !1)
        ...
        with(y) {
          if (!y) return this
          let { scheme: k, authority: E, path: T, query: I, fragment: F } = y
          return (
            k === void 0 ? (k = this.scheme) : k === null && (k = u),
            E === void 0 ? (E = this.authority) : E === null && (E = u),
            T === void 0 ? (T = this.path) : T === null && (T = u),
            I === void 0 ? (I = this.query) : I === null && (I = u),
            F === void 0 ? (F = this.fragment) : F === null && (F = u),
            k === this.scheme &&
            E === this.authority &&
            T === this.path &&
            I === this.query &&
        ...
        static file(y) {
          let k = u
          if ((i && (y = y.replace(/\\/g, h)), y[0] === h && y[1] === h)) {
            const E = y.indexOf(h, 2)
            E === -1
              ? ((k = y.substring(2)), (y = h))
              : ((k = y.substring(2, E)), (y = y.substring(E) || h))
          }
          return new g('file', k, y, u, u)
        }
        static from(y) {
          const k = new g(y.scheme, y.authority, y.path, y.query, y.fragment)
          return o(k, !0), k
        }
        toString(y = !1) {
          return b(this, y)
        ...
        static revive(y) {
          if (y) {
            if (y instanceof d) return y
            {
              const k = new g(y)
              return (
                (k._formatted = y.external),
                (k._fsPath = y._sep === m ? y.fsPath : null),
                k
              )
            }
          }
      ...
      class g extends d {
        constructor() {
          super(...arguments)
          Ke(this, '_formatted', null)
          Ke(this, '_fsPath', null)
        }
        get fsPath() {
      ...
      function x(N, y, k) {
        ...
        for (let I = 0; I < N.length; I++) {
          ...
          if (
            ...
            T !== -1 &&
              ((E += encodeURIComponent(N.substring(T, I))), (T = -1)),
              E !== void 0 && (E += N.charAt(I))
          else {
            E === void 0 && (E = N.substr(0, I))
            const j = p[F]
            j !== void 0
              ? (T !== -1 &&
                  ((E += encodeURIComponent(N.substring(T, I))), (T = -1)),
        ...
        return (
          T !== -1 && (E += encodeURIComponent(N.substring(T))),
          E !== void 0 ? E : N
        )
      }
      function _(N) {
        ...
        for (let k = 0; k < N.length; k++) {
          const E = N.charCodeAt(k)
          E === 35 || E === 63
            ? (y === void 0 && (y = N.substr(0, k)), (y += p[E]))
            : y !== void 0 && (y += N[k])
        }
        return y !== void 0 ? y : N
      }
      ...
      function b(N, y) {
        const k = y ? _ : x
        let E = '',
          { scheme: T, authority: I, path: F, query: j, fragment: W } = N
        if (
          (T && ((E += T), (E += ':')),
          (I || T === 'file') && ((E += h), (E += h)),
          I)
          ...
          let J = I.indexOf('@')
          if (J !== -1) {
            const $e = I.substr(0, J)
            ;(I = I.substr(J + 1)),
              (J = $e.lastIndexOf(':')),
              J === -1
                ? (E += k($e, !1, !1))
                : ((E += k($e.substr(0, J), !1, !1)),
                  (E += ':'),
                  (E += k($e.substr(J + 1), !1, !0))),
              (E += '@')
          }
          ;(I = I.toLowerCase()),
            (J = I.lastIndexOf(':')),
            J === -1
              ? (E += k(I, !1, !0))
              : ((E += k(I.substr(0, J), !1, !0)), (E += I.substr(J)))
        }
        if (F) {
          if (
            F.length >= 3 &&
            ...
            const J = F.charCodeAt(1)
            J >= 65 &&
              J <= 90 &&
              (F = `/${String.fromCharCode(J + 32)}:${F.substr(3)}`)
          } else if (F.length >= 2 && F.charCodeAt(1) === 58) {
            const J = F.charCodeAt(0)
            J >= 65 &&
              J <= 90 &&
              (F = `${String.fromCharCode(J + 32)}:${F.substr(2)}`)
          }
          E += k(F, !0, !1)
        }
        return (
      ...
      function w(N) {
        try {
          ...
          return N.length > 3 ? N.substr(0, 3) + w(N.substr(3)) : N
        }
      }
      const v = /(%[0-9A-Za-z][0-9A-Za-z])+/g
      function L(N) {
        return N.match(v) ? N.replace(v, (y) => w(y)) : N
      }
      var R = n(470)
      const C = R.posix || R,
        P = '/'
      var D
      ;(function (N) {
        ;(N.joinPath = function (y, ...k) {
          return y.with({ path: C.join(y.path, ...k) })
        }),
          (N.resolvePath = function (y, ...k) {
            let E = y.path,
              T = !1
            E[0] !== P && ((E = P + E), (T = !0))
            let I = C.resolve(E, ...k)
            return (
              T && I[0] === P && !y.authority && (I = I.substring(1)),
              y.with({ path: I })
            )
          }),
          (N.dirname = function (y) {
            if (y.path.length === 0 || y.path === P) return y
            let k = C.dirname(y.path)
            return (
              k.length === 1 && k.charCodeAt(0) === 46 && (k = ''),
              y.with({ path: k })
            )
          }),
          (N.basename = function (y) {
            return C.basename(y.path)
          }),
          (N.extname = function (y) {
            return C.extname(y.path)
          })
      })(D || (D = {}))
    })(),
      (Xa = r)
  })()
  var { URI: Ct, Utils: Qc } = Xa
  function pc(e, t) {
    if (typeof e != 'string') throw new TypeError('Expected a string')
    const n = String(e)
    let r = ''
    const i = t ? !!t.extended : !1,
      s = t ? !!t.globstar : !1
    let a = !1
  ...
  var bc = '!',
      ...
      constructor(e, t, n) {
        ...
        try {
          for (let r of e) {
            ...
            i || (r = r.substring(1)),
              r.length > 0 &&
                (r[0] === vc && (r = r.substring(1)),
                this.globWrappers.push({
                  regexp: pc('**/' + r, { extended: !0, globstar: !0 }),
                  include: i,
                }))
          }
          t &&
    ...
    yc = class {
      constructor(e, t, n) {
        ;(this.service = e),
          ...
          (this.anchors = void 0),
          n && (this.unresolvedSchema = this.service.promise.resolve(new Gt(n)))
      }
      getUnresolvedSchema() {
        return (
    ...
    _c = class {
      ...
      onResourceChange(e) {
        ...
        e = Ye(e)
        const n = [e],
          r = Object.keys(this.schemasById).map((i) => this.schemasById[i])
        for (; n.length; ) {
          const i = n.pop()
      ...
      setSchemaContributions(e) {
        ...
        if (Array.isArray(e.schemaAssociations)) {
          ...
          for (let n of t) {
            const r = n.uris.map(Ye),
              i = this.addFilePatternAssociation(n.pattern, n.folderUri, r)
      ...
      loadSchema(e) {
        if (!this.requestService) {
          ...
          return this.promise.resolve(new Gt({}, [t]))
        }
        return (
          ...
          this.requestService(e).then(
            ...
            (t) => {
              ...
              return (
                r.length > 1 && (n = r[1]),
                jt(n, '.') && (n = n.substr(0, n.length - 1)),
                new Gt({}, [
                  M("Unable to load schema from '{0}': {1}.", Jt(e), n),
                ])
              )
            },
          )
      ...
      resolveSchemaContent(e, t) {
        ...
        if (i === 'http://json-schema.org/draft-03/schema')
          return this.promise.resolve(
            new Qa({}, [M('Draft-03 schemas are not supported.')], [], i),
          )
        let s = new Set()
        const a = this.contextService,
          l = (g, p) => {
          ...
          o = (g, p, x) => (p.anchors || (p.anchors = m(g)), p.anchors.get(x)),
          u = (g, p) => {
            for (const x in p)
          ...
          f = (g, p, x, _) => {
            a &&
              ...
              (p = a.resolveRelativePath(p, _.uri)),
              (p = Ye(p))
            const S = this.getOrAddSchemaHandle(p)
            return S.getUnresolvedSchema().then((b) => {
              if ((_.dependencies.add(p), b.errors.length)) {
                const w = x ? p + '#' + x : p
                n.push(
                  M("Problems loading reference '{0}': {1}", w, b.errors[0]),
                )
              }
              return h(g, b.schema, S, x), d(g, b.schema, S)
            })
          },
          d = (g, p, x) => {
            const _ = []
            return (
              this.traverseNodes(g, (S) => {
                const b = new Set()
                for (; S.$ref; ) {
                  const w = S.$ref,
                    v = w.split('#', 2)
                  if ((delete S.$ref, v[0].length > 0)) {
                    _.push(f(S, v[0], v[1], x))
                    return
                  } else if (!b.has(w)) {
                    const L = v[1]
                    h(S, p, x, L), b.add(w)
                ...
                S.$recursiveRef && s.add('$recursiveRef'),
                  S.$dynamicRef && s.add('$dynamicRef')
              }),
              this.promise.all(_)
            )
          },
          m = (g) => {
            const p = new Map()
            return (
              this.traverseNodes(g, (x) => {
                const _ = x.$id || x.id,
                  S = $s(_) && _.charAt(0) === '#' ? _.substring(1) : x.$anchor
                S &&
                  (p.has(S)
                    ? n.push(M("Duplicate anchor declaration: '{0}'", S))
                    : p.set(S, x)),
                  x.$recursiveAnchor && s.add('$recursiveAnchor'),
                  x.$dynamicAnchor && s.add('$dynamicAnchor')
              }),
              p
            )
          }
      ...
      traverseNodes(e, t) {
        ...
        const n = new Set(),
          r = (...u) => {
            for (const h of u) Qe(h) && l.push(h)
          },
          i = (...u) => {
            for (const h of u)
              if (Qe(h))
          ...
          s = (...u) => {
            for (const h of u)
              if (Array.isArray(h)) for (const f of h) Qe(f) && l.push(f)
          },
          a = (u) => {
            if (Array.isArray(u)) for (const h of u) Qe(h) && l.push(h)
            else Qe(u) && l.push(u)
          },
          l = [e]
        let o = l.pop()
        for (; o; )
          n.has(o) ||
            ...
            s(o.anyOf, o.allOf, o.oneOf, o.prefixItems),
            a(o.items)),
            (o = l.pop())
      }
      getSchemaFromProperty(e, t) {
        ...
        if (((n = t.root) == null ? void 0 : n.type) === 'object') {
          for (const i of t.root.properties)
            if (
              i.keyNode.value === '$schema' &&
              ((r = i.valueNode) == null ? void 0 : r.type) === 'string'
            ) {
              let s = i.valueNode.value
              return (
                this.contextService &&
                  !/^\w[\w\d+.-]*:/.test(s) &&
                  (s = this.contextService.resolveRelativePath(s, e)),
                s
              )
            }
        }
      ...
      getAssociatedSchemas(e) {
        ...
        for (const i of this.filePatternAssociations)
          if (i.matchesPattern(r))
            for (const s of i.getURIs()) t[s] || (n.push(s), (t[s] = !0))
        return n
      }
      ...
      getSchemaForResource(e, t) {
        ...
        return (
          (this.cachedSchemaForResource = { resource: e, resolvedSchema: r }), r
        )
      }
      createCombinedSchema(e, t) {
        if (t.length === 1) return this.getOrAddSchemaHandle(t[0])
        {
          const n = 'schemaservice://combinedSchema/' + encodeURIComponent(e),
            r = { allOf: t.map((i) => ({ $ref: i })) }
          return this.addSchemaHandle(n, r)
        }
      }
      getMatchingSchemas(e, t, n) {
        if (n) {
          const r = n.id || 'schemaservice://untitled/matchingSchemas/' + wc++
          return this.addSchemaHandle(r, n)
            .getResolvedSchema()
            .then((s) =>
              t.getMatchingSchemas(s.schema).filter((a) => !a.inverted),
            )
        }
        return this.getSchemaForResource(e.uri, t).then((r) =>
          r ? t.getMatchingSchemas(r.schema).filter((i) => !i.inverted) : [],
        )
      }
    },
    wc = 0
  ...
  function Za(e) {
    try {
      return Ct.parse(e).with({ fragment: null, query: null }).toString(!0)
    } catch {
      return e
    }
  }
  ...
  function Lc(e, t) {
    ...
    for (; l !== 17; ) {
      switch (l) {
        case 1:
        case 3: {
          const g = e.positionAt(a.getTokenOffset()).line,
            p = { startLine: g, endLine: g, kind: l === 1 ? 'object' : 'array' }
          i.push(p)
          break
        }
        case 2:
        case 4: {
          ...
          if (i.length > 0 && i[i.length - 1].kind === g) {
            const p = i.pop(),
              x = e.positionAt(a.getTokenOffset()).line
            p &&
              x > p.startLine + 1 &&
              s !== p.startLine &&
              ((p.endLine = x - 1), o(p), (s = p.startLine))
          }
          break
        }
        case 13: {
          ...
          a.getTokenError() === 1 && g + 1 < e.lineCount
            ? a.setPosition(e.offsetAt(Z.create(g + 1, 0)))
            : g < p &&
              (o({ startLine: g, endLine: p, kind: Wt.Comment }), (s = g))
          break
        }
        case 12: {
          const p = e
          ...
          if (p) {
            ...
            if (p[1]) {
              const _ = { startLine: x, endLine: x, kind: Wt.Region }
              i.push(_)
            } else {
              let _ = i.length - 1
              for (; _ >= 0 && i[_].kind !== Wt.Region; ) _--
              if (_ >= 0) {
                const S = i[_]
                ;(i.length = _),
                  x > S.startLine &&
                    s !== S.startLine &&
                    ((S.endLine = x), o(S), (s = S.startLine))
              }
            }
          }
          break
    ...
    function r(l) {
      ...
      for (; u; ) {
        switch (u.type) {
          ...
          case 'array':
            const d = u.offset + 1,
              m = u.offset + u.length - 1
            d < m && o >= d && o <= m && h.push(i(d, m)),
        ...
        if (u.type === 'property' || (u.parent && u.parent.type === 'array')) {
          const d = a(u.offset + u.length, 5)
          d !== -1 && h.push(i(u.offset, d))
        }
        u = u.parent
      }
      let f
      for (let d = h.length - 1; d >= 0; d--) f = bn.create(h[d], f)
      return f || (f = bn.create($.create(l, l))), f
    }
    function i(l, o) {
      return $.create(e.positionAt(l), e.positionAt(o))
    }
    const s = it(e.getText(), !0)
    function a(l, o) {
      return (
        s.setPosition(l),
        s.scan() === o ? s.getTokenOffset() + s.getTokenLength() : -1
      )
    }
    return t.map(r)
  }
...
`,
    ...
    return ju(e.getText(), r, i).map((s) =>
      Ie.replace(
        $.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)),
        s.content,
      ),
    )
  }
    ...
    addChildProperty(e) {
      if (((e.parent = this), this.childrenProperties.length > 0)) {
        ...
        e.noKeyName
          ...
          : (t = Ac(this.childrenProperties, e, Sc)),
          t < 0 && (t = t * -1 - 1),
  ...
  function kc(e, t) {
    const n = { ...t, keepLines: !1 },
      r = Ae.applyEdits(e, Rr(e, n, void 0)),
      i = Ae.create('test://test.json', 'json', 0, r),
      s = Rc(i),
      a = Mc(i, s),
      l = Rr(a, n, void 0),
      o = Ae.applyEdits(a, l)
    return [
      Ie.replace($.create(Z.create(0, 0), e.positionAt(e.getText().length)), o),
    ]
  }
  function Rc(e) {
    const t = e.getText(),
    ...
    for (; (l = n.scan()) !== 17; ) {
      ...
      if (
        (S === !0 &&
          ...
          l !== 12 &&
          l !== 13 &&
          ((g = n.getTokenStartLine()), (S = !1)),
        n.getTokenStartLine() !== o)
      ) {
        for (let b = o; b < n.getTokenStartLine(); b++) {
          const w = e.getText(
            $.create(Z.create(b, 0), Z.create(b + 1, 0)),
          ).length
          u = u + w
        }
      ...
      switch (l) {
        case 10: {
          if (
            h === void 0 ||
            h === 1 ||
            (h === 5 && x[x.length - 1] === re.Object)
          ) {
            const b = new yn(n.getTokenValue(), g)
        ...
        case 3: {
          if (
            ...
            x[x.length - 1] === re.Object)
          )
            i = s
          else if (x[x.length - 1] === re.Array) {
            const b = new yn(n.getTokenValue(), g)
        ...
        case 5: {
          ;(p = n.getTokenStartLine()),
            s.endLineNumber === void 0 &&
              (x[x.length - 1] === re.Object ||
                (x[x.length - 1] === re.Array && (h === 2 || h === 4))) &&
              ((s.endLineNumber = p),
              (s.commaIndex = n.getTokenOffset() - u),
              (s.commaLine = p)),
            (h === 2 || h === 4) &&
        ...
        case 13: {
          h === 5 &&
            ...
            ((x[x.length - 1] === re.Array && (f === 2 || f === 4)) ||
              x[x.length - 1] === re.Object) &&
            ((x[x.length - 1] === re.Array && (f === 2 || f === 4)) ||
              x[x.length - 1] === re.Object) &&
            ((s.endLineNumber = void 0), (_ = !0)),
            (h === 1 || h === 3) && d === n.getTokenStartLine() && (S = !0)
          break
        }
      }
      l !== 14 &&
        ...
        (h = l),
        (d = n.getTokenStartLine()),
        (m = n.getTokenOffset() + n.getTokenLength() - u))
    }
    return r
  }
  function Mc(e, t) {
    if (t.childrenProperties.length === 0) return e
    const n = Ae.create('test://test.json', 'json', 0, e.getText()),
      r = []
    for (Ya(r, t, t.beginningLineNumber); r.length > 0; ) {
      const i = r.shift(),
      ...
      for (let l = 0; l < s.length; l++) {
        const o = s[l],
          u = $.create(
            Z.create(o.beginningLineNumber, 0),
            Z.create(o.endLineNumber + 1, 0),
          ),
          h = e.getText(u),
          f = Ae.create('test://test.json', 'json', 0, h)
        if (o.lastProperty === !0 && l !== s.length - 1) {
          const g = o.lineWhereToAddComma - o.beginningLineNumber,
            p = o.indexWhereToAddComa,
            x = { range: $.create(Z.create(g, p), Z.create(g, p)), text: ',' }
          Ae.update(f, [x], 1)
        } else if (o.lastProperty === !1 && l === s.length - 1) {
          const g = o.commaIndex,
            x = o.commaLine - o.beginningLineNumber,
            _ = {
              range: $.create(Z.create(x, g), Z.create(x, g + 1)),
              text: '',
            }
          Ae.update(f, [_], 1)
        }
        const d = o.endLineNumber - o.beginningLineNumber + 1,
          m = {
            range: $.create(Z.create(a, 0), Z.create(a + d, 0)),
            text: f.getText(),
          }
        Ae.update(n, [m], 1), Ya(r, o, a), (a = a + d)
      }
    }
    return n
  }
  function Ya(e, t, n) {
    if (t.childrenProperties.length !== 0)
      if (t.type === re.Object) {
        ...
        ;(n = n + i), e.push(new eo(n, t.childrenProperties))
      } else t.type === re.Array && Ka(e, t, n)
  }
  function Ka(e, t, n) {
    for (const r of t.childrenProperties) {
      ...
      r.type === re.Array &&
        Ka(e, r, n + r.beginningLineNumber - t.beginningLineNumber)
    }
  }
  var eo = class {
    constructor(e, t) {
  ...
  function Fc(e) {
    const t = e.promiseConstructor || Promise,
      n = new _c(e.schemaRequestService, e.workspaceContext, t)
    n.setSchemaContributions(kr)
    const r = new sc(n, e.contributions, t, e.clientCapabilities),
      i = new ac(n, e.contributions, t),
      s = new mc(n),
      a = new lc(n, t)
    return {
      configure: (l) => {
      ...
      getFoldingRanges: Lc,
      getSelectionRanges: Nc,
      findDefinition: () => Promise.resolve([]),
      findLinks: Ec,
      format: (l, o, u) => Rr(l, u, o),
      sort: (l, o) => kc(l, o),
    }
  }
  var to
  ...
  var Vc = class {
      constructor(e, t) {
        ;(this._ctx = e),
          ...
          (this._languageService = Fc({
            ...
            schemaRequestService: t.enableSchemaRequest ? to : void 0,
      ...
      _getTextDocument(e) {
        ...
        for (let n of t)
          if (n.uri.toString() === e)
            return Ae.create(e, this._languageId, n.version, n.getValue())
        return null
      }
    },
    Dc = '/'.charCodeAt(0),
    Er = '.'.charCodeAt(0)
  function Oc(e) {
    return e.charCodeAt(0) === Dc
  }
  function Bc(e, t) {
    if (Oc(t)) {
      const n = Ct.parse(e),
        r = t.split('/')
      return n.with({ path: no(r) }).toString()
    }
    return $c(e, t)
  }
  function no(e) {
    ...
    for (const r of e)
      r.length === 0 ||
        (r.length === 1 && r.charCodeAt(0) === Er) ||
        (r.length === 2 && r.charCodeAt(0) === Er && r.charCodeAt(1) === Er
          ? t.pop()
          : t.push(r))
