...
class ACMS_GET_Api_Bing_WebSearch extends ACMS_GET_Api_Bing
{
    var $_scope = array(
        'bid'       => 'global',
        'keyword'   => 'global',
    ...
    function get()
    {
        ...
        $base   = config('api_bing_web_search_base_url');
        ...
        $params = array_clean(array(
            ...
            '$top'          => config('api_bing_web_search_limit'),
            '$skip'         => ($page === 1) ? 0 : (config('api_bing_web_search_limit') * ($page - 1)) + 1,
            'Adult'         => '\''.config('api_bing_web_search_adult').'\'',
        ));
