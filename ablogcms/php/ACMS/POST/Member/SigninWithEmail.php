...
class ACMS_POST_Member_SigninWithEmail extends ACMS_POST_Member_Signin
{
    ...
    {
        return findTemplate(config('mail_auth_signin_tpl_subject'));
    }
    ...
    {
        return findTemplate(config('mail_auth_signin_tpl_body'));
    }
    ...
    {
        return findTemplate(config('mail_auth_signin_tpl_body_html'));
    }
    ...
    {
        return config('mail_auth_signin_from');
    }
