...
class ConfigServer
{
    ...
    protected function getDefinition()
    {
        return array(
            ...
            'REVISON_ARCHIVES_DIR' => 'archives_rev/',
            ...
            'COMMENT_4' => '非同期処理でPHPパスが合わない場合に使用。例1: PHP_BINDIR . \'/php -c /path/to/php.ini\' 例2: \'C:\xampp\php\php.exe\'',
            'PHP_PROCESS_BINARY' => '',
            '6' => 'BR',
            'BID_SEGMENT' => 'bid',
            'AID_SEGMENT' => 'aid',
            ...
            '7' => 'BR',
            'COMMENT_5' => '本番運用時にDEBUG_MODEを 0 に設定して下さい',
            'DEBUG_MODE' => 0,
            'BENCHMARK_MODE' => 0,
        );
    }
